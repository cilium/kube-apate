...
type ClientService interface {
	...
	PostManagementKubernetesIoV1Nodes(params *PostManagementKubernetesIoV1NodesParams) (*PostManagementKubernetesIoV1NodesOK, *PostManagementKubernetesIoV1NodesAccepted, error)
...
*/
func (a *Client) PostManagementKubernetesIoV1Nodes(params *PostManagementKubernetesIoV1NodesParams) (*PostManagementKubernetesIoV1NodesOK, *PostManagementKubernetesIoV1NodesAccepted, error) {
	// TODO: Validate the params before sending
	if params == nil {
		params = NewPostManagementKubernetesIoV1NodesParams()
	}

	result, err := a.transport.Submit(&runtime.ClientOperation{
		ID:                 "PostManagementKubernetesIoV1Nodes",
		Method:             "POST",
		PathPattern:        "/management/kubernetes.io/v1/nodes",
		ProducesMediaTypes: []string{"application/json"},
		ConsumesMediaTypes: []string{"application/json"},
		Schemes:            []string{"http"},
		Params:             params,
		Reader:             &PostManagementKubernetesIoV1NodesReader{formats: a.formats},
		Context:            params.Context,
		Client:             params.HTTPClient,
	})
	if err != nil {
	...
	switch value := result.(type) {
	case *PostManagementKubernetesIoV1NodesOK:
		return value, nil, nil
	case *PostManagementKubernetesIoV1NodesAccepted:
		return nil, value, nil
	}
	// safeguard: normally, absent a default response, unknown success responses return an error above: so this is a codegen issue
	msg := fmt.Sprintf("unexpected success response for cilium: API contract not enforced by server. Client expected to get an error, but got: %T", result)

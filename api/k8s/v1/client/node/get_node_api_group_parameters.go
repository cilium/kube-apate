...
// NewGetNodeAPIGroupParamsWithTimeout creates a new GetNodeAPIGroupParams object
...
// NewGetNodeAPIGroupParamsWithContext creates a new GetNodeAPIGroupParams object
...
// NewGetNodeAPIGroupParamsWithHTTPClient creates a new GetNodeAPIGroupParams object
...
/*GetNodeAPIGroupParams contains all the parameters to send to the API endpoint
for the get node API group operation typically these are written to a http.Request
*/

...
func (o *WatchAdmissionregistrationV1beta1ValidatingWebhookConfigurationReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewWatchAdmissionregistrationV1beta1ValidatingWebhookConfigurationOK()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return result, nil
	case 401:
		result := NewWatchAdmissionregistrationV1beta1ValidatingWebhookConfigurationUnauthorized()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
func (o *WatchAdmissionregistrationV1beta1ValidatingWebhookConfigurationOK) Error() string {
	return fmt.Sprintf("[GET /apis/admissionregistration.k8s.io/v1beta1/watch/validatingwebhookconfigurations/{name}][%d] watchAdmissionregistrationV1beta1ValidatingWebhookConfigurationOK  %+v", 200, o.Payload)
}

func (o *WatchAdmissionregistrationV1beta1ValidatingWebhookConfigurationOK) GetPayload() *models.IoK8sApimachineryPkgApisMetaV1WatchEvent {
	return o.Payload
}

func (o *WatchAdmissionregistrationV1beta1ValidatingWebhookConfigurationOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
...
func (o *WatchAdmissionregistrationV1beta1ValidatingWebhookConfigurationUnauthorized) Error() string {
	return fmt.Sprintf("[GET /apis/admissionregistration.k8s.io/v1beta1/watch/validatingwebhookconfigurations/{name}][%d] watchAdmissionregistrationV1beta1ValidatingWebhookConfigurationUnauthorized ", 401)
}

func (o *WatchAdmissionregistrationV1beta1ValidatingWebhookConfigurationUnauthorized) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {

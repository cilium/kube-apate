...
func (o *PatchAdmissionregistrationV1beta1MutatingWebhookConfigurationReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewPatchAdmissionregistrationV1beta1MutatingWebhookConfigurationOK()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return result, nil
	case 401:
		result := NewPatchAdmissionregistrationV1beta1MutatingWebhookConfigurationUnauthorized()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
func (o *PatchAdmissionregistrationV1beta1MutatingWebhookConfigurationOK) Error() string {
	return fmt.Sprintf("[PATCH /apis/admissionregistration.k8s.io/v1beta1/mutatingwebhookconfigurations/{name}][%d] patchAdmissionregistrationV1beta1MutatingWebhookConfigurationOK  %+v", 200, o.Payload)
}

func (o *PatchAdmissionregistrationV1beta1MutatingWebhookConfigurationOK) GetPayload() *models.IoK8sAPIAdmissionregistrationV1beta1MutatingWebhookConfiguration {
	return o.Payload
}

func (o *PatchAdmissionregistrationV1beta1MutatingWebhookConfigurationOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
...
func (o *PatchAdmissionregistrationV1beta1MutatingWebhookConfigurationUnauthorized) Error() string {
	return fmt.Sprintf("[PATCH /apis/admissionregistration.k8s.io/v1beta1/mutatingwebhookconfigurations/{name}][%d] patchAdmissionregistrationV1beta1MutatingWebhookConfigurationUnauthorized ", 401)
}

func (o *PatchAdmissionregistrationV1beta1MutatingWebhookConfigurationUnauthorized) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {

...
func (o *ListAdmissionregistrationV1beta1MutatingWebhookConfigurationReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewListAdmissionregistrationV1beta1MutatingWebhookConfigurationOK()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return result, nil
	case 401:
		result := NewListAdmissionregistrationV1beta1MutatingWebhookConfigurationUnauthorized()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
func (o *ListAdmissionregistrationV1beta1MutatingWebhookConfigurationOK) Error() string {
	return fmt.Sprintf("[GET /apis/admissionregistration.k8s.io/v1beta1/mutatingwebhookconfigurations][%d] listAdmissionregistrationV1beta1MutatingWebhookConfigurationOK  %+v", 200, o.Payload)
}

func (o *ListAdmissionregistrationV1beta1MutatingWebhookConfigurationOK) GetPayload() *models.IoK8sAPIAdmissionregistrationV1beta1MutatingWebhookConfigurationList {
	return o.Payload
}

func (o *ListAdmissionregistrationV1beta1MutatingWebhookConfigurationOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {

	o.Payload = new(models.IoK8sAPIAdmissionregistrationV1beta1MutatingWebhookConfigurationList)
...
func (o *ListAdmissionregistrationV1beta1MutatingWebhookConfigurationUnauthorized) Error() string {
	return fmt.Sprintf("[GET /apis/admissionregistration.k8s.io/v1beta1/mutatingwebhookconfigurations][%d] listAdmissionregistrationV1beta1MutatingWebhookConfigurationUnauthorized ", 401)
}

func (o *ListAdmissionregistrationV1beta1MutatingWebhookConfigurationUnauthorized) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {

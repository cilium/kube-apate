...
func (o *WatchAutoscalingV2beta1NamespacedHorizontalPodAutoscalerListReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewWatchAutoscalingV2beta1NamespacedHorizontalPodAutoscalerListOK()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return result, nil
	case 401:
		result := NewWatchAutoscalingV2beta1NamespacedHorizontalPodAutoscalerListUnauthorized()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
func (o *WatchAutoscalingV2beta1NamespacedHorizontalPodAutoscalerListOK) Error() string {
	return fmt.Sprintf("[GET /apis/autoscaling/v2beta1/watch/namespaces/{namespace}/horizontalpodautoscalers][%d] watchAutoscalingV2beta1NamespacedHorizontalPodAutoscalerListOK  %+v", 200, o.Payload)
}

func (o *WatchAutoscalingV2beta1NamespacedHorizontalPodAutoscalerListOK) GetPayload() *models.IoK8sApimachineryPkgApisMetaV1WatchEvent {
	return o.Payload
}

func (o *WatchAutoscalingV2beta1NamespacedHorizontalPodAutoscalerListOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
...
func (o *WatchAutoscalingV2beta1NamespacedHorizontalPodAutoscalerListUnauthorized) Error() string {
	return fmt.Sprintf("[GET /apis/autoscaling/v2beta1/watch/namespaces/{namespace}/horizontalpodautoscalers][%d] watchAutoscalingV2beta1NamespacedHorizontalPodAutoscalerListUnauthorized ", 401)
}

func (o *WatchAutoscalingV2beta1NamespacedHorizontalPodAutoscalerListUnauthorized) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {

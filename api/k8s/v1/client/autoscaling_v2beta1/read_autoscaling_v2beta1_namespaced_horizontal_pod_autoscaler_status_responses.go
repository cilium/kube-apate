...
func (o *ReadAutoscalingV2beta1NamespacedHorizontalPodAutoscalerStatusReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewReadAutoscalingV2beta1NamespacedHorizontalPodAutoscalerStatusOK()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return result, nil
	case 401:
		result := NewReadAutoscalingV2beta1NamespacedHorizontalPodAutoscalerStatusUnauthorized()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
func (o *ReadAutoscalingV2beta1NamespacedHorizontalPodAutoscalerStatusOK) Error() string {
	return fmt.Sprintf("[GET /apis/autoscaling/v2beta1/namespaces/{namespace}/horizontalpodautoscalers/{name}/status][%d] readAutoscalingV2beta1NamespacedHorizontalPodAutoscalerStatusOK  %+v", 200, o.Payload)
}

func (o *ReadAutoscalingV2beta1NamespacedHorizontalPodAutoscalerStatusOK) GetPayload() *models.IoK8sAPIAutoscalingV2beta1HorizontalPodAutoscaler {
	return o.Payload
}

func (o *ReadAutoscalingV2beta1NamespacedHorizontalPodAutoscalerStatusOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
...
func (o *ReadAutoscalingV2beta1NamespacedHorizontalPodAutoscalerStatusUnauthorized) Error() string {
	return fmt.Sprintf("[GET /apis/autoscaling/v2beta1/namespaces/{namespace}/horizontalpodautoscalers/{name}/status][%d] readAutoscalingV2beta1NamespacedHorizontalPodAutoscalerStatusUnauthorized ", 401)
}

func (o *ReadAutoscalingV2beta1NamespacedHorizontalPodAutoscalerStatusUnauthorized) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {

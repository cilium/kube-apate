...
func (o *ListAutoscalingV2beta1NamespacedHorizontalPodAutoscalerReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewListAutoscalingV2beta1NamespacedHorizontalPodAutoscalerOK()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return result, nil
	case 401:
		result := NewListAutoscalingV2beta1NamespacedHorizontalPodAutoscalerUnauthorized()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
func (o *ListAutoscalingV2beta1NamespacedHorizontalPodAutoscalerOK) Error() string {
	return fmt.Sprintf("[GET /apis/autoscaling/v2beta1/namespaces/{namespace}/horizontalpodautoscalers][%d] listAutoscalingV2beta1NamespacedHorizontalPodAutoscalerOK  %+v", 200, o.Payload)
}

func (o *ListAutoscalingV2beta1NamespacedHorizontalPodAutoscalerOK) GetPayload() *models.IoK8sAPIAutoscalingV2beta1HorizontalPodAutoscalerList {
	return o.Payload
}

func (o *ListAutoscalingV2beta1NamespacedHorizontalPodAutoscalerOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
...
func (o *ListAutoscalingV2beta1NamespacedHorizontalPodAutoscalerUnauthorized) Error() string {
	return fmt.Sprintf("[GET /apis/autoscaling/v2beta1/namespaces/{namespace}/horizontalpodautoscalers][%d] listAutoscalingV2beta1NamespacedHorizontalPodAutoscalerUnauthorized ", 401)
}

func (o *ListAutoscalingV2beta1NamespacedHorizontalPodAutoscalerUnauthorized) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {

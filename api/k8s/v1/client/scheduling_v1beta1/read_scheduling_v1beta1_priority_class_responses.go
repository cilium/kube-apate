...
func (o *ReadSchedulingV1beta1PriorityClassReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewReadSchedulingV1beta1PriorityClassOK()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return result, nil
	case 401:
		result := NewReadSchedulingV1beta1PriorityClassUnauthorized()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
func (o *ReadSchedulingV1beta1PriorityClassOK) Error() string {
	return fmt.Sprintf("[GET /apis/scheduling.k8s.io/v1beta1/priorityclasses/{name}][%d] readSchedulingV1beta1PriorityClassOK  %+v", 200, o.Payload)
}
...
func (o *ReadSchedulingV1beta1PriorityClassOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
...
func (o *ReadSchedulingV1beta1PriorityClassUnauthorized) Error() string {
	return fmt.Sprintf("[GET /apis/scheduling.k8s.io/v1beta1/priorityclasses/{name}][%d] readSchedulingV1beta1PriorityClassUnauthorized ", 401)
}

func (o *ReadSchedulingV1beta1PriorityClassUnauthorized) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {

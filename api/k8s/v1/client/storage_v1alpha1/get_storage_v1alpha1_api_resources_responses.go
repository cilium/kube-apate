...
func (o *GetStorageV1alpha1APIResourcesReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewGetStorageV1alpha1APIResourcesOK()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return result, nil
	case 401:
		result := NewGetStorageV1alpha1APIResourcesUnauthorized()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
func (o *GetStorageV1alpha1APIResourcesOK) Error() string {
	return fmt.Sprintf("[GET /apis/storage.k8s.io/v1alpha1/][%d] getStorageV1alpha1ApiResourcesOK  %+v", 200, o.Payload)
}
...
func (o *GetStorageV1alpha1APIResourcesOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
...
func (o *GetStorageV1alpha1APIResourcesUnauthorized) Error() string {
	return fmt.Sprintf("[GET /apis/storage.k8s.io/v1alpha1/][%d] getStorageV1alpha1ApiResourcesUnauthorized ", 401)
}

func (o *GetStorageV1alpha1APIResourcesUnauthorized) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {

...
func (a *Client) GetPolicyAPIGroup(params *GetPolicyAPIGroupParams) (*GetPolicyAPIGroupOK, error) {
	...
	if params == nil {
		params = NewGetPolicyAPIGroupParams()
	}

	result, err := a.transport.Submit(&runtime.ClientOperation{
		ID:                 "getPolicyAPIGroup",
		Method:             "GET",
		PathPattern:        "/apis/policy/",
		...
		Schemes:            []string{"http"},
		Params:             params,
		Reader:             &GetPolicyAPIGroupReader{formats: a.formats},
	...
	success, ok := result.(*GetPolicyAPIGroupOK)
	if ok {
		return success, nil
	}
	// unexpected success response
	// safeguard: normally, absent a default response, unknown success responses return an error above: so this is a codegen issue
	msg := fmt.Sprintf("unexpected success response for getPolicyAPIGroup: API contract not enforced by server. Client expected to get an error, but got: %T", result)
	panic(msg)
}

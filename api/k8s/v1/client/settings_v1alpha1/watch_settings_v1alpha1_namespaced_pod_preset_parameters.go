...
// NewWatchSettingsV1alpha1NamespacedPodPresetParamsWithTimeout creates a new WatchSettingsV1alpha1NamespacedPodPresetParams object
...
// NewWatchSettingsV1alpha1NamespacedPodPresetParamsWithContext creates a new WatchSettingsV1alpha1NamespacedPodPresetParams object
...
// NewWatchSettingsV1alpha1NamespacedPodPresetParamsWithHTTPClient creates a new WatchSettingsV1alpha1NamespacedPodPresetParams object
...
/*WatchSettingsV1alpha1NamespacedPodPresetParams contains all the parameters to send to the API endpoint
for the watch settings v1alpha1 namespaced pod preset operation typically these are written to a http.Request
*/
...
func (o *WatchSettingsV1alpha1NamespacedPodPresetParams) WithTimeout(timeout time.Duration) *WatchSettingsV1alpha1NamespacedPodPresetParams {
	o.SetTimeout(timeout)
	return o
}

// SetTimeout adds the timeout to the watch settings v1alpha1 namespaced pod preset params
func (o *WatchSettingsV1alpha1NamespacedPodPresetParams) SetTimeout(timeout time.Duration) {
	o.timeout = timeout
}

// WithContext adds the context to the watch settings v1alpha1 namespaced pod preset params
func (o *WatchSettingsV1alpha1NamespacedPodPresetParams) WithContext(ctx context.Context) *WatchSettingsV1alpha1NamespacedPodPresetParams {
	o.SetContext(ctx)
	return o
}

// SetContext adds the context to the watch settings v1alpha1 namespaced pod preset params
func (o *WatchSettingsV1alpha1NamespacedPodPresetParams) SetContext(ctx context.Context) {
	o.Context = ctx
}

// WithHTTPClient adds the HTTPClient to the watch settings v1alpha1 namespaced pod preset params
func (o *WatchSettingsV1alpha1NamespacedPodPresetParams) WithHTTPClient(client *http.Client) *WatchSettingsV1alpha1NamespacedPodPresetParams {
	o.SetHTTPClient(client)
	return o
}

// SetHTTPClient adds the HTTPClient to the watch settings v1alpha1 namespaced pod preset params
func (o *WatchSettingsV1alpha1NamespacedPodPresetParams) SetHTTPClient(client *http.Client) {
	o.HTTPClient = client
}

// WithAllowWatchBookmarks adds the allowWatchBookmarks to the watch settings v1alpha1 namespaced pod preset params
func (o *WatchSettingsV1alpha1NamespacedPodPresetParams) WithAllowWatchBookmarks(allowWatchBookmarks *bool) *WatchSettingsV1alpha1NamespacedPodPresetParams {
...
func (o *WatchSettingsV1alpha1NamespacedPodPresetParams) WithContinue(continueVar *string) *WatchSettingsV1alpha1NamespacedPodPresetParams {
...
func (o *WatchSettingsV1alpha1NamespacedPodPresetParams) WithFieldSelector(fieldSelector *string) *WatchSettingsV1alpha1NamespacedPodPresetParams {
...
func (o *WatchSettingsV1alpha1NamespacedPodPresetParams) WithLabelSelector(labelSelector *string) *WatchSettingsV1alpha1NamespacedPodPresetParams {
...
func (o *WatchSettingsV1alpha1NamespacedPodPresetParams) WithLimit(limit *int64) *WatchSettingsV1alpha1NamespacedPodPresetParams {
	o.SetLimit(limit)
	return o
}

// SetLimit adds the limit to the watch settings v1alpha1 namespaced pod preset params
func (o *WatchSettingsV1alpha1NamespacedPodPresetParams) SetLimit(limit *int64) {
	o.Limit = limit
}

// WithName adds the name to the watch settings v1alpha1 namespaced pod preset params
func (o *WatchSettingsV1alpha1NamespacedPodPresetParams) WithName(name string) *WatchSettingsV1alpha1NamespacedPodPresetParams {
	o.SetName(name)
	return o
}

// SetName adds the name to the watch settings v1alpha1 namespaced pod preset params
func (o *WatchSettingsV1alpha1NamespacedPodPresetParams) SetName(name string) {
	o.Name = name
}

// WithNamespace adds the namespace to the watch settings v1alpha1 namespaced pod preset params
func (o *WatchSettingsV1alpha1NamespacedPodPresetParams) WithNamespace(namespace string) *WatchSettingsV1alpha1NamespacedPodPresetParams {
...
func (o *WatchSettingsV1alpha1NamespacedPodPresetParams) WithPretty(pretty *string) *WatchSettingsV1alpha1NamespacedPodPresetParams {
	o.SetPretty(pretty)
	return o
}

// SetPretty adds the pretty to the watch settings v1alpha1 namespaced pod preset params
func (o *WatchSettingsV1alpha1NamespacedPodPresetParams) SetPretty(pretty *string) {
	o.Pretty = pretty
}

// WithResourceVersion adds the resourceVersion to the watch settings v1alpha1 namespaced pod preset params
func (o *WatchSettingsV1alpha1NamespacedPodPresetParams) WithResourceVersion(resourceVersion *string) *WatchSettingsV1alpha1NamespacedPodPresetParams {
...
func (o *WatchSettingsV1alpha1NamespacedPodPresetParams) WithResourceVersionMatch(resourceVersionMatch *string) *WatchSettingsV1alpha1NamespacedPodPresetParams {
...
func (o *WatchSettingsV1alpha1NamespacedPodPresetParams) WithTimeoutSeconds(timeoutSeconds *int64) *WatchSettingsV1alpha1NamespacedPodPresetParams {
...
func (o *WatchSettingsV1alpha1NamespacedPodPresetParams) WithWatch(watch *bool) *WatchSettingsV1alpha1NamespacedPodPresetParams {
	o.SetWatch(watch)
	return o
}

// SetWatch adds the watch to the watch settings v1alpha1 namespaced pod preset params
func (o *WatchSettingsV1alpha1NamespacedPodPresetParams) SetWatch(watch *bool) {
	o.Watch = watch
}

// WriteToRequest writes these params to a swagger request
func (o *WatchSettingsV1alpha1NamespacedPodPresetParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {

...
// NewWatchSettingsV1alpha1NamespacedPodPresetListParamsWithTimeout creates a new WatchSettingsV1alpha1NamespacedPodPresetListParams object
...
// NewWatchSettingsV1alpha1NamespacedPodPresetListParamsWithContext creates a new WatchSettingsV1alpha1NamespacedPodPresetListParams object
...
// NewWatchSettingsV1alpha1NamespacedPodPresetListParamsWithHTTPClient creates a new WatchSettingsV1alpha1NamespacedPodPresetListParams object
...
/*WatchSettingsV1alpha1NamespacedPodPresetListParams contains all the parameters to send to the API endpoint
for the watch settings v1alpha1 namespaced pod preset list operation typically these are written to a http.Request
*/
...
func (o *WatchSettingsV1alpha1NamespacedPodPresetListParams) WithTimeout(timeout time.Duration) *WatchSettingsV1alpha1NamespacedPodPresetListParams {
	o.SetTimeout(timeout)
	return o
}

// SetTimeout adds the timeout to the watch settings v1alpha1 namespaced pod preset list params
func (o *WatchSettingsV1alpha1NamespacedPodPresetListParams) SetTimeout(timeout time.Duration) {
	o.timeout = timeout
}

// WithContext adds the context to the watch settings v1alpha1 namespaced pod preset list params
func (o *WatchSettingsV1alpha1NamespacedPodPresetListParams) WithContext(ctx context.Context) *WatchSettingsV1alpha1NamespacedPodPresetListParams {
	o.SetContext(ctx)
	return o
}

// SetContext adds the context to the watch settings v1alpha1 namespaced pod preset list params
func (o *WatchSettingsV1alpha1NamespacedPodPresetListParams) SetContext(ctx context.Context) {
	o.Context = ctx
}

// WithHTTPClient adds the HTTPClient to the watch settings v1alpha1 namespaced pod preset list params
func (o *WatchSettingsV1alpha1NamespacedPodPresetListParams) WithHTTPClient(client *http.Client) *WatchSettingsV1alpha1NamespacedPodPresetListParams {
	o.SetHTTPClient(client)
	return o
}

// SetHTTPClient adds the HTTPClient to the watch settings v1alpha1 namespaced pod preset list params
func (o *WatchSettingsV1alpha1NamespacedPodPresetListParams) SetHTTPClient(client *http.Client) {
	o.HTTPClient = client
}

// WithAllowWatchBookmarks adds the allowWatchBookmarks to the watch settings v1alpha1 namespaced pod preset list params
func (o *WatchSettingsV1alpha1NamespacedPodPresetListParams) WithAllowWatchBookmarks(allowWatchBookmarks *bool) *WatchSettingsV1alpha1NamespacedPodPresetListParams {
...
func (o *WatchSettingsV1alpha1NamespacedPodPresetListParams) WithContinue(continueVar *string) *WatchSettingsV1alpha1NamespacedPodPresetListParams {
...
func (o *WatchSettingsV1alpha1NamespacedPodPresetListParams) WithFieldSelector(fieldSelector *string) *WatchSettingsV1alpha1NamespacedPodPresetListParams {
...
func (o *WatchSettingsV1alpha1NamespacedPodPresetListParams) WithLabelSelector(labelSelector *string) *WatchSettingsV1alpha1NamespacedPodPresetListParams {
...
func (o *WatchSettingsV1alpha1NamespacedPodPresetListParams) WithLimit(limit *int64) *WatchSettingsV1alpha1NamespacedPodPresetListParams {
	o.SetLimit(limit)
	return o
}

// SetLimit adds the limit to the watch settings v1alpha1 namespaced pod preset list params
func (o *WatchSettingsV1alpha1NamespacedPodPresetListParams) SetLimit(limit *int64) {
	o.Limit = limit
}

// WithNamespace adds the namespace to the watch settings v1alpha1 namespaced pod preset list params
func (o *WatchSettingsV1alpha1NamespacedPodPresetListParams) WithNamespace(namespace string) *WatchSettingsV1alpha1NamespacedPodPresetListParams {
	o.SetNamespace(namespace)
	return o
}

// SetNamespace adds the namespace to the watch settings v1alpha1 namespaced pod preset list params
func (o *WatchSettingsV1alpha1NamespacedPodPresetListParams) SetNamespace(namespace string) {
	o.Namespace = namespace
}

// WithPretty adds the pretty to the watch settings v1alpha1 namespaced pod preset list params
func (o *WatchSettingsV1alpha1NamespacedPodPresetListParams) WithPretty(pretty *string) *WatchSettingsV1alpha1NamespacedPodPresetListParams {
	o.SetPretty(pretty)
	return o
}

// SetPretty adds the pretty to the watch settings v1alpha1 namespaced pod preset list params
func (o *WatchSettingsV1alpha1NamespacedPodPresetListParams) SetPretty(pretty *string) {
	o.Pretty = pretty
}

// WithResourceVersion adds the resourceVersion to the watch settings v1alpha1 namespaced pod preset list params
func (o *WatchSettingsV1alpha1NamespacedPodPresetListParams) WithResourceVersion(resourceVersion *string) *WatchSettingsV1alpha1NamespacedPodPresetListParams {
...
func (o *WatchSettingsV1alpha1NamespacedPodPresetListParams) WithResourceVersionMatch(resourceVersionMatch *string) *WatchSettingsV1alpha1NamespacedPodPresetListParams {
...
func (o *WatchSettingsV1alpha1NamespacedPodPresetListParams) WithTimeoutSeconds(timeoutSeconds *int64) *WatchSettingsV1alpha1NamespacedPodPresetListParams {
...
func (o *WatchSettingsV1alpha1NamespacedPodPresetListParams) WithWatch(watch *bool) *WatchSettingsV1alpha1NamespacedPodPresetListParams {
	o.SetWatch(watch)
	return o
}

// SetWatch adds the watch to the watch settings v1alpha1 namespaced pod preset list params
func (o *WatchSettingsV1alpha1NamespacedPodPresetListParams) SetWatch(watch *bool) {
	o.Watch = watch
}

// WriteToRequest writes these params to a swagger request
func (o *WatchSettingsV1alpha1NamespacedPodPresetListParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {

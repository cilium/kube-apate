...
// NewListSettingsV1alpha1PodPresetForAllNamespacesParamsWithTimeout creates a new ListSettingsV1alpha1PodPresetForAllNamespacesParams object
...
// NewListSettingsV1alpha1PodPresetForAllNamespacesParamsWithContext creates a new ListSettingsV1alpha1PodPresetForAllNamespacesParams object
...
// NewListSettingsV1alpha1PodPresetForAllNamespacesParamsWithHTTPClient creates a new ListSettingsV1alpha1PodPresetForAllNamespacesParams object
...
/*ListSettingsV1alpha1PodPresetForAllNamespacesParams contains all the parameters to send to the API endpoint
for the list settings v1alpha1 pod preset for all namespaces operation typically these are written to a http.Request
*/
...
func (o *ListSettingsV1alpha1PodPresetForAllNamespacesParams) WithTimeout(timeout time.Duration) *ListSettingsV1alpha1PodPresetForAllNamespacesParams {
	o.SetTimeout(timeout)
	return o
}

// SetTimeout adds the timeout to the list settings v1alpha1 pod preset for all namespaces params
func (o *ListSettingsV1alpha1PodPresetForAllNamespacesParams) SetTimeout(timeout time.Duration) {
	o.timeout = timeout
}

// WithContext adds the context to the list settings v1alpha1 pod preset for all namespaces params
func (o *ListSettingsV1alpha1PodPresetForAllNamespacesParams) WithContext(ctx context.Context) *ListSettingsV1alpha1PodPresetForAllNamespacesParams {
	o.SetContext(ctx)
	return o
}

// SetContext adds the context to the list settings v1alpha1 pod preset for all namespaces params
func (o *ListSettingsV1alpha1PodPresetForAllNamespacesParams) SetContext(ctx context.Context) {
	o.Context = ctx
}

// WithHTTPClient adds the HTTPClient to the list settings v1alpha1 pod preset for all namespaces params
func (o *ListSettingsV1alpha1PodPresetForAllNamespacesParams) WithHTTPClient(client *http.Client) *ListSettingsV1alpha1PodPresetForAllNamespacesParams {
	o.SetHTTPClient(client)
	return o
}

// SetHTTPClient adds the HTTPClient to the list settings v1alpha1 pod preset for all namespaces params
func (o *ListSettingsV1alpha1PodPresetForAllNamespacesParams) SetHTTPClient(client *http.Client) {
	o.HTTPClient = client
}

// WithAllowWatchBookmarks adds the allowWatchBookmarks to the list settings v1alpha1 pod preset for all namespaces params
func (o *ListSettingsV1alpha1PodPresetForAllNamespacesParams) WithAllowWatchBookmarks(allowWatchBookmarks *bool) *ListSettingsV1alpha1PodPresetForAllNamespacesParams {
...
func (o *ListSettingsV1alpha1PodPresetForAllNamespacesParams) WithContinue(continueVar *string) *ListSettingsV1alpha1PodPresetForAllNamespacesParams {
...
func (o *ListSettingsV1alpha1PodPresetForAllNamespacesParams) WithFieldSelector(fieldSelector *string) *ListSettingsV1alpha1PodPresetForAllNamespacesParams {
...
func (o *ListSettingsV1alpha1PodPresetForAllNamespacesParams) WithLabelSelector(labelSelector *string) *ListSettingsV1alpha1PodPresetForAllNamespacesParams {
...
func (o *ListSettingsV1alpha1PodPresetForAllNamespacesParams) WithLimit(limit *int64) *ListSettingsV1alpha1PodPresetForAllNamespacesParams {
	o.SetLimit(limit)
	return o
}

// SetLimit adds the limit to the list settings v1alpha1 pod preset for all namespaces params
func (o *ListSettingsV1alpha1PodPresetForAllNamespacesParams) SetLimit(limit *int64) {
	o.Limit = limit
}

// WithPretty adds the pretty to the list settings v1alpha1 pod preset for all namespaces params
func (o *ListSettingsV1alpha1PodPresetForAllNamespacesParams) WithPretty(pretty *string) *ListSettingsV1alpha1PodPresetForAllNamespacesParams {
	o.SetPretty(pretty)
	return o
}

// SetPretty adds the pretty to the list settings v1alpha1 pod preset for all namespaces params
func (o *ListSettingsV1alpha1PodPresetForAllNamespacesParams) SetPretty(pretty *string) {
	o.Pretty = pretty
}

// WithResourceVersion adds the resourceVersion to the list settings v1alpha1 pod preset for all namespaces params
func (o *ListSettingsV1alpha1PodPresetForAllNamespacesParams) WithResourceVersion(resourceVersion *string) *ListSettingsV1alpha1PodPresetForAllNamespacesParams {
...
func (o *ListSettingsV1alpha1PodPresetForAllNamespacesParams) WithResourceVersionMatch(resourceVersionMatch *string) *ListSettingsV1alpha1PodPresetForAllNamespacesParams {
...
func (o *ListSettingsV1alpha1PodPresetForAllNamespacesParams) WithTimeoutSeconds(timeoutSeconds *int64) *ListSettingsV1alpha1PodPresetForAllNamespacesParams {
...
func (o *ListSettingsV1alpha1PodPresetForAllNamespacesParams) WithWatch(watch *bool) *ListSettingsV1alpha1PodPresetForAllNamespacesParams {
	o.SetWatch(watch)
	return o
}

// SetWatch adds the watch to the list settings v1alpha1 pod preset for all namespaces params
func (o *ListSettingsV1alpha1PodPresetForAllNamespacesParams) SetWatch(watch *bool) {
	o.Watch = watch
}

// WriteToRequest writes these params to a swagger request
func (o *ListSettingsV1alpha1PodPresetForAllNamespacesParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {

...
// NewWatchSettingsV1alpha1PodPresetListForAllNamespacesParamsWithTimeout creates a new WatchSettingsV1alpha1PodPresetListForAllNamespacesParams object
...
// NewWatchSettingsV1alpha1PodPresetListForAllNamespacesParamsWithContext creates a new WatchSettingsV1alpha1PodPresetListForAllNamespacesParams object
...
// NewWatchSettingsV1alpha1PodPresetListForAllNamespacesParamsWithHTTPClient creates a new WatchSettingsV1alpha1PodPresetListForAllNamespacesParams object
...
/*WatchSettingsV1alpha1PodPresetListForAllNamespacesParams contains all the parameters to send to the API endpoint
for the watch settings v1alpha1 pod preset list for all namespaces operation typically these are written to a http.Request
*/
...
func (o *WatchSettingsV1alpha1PodPresetListForAllNamespacesParams) WithTimeout(timeout time.Duration) *WatchSettingsV1alpha1PodPresetListForAllNamespacesParams {
	o.SetTimeout(timeout)
	return o
}

// SetTimeout adds the timeout to the watch settings v1alpha1 pod preset list for all namespaces params
func (o *WatchSettingsV1alpha1PodPresetListForAllNamespacesParams) SetTimeout(timeout time.Duration) {
	o.timeout = timeout
}

// WithContext adds the context to the watch settings v1alpha1 pod preset list for all namespaces params
func (o *WatchSettingsV1alpha1PodPresetListForAllNamespacesParams) WithContext(ctx context.Context) *WatchSettingsV1alpha1PodPresetListForAllNamespacesParams {
	o.SetContext(ctx)
	return o
}

// SetContext adds the context to the watch settings v1alpha1 pod preset list for all namespaces params
func (o *WatchSettingsV1alpha1PodPresetListForAllNamespacesParams) SetContext(ctx context.Context) {
	o.Context = ctx
}

// WithHTTPClient adds the HTTPClient to the watch settings v1alpha1 pod preset list for all namespaces params
func (o *WatchSettingsV1alpha1PodPresetListForAllNamespacesParams) WithHTTPClient(client *http.Client) *WatchSettingsV1alpha1PodPresetListForAllNamespacesParams {
	o.SetHTTPClient(client)
	return o
}

// SetHTTPClient adds the HTTPClient to the watch settings v1alpha1 pod preset list for all namespaces params
func (o *WatchSettingsV1alpha1PodPresetListForAllNamespacesParams) SetHTTPClient(client *http.Client) {
	o.HTTPClient = client
}
...
func (o *WatchSettingsV1alpha1PodPresetListForAllNamespacesParams) WithAllowWatchBookmarks(allowWatchBookmarks *bool) *WatchSettingsV1alpha1PodPresetListForAllNamespacesParams {
...
func (o *WatchSettingsV1alpha1PodPresetListForAllNamespacesParams) WithContinue(continueVar *string) *WatchSettingsV1alpha1PodPresetListForAllNamespacesParams {
...
func (o *WatchSettingsV1alpha1PodPresetListForAllNamespacesParams) SetContinue(continueVar *string) {
...
func (o *WatchSettingsV1alpha1PodPresetListForAllNamespacesParams) WithFieldSelector(fieldSelector *string) *WatchSettingsV1alpha1PodPresetListForAllNamespacesParams {
...
func (o *WatchSettingsV1alpha1PodPresetListForAllNamespacesParams) WithLabelSelector(labelSelector *string) *WatchSettingsV1alpha1PodPresetListForAllNamespacesParams {
...
func (o *WatchSettingsV1alpha1PodPresetListForAllNamespacesParams) WithLimit(limit *int64) *WatchSettingsV1alpha1PodPresetListForAllNamespacesParams {
	o.SetLimit(limit)
	return o
}

// SetLimit adds the limit to the watch settings v1alpha1 pod preset list for all namespaces params
func (o *WatchSettingsV1alpha1PodPresetListForAllNamespacesParams) SetLimit(limit *int64) {
	o.Limit = limit
}

// WithPretty adds the pretty to the watch settings v1alpha1 pod preset list for all namespaces params
func (o *WatchSettingsV1alpha1PodPresetListForAllNamespacesParams) WithPretty(pretty *string) *WatchSettingsV1alpha1PodPresetListForAllNamespacesParams {
	o.SetPretty(pretty)
	return o
}

// SetPretty adds the pretty to the watch settings v1alpha1 pod preset list for all namespaces params
func (o *WatchSettingsV1alpha1PodPresetListForAllNamespacesParams) SetPretty(pretty *string) {
	o.Pretty = pretty
}

// WithResourceVersion adds the resourceVersion to the watch settings v1alpha1 pod preset list for all namespaces params
func (o *WatchSettingsV1alpha1PodPresetListForAllNamespacesParams) WithResourceVersion(resourceVersion *string) *WatchSettingsV1alpha1PodPresetListForAllNamespacesParams {
...
func (o *WatchSettingsV1alpha1PodPresetListForAllNamespacesParams) WithResourceVersionMatch(resourceVersionMatch *string) *WatchSettingsV1alpha1PodPresetListForAllNamespacesParams {
...
func (o *WatchSettingsV1alpha1PodPresetListForAllNamespacesParams) WithTimeoutSeconds(timeoutSeconds *int64) *WatchSettingsV1alpha1PodPresetListForAllNamespacesParams {
...
func (o *WatchSettingsV1alpha1PodPresetListForAllNamespacesParams) WithWatch(watch *bool) *WatchSettingsV1alpha1PodPresetListForAllNamespacesParams {
	o.SetWatch(watch)
	return o
}

// SetWatch adds the watch to the watch settings v1alpha1 pod preset list for all namespaces params
func (o *WatchSettingsV1alpha1PodPresetListForAllNamespacesParams) SetWatch(watch *bool) {
	o.Watch = watch
}

// WriteToRequest writes these params to a swagger request
func (o *WatchSettingsV1alpha1PodPresetListForAllNamespacesParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {

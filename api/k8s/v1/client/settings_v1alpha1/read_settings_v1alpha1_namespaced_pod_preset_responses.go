...
func (o *ReadSettingsV1alpha1NamespacedPodPresetReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewReadSettingsV1alpha1NamespacedPodPresetOK()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return result, nil
	case 401:
		result := NewReadSettingsV1alpha1NamespacedPodPresetUnauthorized()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
func (o *ReadSettingsV1alpha1NamespacedPodPresetOK) Error() string {
	return fmt.Sprintf("[GET /apis/settings.k8s.io/v1alpha1/namespaces/{namespace}/podpresets/{name}][%d] readSettingsV1alpha1NamespacedPodPresetOK  %+v", 200, o.Payload)
}

func (o *ReadSettingsV1alpha1NamespacedPodPresetOK) GetPayload() *models.IoK8sAPISettingsV1alpha1PodPreset {
	return o.Payload
}

func (o *ReadSettingsV1alpha1NamespacedPodPresetOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
...
func (o *ReadSettingsV1alpha1NamespacedPodPresetUnauthorized) Error() string {
	return fmt.Sprintf("[GET /apis/settings.k8s.io/v1alpha1/namespaces/{namespace}/podpresets/{name}][%d] readSettingsV1alpha1NamespacedPodPresetUnauthorized ", 401)
}

func (o *ReadSettingsV1alpha1NamespacedPodPresetUnauthorized) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {

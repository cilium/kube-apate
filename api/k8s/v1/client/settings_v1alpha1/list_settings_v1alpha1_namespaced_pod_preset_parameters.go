...
// NewListSettingsV1alpha1NamespacedPodPresetParamsWithTimeout creates a new ListSettingsV1alpha1NamespacedPodPresetParams object
...
// NewListSettingsV1alpha1NamespacedPodPresetParamsWithContext creates a new ListSettingsV1alpha1NamespacedPodPresetParams object
...
// NewListSettingsV1alpha1NamespacedPodPresetParamsWithHTTPClient creates a new ListSettingsV1alpha1NamespacedPodPresetParams object
...
/*ListSettingsV1alpha1NamespacedPodPresetParams contains all the parameters to send to the API endpoint
for the list settings v1alpha1 namespaced pod preset operation typically these are written to a http.Request
*/
...
func (o *ListSettingsV1alpha1NamespacedPodPresetParams) WithTimeout(timeout time.Duration) *ListSettingsV1alpha1NamespacedPodPresetParams {
	o.SetTimeout(timeout)
	return o
}

// SetTimeout adds the timeout to the list settings v1alpha1 namespaced pod preset params
func (o *ListSettingsV1alpha1NamespacedPodPresetParams) SetTimeout(timeout time.Duration) {
	o.timeout = timeout
}

// WithContext adds the context to the list settings v1alpha1 namespaced pod preset params
func (o *ListSettingsV1alpha1NamespacedPodPresetParams) WithContext(ctx context.Context) *ListSettingsV1alpha1NamespacedPodPresetParams {
	o.SetContext(ctx)
	return o
}

// SetContext adds the context to the list settings v1alpha1 namespaced pod preset params
func (o *ListSettingsV1alpha1NamespacedPodPresetParams) SetContext(ctx context.Context) {
	o.Context = ctx
}

// WithHTTPClient adds the HTTPClient to the list settings v1alpha1 namespaced pod preset params
func (o *ListSettingsV1alpha1NamespacedPodPresetParams) WithHTTPClient(client *http.Client) *ListSettingsV1alpha1NamespacedPodPresetParams {
...
func (o *ListSettingsV1alpha1NamespacedPodPresetParams) WithAllowWatchBookmarks(allowWatchBookmarks *bool) *ListSettingsV1alpha1NamespacedPodPresetParams {
...
func (o *ListSettingsV1alpha1NamespacedPodPresetParams) WithContinue(continueVar *string) *ListSettingsV1alpha1NamespacedPodPresetParams {
...
func (o *ListSettingsV1alpha1NamespacedPodPresetParams) WithFieldSelector(fieldSelector *string) *ListSettingsV1alpha1NamespacedPodPresetParams {
...
func (o *ListSettingsV1alpha1NamespacedPodPresetParams) WithLabelSelector(labelSelector *string) *ListSettingsV1alpha1NamespacedPodPresetParams {
...
func (o *ListSettingsV1alpha1NamespacedPodPresetParams) WithLimit(limit *int64) *ListSettingsV1alpha1NamespacedPodPresetParams {
	o.SetLimit(limit)
	return o
}

// SetLimit adds the limit to the list settings v1alpha1 namespaced pod preset params
func (o *ListSettingsV1alpha1NamespacedPodPresetParams) SetLimit(limit *int64) {
	o.Limit = limit
}

// WithNamespace adds the namespace to the list settings v1alpha1 namespaced pod preset params
func (o *ListSettingsV1alpha1NamespacedPodPresetParams) WithNamespace(namespace string) *ListSettingsV1alpha1NamespacedPodPresetParams {
...
func (o *ListSettingsV1alpha1NamespacedPodPresetParams) WithPretty(pretty *string) *ListSettingsV1alpha1NamespacedPodPresetParams {
	o.SetPretty(pretty)
	return o
}

// SetPretty adds the pretty to the list settings v1alpha1 namespaced pod preset params
func (o *ListSettingsV1alpha1NamespacedPodPresetParams) SetPretty(pretty *string) {
	o.Pretty = pretty
}

// WithResourceVersion adds the resourceVersion to the list settings v1alpha1 namespaced pod preset params
func (o *ListSettingsV1alpha1NamespacedPodPresetParams) WithResourceVersion(resourceVersion *string) *ListSettingsV1alpha1NamespacedPodPresetParams {
...
func (o *ListSettingsV1alpha1NamespacedPodPresetParams) WithResourceVersionMatch(resourceVersionMatch *string) *ListSettingsV1alpha1NamespacedPodPresetParams {
...
func (o *ListSettingsV1alpha1NamespacedPodPresetParams) WithTimeoutSeconds(timeoutSeconds *int64) *ListSettingsV1alpha1NamespacedPodPresetParams {
...
func (o *ListSettingsV1alpha1NamespacedPodPresetParams) WithWatch(watch *bool) *ListSettingsV1alpha1NamespacedPodPresetParams {
	o.SetWatch(watch)
	return o
}

// SetWatch adds the watch to the list settings v1alpha1 namespaced pod preset params
func (o *ListSettingsV1alpha1NamespacedPodPresetParams) SetWatch(watch *bool) {
	o.Watch = watch
}

// WriteToRequest writes these params to a swagger request
func (o *ListSettingsV1alpha1NamespacedPodPresetParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {

...
// NewDeleteEventsV1CollectionNamespacedEventParamsWithTimeout creates a new DeleteEventsV1CollectionNamespacedEventParams object
...
// NewDeleteEventsV1CollectionNamespacedEventParamsWithContext creates a new DeleteEventsV1CollectionNamespacedEventParams object
...
// NewDeleteEventsV1CollectionNamespacedEventParamsWithHTTPClient creates a new DeleteEventsV1CollectionNamespacedEventParams object
...
/*DeleteEventsV1CollectionNamespacedEventParams contains all the parameters to send to the API endpoint
for the delete events v1 collection namespaced event operation typically these are written to a http.Request
*/

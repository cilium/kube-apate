...
func (o *ReplaceExtensionsV1beta1NamespacedIngressReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewReplaceExtensionsV1beta1NamespacedIngressOK()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return result, nil
	case 201:
		result := NewReplaceExtensionsV1beta1NamespacedIngressCreated()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return result, nil
	case 401:
		result := NewReplaceExtensionsV1beta1NamespacedIngressUnauthorized()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
func (o *ReplaceExtensionsV1beta1NamespacedIngressOK) Error() string {
	return fmt.Sprintf("[PUT /apis/extensions/v1beta1/namespaces/{namespace}/ingresses/{name}][%d] replaceExtensionsV1beta1NamespacedIngressOK  %+v", 200, o.Payload)
}
...
func (o *ReplaceExtensionsV1beta1NamespacedIngressOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
...
func (o *ReplaceExtensionsV1beta1NamespacedIngressCreated) Error() string {
	return fmt.Sprintf("[PUT /apis/extensions/v1beta1/namespaces/{namespace}/ingresses/{name}][%d] replaceExtensionsV1beta1NamespacedIngressCreated  %+v", 201, o.Payload)
}
...
func (o *ReplaceExtensionsV1beta1NamespacedIngressCreated) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
...
func (o *ReplaceExtensionsV1beta1NamespacedIngressUnauthorized) Error() string {
	return fmt.Sprintf("[PUT /apis/extensions/v1beta1/namespaces/{namespace}/ingresses/{name}][%d] replaceExtensionsV1beta1NamespacedIngressUnauthorized ", 401)
}

func (o *ReplaceExtensionsV1beta1NamespacedIngressUnauthorized) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {

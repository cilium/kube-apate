...
func (o *ListExtensionsV1beta1NamespacedIngressReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewListExtensionsV1beta1NamespacedIngressOK()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return result, nil
	case 401:
		result := NewListExtensionsV1beta1NamespacedIngressUnauthorized()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
func (o *ListExtensionsV1beta1NamespacedIngressOK) Error() string {
	return fmt.Sprintf("[GET /apis/extensions/v1beta1/namespaces/{namespace}/ingresses][%d] listExtensionsV1beta1NamespacedIngressOK  %+v", 200, o.Payload)
}
...
func (o *ListExtensionsV1beta1NamespacedIngressOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
...
func (o *ListExtensionsV1beta1NamespacedIngressUnauthorized) Error() string {
	return fmt.Sprintf("[GET /apis/extensions/v1beta1/namespaces/{namespace}/ingresses][%d] listExtensionsV1beta1NamespacedIngressUnauthorized ", 401)
}

func (o *ListExtensionsV1beta1NamespacedIngressUnauthorized) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {

...
func (o *DeleteExtensionsV1beta1NamespacedIngressReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewDeleteExtensionsV1beta1NamespacedIngressOK()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return result, nil
	case 202:
		result := NewDeleteExtensionsV1beta1NamespacedIngressAccepted()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return result, nil
	case 401:
		result := NewDeleteExtensionsV1beta1NamespacedIngressUnauthorized()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
func (o *DeleteExtensionsV1beta1NamespacedIngressOK) Error() string {
	return fmt.Sprintf("[DELETE /apis/extensions/v1beta1/namespaces/{namespace}/ingresses/{name}][%d] deleteExtensionsV1beta1NamespacedIngressOK  %+v", 200, o.Payload)
}
...
func (o *DeleteExtensionsV1beta1NamespacedIngressOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
...
func (o *DeleteExtensionsV1beta1NamespacedIngressAccepted) Error() string {
	return fmt.Sprintf("[DELETE /apis/extensions/v1beta1/namespaces/{namespace}/ingresses/{name}][%d] deleteExtensionsV1beta1NamespacedIngressAccepted  %+v", 202, o.Payload)
}
...
func (o *DeleteExtensionsV1beta1NamespacedIngressAccepted) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
...
func (o *DeleteExtensionsV1beta1NamespacedIngressUnauthorized) Error() string {
	return fmt.Sprintf("[DELETE /apis/extensions/v1beta1/namespaces/{namespace}/ingresses/{name}][%d] deleteExtensionsV1beta1NamespacedIngressUnauthorized ", 401)
}

func (o *DeleteExtensionsV1beta1NamespacedIngressUnauthorized) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {

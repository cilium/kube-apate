...
func (o *ReadExtensionsV1beta1NamespacedIngressStatusReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewReadExtensionsV1beta1NamespacedIngressStatusOK()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return result, nil
	case 401:
		result := NewReadExtensionsV1beta1NamespacedIngressStatusUnauthorized()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
func (o *ReadExtensionsV1beta1NamespacedIngressStatusOK) Error() string {
	return fmt.Sprintf("[GET /apis/extensions/v1beta1/namespaces/{namespace}/ingresses/{name}/status][%d] readExtensionsV1beta1NamespacedIngressStatusOK  %+v", 200, o.Payload)
}
...
func (o *ReadExtensionsV1beta1NamespacedIngressStatusOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
...
func (o *ReadExtensionsV1beta1NamespacedIngressStatusUnauthorized) Error() string {
	return fmt.Sprintf("[GET /apis/extensions/v1beta1/namespaces/{namespace}/ingresses/{name}/status][%d] readExtensionsV1beta1NamespacedIngressStatusUnauthorized ", 401)
}

func (o *ReadExtensionsV1beta1NamespacedIngressStatusUnauthorized) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {

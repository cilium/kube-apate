...
func (o *PatchCertificatesV1CertificateSigningRequestReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewPatchCertificatesV1CertificateSigningRequestOK()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return result, nil
	case 401:
		result := NewPatchCertificatesV1CertificateSigningRequestUnauthorized()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
func (o *PatchCertificatesV1CertificateSigningRequestOK) Error() string {
	return fmt.Sprintf("[PATCH /apis/certificates.k8s.io/v1/certificatesigningrequests/{name}][%d] patchCertificatesV1CertificateSigningRequestOK  %+v", 200, o.Payload)
}
...
func (o *PatchCertificatesV1CertificateSigningRequestOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
...
func (o *PatchCertificatesV1CertificateSigningRequestUnauthorized) Error() string {
	return fmt.Sprintf("[PATCH /apis/certificates.k8s.io/v1/certificatesigningrequests/{name}][%d] patchCertificatesV1CertificateSigningRequestUnauthorized ", 401)
}

func (o *PatchCertificatesV1CertificateSigningRequestUnauthorized) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {

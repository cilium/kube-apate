...
func (o *ReadCertificatesV1CertificateSigningRequestApprovalReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewReadCertificatesV1CertificateSigningRequestApprovalOK()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return result, nil
	case 401:
		result := NewReadCertificatesV1CertificateSigningRequestApprovalUnauthorized()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
func (o *ReadCertificatesV1CertificateSigningRequestApprovalOK) Error() string {
	return fmt.Sprintf("[GET /apis/certificates.k8s.io/v1/certificatesigningrequests/{name}/approval][%d] readCertificatesV1CertificateSigningRequestApprovalOK  %+v", 200, o.Payload)
}

func (o *ReadCertificatesV1CertificateSigningRequestApprovalOK) GetPayload() *models.IoK8sAPICertificatesV1CertificateSigningRequest {
	return o.Payload
}

func (o *ReadCertificatesV1CertificateSigningRequestApprovalOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
...
func (o *ReadCertificatesV1CertificateSigningRequestApprovalUnauthorized) Error() string {
	return fmt.Sprintf("[GET /apis/certificates.k8s.io/v1/certificatesigningrequests/{name}/approval][%d] readCertificatesV1CertificateSigningRequestApprovalUnauthorized ", 401)
}

func (o *ReadCertificatesV1CertificateSigningRequestApprovalUnauthorized) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {

...
func (o *DeleteCertificatesV1CollectionCertificateSigningRequestReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewDeleteCertificatesV1CollectionCertificateSigningRequestOK()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return result, nil
	case 401:
		result := NewDeleteCertificatesV1CollectionCertificateSigningRequestUnauthorized()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
func (o *DeleteCertificatesV1CollectionCertificateSigningRequestOK) Error() string {
	return fmt.Sprintf("[DELETE /apis/certificates.k8s.io/v1/certificatesigningrequests][%d] deleteCertificatesV1CollectionCertificateSigningRequestOK  %+v", 200, o.Payload)
}
...
func (o *DeleteCertificatesV1CollectionCertificateSigningRequestOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
...
func (o *DeleteCertificatesV1CollectionCertificateSigningRequestUnauthorized) Error() string {
	return fmt.Sprintf("[DELETE /apis/certificates.k8s.io/v1/certificatesigningrequests][%d] deleteCertificatesV1CollectionCertificateSigningRequestUnauthorized ", 401)
}

func (o *DeleteCertificatesV1CollectionCertificateSigningRequestUnauthorized) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {

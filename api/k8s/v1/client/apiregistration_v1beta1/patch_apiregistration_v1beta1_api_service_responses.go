...
func (o *PatchApiregistrationV1beta1APIServiceReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewPatchApiregistrationV1beta1APIServiceOK()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return result, nil
	case 401:
		result := NewPatchApiregistrationV1beta1APIServiceUnauthorized()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
func (o *PatchApiregistrationV1beta1APIServiceOK) Error() string {
	return fmt.Sprintf("[PATCH /apis/apiregistration.k8s.io/v1beta1/apiservices/{name}][%d] patchApiregistrationV1beta1ApiServiceOK  %+v", 200, o.Payload)
}

func (o *PatchApiregistrationV1beta1APIServiceOK) GetPayload() *models.IoK8sKubeAggregatorPkgApisApiregistrationV1beta1APIService {
	return o.Payload
}

func (o *PatchApiregistrationV1beta1APIServiceOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
...
func (o *PatchApiregistrationV1beta1APIServiceUnauthorized) Error() string {
	return fmt.Sprintf("[PATCH /apis/apiregistration.k8s.io/v1beta1/apiservices/{name}][%d] patchApiregistrationV1beta1ApiServiceUnauthorized ", 401)
}

func (o *PatchApiregistrationV1beta1APIServiceUnauthorized) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {

...
// NewListApiregistrationV1beta1APIServiceParamsWithTimeout creates a new ListApiregistrationV1beta1APIServiceParams object
...
// NewListApiregistrationV1beta1APIServiceParamsWithContext creates a new ListApiregistrationV1beta1APIServiceParams object
...
// NewListApiregistrationV1beta1APIServiceParamsWithHTTPClient creates a new ListApiregistrationV1beta1APIServiceParams object
...
/*ListApiregistrationV1beta1APIServiceParams contains all the parameters to send to the API endpoint
for the list apiregistration v1beta1 API service operation typically these are written to a http.Request
*/
...
func (o *ListApiregistrationV1beta1APIServiceParams) WithTimeout(timeout time.Duration) *ListApiregistrationV1beta1APIServiceParams {
	o.SetTimeout(timeout)
	return o
}

// SetTimeout adds the timeout to the list apiregistration v1beta1 API service params
func (o *ListApiregistrationV1beta1APIServiceParams) SetTimeout(timeout time.Duration) {
	o.timeout = timeout
}

// WithContext adds the context to the list apiregistration v1beta1 API service params
func (o *ListApiregistrationV1beta1APIServiceParams) WithContext(ctx context.Context) *ListApiregistrationV1beta1APIServiceParams {
	o.SetContext(ctx)
	return o
}

// SetContext adds the context to the list apiregistration v1beta1 API service params
func (o *ListApiregistrationV1beta1APIServiceParams) SetContext(ctx context.Context) {
	o.Context = ctx
}

// WithHTTPClient adds the HTTPClient to the list apiregistration v1beta1 API service params
func (o *ListApiregistrationV1beta1APIServiceParams) WithHTTPClient(client *http.Client) *ListApiregistrationV1beta1APIServiceParams {
...
func (o *ListApiregistrationV1beta1APIServiceParams) WithContinue(continueVar *string) *ListApiregistrationV1beta1APIServiceParams {
...
func (o *ListApiregistrationV1beta1APIServiceParams) WithFieldSelector(fieldSelector *string) *ListApiregistrationV1beta1APIServiceParams {
...
func (o *ListApiregistrationV1beta1APIServiceParams) WithLabelSelector(labelSelector *string) *ListApiregistrationV1beta1APIServiceParams {
...
func (o *ListApiregistrationV1beta1APIServiceParams) WithLimit(limit *int64) *ListApiregistrationV1beta1APIServiceParams {
	o.SetLimit(limit)
	return o
}

// SetLimit adds the limit to the list apiregistration v1beta1 API service params
func (o *ListApiregistrationV1beta1APIServiceParams) SetLimit(limit *int64) {
	o.Limit = limit
}

// WithPretty adds the pretty to the list apiregistration v1beta1 API service params
func (o *ListApiregistrationV1beta1APIServiceParams) WithPretty(pretty *string) *ListApiregistrationV1beta1APIServiceParams {
	o.SetPretty(pretty)
	return o
}
...
func (o *ListApiregistrationV1beta1APIServiceParams) WithResourceVersion(resourceVersion *string) *ListApiregistrationV1beta1APIServiceParams {
...
func (o *ListApiregistrationV1beta1APIServiceParams) WithTimeoutSeconds(timeoutSeconds *int64) *ListApiregistrationV1beta1APIServiceParams {
...
func (o *ListApiregistrationV1beta1APIServiceParams) WithWatch(watch *bool) *ListApiregistrationV1beta1APIServiceParams {
	o.SetWatch(watch)
	return o
}

// SetWatch adds the watch to the list apiregistration v1beta1 API service params
func (o *ListApiregistrationV1beta1APIServiceParams) SetWatch(watch *bool) {
	o.Watch = watch
}

// WriteToRequest writes these params to a swagger request
func (o *ListApiregistrationV1beta1APIServiceParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {

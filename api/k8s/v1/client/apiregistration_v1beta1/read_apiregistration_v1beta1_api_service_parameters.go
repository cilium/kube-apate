...
// NewReadApiregistrationV1beta1APIServiceParamsWithTimeout creates a new ReadApiregistrationV1beta1APIServiceParams object
...
// NewReadApiregistrationV1beta1APIServiceParamsWithContext creates a new ReadApiregistrationV1beta1APIServiceParams object
...
// NewReadApiregistrationV1beta1APIServiceParamsWithHTTPClient creates a new ReadApiregistrationV1beta1APIServiceParams object
...
/*ReadApiregistrationV1beta1APIServiceParams contains all the parameters to send to the API endpoint
for the read apiregistration v1beta1 API service operation typically these are written to a http.Request
*/
...
func (o *ReadApiregistrationV1beta1APIServiceParams) WithTimeout(timeout time.Duration) *ReadApiregistrationV1beta1APIServiceParams {
	o.SetTimeout(timeout)
	return o
}

// SetTimeout adds the timeout to the read apiregistration v1beta1 API service params
func (o *ReadApiregistrationV1beta1APIServiceParams) SetTimeout(timeout time.Duration) {
	o.timeout = timeout
}

// WithContext adds the context to the read apiregistration v1beta1 API service params
func (o *ReadApiregistrationV1beta1APIServiceParams) WithContext(ctx context.Context) *ReadApiregistrationV1beta1APIServiceParams {
	o.SetContext(ctx)
	return o
}

// SetContext adds the context to the read apiregistration v1beta1 API service params
func (o *ReadApiregistrationV1beta1APIServiceParams) SetContext(ctx context.Context) {
	o.Context = ctx
}

// WithHTTPClient adds the HTTPClient to the read apiregistration v1beta1 API service params
func (o *ReadApiregistrationV1beta1APIServiceParams) WithHTTPClient(client *http.Client) *ReadApiregistrationV1beta1APIServiceParams {
...
func (o *ReadApiregistrationV1beta1APIServiceParams) WithExact(exact *bool) *ReadApiregistrationV1beta1APIServiceParams {
	o.SetExact(exact)
	return o
}

// SetExact adds the exact to the read apiregistration v1beta1 API service params
func (o *ReadApiregistrationV1beta1APIServiceParams) SetExact(exact *bool) {
	o.Exact = exact
}

// WithExport adds the export to the read apiregistration v1beta1 API service params
func (o *ReadApiregistrationV1beta1APIServiceParams) WithExport(export *bool) *ReadApiregistrationV1beta1APIServiceParams {
	o.SetExport(export)
	return o
}
...
func (o *ReadApiregistrationV1beta1APIServiceParams) WithName(name string) *ReadApiregistrationV1beta1APIServiceParams {
	o.SetName(name)
	return o
}

// SetName adds the name to the read apiregistration v1beta1 API service params
func (o *ReadApiregistrationV1beta1APIServiceParams) SetName(name string) {
	o.Name = name
}

// WithPretty adds the pretty to the read apiregistration v1beta1 API service params
func (o *ReadApiregistrationV1beta1APIServiceParams) WithPretty(pretty *string) *ReadApiregistrationV1beta1APIServiceParams {
	o.SetPretty(pretty)
	return o
}
...
func (o *ReadApiregistrationV1beta1APIServiceParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {

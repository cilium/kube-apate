...
func (o *DeleteApiregistrationV1beta1APIServiceReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewDeleteApiregistrationV1beta1APIServiceOK()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return result, nil
	case 202:
		result := NewDeleteApiregistrationV1beta1APIServiceAccepted()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return result, nil
	case 401:
		result := NewDeleteApiregistrationV1beta1APIServiceUnauthorized()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
func (o *DeleteApiregistrationV1beta1APIServiceOK) Error() string {
	return fmt.Sprintf("[DELETE /apis/apiregistration.k8s.io/v1beta1/apiservices/{name}][%d] deleteApiregistrationV1beta1ApiServiceOK  %+v", 200, o.Payload)
}

func (o *DeleteApiregistrationV1beta1APIServiceOK) GetPayload() *models.IoK8sApimachineryPkgApisMetaV1Status {
	return o.Payload
}

func (o *DeleteApiregistrationV1beta1APIServiceOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
...
func (o *DeleteApiregistrationV1beta1APIServiceAccepted) Error() string {
	return fmt.Sprintf("[DELETE /apis/apiregistration.k8s.io/v1beta1/apiservices/{name}][%d] deleteApiregistrationV1beta1ApiServiceAccepted  %+v", 202, o.Payload)
}

func (o *DeleteApiregistrationV1beta1APIServiceAccepted) GetPayload() *models.IoK8sApimachineryPkgApisMetaV1Status {
	return o.Payload
}

func (o *DeleteApiregistrationV1beta1APIServiceAccepted) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
...
func (o *DeleteApiregistrationV1beta1APIServiceUnauthorized) Error() string {
	return fmt.Sprintf("[DELETE /apis/apiregistration.k8s.io/v1beta1/apiservices/{name}][%d] deleteApiregistrationV1beta1ApiServiceUnauthorized ", 401)
}

func (o *DeleteApiregistrationV1beta1APIServiceUnauthorized) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {

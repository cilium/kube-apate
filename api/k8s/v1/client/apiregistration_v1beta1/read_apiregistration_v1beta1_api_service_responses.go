...
func (o *ReadApiregistrationV1beta1APIServiceReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewReadApiregistrationV1beta1APIServiceOK()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return result, nil
	case 401:
		result := NewReadApiregistrationV1beta1APIServiceUnauthorized()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
func (o *ReadApiregistrationV1beta1APIServiceOK) Error() string {
	return fmt.Sprintf("[GET /apis/apiregistration.k8s.io/v1beta1/apiservices/{name}][%d] readApiregistrationV1beta1ApiServiceOK  %+v", 200, o.Payload)
}

func (o *ReadApiregistrationV1beta1APIServiceOK) GetPayload() *models.IoK8sKubeAggregatorPkgApisApiregistrationV1beta1APIService {
	return o.Payload
}

func (o *ReadApiregistrationV1beta1APIServiceOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
...
func (o *ReadApiregistrationV1beta1APIServiceUnauthorized) Error() string {
	return fmt.Sprintf("[GET /apis/apiregistration.k8s.io/v1beta1/apiservices/{name}][%d] readApiregistrationV1beta1ApiServiceUnauthorized ", 401)
}

func (o *ReadApiregistrationV1beta1APIServiceUnauthorized) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {

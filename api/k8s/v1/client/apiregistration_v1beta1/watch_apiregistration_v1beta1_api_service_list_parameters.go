...
// NewWatchApiregistrationV1beta1APIServiceListParamsWithTimeout creates a new WatchApiregistrationV1beta1APIServiceListParams object
...
// NewWatchApiregistrationV1beta1APIServiceListParamsWithContext creates a new WatchApiregistrationV1beta1APIServiceListParams object
...
// NewWatchApiregistrationV1beta1APIServiceListParamsWithHTTPClient creates a new WatchApiregistrationV1beta1APIServiceListParams object
...
/*WatchApiregistrationV1beta1APIServiceListParams contains all the parameters to send to the API endpoint
for the watch apiregistration v1beta1 API service list operation typically these are written to a http.Request
*/
...
func (o *WatchApiregistrationV1beta1APIServiceListParams) WithTimeout(timeout time.Duration) *WatchApiregistrationV1beta1APIServiceListParams {
	o.SetTimeout(timeout)
	return o
}

// SetTimeout adds the timeout to the watch apiregistration v1beta1 API service list params
func (o *WatchApiregistrationV1beta1APIServiceListParams) SetTimeout(timeout time.Duration) {
	o.timeout = timeout
}

// WithContext adds the context to the watch apiregistration v1beta1 API service list params
func (o *WatchApiregistrationV1beta1APIServiceListParams) WithContext(ctx context.Context) *WatchApiregistrationV1beta1APIServiceListParams {
	o.SetContext(ctx)
	return o
}

// SetContext adds the context to the watch apiregistration v1beta1 API service list params
func (o *WatchApiregistrationV1beta1APIServiceListParams) SetContext(ctx context.Context) {
	o.Context = ctx
}

// WithHTTPClient adds the HTTPClient to the watch apiregistration v1beta1 API service list params
func (o *WatchApiregistrationV1beta1APIServiceListParams) WithHTTPClient(client *http.Client) *WatchApiregistrationV1beta1APIServiceListParams {
	o.SetHTTPClient(client)
	return o
}

// SetHTTPClient adds the HTTPClient to the watch apiregistration v1beta1 API service list params
func (o *WatchApiregistrationV1beta1APIServiceListParams) SetHTTPClient(client *http.Client) {
	o.HTTPClient = client
}

// WithAllowWatchBookmarks adds the allowWatchBookmarks to the watch apiregistration v1beta1 API service list params
func (o *WatchApiregistrationV1beta1APIServiceListParams) WithAllowWatchBookmarks(allowWatchBookmarks *bool) *WatchApiregistrationV1beta1APIServiceListParams {
...
func (o *WatchApiregistrationV1beta1APIServiceListParams) WithContinue(continueVar *string) *WatchApiregistrationV1beta1APIServiceListParams {
...
func (o *WatchApiregistrationV1beta1APIServiceListParams) WithFieldSelector(fieldSelector *string) *WatchApiregistrationV1beta1APIServiceListParams {
...
func (o *WatchApiregistrationV1beta1APIServiceListParams) WithLabelSelector(labelSelector *string) *WatchApiregistrationV1beta1APIServiceListParams {
...
func (o *WatchApiregistrationV1beta1APIServiceListParams) WithLimit(limit *int64) *WatchApiregistrationV1beta1APIServiceListParams {
	o.SetLimit(limit)
	return o
}

// SetLimit adds the limit to the watch apiregistration v1beta1 API service list params
func (o *WatchApiregistrationV1beta1APIServiceListParams) SetLimit(limit *int64) {
	o.Limit = limit
}

// WithPretty adds the pretty to the watch apiregistration v1beta1 API service list params
func (o *WatchApiregistrationV1beta1APIServiceListParams) WithPretty(pretty *string) *WatchApiregistrationV1beta1APIServiceListParams {
	o.SetPretty(pretty)
	return o
}

// SetPretty adds the pretty to the watch apiregistration v1beta1 API service list params
func (o *WatchApiregistrationV1beta1APIServiceListParams) SetPretty(pretty *string) {
	o.Pretty = pretty
}

// WithResourceVersion adds the resourceVersion to the watch apiregistration v1beta1 API service list params
func (o *WatchApiregistrationV1beta1APIServiceListParams) WithResourceVersion(resourceVersion *string) *WatchApiregistrationV1beta1APIServiceListParams {
...
func (o *WatchApiregistrationV1beta1APIServiceListParams) WithResourceVersionMatch(resourceVersionMatch *string) *WatchApiregistrationV1beta1APIServiceListParams {
...
func (o *WatchApiregistrationV1beta1APIServiceListParams) WithTimeoutSeconds(timeoutSeconds *int64) *WatchApiregistrationV1beta1APIServiceListParams {
...
func (o *WatchApiregistrationV1beta1APIServiceListParams) WithWatch(watch *bool) *WatchApiregistrationV1beta1APIServiceListParams {
	o.SetWatch(watch)
	return o
}

// SetWatch adds the watch to the watch apiregistration v1beta1 API service list params
func (o *WatchApiregistrationV1beta1APIServiceListParams) SetWatch(watch *bool) {
	o.Watch = watch
}

// WriteToRequest writes these params to a swagger request
func (o *WatchApiregistrationV1beta1APIServiceListParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {

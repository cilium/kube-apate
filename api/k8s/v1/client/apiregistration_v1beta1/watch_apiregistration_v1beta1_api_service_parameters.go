...
// NewWatchApiregistrationV1beta1APIServiceParamsWithTimeout creates a new WatchApiregistrationV1beta1APIServiceParams object
...
// NewWatchApiregistrationV1beta1APIServiceParamsWithContext creates a new WatchApiregistrationV1beta1APIServiceParams object
...
// NewWatchApiregistrationV1beta1APIServiceParamsWithHTTPClient creates a new WatchApiregistrationV1beta1APIServiceParams object
...
/*WatchApiregistrationV1beta1APIServiceParams contains all the parameters to send to the API endpoint
for the watch apiregistration v1beta1 API service operation typically these are written to a http.Request
*/
...
func (o *WatchApiregistrationV1beta1APIServiceParams) WithTimeout(timeout time.Duration) *WatchApiregistrationV1beta1APIServiceParams {
	o.SetTimeout(timeout)
	return o
}

// SetTimeout adds the timeout to the watch apiregistration v1beta1 API service params
func (o *WatchApiregistrationV1beta1APIServiceParams) SetTimeout(timeout time.Duration) {
	o.timeout = timeout
}

// WithContext adds the context to the watch apiregistration v1beta1 API service params
func (o *WatchApiregistrationV1beta1APIServiceParams) WithContext(ctx context.Context) *WatchApiregistrationV1beta1APIServiceParams {
	o.SetContext(ctx)
	return o
}

// SetContext adds the context to the watch apiregistration v1beta1 API service params
func (o *WatchApiregistrationV1beta1APIServiceParams) SetContext(ctx context.Context) {
	o.Context = ctx
}

// WithHTTPClient adds the HTTPClient to the watch apiregistration v1beta1 API service params
func (o *WatchApiregistrationV1beta1APIServiceParams) WithHTTPClient(client *http.Client) *WatchApiregistrationV1beta1APIServiceParams {
...
func (o *WatchApiregistrationV1beta1APIServiceParams) WithContinue(continueVar *string) *WatchApiregistrationV1beta1APIServiceParams {
...
func (o *WatchApiregistrationV1beta1APIServiceParams) WithFieldSelector(fieldSelector *string) *WatchApiregistrationV1beta1APIServiceParams {
...
func (o *WatchApiregistrationV1beta1APIServiceParams) WithLabelSelector(labelSelector *string) *WatchApiregistrationV1beta1APIServiceParams {
...
func (o *WatchApiregistrationV1beta1APIServiceParams) WithLimit(limit *int64) *WatchApiregistrationV1beta1APIServiceParams {
	o.SetLimit(limit)
	return o
}

// SetLimit adds the limit to the watch apiregistration v1beta1 API service params
func (o *WatchApiregistrationV1beta1APIServiceParams) SetLimit(limit *int64) {
	o.Limit = limit
}

// WithName adds the name to the watch apiregistration v1beta1 API service params
func (o *WatchApiregistrationV1beta1APIServiceParams) WithName(name string) *WatchApiregistrationV1beta1APIServiceParams {
	o.SetName(name)
	return o
}

// SetName adds the name to the watch apiregistration v1beta1 API service params
func (o *WatchApiregistrationV1beta1APIServiceParams) SetName(name string) {
	o.Name = name
}

// WithPretty adds the pretty to the watch apiregistration v1beta1 API service params
func (o *WatchApiregistrationV1beta1APIServiceParams) WithPretty(pretty *string) *WatchApiregistrationV1beta1APIServiceParams {
	o.SetPretty(pretty)
	return o
}

// SetPretty adds the pretty to the watch apiregistration v1beta1 API service params
func (o *WatchApiregistrationV1beta1APIServiceParams) SetPretty(pretty *string) {
	o.Pretty = pretty
}

// WithResourceVersion adds the resourceVersion to the watch apiregistration v1beta1 API service params
func (o *WatchApiregistrationV1beta1APIServiceParams) WithResourceVersion(resourceVersion *string) *WatchApiregistrationV1beta1APIServiceParams {
...
func (o *WatchApiregistrationV1beta1APIServiceParams) WithTimeoutSeconds(timeoutSeconds *int64) *WatchApiregistrationV1beta1APIServiceParams {
...
func (o *WatchApiregistrationV1beta1APIServiceParams) WithWatch(watch *bool) *WatchApiregistrationV1beta1APIServiceParams {
	o.SetWatch(watch)
	return o
}

// SetWatch adds the watch to the watch apiregistration v1beta1 API service params
func (o *WatchApiregistrationV1beta1APIServiceParams) SetWatch(watch *bool) {
	o.Watch = watch
}

// WriteToRequest writes these params to a swagger request
func (o *WatchApiregistrationV1beta1APIServiceParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {

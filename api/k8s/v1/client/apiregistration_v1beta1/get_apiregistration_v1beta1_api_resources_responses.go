...
func (o *GetApiregistrationV1beta1APIResourcesReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewGetApiregistrationV1beta1APIResourcesOK()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return result, nil
	case 401:
		result := NewGetApiregistrationV1beta1APIResourcesUnauthorized()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
func (o *GetApiregistrationV1beta1APIResourcesOK) Error() string {
	return fmt.Sprintf("[GET /apis/apiregistration.k8s.io/v1beta1/][%d] getApiregistrationV1beta1ApiResourcesOK  %+v", 200, o.Payload)
}

func (o *GetApiregistrationV1beta1APIResourcesOK) GetPayload() *models.IoK8sApimachineryPkgApisMetaV1APIResourceList {
	return o.Payload
}

func (o *GetApiregistrationV1beta1APIResourcesOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
...
func (o *GetApiregistrationV1beta1APIResourcesUnauthorized) Error() string {
	return fmt.Sprintf("[GET /apis/apiregistration.k8s.io/v1beta1/][%d] getApiregistrationV1beta1ApiResourcesUnauthorized ", 401)
}

func (o *GetApiregistrationV1beta1APIResourcesUnauthorized) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {

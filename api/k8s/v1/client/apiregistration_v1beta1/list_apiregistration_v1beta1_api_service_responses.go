...
func (o *ListApiregistrationV1beta1APIServiceReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewListApiregistrationV1beta1APIServiceOK()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return result, nil
	case 401:
		result := NewListApiregistrationV1beta1APIServiceUnauthorized()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
func (o *ListApiregistrationV1beta1APIServiceOK) Error() string {
	return fmt.Sprintf("[GET /apis/apiregistration.k8s.io/v1beta1/apiservices][%d] listApiregistrationV1beta1ApiServiceOK  %+v", 200, o.Payload)
}

func (o *ListApiregistrationV1beta1APIServiceOK) GetPayload() *models.IoK8sKubeAggregatorPkgApisApiregistrationV1beta1APIServiceList {
	return o.Payload
}

func (o *ListApiregistrationV1beta1APIServiceOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {

	o.Payload = new(models.IoK8sKubeAggregatorPkgApisApiregistrationV1beta1APIServiceList)
...
func (o *ListApiregistrationV1beta1APIServiceUnauthorized) Error() string {
	return fmt.Sprintf("[GET /apis/apiregistration.k8s.io/v1beta1/apiservices][%d] listApiregistrationV1beta1ApiServiceUnauthorized ", 401)
}

func (o *ListApiregistrationV1beta1APIServiceUnauthorized) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {

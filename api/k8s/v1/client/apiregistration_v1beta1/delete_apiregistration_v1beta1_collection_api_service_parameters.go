...
// NewDeleteApiregistrationV1beta1CollectionAPIServiceParamsWithTimeout creates a new DeleteApiregistrationV1beta1CollectionAPIServiceParams object
...
// NewDeleteApiregistrationV1beta1CollectionAPIServiceParamsWithContext creates a new DeleteApiregistrationV1beta1CollectionAPIServiceParams object
...
// NewDeleteApiregistrationV1beta1CollectionAPIServiceParamsWithHTTPClient creates a new DeleteApiregistrationV1beta1CollectionAPIServiceParams object
...
/*DeleteApiregistrationV1beta1CollectionAPIServiceParams contains all the parameters to send to the API endpoint
for the delete apiregistration v1beta1 collection API service operation typically these are written to a http.Request
*/
...
func (o *DeleteApiregistrationV1beta1CollectionAPIServiceParams) WithTimeout(timeout time.Duration) *DeleteApiregistrationV1beta1CollectionAPIServiceParams {
	o.SetTimeout(timeout)
	return o
}

// SetTimeout adds the timeout to the delete apiregistration v1beta1 collection API service params
func (o *DeleteApiregistrationV1beta1CollectionAPIServiceParams) SetTimeout(timeout time.Duration) {
	o.timeout = timeout
}

// WithContext adds the context to the delete apiregistration v1beta1 collection API service params
func (o *DeleteApiregistrationV1beta1CollectionAPIServiceParams) WithContext(ctx context.Context) *DeleteApiregistrationV1beta1CollectionAPIServiceParams {
	o.SetContext(ctx)
	return o
}

// SetContext adds the context to the delete apiregistration v1beta1 collection API service params
func (o *DeleteApiregistrationV1beta1CollectionAPIServiceParams) SetContext(ctx context.Context) {
	o.Context = ctx
}

// WithHTTPClient adds the HTTPClient to the delete apiregistration v1beta1 collection API service params
func (o *DeleteApiregistrationV1beta1CollectionAPIServiceParams) WithHTTPClient(client *http.Client) *DeleteApiregistrationV1beta1CollectionAPIServiceParams {
	o.SetHTTPClient(client)
	return o
}

// SetHTTPClient adds the HTTPClient to the delete apiregistration v1beta1 collection API service params
func (o *DeleteApiregistrationV1beta1CollectionAPIServiceParams) SetHTTPClient(client *http.Client) {
	o.HTTPClient = client
}

// WithBody adds the body to the delete apiregistration v1beta1 collection API service params
func (o *DeleteApiregistrationV1beta1CollectionAPIServiceParams) WithBody(body *models.IoK8sApimachineryPkgApisMetaV1DeleteOptions) *DeleteApiregistrationV1beta1CollectionAPIServiceParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the delete apiregistration v1beta1 collection API service params
func (o *DeleteApiregistrationV1beta1CollectionAPIServiceParams) SetBody(body *models.IoK8sApimachineryPkgApisMetaV1DeleteOptions) {
	o.Body = body
}

// WithContinue adds the continueVar to the delete apiregistration v1beta1 collection API service params
func (o *DeleteApiregistrationV1beta1CollectionAPIServiceParams) WithContinue(continueVar *string) *DeleteApiregistrationV1beta1CollectionAPIServiceParams {
...
func (o *DeleteApiregistrationV1beta1CollectionAPIServiceParams) SetContinue(continueVar *string) {
	o.Continue = continueVar
}

// WithDryRun adds the dryRun to the delete apiregistration v1beta1 collection API service params
func (o *DeleteApiregistrationV1beta1CollectionAPIServiceParams) WithDryRun(dryRun *string) *DeleteApiregistrationV1beta1CollectionAPIServiceParams {
	o.SetDryRun(dryRun)
	return o
}

// SetDryRun adds the dryRun to the delete apiregistration v1beta1 collection API service params
func (o *DeleteApiregistrationV1beta1CollectionAPIServiceParams) SetDryRun(dryRun *string) {
	o.DryRun = dryRun
}

// WithFieldSelector adds the fieldSelector to the delete apiregistration v1beta1 collection API service params
func (o *DeleteApiregistrationV1beta1CollectionAPIServiceParams) WithFieldSelector(fieldSelector *string) *DeleteApiregistrationV1beta1CollectionAPIServiceParams {
...
func (o *DeleteApiregistrationV1beta1CollectionAPIServiceParams) WithGracePeriodSeconds(gracePeriodSeconds *int64) *DeleteApiregistrationV1beta1CollectionAPIServiceParams {
...
func (o *DeleteApiregistrationV1beta1CollectionAPIServiceParams) WithLabelSelector(labelSelector *string) *DeleteApiregistrationV1beta1CollectionAPIServiceParams {
...
func (o *DeleteApiregistrationV1beta1CollectionAPIServiceParams) WithLimit(limit *int64) *DeleteApiregistrationV1beta1CollectionAPIServiceParams {
	o.SetLimit(limit)
	return o
}

// SetLimit adds the limit to the delete apiregistration v1beta1 collection API service params
func (o *DeleteApiregistrationV1beta1CollectionAPIServiceParams) SetLimit(limit *int64) {
	o.Limit = limit
}

// WithOrphanDependents adds the orphanDependents to the delete apiregistration v1beta1 collection API service params
func (o *DeleteApiregistrationV1beta1CollectionAPIServiceParams) WithOrphanDependents(orphanDependents *bool) *DeleteApiregistrationV1beta1CollectionAPIServiceParams {
...
func (o *DeleteApiregistrationV1beta1CollectionAPIServiceParams) WithPretty(pretty *string) *DeleteApiregistrationV1beta1CollectionAPIServiceParams {
	o.SetPretty(pretty)
	return o
}

// SetPretty adds the pretty to the delete apiregistration v1beta1 collection API service params
func (o *DeleteApiregistrationV1beta1CollectionAPIServiceParams) SetPretty(pretty *string) {
	o.Pretty = pretty
}

// WithPropagationPolicy adds the propagationPolicy to the delete apiregistration v1beta1 collection API service params
func (o *DeleteApiregistrationV1beta1CollectionAPIServiceParams) WithPropagationPolicy(propagationPolicy *string) *DeleteApiregistrationV1beta1CollectionAPIServiceParams {
...
func (o *DeleteApiregistrationV1beta1CollectionAPIServiceParams) WithResourceVersion(resourceVersion *string) *DeleteApiregistrationV1beta1CollectionAPIServiceParams {
...
func (o *DeleteApiregistrationV1beta1CollectionAPIServiceParams) WithResourceVersionMatch(resourceVersionMatch *string) *DeleteApiregistrationV1beta1CollectionAPIServiceParams {
...
func (o *DeleteApiregistrationV1beta1CollectionAPIServiceParams) WithTimeoutSeconds(timeoutSeconds *int64) *DeleteApiregistrationV1beta1CollectionAPIServiceParams {
...
func (o *DeleteApiregistrationV1beta1CollectionAPIServiceParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {

...
func (a *Client) GetEventsAPIGroup(params *GetEventsAPIGroupParams) (*GetEventsAPIGroupOK, error) {
	...
	if params == nil {
		params = NewGetEventsAPIGroupParams()
	}

	result, err := a.transport.Submit(&runtime.ClientOperation{
		ID:                 "getEventsAPIGroup",
		Method:             "GET",
		PathPattern:        "/apis/events.k8s.io/",
		...
		Schemes:            []string{"http"},
		Params:             params,
		Reader:             &GetEventsAPIGroupReader{formats: a.formats},
	...
	success, ok := result.(*GetEventsAPIGroupOK)
	if ok {
		return success, nil
	}
	// unexpected success response
	// safeguard: normally, absent a default response, unknown success responses return an error above: so this is a codegen issue
	msg := fmt.Sprintf("unexpected success response for getEventsAPIGroup: API contract not enforced by server. Client expected to get an error, but got: %T", result)
	panic(msg)
}

...
// NewDeletePolicyV1beta1CollectionPodSecurityPolicyParamsWithTimeout creates a new DeletePolicyV1beta1CollectionPodSecurityPolicyParams object
...
// NewDeletePolicyV1beta1CollectionPodSecurityPolicyParamsWithContext creates a new DeletePolicyV1beta1CollectionPodSecurityPolicyParams object
...
// NewDeletePolicyV1beta1CollectionPodSecurityPolicyParamsWithHTTPClient creates a new DeletePolicyV1beta1CollectionPodSecurityPolicyParams object
...
/*DeletePolicyV1beta1CollectionPodSecurityPolicyParams contains all the parameters to send to the API endpoint
for the delete policy v1beta1 collection pod security policy operation typically these are written to a http.Request
*/

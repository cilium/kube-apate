...
func (o *DeletePolicyV1beta1CollectionNamespacedPodDisruptionBudgetReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewDeletePolicyV1beta1CollectionNamespacedPodDisruptionBudgetOK()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return result, nil
	case 401:
		result := NewDeletePolicyV1beta1CollectionNamespacedPodDisruptionBudgetUnauthorized()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
func (o *DeletePolicyV1beta1CollectionNamespacedPodDisruptionBudgetOK) Error() string {
	return fmt.Sprintf("[DELETE /apis/policy/v1beta1/namespaces/{namespace}/poddisruptionbudgets][%d] deletePolicyV1beta1CollectionNamespacedPodDisruptionBudgetOK  %+v", 200, o.Payload)
}
...
func (o *DeletePolicyV1beta1CollectionNamespacedPodDisruptionBudgetOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
...
func (o *DeletePolicyV1beta1CollectionNamespacedPodDisruptionBudgetUnauthorized) Error() string {
	return fmt.Sprintf("[DELETE /apis/policy/v1beta1/namespaces/{namespace}/poddisruptionbudgets][%d] deletePolicyV1beta1CollectionNamespacedPodDisruptionBudgetUnauthorized ", 401)
}

func (o *DeletePolicyV1beta1CollectionNamespacedPodDisruptionBudgetUnauthorized) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {

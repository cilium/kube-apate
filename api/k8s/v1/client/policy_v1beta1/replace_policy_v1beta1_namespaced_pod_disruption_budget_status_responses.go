...
func (o *ReplacePolicyV1beta1NamespacedPodDisruptionBudgetStatusReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewReplacePolicyV1beta1NamespacedPodDisruptionBudgetStatusOK()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return result, nil
	case 201:
		result := NewReplacePolicyV1beta1NamespacedPodDisruptionBudgetStatusCreated()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return result, nil
	case 401:
		result := NewReplacePolicyV1beta1NamespacedPodDisruptionBudgetStatusUnauthorized()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
func (o *ReplacePolicyV1beta1NamespacedPodDisruptionBudgetStatusOK) Error() string {
	return fmt.Sprintf("[PUT /apis/policy/v1beta1/namespaces/{namespace}/poddisruptionbudgets/{name}/status][%d] replacePolicyV1beta1NamespacedPodDisruptionBudgetStatusOK  %+v", 200, o.Payload)
}
...
func (o *ReplacePolicyV1beta1NamespacedPodDisruptionBudgetStatusOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
...
func (o *ReplacePolicyV1beta1NamespacedPodDisruptionBudgetStatusCreated) Error() string {
	return fmt.Sprintf("[PUT /apis/policy/v1beta1/namespaces/{namespace}/poddisruptionbudgets/{name}/status][%d] replacePolicyV1beta1NamespacedPodDisruptionBudgetStatusCreated  %+v", 201, o.Payload)
}

func (o *ReplacePolicyV1beta1NamespacedPodDisruptionBudgetStatusCreated) GetPayload() *models.IoK8sAPIPolicyV1beta1PodDisruptionBudget {
	return o.Payload
}

func (o *ReplacePolicyV1beta1NamespacedPodDisruptionBudgetStatusCreated) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
...
func (o *ReplacePolicyV1beta1NamespacedPodDisruptionBudgetStatusUnauthorized) Error() string {
	return fmt.Sprintf("[PUT /apis/policy/v1beta1/namespaces/{namespace}/poddisruptionbudgets/{name}/status][%d] replacePolicyV1beta1NamespacedPodDisruptionBudgetStatusUnauthorized ", 401)
}

func (o *ReplacePolicyV1beta1NamespacedPodDisruptionBudgetStatusUnauthorized) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {

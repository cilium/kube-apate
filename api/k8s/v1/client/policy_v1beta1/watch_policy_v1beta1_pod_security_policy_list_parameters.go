...
// NewWatchPolicyV1beta1PodSecurityPolicyListParamsWithTimeout creates a new WatchPolicyV1beta1PodSecurityPolicyListParams object
...
// NewWatchPolicyV1beta1PodSecurityPolicyListParamsWithContext creates a new WatchPolicyV1beta1PodSecurityPolicyListParams object
...
// NewWatchPolicyV1beta1PodSecurityPolicyListParamsWithHTTPClient creates a new WatchPolicyV1beta1PodSecurityPolicyListParams object
...
/*WatchPolicyV1beta1PodSecurityPolicyListParams contains all the parameters to send to the API endpoint
for the watch policy v1beta1 pod security policy list operation typically these are written to a http.Request
*/

...
func (o *WatchPolicyV1beta1NamespacedPodDisruptionBudgetReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewWatchPolicyV1beta1NamespacedPodDisruptionBudgetOK()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return result, nil
	case 401:
		result := NewWatchPolicyV1beta1NamespacedPodDisruptionBudgetUnauthorized()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
func (o *WatchPolicyV1beta1NamespacedPodDisruptionBudgetOK) Error() string {
	return fmt.Sprintf("[GET /apis/policy/v1beta1/watch/namespaces/{namespace}/poddisruptionbudgets/{name}][%d] watchPolicyV1beta1NamespacedPodDisruptionBudgetOK  %+v", 200, o.Payload)
}
...
func (o *WatchPolicyV1beta1NamespacedPodDisruptionBudgetOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
...
func (o *WatchPolicyV1beta1NamespacedPodDisruptionBudgetUnauthorized) Error() string {
	return fmt.Sprintf("[GET /apis/policy/v1beta1/watch/namespaces/{namespace}/poddisruptionbudgets/{name}][%d] watchPolicyV1beta1NamespacedPodDisruptionBudgetUnauthorized ", 401)
}

func (o *WatchPolicyV1beta1NamespacedPodDisruptionBudgetUnauthorized) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {

...
// NewDeleteStorageV1beta1CollectionVolumeAttachmentParamsWithTimeout creates a new DeleteStorageV1beta1CollectionVolumeAttachmentParams object
...
// NewDeleteStorageV1beta1CollectionVolumeAttachmentParamsWithContext creates a new DeleteStorageV1beta1CollectionVolumeAttachmentParams object
...
// NewDeleteStorageV1beta1CollectionVolumeAttachmentParamsWithHTTPClient creates a new DeleteStorageV1beta1CollectionVolumeAttachmentParams object
...
/*DeleteStorageV1beta1CollectionVolumeAttachmentParams contains all the parameters to send to the API endpoint
for the delete storage v1beta1 collection volume attachment operation typically these are written to a http.Request
*/
...
func (o *DeleteStorageV1beta1CollectionVolumeAttachmentParams) WithTimeout(timeout time.Duration) *DeleteStorageV1beta1CollectionVolumeAttachmentParams {
	o.SetTimeout(timeout)
	return o
}

// SetTimeout adds the timeout to the delete storage v1beta1 collection volume attachment params
func (o *DeleteStorageV1beta1CollectionVolumeAttachmentParams) SetTimeout(timeout time.Duration) {
	o.timeout = timeout
}

// WithContext adds the context to the delete storage v1beta1 collection volume attachment params
func (o *DeleteStorageV1beta1CollectionVolumeAttachmentParams) WithContext(ctx context.Context) *DeleteStorageV1beta1CollectionVolumeAttachmentParams {
	o.SetContext(ctx)
	return o
}

// SetContext adds the context to the delete storage v1beta1 collection volume attachment params
func (o *DeleteStorageV1beta1CollectionVolumeAttachmentParams) SetContext(ctx context.Context) {
	o.Context = ctx
}

// WithHTTPClient adds the HTTPClient to the delete storage v1beta1 collection volume attachment params
func (o *DeleteStorageV1beta1CollectionVolumeAttachmentParams) WithHTTPClient(client *http.Client) *DeleteStorageV1beta1CollectionVolumeAttachmentParams {
	o.SetHTTPClient(client)
	return o
}

// SetHTTPClient adds the HTTPClient to the delete storage v1beta1 collection volume attachment params
func (o *DeleteStorageV1beta1CollectionVolumeAttachmentParams) SetHTTPClient(client *http.Client) {
	o.HTTPClient = client
}

// WithBody adds the body to the delete storage v1beta1 collection volume attachment params
func (o *DeleteStorageV1beta1CollectionVolumeAttachmentParams) WithBody(body *models.IoK8sApimachineryPkgApisMetaV1DeleteOptions) *DeleteStorageV1beta1CollectionVolumeAttachmentParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the delete storage v1beta1 collection volume attachment params
func (o *DeleteStorageV1beta1CollectionVolumeAttachmentParams) SetBody(body *models.IoK8sApimachineryPkgApisMetaV1DeleteOptions) {
	o.Body = body
}

// WithContinue adds the continueVar to the delete storage v1beta1 collection volume attachment params
func (o *DeleteStorageV1beta1CollectionVolumeAttachmentParams) WithContinue(continueVar *string) *DeleteStorageV1beta1CollectionVolumeAttachmentParams {
...
func (o *DeleteStorageV1beta1CollectionVolumeAttachmentParams) WithDryRun(dryRun *string) *DeleteStorageV1beta1CollectionVolumeAttachmentParams {
	o.SetDryRun(dryRun)
	return o
}

// SetDryRun adds the dryRun to the delete storage v1beta1 collection volume attachment params
func (o *DeleteStorageV1beta1CollectionVolumeAttachmentParams) SetDryRun(dryRun *string) {
	o.DryRun = dryRun
}

// WithFieldSelector adds the fieldSelector to the delete storage v1beta1 collection volume attachment params
func (o *DeleteStorageV1beta1CollectionVolumeAttachmentParams) WithFieldSelector(fieldSelector *string) *DeleteStorageV1beta1CollectionVolumeAttachmentParams {
...
func (o *DeleteStorageV1beta1CollectionVolumeAttachmentParams) WithGracePeriodSeconds(gracePeriodSeconds *int64) *DeleteStorageV1beta1CollectionVolumeAttachmentParams {
...
func (o *DeleteStorageV1beta1CollectionVolumeAttachmentParams) WithLabelSelector(labelSelector *string) *DeleteStorageV1beta1CollectionVolumeAttachmentParams {
...
func (o *DeleteStorageV1beta1CollectionVolumeAttachmentParams) WithLimit(limit *int64) *DeleteStorageV1beta1CollectionVolumeAttachmentParams {
	o.SetLimit(limit)
	return o
}

// SetLimit adds the limit to the delete storage v1beta1 collection volume attachment params
func (o *DeleteStorageV1beta1CollectionVolumeAttachmentParams) SetLimit(limit *int64) {
	o.Limit = limit
}

// WithOrphanDependents adds the orphanDependents to the delete storage v1beta1 collection volume attachment params
func (o *DeleteStorageV1beta1CollectionVolumeAttachmentParams) WithOrphanDependents(orphanDependents *bool) *DeleteStorageV1beta1CollectionVolumeAttachmentParams {
...
func (o *DeleteStorageV1beta1CollectionVolumeAttachmentParams) WithPretty(pretty *string) *DeleteStorageV1beta1CollectionVolumeAttachmentParams {
	o.SetPretty(pretty)
	return o
}

// SetPretty adds the pretty to the delete storage v1beta1 collection volume attachment params
func (o *DeleteStorageV1beta1CollectionVolumeAttachmentParams) SetPretty(pretty *string) {
	o.Pretty = pretty
}

// WithPropagationPolicy adds the propagationPolicy to the delete storage v1beta1 collection volume attachment params
func (o *DeleteStorageV1beta1CollectionVolumeAttachmentParams) WithPropagationPolicy(propagationPolicy *string) *DeleteStorageV1beta1CollectionVolumeAttachmentParams {
...
func (o *DeleteStorageV1beta1CollectionVolumeAttachmentParams) WithResourceVersion(resourceVersion *string) *DeleteStorageV1beta1CollectionVolumeAttachmentParams {
...
func (o *DeleteStorageV1beta1CollectionVolumeAttachmentParams) WithResourceVersionMatch(resourceVersionMatch *string) *DeleteStorageV1beta1CollectionVolumeAttachmentParams {
...
func (o *DeleteStorageV1beta1CollectionVolumeAttachmentParams) WithTimeoutSeconds(timeoutSeconds *int64) *DeleteStorageV1beta1CollectionVolumeAttachmentParams {
...
func (o *DeleteStorageV1beta1CollectionVolumeAttachmentParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {

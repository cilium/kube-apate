...
// NewReplaceStorageV1beta1StorageClassParamsWithTimeout creates a new ReplaceStorageV1beta1StorageClassParams object
...
// NewReplaceStorageV1beta1StorageClassParamsWithContext creates a new ReplaceStorageV1beta1StorageClassParams object
...
// NewReplaceStorageV1beta1StorageClassParamsWithHTTPClient creates a new ReplaceStorageV1beta1StorageClassParams object
...
/*ReplaceStorageV1beta1StorageClassParams contains all the parameters to send to the API endpoint
for the replace storage v1beta1 storage class operation typically these are written to a http.Request
*/
...
func (o *ReplaceStorageV1beta1StorageClassParams) WithTimeout(timeout time.Duration) *ReplaceStorageV1beta1StorageClassParams {
...
func (o *ReplaceStorageV1beta1StorageClassParams) WithContext(ctx context.Context) *ReplaceStorageV1beta1StorageClassParams {
	o.SetContext(ctx)
	return o
}

// SetContext adds the context to the replace storage v1beta1 storage class params
func (o *ReplaceStorageV1beta1StorageClassParams) SetContext(ctx context.Context) {
	o.Context = ctx
}

// WithHTTPClient adds the HTTPClient to the replace storage v1beta1 storage class params
func (o *ReplaceStorageV1beta1StorageClassParams) WithHTTPClient(client *http.Client) *ReplaceStorageV1beta1StorageClassParams {
...
func (o *ReplaceStorageV1beta1StorageClassParams) WithBody(body *models.IoK8sAPIStorageV1beta1StorageClass) *ReplaceStorageV1beta1StorageClassParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the replace storage v1beta1 storage class params
func (o *ReplaceStorageV1beta1StorageClassParams) SetBody(body *models.IoK8sAPIStorageV1beta1StorageClass) {
	o.Body = body
}

// WithDryRun adds the dryRun to the replace storage v1beta1 storage class params
func (o *ReplaceStorageV1beta1StorageClassParams) WithDryRun(dryRun *string) *ReplaceStorageV1beta1StorageClassParams {
	o.SetDryRun(dryRun)
	return o
}
...
func (o *ReplaceStorageV1beta1StorageClassParams) WithFieldManager(fieldManager *string) *ReplaceStorageV1beta1StorageClassParams {
...
func (o *ReplaceStorageV1beta1StorageClassParams) WithName(name string) *ReplaceStorageV1beta1StorageClassParams {
	o.SetName(name)
	return o
}

// SetName adds the name to the replace storage v1beta1 storage class params
func (o *ReplaceStorageV1beta1StorageClassParams) SetName(name string) {
	o.Name = name
}

// WithPretty adds the pretty to the replace storage v1beta1 storage class params
func (o *ReplaceStorageV1beta1StorageClassParams) WithPretty(pretty *string) *ReplaceStorageV1beta1StorageClassParams {
	o.SetPretty(pretty)
	return o
}
...
func (o *ReplaceStorageV1beta1StorageClassParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {

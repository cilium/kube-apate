...
// NewGetStorageV1beta1APIResourcesParamsWithTimeout creates a new GetStorageV1beta1APIResourcesParams object
...
// NewGetStorageV1beta1APIResourcesParamsWithContext creates a new GetStorageV1beta1APIResourcesParams object
...
// NewGetStorageV1beta1APIResourcesParamsWithHTTPClient creates a new GetStorageV1beta1APIResourcesParams object
...
/*GetStorageV1beta1APIResourcesParams contains all the parameters to send to the API endpoint
for the get storage v1beta1 API resources operation typically these are written to a http.Request
*/
...
func (o *GetStorageV1beta1APIResourcesParams) WithTimeout(timeout time.Duration) *GetStorageV1beta1APIResourcesParams {
...
func (o *GetStorageV1beta1APIResourcesParams) WithContext(ctx context.Context) *GetStorageV1beta1APIResourcesParams {
	o.SetContext(ctx)
	return o
}

// SetContext adds the context to the get storage v1beta1 API resources params
func (o *GetStorageV1beta1APIResourcesParams) SetContext(ctx context.Context) {
	o.Context = ctx
}

// WithHTTPClient adds the HTTPClient to the get storage v1beta1 API resources params
func (o *GetStorageV1beta1APIResourcesParams) WithHTTPClient(client *http.Client) *GetStorageV1beta1APIResourcesParams {
...
func (o *GetStorageV1beta1APIResourcesParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {

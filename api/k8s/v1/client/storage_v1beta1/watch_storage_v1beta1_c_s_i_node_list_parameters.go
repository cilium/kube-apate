...
// NewWatchStorageV1beta1CSINodeListParamsWithTimeout creates a new WatchStorageV1beta1CSINodeListParams object
...
// NewWatchStorageV1beta1CSINodeListParamsWithContext creates a new WatchStorageV1beta1CSINodeListParams object
...
// NewWatchStorageV1beta1CSINodeListParamsWithHTTPClient creates a new WatchStorageV1beta1CSINodeListParams object
...
/*WatchStorageV1beta1CSINodeListParams contains all the parameters to send to the API endpoint
for the watch storage v1beta1 c s i node list operation typically these are written to a http.Request
*/
...
func (o *WatchStorageV1beta1CSINodeListParams) WithTimeout(timeout time.Duration) *WatchStorageV1beta1CSINodeListParams {
...
func (o *WatchStorageV1beta1CSINodeListParams) WithContext(ctx context.Context) *WatchStorageV1beta1CSINodeListParams {
	o.SetContext(ctx)
	return o
}

// SetContext adds the context to the watch storage v1beta1 c s i node list params
func (o *WatchStorageV1beta1CSINodeListParams) SetContext(ctx context.Context) {
	o.Context = ctx
}

// WithHTTPClient adds the HTTPClient to the watch storage v1beta1 c s i node list params
func (o *WatchStorageV1beta1CSINodeListParams) WithHTTPClient(client *http.Client) *WatchStorageV1beta1CSINodeListParams {
...
func (o *WatchStorageV1beta1CSINodeListParams) WithContinue(continueVar *string) *WatchStorageV1beta1CSINodeListParams {
...
func (o *WatchStorageV1beta1CSINodeListParams) WithFieldSelector(fieldSelector *string) *WatchStorageV1beta1CSINodeListParams {
...
func (o *WatchStorageV1beta1CSINodeListParams) WithLabelSelector(labelSelector *string) *WatchStorageV1beta1CSINodeListParams {
...
func (o *WatchStorageV1beta1CSINodeListParams) WithLimit(limit *int64) *WatchStorageV1beta1CSINodeListParams {
	o.SetLimit(limit)
	return o
}
...
func (o *WatchStorageV1beta1CSINodeListParams) WithPretty(pretty *string) *WatchStorageV1beta1CSINodeListParams {
	o.SetPretty(pretty)
	return o
}
...
func (o *WatchStorageV1beta1CSINodeListParams) WithTimeoutSeconds(timeoutSeconds *int64) *WatchStorageV1beta1CSINodeListParams {
...
func (o *WatchStorageV1beta1CSINodeListParams) WithWatch(watch *bool) *WatchStorageV1beta1CSINodeListParams {
	o.SetWatch(watch)
	return o
}
...
func (o *WatchStorageV1beta1CSINodeListParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {

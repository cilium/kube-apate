...
func (o *ReadStorageV1beta1CSINodeReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewReadStorageV1beta1CSINodeOK()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return result, nil
	case 401:
		result := NewReadStorageV1beta1CSINodeUnauthorized()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
func (o *ReadStorageV1beta1CSINodeOK) Error() string {
	return fmt.Sprintf("[GET /apis/storage.k8s.io/v1beta1/csinodes/{name}][%d] readStorageV1beta1CSINodeOK  %+v", 200, o.Payload)
}

func (o *ReadStorageV1beta1CSINodeOK) GetPayload() *models.IoK8sAPIStorageV1beta1CSINode {
	return o.Payload
}

func (o *ReadStorageV1beta1CSINodeOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
...
func (o *ReadStorageV1beta1CSINodeUnauthorized) Error() string {
	return fmt.Sprintf("[GET /apis/storage.k8s.io/v1beta1/csinodes/{name}][%d] readStorageV1beta1CSINodeUnauthorized ", 401)
}

func (o *ReadStorageV1beta1CSINodeUnauthorized) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {

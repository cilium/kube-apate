...
// NewReadStorageV1beta1StorageClassParamsWithTimeout creates a new ReadStorageV1beta1StorageClassParams object
...
// NewReadStorageV1beta1StorageClassParamsWithContext creates a new ReadStorageV1beta1StorageClassParams object
...
// NewReadStorageV1beta1StorageClassParamsWithHTTPClient creates a new ReadStorageV1beta1StorageClassParams object
...
/*ReadStorageV1beta1StorageClassParams contains all the parameters to send to the API endpoint
for the read storage v1beta1 storage class operation typically these are written to a http.Request
*/
...
func (o *ReadStorageV1beta1StorageClassParams) WithTimeout(timeout time.Duration) *ReadStorageV1beta1StorageClassParams {
...
func (o *ReadStorageV1beta1StorageClassParams) WithContext(ctx context.Context) *ReadStorageV1beta1StorageClassParams {
	o.SetContext(ctx)
	return o
}

// SetContext adds the context to the read storage v1beta1 storage class params
func (o *ReadStorageV1beta1StorageClassParams) SetContext(ctx context.Context) {
	o.Context = ctx
}

// WithHTTPClient adds the HTTPClient to the read storage v1beta1 storage class params
func (o *ReadStorageV1beta1StorageClassParams) WithHTTPClient(client *http.Client) *ReadStorageV1beta1StorageClassParams {
...
func (o *ReadStorageV1beta1StorageClassParams) WithExact(exact *bool) *ReadStorageV1beta1StorageClassParams {
	o.SetExact(exact)
	return o
}
...
func (o *ReadStorageV1beta1StorageClassParams) WithExport(export *bool) *ReadStorageV1beta1StorageClassParams {
	o.SetExport(export)
	return o
}
...
func (o *ReadStorageV1beta1StorageClassParams) WithName(name string) *ReadStorageV1beta1StorageClassParams {
	o.SetName(name)
	return o
}

// SetName adds the name to the read storage v1beta1 storage class params
func (o *ReadStorageV1beta1StorageClassParams) SetName(name string) {
	o.Name = name
}

// WithPretty adds the pretty to the read storage v1beta1 storage class params
func (o *ReadStorageV1beta1StorageClassParams) WithPretty(pretty *string) *ReadStorageV1beta1StorageClassParams {
	o.SetPretty(pretty)
	return o
}
...
func (o *ReadStorageV1beta1StorageClassParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {

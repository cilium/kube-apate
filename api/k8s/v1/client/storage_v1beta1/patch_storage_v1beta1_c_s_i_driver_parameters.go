...
// NewPatchStorageV1beta1CSIDriverParamsWithTimeout creates a new PatchStorageV1beta1CSIDriverParams object
...
// NewPatchStorageV1beta1CSIDriverParamsWithContext creates a new PatchStorageV1beta1CSIDriverParams object
...
// NewPatchStorageV1beta1CSIDriverParamsWithHTTPClient creates a new PatchStorageV1beta1CSIDriverParams object
...
/*PatchStorageV1beta1CSIDriverParams contains all the parameters to send to the API endpoint
for the patch storage v1beta1 c s i driver operation typically these are written to a http.Request
*/
...
func (o *PatchStorageV1beta1CSIDriverParams) WithTimeout(timeout time.Duration) *PatchStorageV1beta1CSIDriverParams {
...
func (o *PatchStorageV1beta1CSIDriverParams) WithContext(ctx context.Context) *PatchStorageV1beta1CSIDriverParams {
	o.SetContext(ctx)
	return o
}

// SetContext adds the context to the patch storage v1beta1 c s i driver params
func (o *PatchStorageV1beta1CSIDriverParams) SetContext(ctx context.Context) {
	o.Context = ctx
}

// WithHTTPClient adds the HTTPClient to the patch storage v1beta1 c s i driver params
func (o *PatchStorageV1beta1CSIDriverParams) WithHTTPClient(client *http.Client) *PatchStorageV1beta1CSIDriverParams {
...
func (o *PatchStorageV1beta1CSIDriverParams) WithBody(body models.IoK8sApimachineryPkgApisMetaV1Patch) *PatchStorageV1beta1CSIDriverParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the patch storage v1beta1 c s i driver params
func (o *PatchStorageV1beta1CSIDriverParams) SetBody(body models.IoK8sApimachineryPkgApisMetaV1Patch) {
	o.Body = body
}

// WithDryRun adds the dryRun to the patch storage v1beta1 c s i driver params
func (o *PatchStorageV1beta1CSIDriverParams) WithDryRun(dryRun *string) *PatchStorageV1beta1CSIDriverParams {
	o.SetDryRun(dryRun)
	return o
}
...
func (o *PatchStorageV1beta1CSIDriverParams) WithFieldManager(fieldManager *string) *PatchStorageV1beta1CSIDriverParams {
...
func (o *PatchStorageV1beta1CSIDriverParams) WithForce(force *bool) *PatchStorageV1beta1CSIDriverParams {
	o.SetForce(force)
	return o
}
...
func (o *PatchStorageV1beta1CSIDriverParams) WithName(name string) *PatchStorageV1beta1CSIDriverParams {
	o.SetName(name)
	return o
}
...
func (o *PatchStorageV1beta1CSIDriverParams) WithPretty(pretty *string) *PatchStorageV1beta1CSIDriverParams {
	o.SetPretty(pretty)
	return o
}
...
func (o *PatchStorageV1beta1CSIDriverParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {

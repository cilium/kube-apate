...
// NewDeleteStorageV1beta1StorageClassParamsWithTimeout creates a new DeleteStorageV1beta1StorageClassParams object
...
// NewDeleteStorageV1beta1StorageClassParamsWithContext creates a new DeleteStorageV1beta1StorageClassParams object
...
// NewDeleteStorageV1beta1StorageClassParamsWithHTTPClient creates a new DeleteStorageV1beta1StorageClassParams object
...
/*DeleteStorageV1beta1StorageClassParams contains all the parameters to send to the API endpoint
for the delete storage v1beta1 storage class operation typically these are written to a http.Request
*/
...
func (o *DeleteStorageV1beta1StorageClassParams) WithTimeout(timeout time.Duration) *DeleteStorageV1beta1StorageClassParams {
...
func (o *DeleteStorageV1beta1StorageClassParams) WithContext(ctx context.Context) *DeleteStorageV1beta1StorageClassParams {
	o.SetContext(ctx)
	return o
}

// SetContext adds the context to the delete storage v1beta1 storage class params
func (o *DeleteStorageV1beta1StorageClassParams) SetContext(ctx context.Context) {
	o.Context = ctx
}

// WithHTTPClient adds the HTTPClient to the delete storage v1beta1 storage class params
func (o *DeleteStorageV1beta1StorageClassParams) WithHTTPClient(client *http.Client) *DeleteStorageV1beta1StorageClassParams {
...
func (o *DeleteStorageV1beta1StorageClassParams) WithBody(body *models.IoK8sApimachineryPkgApisMetaV1DeleteOptions) *DeleteStorageV1beta1StorageClassParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the delete storage v1beta1 storage class params
func (o *DeleteStorageV1beta1StorageClassParams) SetBody(body *models.IoK8sApimachineryPkgApisMetaV1DeleteOptions) {
	o.Body = body
}

// WithDryRun adds the dryRun to the delete storage v1beta1 storage class params
func (o *DeleteStorageV1beta1StorageClassParams) WithDryRun(dryRun *string) *DeleteStorageV1beta1StorageClassParams {
	o.SetDryRun(dryRun)
	return o
}
...
func (o *DeleteStorageV1beta1StorageClassParams) WithName(name string) *DeleteStorageV1beta1StorageClassParams {
	o.SetName(name)
	return o
}

// SetName adds the name to the delete storage v1beta1 storage class params
func (o *DeleteStorageV1beta1StorageClassParams) SetName(name string) {
	o.Name = name
}
...
func (o *DeleteStorageV1beta1StorageClassParams) WithPretty(pretty *string) *DeleteStorageV1beta1StorageClassParams {
	o.SetPretty(pretty)
	return o
}
...
func (o *DeleteStorageV1beta1StorageClassParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {

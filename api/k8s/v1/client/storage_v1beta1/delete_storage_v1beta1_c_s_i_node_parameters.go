...
// NewDeleteStorageV1beta1CSINodeParamsWithTimeout creates a new DeleteStorageV1beta1CSINodeParams object
...
// NewDeleteStorageV1beta1CSINodeParamsWithContext creates a new DeleteStorageV1beta1CSINodeParams object
...
// NewDeleteStorageV1beta1CSINodeParamsWithHTTPClient creates a new DeleteStorageV1beta1CSINodeParams object
...
/*DeleteStorageV1beta1CSINodeParams contains all the parameters to send to the API endpoint
for the delete storage v1beta1 c s i node operation typically these are written to a http.Request
*/
...
func (o *DeleteStorageV1beta1CSINodeParams) WithTimeout(timeout time.Duration) *DeleteStorageV1beta1CSINodeParams {
...
func (o *DeleteStorageV1beta1CSINodeParams) WithContext(ctx context.Context) *DeleteStorageV1beta1CSINodeParams {
	o.SetContext(ctx)
	return o
}

// SetContext adds the context to the delete storage v1beta1 c s i node params
func (o *DeleteStorageV1beta1CSINodeParams) SetContext(ctx context.Context) {
	o.Context = ctx
}

// WithHTTPClient adds the HTTPClient to the delete storage v1beta1 c s i node params
func (o *DeleteStorageV1beta1CSINodeParams) WithHTTPClient(client *http.Client) *DeleteStorageV1beta1CSINodeParams {
...
func (o *DeleteStorageV1beta1CSINodeParams) WithBody(body *models.IoK8sApimachineryPkgApisMetaV1DeleteOptions) *DeleteStorageV1beta1CSINodeParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the delete storage v1beta1 c s i node params
func (o *DeleteStorageV1beta1CSINodeParams) SetBody(body *models.IoK8sApimachineryPkgApisMetaV1DeleteOptions) {
	o.Body = body
}

// WithDryRun adds the dryRun to the delete storage v1beta1 c s i node params
func (o *DeleteStorageV1beta1CSINodeParams) WithDryRun(dryRun *string) *DeleteStorageV1beta1CSINodeParams {
	o.SetDryRun(dryRun)
	return o
}
...
func (o *DeleteStorageV1beta1CSINodeParams) WithName(name string) *DeleteStorageV1beta1CSINodeParams {
	o.SetName(name)
	return o
}
...
func (o *DeleteStorageV1beta1CSINodeParams) WithPretty(pretty *string) *DeleteStorageV1beta1CSINodeParams {
	o.SetPretty(pretty)
	return o
}
...
func (o *DeleteStorageV1beta1CSINodeParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {

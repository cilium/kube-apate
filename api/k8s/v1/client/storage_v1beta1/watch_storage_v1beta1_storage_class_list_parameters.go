...
// NewWatchStorageV1beta1StorageClassListParamsWithTimeout creates a new WatchStorageV1beta1StorageClassListParams object
...
// NewWatchStorageV1beta1StorageClassListParamsWithContext creates a new WatchStorageV1beta1StorageClassListParams object
...
// NewWatchStorageV1beta1StorageClassListParamsWithHTTPClient creates a new WatchStorageV1beta1StorageClassListParams object
...
/*WatchStorageV1beta1StorageClassListParams contains all the parameters to send to the API endpoint
for the watch storage v1beta1 storage class list operation typically these are written to a http.Request
*/
...
func (o *WatchStorageV1beta1StorageClassListParams) WithTimeout(timeout time.Duration) *WatchStorageV1beta1StorageClassListParams {
	o.SetTimeout(timeout)
	return o
}

// SetTimeout adds the timeout to the watch storage v1beta1 storage class list params
func (o *WatchStorageV1beta1StorageClassListParams) SetTimeout(timeout time.Duration) {
	o.timeout = timeout
}

// WithContext adds the context to the watch storage v1beta1 storage class list params
func (o *WatchStorageV1beta1StorageClassListParams) WithContext(ctx context.Context) *WatchStorageV1beta1StorageClassListParams {
	o.SetContext(ctx)
	return o
}

// SetContext adds the context to the watch storage v1beta1 storage class list params
func (o *WatchStorageV1beta1StorageClassListParams) SetContext(ctx context.Context) {
	o.Context = ctx
}

// WithHTTPClient adds the HTTPClient to the watch storage v1beta1 storage class list params
func (o *WatchStorageV1beta1StorageClassListParams) WithHTTPClient(client *http.Client) *WatchStorageV1beta1StorageClassListParams {
...
func (o *WatchStorageV1beta1StorageClassListParams) WithContinue(continueVar *string) *WatchStorageV1beta1StorageClassListParams {
...
func (o *WatchStorageV1beta1StorageClassListParams) WithFieldSelector(fieldSelector *string) *WatchStorageV1beta1StorageClassListParams {
...
func (o *WatchStorageV1beta1StorageClassListParams) WithLabelSelector(labelSelector *string) *WatchStorageV1beta1StorageClassListParams {
...
func (o *WatchStorageV1beta1StorageClassListParams) WithLimit(limit *int64) *WatchStorageV1beta1StorageClassListParams {
	o.SetLimit(limit)
	return o
}

// SetLimit adds the limit to the watch storage v1beta1 storage class list params
func (o *WatchStorageV1beta1StorageClassListParams) SetLimit(limit *int64) {
	o.Limit = limit
}

// WithPretty adds the pretty to the watch storage v1beta1 storage class list params
func (o *WatchStorageV1beta1StorageClassListParams) WithPretty(pretty *string) *WatchStorageV1beta1StorageClassListParams {
	o.SetPretty(pretty)
	return o
}
...
func (o *WatchStorageV1beta1StorageClassListParams) WithResourceVersion(resourceVersion *string) *WatchStorageV1beta1StorageClassListParams {
...
func (o *WatchStorageV1beta1StorageClassListParams) WithTimeoutSeconds(timeoutSeconds *int64) *WatchStorageV1beta1StorageClassListParams {
...
func (o *WatchStorageV1beta1StorageClassListParams) WithWatch(watch *bool) *WatchStorageV1beta1StorageClassListParams {
	o.SetWatch(watch)
	return o
}
...
func (o *WatchStorageV1beta1StorageClassListParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {

...
func (o *ListStorageV1beta1StorageClassReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewListStorageV1beta1StorageClassOK()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return result, nil
	case 401:
		result := NewListStorageV1beta1StorageClassUnauthorized()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
func (o *ListStorageV1beta1StorageClassOK) Error() string {
	return fmt.Sprintf("[GET /apis/storage.k8s.io/v1beta1/storageclasses][%d] listStorageV1beta1StorageClassOK  %+v", 200, o.Payload)
}

func (o *ListStorageV1beta1StorageClassOK) GetPayload() *models.IoK8sAPIStorageV1beta1StorageClassList {
	return o.Payload
}

func (o *ListStorageV1beta1StorageClassOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {

	o.Payload = new(models.IoK8sAPIStorageV1beta1StorageClassList)
...
func (o *ListStorageV1beta1StorageClassUnauthorized) Error() string {
	return fmt.Sprintf("[GET /apis/storage.k8s.io/v1beta1/storageclasses][%d] listStorageV1beta1StorageClassUnauthorized ", 401)
}

func (o *ListStorageV1beta1StorageClassUnauthorized) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {

...
// NewWatchStorageV1beta1VolumeAttachmentParamsWithTimeout creates a new WatchStorageV1beta1VolumeAttachmentParams object
...
// NewWatchStorageV1beta1VolumeAttachmentParamsWithContext creates a new WatchStorageV1beta1VolumeAttachmentParams object
...
// NewWatchStorageV1beta1VolumeAttachmentParamsWithHTTPClient creates a new WatchStorageV1beta1VolumeAttachmentParams object
...
/*WatchStorageV1beta1VolumeAttachmentParams contains all the parameters to send to the API endpoint
for the watch storage v1beta1 volume attachment operation typically these are written to a http.Request
*/
...
func (o *WatchStorageV1beta1VolumeAttachmentParams) WithTimeout(timeout time.Duration) *WatchStorageV1beta1VolumeAttachmentParams {
	o.SetTimeout(timeout)
	return o
}

// SetTimeout adds the timeout to the watch storage v1beta1 volume attachment params
func (o *WatchStorageV1beta1VolumeAttachmentParams) SetTimeout(timeout time.Duration) {
	o.timeout = timeout
}

// WithContext adds the context to the watch storage v1beta1 volume attachment params
func (o *WatchStorageV1beta1VolumeAttachmentParams) WithContext(ctx context.Context) *WatchStorageV1beta1VolumeAttachmentParams {
	o.SetContext(ctx)
	return o
}

// SetContext adds the context to the watch storage v1beta1 volume attachment params
func (o *WatchStorageV1beta1VolumeAttachmentParams) SetContext(ctx context.Context) {
	o.Context = ctx
}

// WithHTTPClient adds the HTTPClient to the watch storage v1beta1 volume attachment params
func (o *WatchStorageV1beta1VolumeAttachmentParams) WithHTTPClient(client *http.Client) *WatchStorageV1beta1VolumeAttachmentParams {
...
func (o *WatchStorageV1beta1VolumeAttachmentParams) WithContinue(continueVar *string) *WatchStorageV1beta1VolumeAttachmentParams {
...
func (o *WatchStorageV1beta1VolumeAttachmentParams) WithFieldSelector(fieldSelector *string) *WatchStorageV1beta1VolumeAttachmentParams {
...
func (o *WatchStorageV1beta1VolumeAttachmentParams) WithLabelSelector(labelSelector *string) *WatchStorageV1beta1VolumeAttachmentParams {
...
func (o *WatchStorageV1beta1VolumeAttachmentParams) WithLimit(limit *int64) *WatchStorageV1beta1VolumeAttachmentParams {
	o.SetLimit(limit)
	return o
}

// SetLimit adds the limit to the watch storage v1beta1 volume attachment params
func (o *WatchStorageV1beta1VolumeAttachmentParams) SetLimit(limit *int64) {
	o.Limit = limit
}

// WithName adds the name to the watch storage v1beta1 volume attachment params
func (o *WatchStorageV1beta1VolumeAttachmentParams) WithName(name string) *WatchStorageV1beta1VolumeAttachmentParams {
	o.SetName(name)
	return o
}

// SetName adds the name to the watch storage v1beta1 volume attachment params
func (o *WatchStorageV1beta1VolumeAttachmentParams) SetName(name string) {
	o.Name = name
}

// WithPretty adds the pretty to the watch storage v1beta1 volume attachment params
func (o *WatchStorageV1beta1VolumeAttachmentParams) WithPretty(pretty *string) *WatchStorageV1beta1VolumeAttachmentParams {
	o.SetPretty(pretty)
	return o
}
...
func (o *WatchStorageV1beta1VolumeAttachmentParams) WithResourceVersion(resourceVersion *string) *WatchStorageV1beta1VolumeAttachmentParams {
...
func (o *WatchStorageV1beta1VolumeAttachmentParams) WithTimeoutSeconds(timeoutSeconds *int64) *WatchStorageV1beta1VolumeAttachmentParams {
...
func (o *WatchStorageV1beta1VolumeAttachmentParams) WithWatch(watch *bool) *WatchStorageV1beta1VolumeAttachmentParams {
	o.SetWatch(watch)
	return o
}
...
func (o *WatchStorageV1beta1VolumeAttachmentParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {

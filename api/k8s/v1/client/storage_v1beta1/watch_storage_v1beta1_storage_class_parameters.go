...
// NewWatchStorageV1beta1StorageClassParamsWithTimeout creates a new WatchStorageV1beta1StorageClassParams object
...
// NewWatchStorageV1beta1StorageClassParamsWithContext creates a new WatchStorageV1beta1StorageClassParams object
...
// NewWatchStorageV1beta1StorageClassParamsWithHTTPClient creates a new WatchStorageV1beta1StorageClassParams object
...
/*WatchStorageV1beta1StorageClassParams contains all the parameters to send to the API endpoint
for the watch storage v1beta1 storage class operation typically these are written to a http.Request
*/
...
func (o *WatchStorageV1beta1StorageClassParams) WithTimeout(timeout time.Duration) *WatchStorageV1beta1StorageClassParams {
...
func (o *WatchStorageV1beta1StorageClassParams) WithContext(ctx context.Context) *WatchStorageV1beta1StorageClassParams {
	o.SetContext(ctx)
	return o
}

// SetContext adds the context to the watch storage v1beta1 storage class params
func (o *WatchStorageV1beta1StorageClassParams) SetContext(ctx context.Context) {
	o.Context = ctx
}

// WithHTTPClient adds the HTTPClient to the watch storage v1beta1 storage class params
func (o *WatchStorageV1beta1StorageClassParams) WithHTTPClient(client *http.Client) *WatchStorageV1beta1StorageClassParams {
...
func (o *WatchStorageV1beta1StorageClassParams) WithContinue(continueVar *string) *WatchStorageV1beta1StorageClassParams {
...
func (o *WatchStorageV1beta1StorageClassParams) WithFieldSelector(fieldSelector *string) *WatchStorageV1beta1StorageClassParams {
...
func (o *WatchStorageV1beta1StorageClassParams) WithLabelSelector(labelSelector *string) *WatchStorageV1beta1StorageClassParams {
...
func (o *WatchStorageV1beta1StorageClassParams) WithLimit(limit *int64) *WatchStorageV1beta1StorageClassParams {
	o.SetLimit(limit)
	return o
}
...
func (o *WatchStorageV1beta1StorageClassParams) WithName(name string) *WatchStorageV1beta1StorageClassParams {
	o.SetName(name)
	return o
}

// SetName adds the name to the watch storage v1beta1 storage class params
func (o *WatchStorageV1beta1StorageClassParams) SetName(name string) {
	o.Name = name
}

// WithPretty adds the pretty to the watch storage v1beta1 storage class params
func (o *WatchStorageV1beta1StorageClassParams) WithPretty(pretty *string) *WatchStorageV1beta1StorageClassParams {
	o.SetPretty(pretty)
	return o
}
...
func (o *WatchStorageV1beta1StorageClassParams) WithResourceVersion(resourceVersion *string) *WatchStorageV1beta1StorageClassParams {
...
func (o *WatchStorageV1beta1StorageClassParams) WithTimeoutSeconds(timeoutSeconds *int64) *WatchStorageV1beta1StorageClassParams {
...
func (o *WatchStorageV1beta1StorageClassParams) WithWatch(watch *bool) *WatchStorageV1beta1StorageClassParams {
	o.SetWatch(watch)
	return o
}
...
func (o *WatchStorageV1beta1StorageClassParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {

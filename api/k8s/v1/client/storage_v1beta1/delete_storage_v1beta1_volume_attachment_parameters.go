...
// NewDeleteStorageV1beta1VolumeAttachmentParamsWithTimeout creates a new DeleteStorageV1beta1VolumeAttachmentParams object
...
// NewDeleteStorageV1beta1VolumeAttachmentParamsWithContext creates a new DeleteStorageV1beta1VolumeAttachmentParams object
...
// NewDeleteStorageV1beta1VolumeAttachmentParamsWithHTTPClient creates a new DeleteStorageV1beta1VolumeAttachmentParams object
...
/*DeleteStorageV1beta1VolumeAttachmentParams contains all the parameters to send to the API endpoint
for the delete storage v1beta1 volume attachment operation typically these are written to a http.Request
*/
...
func (o *DeleteStorageV1beta1VolumeAttachmentParams) WithTimeout(timeout time.Duration) *DeleteStorageV1beta1VolumeAttachmentParams {
	o.SetTimeout(timeout)
	return o
}

// SetTimeout adds the timeout to the delete storage v1beta1 volume attachment params
func (o *DeleteStorageV1beta1VolumeAttachmentParams) SetTimeout(timeout time.Duration) {
	o.timeout = timeout
}

// WithContext adds the context to the delete storage v1beta1 volume attachment params
func (o *DeleteStorageV1beta1VolumeAttachmentParams) WithContext(ctx context.Context) *DeleteStorageV1beta1VolumeAttachmentParams {
	o.SetContext(ctx)
	return o
}

// SetContext adds the context to the delete storage v1beta1 volume attachment params
func (o *DeleteStorageV1beta1VolumeAttachmentParams) SetContext(ctx context.Context) {
	o.Context = ctx
}

// WithHTTPClient adds the HTTPClient to the delete storage v1beta1 volume attachment params
func (o *DeleteStorageV1beta1VolumeAttachmentParams) WithHTTPClient(client *http.Client) *DeleteStorageV1beta1VolumeAttachmentParams {
...
func (o *DeleteStorageV1beta1VolumeAttachmentParams) WithBody(body *models.IoK8sApimachineryPkgApisMetaV1DeleteOptions) *DeleteStorageV1beta1VolumeAttachmentParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the delete storage v1beta1 volume attachment params
func (o *DeleteStorageV1beta1VolumeAttachmentParams) SetBody(body *models.IoK8sApimachineryPkgApisMetaV1DeleteOptions) {
	o.Body = body
}

// WithDryRun adds the dryRun to the delete storage v1beta1 volume attachment params
func (o *DeleteStorageV1beta1VolumeAttachmentParams) WithDryRun(dryRun *string) *DeleteStorageV1beta1VolumeAttachmentParams {
	o.SetDryRun(dryRun)
	return o
}
...
func (o *DeleteStorageV1beta1VolumeAttachmentParams) WithGracePeriodSeconds(gracePeriodSeconds *int64) *DeleteStorageV1beta1VolumeAttachmentParams {
...
func (o *DeleteStorageV1beta1VolumeAttachmentParams) WithName(name string) *DeleteStorageV1beta1VolumeAttachmentParams {
	o.SetName(name)
	return o
}

// SetName adds the name to the delete storage v1beta1 volume attachment params
func (o *DeleteStorageV1beta1VolumeAttachmentParams) SetName(name string) {
	o.Name = name
}

// WithOrphanDependents adds the orphanDependents to the delete storage v1beta1 volume attachment params
func (o *DeleteStorageV1beta1VolumeAttachmentParams) WithOrphanDependents(orphanDependents *bool) *DeleteStorageV1beta1VolumeAttachmentParams {
...
func (o *DeleteStorageV1beta1VolumeAttachmentParams) WithPretty(pretty *string) *DeleteStorageV1beta1VolumeAttachmentParams {
	o.SetPretty(pretty)
	return o
}
...
func (o *DeleteStorageV1beta1VolumeAttachmentParams) WithPropagationPolicy(propagationPolicy *string) *DeleteStorageV1beta1VolumeAttachmentParams {
...
func (o *DeleteStorageV1beta1VolumeAttachmentParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {

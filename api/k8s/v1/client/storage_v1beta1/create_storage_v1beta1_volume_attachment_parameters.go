...
// NewCreateStorageV1beta1VolumeAttachmentParamsWithTimeout creates a new CreateStorageV1beta1VolumeAttachmentParams object
...
// NewCreateStorageV1beta1VolumeAttachmentParamsWithContext creates a new CreateStorageV1beta1VolumeAttachmentParams object
...
// NewCreateStorageV1beta1VolumeAttachmentParamsWithHTTPClient creates a new CreateStorageV1beta1VolumeAttachmentParams object
...
/*CreateStorageV1beta1VolumeAttachmentParams contains all the parameters to send to the API endpoint
for the create storage v1beta1 volume attachment operation typically these are written to a http.Request
*/
...
func (o *CreateStorageV1beta1VolumeAttachmentParams) WithTimeout(timeout time.Duration) *CreateStorageV1beta1VolumeAttachmentParams {
	o.SetTimeout(timeout)
	return o
}

// SetTimeout adds the timeout to the create storage v1beta1 volume attachment params
func (o *CreateStorageV1beta1VolumeAttachmentParams) SetTimeout(timeout time.Duration) {
	o.timeout = timeout
}

// WithContext adds the context to the create storage v1beta1 volume attachment params
func (o *CreateStorageV1beta1VolumeAttachmentParams) WithContext(ctx context.Context) *CreateStorageV1beta1VolumeAttachmentParams {
	o.SetContext(ctx)
	return o
}

// SetContext adds the context to the create storage v1beta1 volume attachment params
func (o *CreateStorageV1beta1VolumeAttachmentParams) SetContext(ctx context.Context) {
	o.Context = ctx
}

// WithHTTPClient adds the HTTPClient to the create storage v1beta1 volume attachment params
func (o *CreateStorageV1beta1VolumeAttachmentParams) WithHTTPClient(client *http.Client) *CreateStorageV1beta1VolumeAttachmentParams {
...
func (o *CreateStorageV1beta1VolumeAttachmentParams) WithBody(body *models.IoK8sAPIStorageV1beta1VolumeAttachment) *CreateStorageV1beta1VolumeAttachmentParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the create storage v1beta1 volume attachment params
func (o *CreateStorageV1beta1VolumeAttachmentParams) SetBody(body *models.IoK8sAPIStorageV1beta1VolumeAttachment) {
	o.Body = body
}

// WithDryRun adds the dryRun to the create storage v1beta1 volume attachment params
func (o *CreateStorageV1beta1VolumeAttachmentParams) WithDryRun(dryRun *string) *CreateStorageV1beta1VolumeAttachmentParams {
	o.SetDryRun(dryRun)
	return o
}
...
func (o *CreateStorageV1beta1VolumeAttachmentParams) WithFieldManager(fieldManager *string) *CreateStorageV1beta1VolumeAttachmentParams {
...
func (o *CreateStorageV1beta1VolumeAttachmentParams) WithPretty(pretty *string) *CreateStorageV1beta1VolumeAttachmentParams {
	o.SetPretty(pretty)
	return o
}
...
func (o *CreateStorageV1beta1VolumeAttachmentParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {

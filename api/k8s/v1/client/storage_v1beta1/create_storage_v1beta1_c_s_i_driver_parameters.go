...
// NewCreateStorageV1beta1CSIDriverParamsWithTimeout creates a new CreateStorageV1beta1CSIDriverParams object
...
// NewCreateStorageV1beta1CSIDriverParamsWithContext creates a new CreateStorageV1beta1CSIDriverParams object
...
// NewCreateStorageV1beta1CSIDriverParamsWithHTTPClient creates a new CreateStorageV1beta1CSIDriverParams object
...
/*CreateStorageV1beta1CSIDriverParams contains all the parameters to send to the API endpoint
for the create storage v1beta1 c s i driver operation typically these are written to a http.Request
*/
...
func (o *CreateStorageV1beta1CSIDriverParams) WithTimeout(timeout time.Duration) *CreateStorageV1beta1CSIDriverParams {
...
func (o *CreateStorageV1beta1CSIDriverParams) WithContext(ctx context.Context) *CreateStorageV1beta1CSIDriverParams {
	o.SetContext(ctx)
	return o
}

// SetContext adds the context to the create storage v1beta1 c s i driver params
func (o *CreateStorageV1beta1CSIDriverParams) SetContext(ctx context.Context) {
	o.Context = ctx
}

// WithHTTPClient adds the HTTPClient to the create storage v1beta1 c s i driver params
func (o *CreateStorageV1beta1CSIDriverParams) WithHTTPClient(client *http.Client) *CreateStorageV1beta1CSIDriverParams {
...
func (o *CreateStorageV1beta1CSIDriverParams) WithBody(body *models.IoK8sAPIStorageV1beta1CSIDriver) *CreateStorageV1beta1CSIDriverParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the create storage v1beta1 c s i driver params
func (o *CreateStorageV1beta1CSIDriverParams) SetBody(body *models.IoK8sAPIStorageV1beta1CSIDriver) {
	o.Body = body
}

// WithDryRun adds the dryRun to the create storage v1beta1 c s i driver params
func (o *CreateStorageV1beta1CSIDriverParams) WithDryRun(dryRun *string) *CreateStorageV1beta1CSIDriverParams {
	o.SetDryRun(dryRun)
	return o
}
...
func (o *CreateStorageV1beta1CSIDriverParams) WithFieldManager(fieldManager *string) *CreateStorageV1beta1CSIDriverParams {
...
func (o *CreateStorageV1beta1CSIDriverParams) WithPretty(pretty *string) *CreateStorageV1beta1CSIDriverParams {
	o.SetPretty(pretty)
	return o
}
...
func (o *CreateStorageV1beta1CSIDriverParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {

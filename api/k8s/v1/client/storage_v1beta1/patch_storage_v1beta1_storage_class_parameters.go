...
// NewPatchStorageV1beta1StorageClassParamsWithTimeout creates a new PatchStorageV1beta1StorageClassParams object
...
// NewPatchStorageV1beta1StorageClassParamsWithContext creates a new PatchStorageV1beta1StorageClassParams object
...
// NewPatchStorageV1beta1StorageClassParamsWithHTTPClient creates a new PatchStorageV1beta1StorageClassParams object
...
/*PatchStorageV1beta1StorageClassParams contains all the parameters to send to the API endpoint
for the patch storage v1beta1 storage class operation typically these are written to a http.Request
*/
...
func (o *PatchStorageV1beta1StorageClassParams) WithTimeout(timeout time.Duration) *PatchStorageV1beta1StorageClassParams {
...
func (o *PatchStorageV1beta1StorageClassParams) WithContext(ctx context.Context) *PatchStorageV1beta1StorageClassParams {
	o.SetContext(ctx)
	return o
}

// SetContext adds the context to the patch storage v1beta1 storage class params
func (o *PatchStorageV1beta1StorageClassParams) SetContext(ctx context.Context) {
	o.Context = ctx
}

// WithHTTPClient adds the HTTPClient to the patch storage v1beta1 storage class params
func (o *PatchStorageV1beta1StorageClassParams) WithHTTPClient(client *http.Client) *PatchStorageV1beta1StorageClassParams {
...
func (o *PatchStorageV1beta1StorageClassParams) WithBody(body models.IoK8sApimachineryPkgApisMetaV1Patch) *PatchStorageV1beta1StorageClassParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the patch storage v1beta1 storage class params
func (o *PatchStorageV1beta1StorageClassParams) SetBody(body models.IoK8sApimachineryPkgApisMetaV1Patch) {
	o.Body = body
}

// WithDryRun adds the dryRun to the patch storage v1beta1 storage class params
func (o *PatchStorageV1beta1StorageClassParams) WithDryRun(dryRun *string) *PatchStorageV1beta1StorageClassParams {
	o.SetDryRun(dryRun)
	return o
}
...
func (o *PatchStorageV1beta1StorageClassParams) WithFieldManager(fieldManager *string) *PatchStorageV1beta1StorageClassParams {
...
func (o *PatchStorageV1beta1StorageClassParams) WithForce(force *bool) *PatchStorageV1beta1StorageClassParams {
	o.SetForce(force)
	return o
}
...
func (o *PatchStorageV1beta1StorageClassParams) WithName(name string) *PatchStorageV1beta1StorageClassParams {
	o.SetName(name)
	return o
}

// SetName adds the name to the patch storage v1beta1 storage class params
func (o *PatchStorageV1beta1StorageClassParams) SetName(name string) {
	o.Name = name
}

// WithPretty adds the pretty to the patch storage v1beta1 storage class params
func (o *PatchStorageV1beta1StorageClassParams) WithPretty(pretty *string) *PatchStorageV1beta1StorageClassParams {
	o.SetPretty(pretty)
	return o
}
...
func (o *PatchStorageV1beta1StorageClassParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {

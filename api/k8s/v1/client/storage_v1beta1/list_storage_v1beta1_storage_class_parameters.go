...
// NewListStorageV1beta1StorageClassParamsWithTimeout creates a new ListStorageV1beta1StorageClassParams object
...
// NewListStorageV1beta1StorageClassParamsWithContext creates a new ListStorageV1beta1StorageClassParams object
...
// NewListStorageV1beta1StorageClassParamsWithHTTPClient creates a new ListStorageV1beta1StorageClassParams object
...
/*ListStorageV1beta1StorageClassParams contains all the parameters to send to the API endpoint
for the list storage v1beta1 storage class operation typically these are written to a http.Request
*/
...
func (o *ListStorageV1beta1StorageClassParams) WithTimeout(timeout time.Duration) *ListStorageV1beta1StorageClassParams {
...
func (o *ListStorageV1beta1StorageClassParams) WithContext(ctx context.Context) *ListStorageV1beta1StorageClassParams {
	o.SetContext(ctx)
	return o
}

// SetContext adds the context to the list storage v1beta1 storage class params
func (o *ListStorageV1beta1StorageClassParams) SetContext(ctx context.Context) {
	o.Context = ctx
}

// WithHTTPClient adds the HTTPClient to the list storage v1beta1 storage class params
func (o *ListStorageV1beta1StorageClassParams) WithHTTPClient(client *http.Client) *ListStorageV1beta1StorageClassParams {
...
func (o *ListStorageV1beta1StorageClassParams) WithContinue(continueVar *string) *ListStorageV1beta1StorageClassParams {
...
func (o *ListStorageV1beta1StorageClassParams) WithFieldSelector(fieldSelector *string) *ListStorageV1beta1StorageClassParams {
...
func (o *ListStorageV1beta1StorageClassParams) WithLabelSelector(labelSelector *string) *ListStorageV1beta1StorageClassParams {
...
func (o *ListStorageV1beta1StorageClassParams) WithLimit(limit *int64) *ListStorageV1beta1StorageClassParams {
	o.SetLimit(limit)
	return o
}
...
func (o *ListStorageV1beta1StorageClassParams) WithPretty(pretty *string) *ListStorageV1beta1StorageClassParams {
	o.SetPretty(pretty)
	return o
}
...
func (o *ListStorageV1beta1StorageClassParams) WithTimeoutSeconds(timeoutSeconds *int64) *ListStorageV1beta1StorageClassParams {
...
func (o *ListStorageV1beta1StorageClassParams) WithWatch(watch *bool) *ListStorageV1beta1StorageClassParams {
	o.SetWatch(watch)
	return o
}
...
func (o *ListStorageV1beta1StorageClassParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {

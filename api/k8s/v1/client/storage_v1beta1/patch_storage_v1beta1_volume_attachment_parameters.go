...
// NewPatchStorageV1beta1VolumeAttachmentParamsWithTimeout creates a new PatchStorageV1beta1VolumeAttachmentParams object
...
// NewPatchStorageV1beta1VolumeAttachmentParamsWithContext creates a new PatchStorageV1beta1VolumeAttachmentParams object
...
// NewPatchStorageV1beta1VolumeAttachmentParamsWithHTTPClient creates a new PatchStorageV1beta1VolumeAttachmentParams object
...
/*PatchStorageV1beta1VolumeAttachmentParams contains all the parameters to send to the API endpoint
for the patch storage v1beta1 volume attachment operation typically these are written to a http.Request
*/
...
func (o *PatchStorageV1beta1VolumeAttachmentParams) WithTimeout(timeout time.Duration) *PatchStorageV1beta1VolumeAttachmentParams {
	o.SetTimeout(timeout)
	return o
}

// SetTimeout adds the timeout to the patch storage v1beta1 volume attachment params
func (o *PatchStorageV1beta1VolumeAttachmentParams) SetTimeout(timeout time.Duration) {
	o.timeout = timeout
}

// WithContext adds the context to the patch storage v1beta1 volume attachment params
func (o *PatchStorageV1beta1VolumeAttachmentParams) WithContext(ctx context.Context) *PatchStorageV1beta1VolumeAttachmentParams {
	o.SetContext(ctx)
	return o
}

// SetContext adds the context to the patch storage v1beta1 volume attachment params
func (o *PatchStorageV1beta1VolumeAttachmentParams) SetContext(ctx context.Context) {
	o.Context = ctx
}

// WithHTTPClient adds the HTTPClient to the patch storage v1beta1 volume attachment params
func (o *PatchStorageV1beta1VolumeAttachmentParams) WithHTTPClient(client *http.Client) *PatchStorageV1beta1VolumeAttachmentParams {
...
func (o *PatchStorageV1beta1VolumeAttachmentParams) WithBody(body models.IoK8sApimachineryPkgApisMetaV1Patch) *PatchStorageV1beta1VolumeAttachmentParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the patch storage v1beta1 volume attachment params
func (o *PatchStorageV1beta1VolumeAttachmentParams) SetBody(body models.IoK8sApimachineryPkgApisMetaV1Patch) {
	o.Body = body
}

// WithDryRun adds the dryRun to the patch storage v1beta1 volume attachment params
func (o *PatchStorageV1beta1VolumeAttachmentParams) WithDryRun(dryRun *string) *PatchStorageV1beta1VolumeAttachmentParams {
	o.SetDryRun(dryRun)
	return o
}
...
func (o *PatchStorageV1beta1VolumeAttachmentParams) WithFieldManager(fieldManager *string) *PatchStorageV1beta1VolumeAttachmentParams {
...
func (o *PatchStorageV1beta1VolumeAttachmentParams) WithForce(force *bool) *PatchStorageV1beta1VolumeAttachmentParams {
	o.SetForce(force)
	return o
}
...
func (o *PatchStorageV1beta1VolumeAttachmentParams) WithName(name string) *PatchStorageV1beta1VolumeAttachmentParams {
	o.SetName(name)
	return o
}

// SetName adds the name to the patch storage v1beta1 volume attachment params
func (o *PatchStorageV1beta1VolumeAttachmentParams) SetName(name string) {
	o.Name = name
}

// WithPretty adds the pretty to the patch storage v1beta1 volume attachment params
func (o *PatchStorageV1beta1VolumeAttachmentParams) WithPretty(pretty *string) *PatchStorageV1beta1VolumeAttachmentParams {
	o.SetPretty(pretty)
	return o
}
...
func (o *PatchStorageV1beta1VolumeAttachmentParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {

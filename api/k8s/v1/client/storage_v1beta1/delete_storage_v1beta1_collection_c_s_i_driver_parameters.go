...
// NewDeleteStorageV1beta1CollectionCSIDriverParamsWithTimeout creates a new DeleteStorageV1beta1CollectionCSIDriverParams object
...
// NewDeleteStorageV1beta1CollectionCSIDriverParamsWithContext creates a new DeleteStorageV1beta1CollectionCSIDriverParams object
...
// NewDeleteStorageV1beta1CollectionCSIDriverParamsWithHTTPClient creates a new DeleteStorageV1beta1CollectionCSIDriverParams object
...
/*DeleteStorageV1beta1CollectionCSIDriverParams contains all the parameters to send to the API endpoint
for the delete storage v1beta1 collection c s i driver operation typically these are written to a http.Request
*/
...
func (o *DeleteStorageV1beta1CollectionCSIDriverParams) WithTimeout(timeout time.Duration) *DeleteStorageV1beta1CollectionCSIDriverParams {
	o.SetTimeout(timeout)
	return o
}

// SetTimeout adds the timeout to the delete storage v1beta1 collection c s i driver params
func (o *DeleteStorageV1beta1CollectionCSIDriverParams) SetTimeout(timeout time.Duration) {
	o.timeout = timeout
}

// WithContext adds the context to the delete storage v1beta1 collection c s i driver params
func (o *DeleteStorageV1beta1CollectionCSIDriverParams) WithContext(ctx context.Context) *DeleteStorageV1beta1CollectionCSIDriverParams {
	o.SetContext(ctx)
	return o
}

// SetContext adds the context to the delete storage v1beta1 collection c s i driver params
func (o *DeleteStorageV1beta1CollectionCSIDriverParams) SetContext(ctx context.Context) {
	o.Context = ctx
}

// WithHTTPClient adds the HTTPClient to the delete storage v1beta1 collection c s i driver params
func (o *DeleteStorageV1beta1CollectionCSIDriverParams) WithHTTPClient(client *http.Client) *DeleteStorageV1beta1CollectionCSIDriverParams {
...
func (o *DeleteStorageV1beta1CollectionCSIDriverParams) WithBody(body *models.IoK8sApimachineryPkgApisMetaV1DeleteOptions) *DeleteStorageV1beta1CollectionCSIDriverParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the delete storage v1beta1 collection c s i driver params
func (o *DeleteStorageV1beta1CollectionCSIDriverParams) SetBody(body *models.IoK8sApimachineryPkgApisMetaV1DeleteOptions) {
	o.Body = body
}

// WithContinue adds the continueVar to the delete storage v1beta1 collection c s i driver params
func (o *DeleteStorageV1beta1CollectionCSIDriverParams) WithContinue(continueVar *string) *DeleteStorageV1beta1CollectionCSIDriverParams {
...
func (o *DeleteStorageV1beta1CollectionCSIDriverParams) WithDryRun(dryRun *string) *DeleteStorageV1beta1CollectionCSIDriverParams {
	o.SetDryRun(dryRun)
	return o
}

// SetDryRun adds the dryRun to the delete storage v1beta1 collection c s i driver params
func (o *DeleteStorageV1beta1CollectionCSIDriverParams) SetDryRun(dryRun *string) {
	o.DryRun = dryRun
}

// WithFieldSelector adds the fieldSelector to the delete storage v1beta1 collection c s i driver params
func (o *DeleteStorageV1beta1CollectionCSIDriverParams) WithFieldSelector(fieldSelector *string) *DeleteStorageV1beta1CollectionCSIDriverParams {
...
func (o *DeleteStorageV1beta1CollectionCSIDriverParams) WithGracePeriodSeconds(gracePeriodSeconds *int64) *DeleteStorageV1beta1CollectionCSIDriverParams {
...
func (o *DeleteStorageV1beta1CollectionCSIDriverParams) WithLabelSelector(labelSelector *string) *DeleteStorageV1beta1CollectionCSIDriverParams {
...
func (o *DeleteStorageV1beta1CollectionCSIDriverParams) WithLimit(limit *int64) *DeleteStorageV1beta1CollectionCSIDriverParams {
	o.SetLimit(limit)
	return o
}

// SetLimit adds the limit to the delete storage v1beta1 collection c s i driver params
func (o *DeleteStorageV1beta1CollectionCSIDriverParams) SetLimit(limit *int64) {
	o.Limit = limit
}

// WithOrphanDependents adds the orphanDependents to the delete storage v1beta1 collection c s i driver params
func (o *DeleteStorageV1beta1CollectionCSIDriverParams) WithOrphanDependents(orphanDependents *bool) *DeleteStorageV1beta1CollectionCSIDriverParams {
...
func (o *DeleteStorageV1beta1CollectionCSIDriverParams) WithPretty(pretty *string) *DeleteStorageV1beta1CollectionCSIDriverParams {
	o.SetPretty(pretty)
	return o
}

// SetPretty adds the pretty to the delete storage v1beta1 collection c s i driver params
func (o *DeleteStorageV1beta1CollectionCSIDriverParams) SetPretty(pretty *string) {
	o.Pretty = pretty
}

// WithPropagationPolicy adds the propagationPolicy to the delete storage v1beta1 collection c s i driver params
func (o *DeleteStorageV1beta1CollectionCSIDriverParams) WithPropagationPolicy(propagationPolicy *string) *DeleteStorageV1beta1CollectionCSIDriverParams {
...
func (o *DeleteStorageV1beta1CollectionCSIDriverParams) WithResourceVersion(resourceVersion *string) *DeleteStorageV1beta1CollectionCSIDriverParams {
...
func (o *DeleteStorageV1beta1CollectionCSIDriverParams) WithResourceVersionMatch(resourceVersionMatch *string) *DeleteStorageV1beta1CollectionCSIDriverParams {
...
func (o *DeleteStorageV1beta1CollectionCSIDriverParams) WithTimeoutSeconds(timeoutSeconds *int64) *DeleteStorageV1beta1CollectionCSIDriverParams {
...
func (o *DeleteStorageV1beta1CollectionCSIDriverParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {

...
// NewWatchStorageV1beta1CSIDriverListParamsWithTimeout creates a new WatchStorageV1beta1CSIDriverListParams object
...
// NewWatchStorageV1beta1CSIDriverListParamsWithContext creates a new WatchStorageV1beta1CSIDriverListParams object
...
// NewWatchStorageV1beta1CSIDriverListParamsWithHTTPClient creates a new WatchStorageV1beta1CSIDriverListParams object
...
/*WatchStorageV1beta1CSIDriverListParams contains all the parameters to send to the API endpoint
for the watch storage v1beta1 c s i driver list operation typically these are written to a http.Request
*/
...
func (o *WatchStorageV1beta1CSIDriverListParams) WithTimeout(timeout time.Duration) *WatchStorageV1beta1CSIDriverListParams {
...
func (o *WatchStorageV1beta1CSIDriverListParams) WithContext(ctx context.Context) *WatchStorageV1beta1CSIDriverListParams {
	o.SetContext(ctx)
	return o
}

// SetContext adds the context to the watch storage v1beta1 c s i driver list params
func (o *WatchStorageV1beta1CSIDriverListParams) SetContext(ctx context.Context) {
	o.Context = ctx
}

// WithHTTPClient adds the HTTPClient to the watch storage v1beta1 c s i driver list params
func (o *WatchStorageV1beta1CSIDriverListParams) WithHTTPClient(client *http.Client) *WatchStorageV1beta1CSIDriverListParams {
...
func (o *WatchStorageV1beta1CSIDriverListParams) WithContinue(continueVar *string) *WatchStorageV1beta1CSIDriverListParams {
...
func (o *WatchStorageV1beta1CSIDriverListParams) WithFieldSelector(fieldSelector *string) *WatchStorageV1beta1CSIDriverListParams {
...
func (o *WatchStorageV1beta1CSIDriverListParams) WithLabelSelector(labelSelector *string) *WatchStorageV1beta1CSIDriverListParams {
...
func (o *WatchStorageV1beta1CSIDriverListParams) WithLimit(limit *int64) *WatchStorageV1beta1CSIDriverListParams {
	o.SetLimit(limit)
	return o
}
...
func (o *WatchStorageV1beta1CSIDriverListParams) WithPretty(pretty *string) *WatchStorageV1beta1CSIDriverListParams {
	o.SetPretty(pretty)
	return o
}
...
func (o *WatchStorageV1beta1CSIDriverListParams) WithResourceVersion(resourceVersion *string) *WatchStorageV1beta1CSIDriverListParams {
...
func (o *WatchStorageV1beta1CSIDriverListParams) WithTimeoutSeconds(timeoutSeconds *int64) *WatchStorageV1beta1CSIDriverListParams {
...
func (o *WatchStorageV1beta1CSIDriverListParams) WithWatch(watch *bool) *WatchStorageV1beta1CSIDriverListParams {
	o.SetWatch(watch)
	return o
}
...
func (o *WatchStorageV1beta1CSIDriverListParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {

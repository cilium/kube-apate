...
// NewPatchStorageV1beta1CSINodeParamsWithTimeout creates a new PatchStorageV1beta1CSINodeParams object
...
// NewPatchStorageV1beta1CSINodeParamsWithContext creates a new PatchStorageV1beta1CSINodeParams object
...
// NewPatchStorageV1beta1CSINodeParamsWithHTTPClient creates a new PatchStorageV1beta1CSINodeParams object
...
/*PatchStorageV1beta1CSINodeParams contains all the parameters to send to the API endpoint
for the patch storage v1beta1 c s i node operation typically these are written to a http.Request
*/
...
func (o *PatchStorageV1beta1CSINodeParams) WithTimeout(timeout time.Duration) *PatchStorageV1beta1CSINodeParams {
...
func (o *PatchStorageV1beta1CSINodeParams) WithContext(ctx context.Context) *PatchStorageV1beta1CSINodeParams {
	o.SetContext(ctx)
	return o
}

// SetContext adds the context to the patch storage v1beta1 c s i node params
func (o *PatchStorageV1beta1CSINodeParams) SetContext(ctx context.Context) {
	o.Context = ctx
}

// WithHTTPClient adds the HTTPClient to the patch storage v1beta1 c s i node params
func (o *PatchStorageV1beta1CSINodeParams) WithHTTPClient(client *http.Client) *PatchStorageV1beta1CSINodeParams {
...
func (o *PatchStorageV1beta1CSINodeParams) WithBody(body models.IoK8sApimachineryPkgApisMetaV1Patch) *PatchStorageV1beta1CSINodeParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the patch storage v1beta1 c s i node params
func (o *PatchStorageV1beta1CSINodeParams) SetBody(body models.IoK8sApimachineryPkgApisMetaV1Patch) {
	o.Body = body
}

// WithDryRun adds the dryRun to the patch storage v1beta1 c s i node params
func (o *PatchStorageV1beta1CSINodeParams) WithDryRun(dryRun *string) *PatchStorageV1beta1CSINodeParams {
	o.SetDryRun(dryRun)
	return o
}
...
func (o *PatchStorageV1beta1CSINodeParams) WithForce(force *bool) *PatchStorageV1beta1CSINodeParams {
	o.SetForce(force)
	return o
}
...
func (o *PatchStorageV1beta1CSINodeParams) WithName(name string) *PatchStorageV1beta1CSINodeParams {
	o.SetName(name)
	return o
}
...
func (o *PatchStorageV1beta1CSINodeParams) WithPretty(pretty *string) *PatchStorageV1beta1CSINodeParams {
	o.SetPretty(pretty)
	return o
}
...
func (o *PatchStorageV1beta1CSINodeParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {

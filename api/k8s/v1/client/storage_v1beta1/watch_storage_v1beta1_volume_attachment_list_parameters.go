...
// NewWatchStorageV1beta1VolumeAttachmentListParamsWithTimeout creates a new WatchStorageV1beta1VolumeAttachmentListParams object
...
// NewWatchStorageV1beta1VolumeAttachmentListParamsWithContext creates a new WatchStorageV1beta1VolumeAttachmentListParams object
...
// NewWatchStorageV1beta1VolumeAttachmentListParamsWithHTTPClient creates a new WatchStorageV1beta1VolumeAttachmentListParams object
...
/*WatchStorageV1beta1VolumeAttachmentListParams contains all the parameters to send to the API endpoint
for the watch storage v1beta1 volume attachment list operation typically these are written to a http.Request
*/
...
func (o *WatchStorageV1beta1VolumeAttachmentListParams) WithTimeout(timeout time.Duration) *WatchStorageV1beta1VolumeAttachmentListParams {
	o.SetTimeout(timeout)
	return o
}

// SetTimeout adds the timeout to the watch storage v1beta1 volume attachment list params
func (o *WatchStorageV1beta1VolumeAttachmentListParams) SetTimeout(timeout time.Duration) {
	o.timeout = timeout
}

// WithContext adds the context to the watch storage v1beta1 volume attachment list params
func (o *WatchStorageV1beta1VolumeAttachmentListParams) WithContext(ctx context.Context) *WatchStorageV1beta1VolumeAttachmentListParams {
	o.SetContext(ctx)
	return o
}

// SetContext adds the context to the watch storage v1beta1 volume attachment list params
func (o *WatchStorageV1beta1VolumeAttachmentListParams) SetContext(ctx context.Context) {
	o.Context = ctx
}

// WithHTTPClient adds the HTTPClient to the watch storage v1beta1 volume attachment list params
func (o *WatchStorageV1beta1VolumeAttachmentListParams) WithHTTPClient(client *http.Client) *WatchStorageV1beta1VolumeAttachmentListParams {
...
func (o *WatchStorageV1beta1VolumeAttachmentListParams) WithAllowWatchBookmarks(allowWatchBookmarks *bool) *WatchStorageV1beta1VolumeAttachmentListParams {
...
func (o *WatchStorageV1beta1VolumeAttachmentListParams) WithContinue(continueVar *string) *WatchStorageV1beta1VolumeAttachmentListParams {
...
func (o *WatchStorageV1beta1VolumeAttachmentListParams) WithFieldSelector(fieldSelector *string) *WatchStorageV1beta1VolumeAttachmentListParams {
...
func (o *WatchStorageV1beta1VolumeAttachmentListParams) WithLabelSelector(labelSelector *string) *WatchStorageV1beta1VolumeAttachmentListParams {
...
func (o *WatchStorageV1beta1VolumeAttachmentListParams) WithLimit(limit *int64) *WatchStorageV1beta1VolumeAttachmentListParams {
	o.SetLimit(limit)
	return o
}

// SetLimit adds the limit to the watch storage v1beta1 volume attachment list params
func (o *WatchStorageV1beta1VolumeAttachmentListParams) SetLimit(limit *int64) {
	o.Limit = limit
}

// WithPretty adds the pretty to the watch storage v1beta1 volume attachment list params
func (o *WatchStorageV1beta1VolumeAttachmentListParams) WithPretty(pretty *string) *WatchStorageV1beta1VolumeAttachmentListParams {
	o.SetPretty(pretty)
	return o
}

// SetPretty adds the pretty to the watch storage v1beta1 volume attachment list params
func (o *WatchStorageV1beta1VolumeAttachmentListParams) SetPretty(pretty *string) {
	o.Pretty = pretty
}

// WithResourceVersion adds the resourceVersion to the watch storage v1beta1 volume attachment list params
func (o *WatchStorageV1beta1VolumeAttachmentListParams) WithResourceVersion(resourceVersion *string) *WatchStorageV1beta1VolumeAttachmentListParams {
...
func (o *WatchStorageV1beta1VolumeAttachmentListParams) WithResourceVersionMatch(resourceVersionMatch *string) *WatchStorageV1beta1VolumeAttachmentListParams {
...
func (o *WatchStorageV1beta1VolumeAttachmentListParams) WithTimeoutSeconds(timeoutSeconds *int64) *WatchStorageV1beta1VolumeAttachmentListParams {
...
func (o *WatchStorageV1beta1VolumeAttachmentListParams) WithWatch(watch *bool) *WatchStorageV1beta1VolumeAttachmentListParams {
	o.SetWatch(watch)
	return o
}

// SetWatch adds the watch to the watch storage v1beta1 volume attachment list params
func (o *WatchStorageV1beta1VolumeAttachmentListParams) SetWatch(watch *bool) {
	o.Watch = watch
}

// WriteToRequest writes these params to a swagger request
func (o *WatchStorageV1beta1VolumeAttachmentListParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {

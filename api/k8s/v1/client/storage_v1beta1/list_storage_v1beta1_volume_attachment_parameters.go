...
// NewListStorageV1beta1VolumeAttachmentParamsWithTimeout creates a new ListStorageV1beta1VolumeAttachmentParams object
...
// NewListStorageV1beta1VolumeAttachmentParamsWithContext creates a new ListStorageV1beta1VolumeAttachmentParams object
...
// NewListStorageV1beta1VolumeAttachmentParamsWithHTTPClient creates a new ListStorageV1beta1VolumeAttachmentParams object
...
/*ListStorageV1beta1VolumeAttachmentParams contains all the parameters to send to the API endpoint
for the list storage v1beta1 volume attachment operation typically these are written to a http.Request
*/
...
func (o *ListStorageV1beta1VolumeAttachmentParams) WithTimeout(timeout time.Duration) *ListStorageV1beta1VolumeAttachmentParams {
	o.SetTimeout(timeout)
	return o
}

// SetTimeout adds the timeout to the list storage v1beta1 volume attachment params
func (o *ListStorageV1beta1VolumeAttachmentParams) SetTimeout(timeout time.Duration) {
	o.timeout = timeout
}

// WithContext adds the context to the list storage v1beta1 volume attachment params
func (o *ListStorageV1beta1VolumeAttachmentParams) WithContext(ctx context.Context) *ListStorageV1beta1VolumeAttachmentParams {
	o.SetContext(ctx)
	return o
}

// SetContext adds the context to the list storage v1beta1 volume attachment params
func (o *ListStorageV1beta1VolumeAttachmentParams) SetContext(ctx context.Context) {
	o.Context = ctx
}

// WithHTTPClient adds the HTTPClient to the list storage v1beta1 volume attachment params
func (o *ListStorageV1beta1VolumeAttachmentParams) WithHTTPClient(client *http.Client) *ListStorageV1beta1VolumeAttachmentParams {
...
func (o *ListStorageV1beta1VolumeAttachmentParams) WithContinue(continueVar *string) *ListStorageV1beta1VolumeAttachmentParams {
...
func (o *ListStorageV1beta1VolumeAttachmentParams) WithFieldSelector(fieldSelector *string) *ListStorageV1beta1VolumeAttachmentParams {
...
func (o *ListStorageV1beta1VolumeAttachmentParams) WithLabelSelector(labelSelector *string) *ListStorageV1beta1VolumeAttachmentParams {
...
func (o *ListStorageV1beta1VolumeAttachmentParams) WithLimit(limit *int64) *ListStorageV1beta1VolumeAttachmentParams {
	o.SetLimit(limit)
	return o
}
...
func (o *ListStorageV1beta1VolumeAttachmentParams) WithPretty(pretty *string) *ListStorageV1beta1VolumeAttachmentParams {
	o.SetPretty(pretty)
	return o
}
...
func (o *ListStorageV1beta1VolumeAttachmentParams) WithResourceVersion(resourceVersion *string) *ListStorageV1beta1VolumeAttachmentParams {
...
func (o *ListStorageV1beta1VolumeAttachmentParams) WithTimeoutSeconds(timeoutSeconds *int64) *ListStorageV1beta1VolumeAttachmentParams {
...
func (o *ListStorageV1beta1VolumeAttachmentParams) WithWatch(watch *bool) *ListStorageV1beta1VolumeAttachmentParams {
	o.SetWatch(watch)
	return o
}
...
func (o *ListStorageV1beta1VolumeAttachmentParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {

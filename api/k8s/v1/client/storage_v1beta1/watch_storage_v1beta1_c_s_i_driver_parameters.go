...
// NewWatchStorageV1beta1CSIDriverParamsWithTimeout creates a new WatchStorageV1beta1CSIDriverParams object
...
// NewWatchStorageV1beta1CSIDriverParamsWithContext creates a new WatchStorageV1beta1CSIDriverParams object
...
// NewWatchStorageV1beta1CSIDriverParamsWithHTTPClient creates a new WatchStorageV1beta1CSIDriverParams object
...
/*WatchStorageV1beta1CSIDriverParams contains all the parameters to send to the API endpoint
for the watch storage v1beta1 c s i driver operation typically these are written to a http.Request
*/
...
func (o *WatchStorageV1beta1CSIDriverParams) WithTimeout(timeout time.Duration) *WatchStorageV1beta1CSIDriverParams {
...
func (o *WatchStorageV1beta1CSIDriverParams) WithContext(ctx context.Context) *WatchStorageV1beta1CSIDriverParams {
	o.SetContext(ctx)
	return o
}

// SetContext adds the context to the watch storage v1beta1 c s i driver params
func (o *WatchStorageV1beta1CSIDriverParams) SetContext(ctx context.Context) {
	o.Context = ctx
}

// WithHTTPClient adds the HTTPClient to the watch storage v1beta1 c s i driver params
func (o *WatchStorageV1beta1CSIDriverParams) WithHTTPClient(client *http.Client) *WatchStorageV1beta1CSIDriverParams {
...
func (o *WatchStorageV1beta1CSIDriverParams) WithContinue(continueVar *string) *WatchStorageV1beta1CSIDriverParams {
...
func (o *WatchStorageV1beta1CSIDriverParams) WithFieldSelector(fieldSelector *string) *WatchStorageV1beta1CSIDriverParams {
...
func (o *WatchStorageV1beta1CSIDriverParams) WithLabelSelector(labelSelector *string) *WatchStorageV1beta1CSIDriverParams {
...
func (o *WatchStorageV1beta1CSIDriverParams) WithLimit(limit *int64) *WatchStorageV1beta1CSIDriverParams {
	o.SetLimit(limit)
	return o
}
...
func (o *WatchStorageV1beta1CSIDriverParams) WithName(name string) *WatchStorageV1beta1CSIDriverParams {
	o.SetName(name)
	return o
}
...
func (o *WatchStorageV1beta1CSIDriverParams) WithPretty(pretty *string) *WatchStorageV1beta1CSIDriverParams {
	o.SetPretty(pretty)
	return o
}
...
func (o *WatchStorageV1beta1CSIDriverParams) WithWatch(watch *bool) *WatchStorageV1beta1CSIDriverParams {
	o.SetWatch(watch)
	return o
}
...
func (o *WatchStorageV1beta1CSIDriverParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {

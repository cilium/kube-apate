...
// NewReplaceStorageV1beta1CSIDriverParamsWithTimeout creates a new ReplaceStorageV1beta1CSIDriverParams object
...
// NewReplaceStorageV1beta1CSIDriverParamsWithContext creates a new ReplaceStorageV1beta1CSIDriverParams object
...
// NewReplaceStorageV1beta1CSIDriverParamsWithHTTPClient creates a new ReplaceStorageV1beta1CSIDriverParams object
...
/*ReplaceStorageV1beta1CSIDriverParams contains all the parameters to send to the API endpoint
for the replace storage v1beta1 c s i driver operation typically these are written to a http.Request
*/
...
func (o *ReplaceStorageV1beta1CSIDriverParams) WithTimeout(timeout time.Duration) *ReplaceStorageV1beta1CSIDriverParams {
...
func (o *ReplaceStorageV1beta1CSIDriverParams) WithContext(ctx context.Context) *ReplaceStorageV1beta1CSIDriverParams {
	o.SetContext(ctx)
	return o
}

// SetContext adds the context to the replace storage v1beta1 c s i driver params
func (o *ReplaceStorageV1beta1CSIDriverParams) SetContext(ctx context.Context) {
	o.Context = ctx
}

// WithHTTPClient adds the HTTPClient to the replace storage v1beta1 c s i driver params
func (o *ReplaceStorageV1beta1CSIDriverParams) WithHTTPClient(client *http.Client) *ReplaceStorageV1beta1CSIDriverParams {
...
func (o *ReplaceStorageV1beta1CSIDriverParams) WithBody(body *models.IoK8sAPIStorageV1beta1CSIDriver) *ReplaceStorageV1beta1CSIDriverParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the replace storage v1beta1 c s i driver params
func (o *ReplaceStorageV1beta1CSIDriverParams) SetBody(body *models.IoK8sAPIStorageV1beta1CSIDriver) {
	o.Body = body
}

// WithDryRun adds the dryRun to the replace storage v1beta1 c s i driver params
func (o *ReplaceStorageV1beta1CSIDriverParams) WithDryRun(dryRun *string) *ReplaceStorageV1beta1CSIDriverParams {
	o.SetDryRun(dryRun)
	return o
}
...
func (o *ReplaceStorageV1beta1CSIDriverParams) WithFieldManager(fieldManager *string) *ReplaceStorageV1beta1CSIDriverParams {
...
func (o *ReplaceStorageV1beta1CSIDriverParams) WithName(name string) *ReplaceStorageV1beta1CSIDriverParams {
	o.SetName(name)
	return o
}

// SetName adds the name to the replace storage v1beta1 c s i driver params
func (o *ReplaceStorageV1beta1CSIDriverParams) SetName(name string) {
	o.Name = name
}

// WithPretty adds the pretty to the replace storage v1beta1 c s i driver params
func (o *ReplaceStorageV1beta1CSIDriverParams) WithPretty(pretty *string) *ReplaceStorageV1beta1CSIDriverParams {
	o.SetPretty(pretty)
	return o
}
...
func (o *ReplaceStorageV1beta1CSIDriverParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {

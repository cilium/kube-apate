...
// NewReplaceStorageV1beta1CSINodeParamsWithTimeout creates a new ReplaceStorageV1beta1CSINodeParams object
...
// NewReplaceStorageV1beta1CSINodeParamsWithContext creates a new ReplaceStorageV1beta1CSINodeParams object
...
// NewReplaceStorageV1beta1CSINodeParamsWithHTTPClient creates a new ReplaceStorageV1beta1CSINodeParams object
...
/*ReplaceStorageV1beta1CSINodeParams contains all the parameters to send to the API endpoint
for the replace storage v1beta1 c s i node operation typically these are written to a http.Request
*/
...
func (o *ReplaceStorageV1beta1CSINodeParams) WithTimeout(timeout time.Duration) *ReplaceStorageV1beta1CSINodeParams {
...
func (o *ReplaceStorageV1beta1CSINodeParams) WithContext(ctx context.Context) *ReplaceStorageV1beta1CSINodeParams {
	o.SetContext(ctx)
	return o
}

// SetContext adds the context to the replace storage v1beta1 c s i node params
func (o *ReplaceStorageV1beta1CSINodeParams) SetContext(ctx context.Context) {
	o.Context = ctx
}

// WithHTTPClient adds the HTTPClient to the replace storage v1beta1 c s i node params
func (o *ReplaceStorageV1beta1CSINodeParams) WithHTTPClient(client *http.Client) *ReplaceStorageV1beta1CSINodeParams {
...
func (o *ReplaceStorageV1beta1CSINodeParams) WithBody(body *models.IoK8sAPIStorageV1beta1CSINode) *ReplaceStorageV1beta1CSINodeParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the replace storage v1beta1 c s i node params
func (o *ReplaceStorageV1beta1CSINodeParams) SetBody(body *models.IoK8sAPIStorageV1beta1CSINode) {
	o.Body = body
}

// WithDryRun adds the dryRun to the replace storage v1beta1 c s i node params
func (o *ReplaceStorageV1beta1CSINodeParams) WithDryRun(dryRun *string) *ReplaceStorageV1beta1CSINodeParams {
	o.SetDryRun(dryRun)
	return o
}
...
func (o *ReplaceStorageV1beta1CSINodeParams) WithFieldManager(fieldManager *string) *ReplaceStorageV1beta1CSINodeParams {
...
func (o *ReplaceStorageV1beta1CSINodeParams) WithName(name string) *ReplaceStorageV1beta1CSINodeParams {
	o.SetName(name)
	return o
}
...
func (o *ReplaceStorageV1beta1CSINodeParams) WithPretty(pretty *string) *ReplaceStorageV1beta1CSINodeParams {
	o.SetPretty(pretty)
	return o
}
...
func (o *ReplaceStorageV1beta1CSINodeParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {

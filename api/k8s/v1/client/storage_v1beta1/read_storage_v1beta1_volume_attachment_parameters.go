...
// NewReadStorageV1beta1VolumeAttachmentParamsWithTimeout creates a new ReadStorageV1beta1VolumeAttachmentParams object
...
// NewReadStorageV1beta1VolumeAttachmentParamsWithContext creates a new ReadStorageV1beta1VolumeAttachmentParams object
...
// NewReadStorageV1beta1VolumeAttachmentParamsWithHTTPClient creates a new ReadStorageV1beta1VolumeAttachmentParams object
...
/*ReadStorageV1beta1VolumeAttachmentParams contains all the parameters to send to the API endpoint
for the read storage v1beta1 volume attachment operation typically these are written to a http.Request
*/
...
func (o *ReadStorageV1beta1VolumeAttachmentParams) WithTimeout(timeout time.Duration) *ReadStorageV1beta1VolumeAttachmentParams {
	o.SetTimeout(timeout)
	return o
}

// SetTimeout adds the timeout to the read storage v1beta1 volume attachment params
func (o *ReadStorageV1beta1VolumeAttachmentParams) SetTimeout(timeout time.Duration) {
	o.timeout = timeout
}

// WithContext adds the context to the read storage v1beta1 volume attachment params
func (o *ReadStorageV1beta1VolumeAttachmentParams) WithContext(ctx context.Context) *ReadStorageV1beta1VolumeAttachmentParams {
	o.SetContext(ctx)
	return o
}

// SetContext adds the context to the read storage v1beta1 volume attachment params
func (o *ReadStorageV1beta1VolumeAttachmentParams) SetContext(ctx context.Context) {
	o.Context = ctx
}

// WithHTTPClient adds the HTTPClient to the read storage v1beta1 volume attachment params
func (o *ReadStorageV1beta1VolumeAttachmentParams) WithHTTPClient(client *http.Client) *ReadStorageV1beta1VolumeAttachmentParams {
...
func (o *ReadStorageV1beta1VolumeAttachmentParams) WithExact(exact *bool) *ReadStorageV1beta1VolumeAttachmentParams {
	o.SetExact(exact)
	return o
}
...
func (o *ReadStorageV1beta1VolumeAttachmentParams) WithExport(export *bool) *ReadStorageV1beta1VolumeAttachmentParams {
	o.SetExport(export)
	return o
}
...
func (o *ReadStorageV1beta1VolumeAttachmentParams) WithName(name string) *ReadStorageV1beta1VolumeAttachmentParams {
	o.SetName(name)
	return o
}

// SetName adds the name to the read storage v1beta1 volume attachment params
func (o *ReadStorageV1beta1VolumeAttachmentParams) SetName(name string) {
	o.Name = name
}

// WithPretty adds the pretty to the read storage v1beta1 volume attachment params
func (o *ReadStorageV1beta1VolumeAttachmentParams) WithPretty(pretty *string) *ReadStorageV1beta1VolumeAttachmentParams {
	o.SetPretty(pretty)
	return o
}
...
func (o *ReadStorageV1beta1VolumeAttachmentParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {

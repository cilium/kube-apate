...
func (o *WatchStorageV1beta1CSIDriverReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewWatchStorageV1beta1CSIDriverOK()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return result, nil
	case 401:
		result := NewWatchStorageV1beta1CSIDriverUnauthorized()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
func (o *WatchStorageV1beta1CSIDriverOK) Error() string {
	return fmt.Sprintf("[GET /apis/storage.k8s.io/v1beta1/watch/csidrivers/{name}][%d] watchStorageV1beta1CSIDriverOK  %+v", 200, o.Payload)
}

func (o *WatchStorageV1beta1CSIDriverOK) GetPayload() *models.IoK8sApimachineryPkgApisMetaV1WatchEvent {
	return o.Payload
}

func (o *WatchStorageV1beta1CSIDriverOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
...
func (o *WatchStorageV1beta1CSIDriverUnauthorized) Error() string {
	return fmt.Sprintf("[GET /apis/storage.k8s.io/v1beta1/watch/csidrivers/{name}][%d] watchStorageV1beta1CSIDriverUnauthorized ", 401)
}

func (o *WatchStorageV1beta1CSIDriverUnauthorized) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {

...
// NewDeleteStorageV1beta1CollectionStorageClassParamsWithTimeout creates a new DeleteStorageV1beta1CollectionStorageClassParams object
...
// NewDeleteStorageV1beta1CollectionStorageClassParamsWithContext creates a new DeleteStorageV1beta1CollectionStorageClassParams object
...
// NewDeleteStorageV1beta1CollectionStorageClassParamsWithHTTPClient creates a new DeleteStorageV1beta1CollectionStorageClassParams object
...
/*DeleteStorageV1beta1CollectionStorageClassParams contains all the parameters to send to the API endpoint
for the delete storage v1beta1 collection storage class operation typically these are written to a http.Request
*/
...
func (o *DeleteStorageV1beta1CollectionStorageClassParams) WithTimeout(timeout time.Duration) *DeleteStorageV1beta1CollectionStorageClassParams {
	o.SetTimeout(timeout)
	return o
}

// SetTimeout adds the timeout to the delete storage v1beta1 collection storage class params
func (o *DeleteStorageV1beta1CollectionStorageClassParams) SetTimeout(timeout time.Duration) {
	o.timeout = timeout
}

// WithContext adds the context to the delete storage v1beta1 collection storage class params
func (o *DeleteStorageV1beta1CollectionStorageClassParams) WithContext(ctx context.Context) *DeleteStorageV1beta1CollectionStorageClassParams {
	o.SetContext(ctx)
	return o
}

// SetContext adds the context to the delete storage v1beta1 collection storage class params
func (o *DeleteStorageV1beta1CollectionStorageClassParams) SetContext(ctx context.Context) {
	o.Context = ctx
}

// WithHTTPClient adds the HTTPClient to the delete storage v1beta1 collection storage class params
func (o *DeleteStorageV1beta1CollectionStorageClassParams) WithHTTPClient(client *http.Client) *DeleteStorageV1beta1CollectionStorageClassParams {
	o.SetHTTPClient(client)
	return o
}

// SetHTTPClient adds the HTTPClient to the delete storage v1beta1 collection storage class params
func (o *DeleteStorageV1beta1CollectionStorageClassParams) SetHTTPClient(client *http.Client) {
	o.HTTPClient = client
}

// WithBody adds the body to the delete storage v1beta1 collection storage class params
func (o *DeleteStorageV1beta1CollectionStorageClassParams) WithBody(body *models.IoK8sApimachineryPkgApisMetaV1DeleteOptions) *DeleteStorageV1beta1CollectionStorageClassParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the delete storage v1beta1 collection storage class params
func (o *DeleteStorageV1beta1CollectionStorageClassParams) SetBody(body *models.IoK8sApimachineryPkgApisMetaV1DeleteOptions) {
	o.Body = body
}

// WithContinue adds the continueVar to the delete storage v1beta1 collection storage class params
func (o *DeleteStorageV1beta1CollectionStorageClassParams) WithContinue(continueVar *string) *DeleteStorageV1beta1CollectionStorageClassParams {
...
func (o *DeleteStorageV1beta1CollectionStorageClassParams) WithDryRun(dryRun *string) *DeleteStorageV1beta1CollectionStorageClassParams {
	o.SetDryRun(dryRun)
	return o
}

// SetDryRun adds the dryRun to the delete storage v1beta1 collection storage class params
func (o *DeleteStorageV1beta1CollectionStorageClassParams) SetDryRun(dryRun *string) {
	o.DryRun = dryRun
}

// WithFieldSelector adds the fieldSelector to the delete storage v1beta1 collection storage class params
func (o *DeleteStorageV1beta1CollectionStorageClassParams) WithFieldSelector(fieldSelector *string) *DeleteStorageV1beta1CollectionStorageClassParams {
...
func (o *DeleteStorageV1beta1CollectionStorageClassParams) WithGracePeriodSeconds(gracePeriodSeconds *int64) *DeleteStorageV1beta1CollectionStorageClassParams {
...
func (o *DeleteStorageV1beta1CollectionStorageClassParams) WithLabelSelector(labelSelector *string) *DeleteStorageV1beta1CollectionStorageClassParams {
...
func (o *DeleteStorageV1beta1CollectionStorageClassParams) WithLimit(limit *int64) *DeleteStorageV1beta1CollectionStorageClassParams {
	o.SetLimit(limit)
	return o
}

// SetLimit adds the limit to the delete storage v1beta1 collection storage class params
func (o *DeleteStorageV1beta1CollectionStorageClassParams) SetLimit(limit *int64) {
	o.Limit = limit
}

// WithOrphanDependents adds the orphanDependents to the delete storage v1beta1 collection storage class params
func (o *DeleteStorageV1beta1CollectionStorageClassParams) WithOrphanDependents(orphanDependents *bool) *DeleteStorageV1beta1CollectionStorageClassParams {
...
func (o *DeleteStorageV1beta1CollectionStorageClassParams) WithPretty(pretty *string) *DeleteStorageV1beta1CollectionStorageClassParams {
	o.SetPretty(pretty)
	return o
}

// SetPretty adds the pretty to the delete storage v1beta1 collection storage class params
func (o *DeleteStorageV1beta1CollectionStorageClassParams) SetPretty(pretty *string) {
	o.Pretty = pretty
}

// WithPropagationPolicy adds the propagationPolicy to the delete storage v1beta1 collection storage class params
func (o *DeleteStorageV1beta1CollectionStorageClassParams) WithPropagationPolicy(propagationPolicy *string) *DeleteStorageV1beta1CollectionStorageClassParams {
...
func (o *DeleteStorageV1beta1CollectionStorageClassParams) WithResourceVersion(resourceVersion *string) *DeleteStorageV1beta1CollectionStorageClassParams {
...
func (o *DeleteStorageV1beta1CollectionStorageClassParams) WithResourceVersionMatch(resourceVersionMatch *string) *DeleteStorageV1beta1CollectionStorageClassParams {
...
func (o *DeleteStorageV1beta1CollectionStorageClassParams) WithTimeoutSeconds(timeoutSeconds *int64) *DeleteStorageV1beta1CollectionStorageClassParams {
...
func (o *DeleteStorageV1beta1CollectionStorageClassParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {

...
// NewWatchStorageV1beta1CSINodeParamsWithTimeout creates a new WatchStorageV1beta1CSINodeParams object
...
// NewWatchStorageV1beta1CSINodeParamsWithContext creates a new WatchStorageV1beta1CSINodeParams object
...
// NewWatchStorageV1beta1CSINodeParamsWithHTTPClient creates a new WatchStorageV1beta1CSINodeParams object
...
/*WatchStorageV1beta1CSINodeParams contains all the parameters to send to the API endpoint
for the watch storage v1beta1 c s i node operation typically these are written to a http.Request
*/
...
func (o *WatchStorageV1beta1CSINodeParams) WithTimeout(timeout time.Duration) *WatchStorageV1beta1CSINodeParams {
...
func (o *WatchStorageV1beta1CSINodeParams) WithContext(ctx context.Context) *WatchStorageV1beta1CSINodeParams {
	o.SetContext(ctx)
	return o
}

// SetContext adds the context to the watch storage v1beta1 c s i node params
func (o *WatchStorageV1beta1CSINodeParams) SetContext(ctx context.Context) {
	o.Context = ctx
}

// WithHTTPClient adds the HTTPClient to the watch storage v1beta1 c s i node params
func (o *WatchStorageV1beta1CSINodeParams) WithHTTPClient(client *http.Client) *WatchStorageV1beta1CSINodeParams {
...
func (o *WatchStorageV1beta1CSINodeParams) WithContinue(continueVar *string) *WatchStorageV1beta1CSINodeParams {
...
func (o *WatchStorageV1beta1CSINodeParams) WithLimit(limit *int64) *WatchStorageV1beta1CSINodeParams {
	o.SetLimit(limit)
	return o
}
...
func (o *WatchStorageV1beta1CSINodeParams) WithName(name string) *WatchStorageV1beta1CSINodeParams {
	o.SetName(name)
	return o
}
...
func (o *WatchStorageV1beta1CSINodeParams) WithPretty(pretty *string) *WatchStorageV1beta1CSINodeParams {
	o.SetPretty(pretty)
	return o
}
...
func (o *WatchStorageV1beta1CSINodeParams) WithWatch(watch *bool) *WatchStorageV1beta1CSINodeParams {
	o.SetWatch(watch)
	return o
}
...
func (o *WatchStorageV1beta1CSINodeParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {

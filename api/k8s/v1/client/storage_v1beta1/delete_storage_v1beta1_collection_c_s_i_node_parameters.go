...
// NewDeleteStorageV1beta1CollectionCSINodeParamsWithTimeout creates a new DeleteStorageV1beta1CollectionCSINodeParams object
...
// NewDeleteStorageV1beta1CollectionCSINodeParamsWithContext creates a new DeleteStorageV1beta1CollectionCSINodeParams object
...
// NewDeleteStorageV1beta1CollectionCSINodeParamsWithHTTPClient creates a new DeleteStorageV1beta1CollectionCSINodeParams object
...
/*DeleteStorageV1beta1CollectionCSINodeParams contains all the parameters to send to the API endpoint
for the delete storage v1beta1 collection c s i node operation typically these are written to a http.Request
*/
...
func (o *DeleteStorageV1beta1CollectionCSINodeParams) WithTimeout(timeout time.Duration) *DeleteStorageV1beta1CollectionCSINodeParams {
	o.SetTimeout(timeout)
	return o
}

// SetTimeout adds the timeout to the delete storage v1beta1 collection c s i node params
func (o *DeleteStorageV1beta1CollectionCSINodeParams) SetTimeout(timeout time.Duration) {
	o.timeout = timeout
}

// WithContext adds the context to the delete storage v1beta1 collection c s i node params
func (o *DeleteStorageV1beta1CollectionCSINodeParams) WithContext(ctx context.Context) *DeleteStorageV1beta1CollectionCSINodeParams {
	o.SetContext(ctx)
	return o
}

// SetContext adds the context to the delete storage v1beta1 collection c s i node params
func (o *DeleteStorageV1beta1CollectionCSINodeParams) SetContext(ctx context.Context) {
	o.Context = ctx
}

// WithHTTPClient adds the HTTPClient to the delete storage v1beta1 collection c s i node params
func (o *DeleteStorageV1beta1CollectionCSINodeParams) WithHTTPClient(client *http.Client) *DeleteStorageV1beta1CollectionCSINodeParams {
...
func (o *DeleteStorageV1beta1CollectionCSINodeParams) WithBody(body *models.IoK8sApimachineryPkgApisMetaV1DeleteOptions) *DeleteStorageV1beta1CollectionCSINodeParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the delete storage v1beta1 collection c s i node params
func (o *DeleteStorageV1beta1CollectionCSINodeParams) SetBody(body *models.IoK8sApimachineryPkgApisMetaV1DeleteOptions) {
	o.Body = body
}

// WithContinue adds the continueVar to the delete storage v1beta1 collection c s i node params
func (o *DeleteStorageV1beta1CollectionCSINodeParams) WithContinue(continueVar *string) *DeleteStorageV1beta1CollectionCSINodeParams {
...
func (o *DeleteStorageV1beta1CollectionCSINodeParams) WithDryRun(dryRun *string) *DeleteStorageV1beta1CollectionCSINodeParams {
	o.SetDryRun(dryRun)
	return o
}

// SetDryRun adds the dryRun to the delete storage v1beta1 collection c s i node params
func (o *DeleteStorageV1beta1CollectionCSINodeParams) SetDryRun(dryRun *string) {
	o.DryRun = dryRun
}

// WithFieldSelector adds the fieldSelector to the delete storage v1beta1 collection c s i node params
func (o *DeleteStorageV1beta1CollectionCSINodeParams) WithFieldSelector(fieldSelector *string) *DeleteStorageV1beta1CollectionCSINodeParams {
...
func (o *DeleteStorageV1beta1CollectionCSINodeParams) WithGracePeriodSeconds(gracePeriodSeconds *int64) *DeleteStorageV1beta1CollectionCSINodeParams {
...
func (o *DeleteStorageV1beta1CollectionCSINodeParams) WithLabelSelector(labelSelector *string) *DeleteStorageV1beta1CollectionCSINodeParams {
...
func (o *DeleteStorageV1beta1CollectionCSINodeParams) WithLimit(limit *int64) *DeleteStorageV1beta1CollectionCSINodeParams {
	o.SetLimit(limit)
	return o
}

// SetLimit adds the limit to the delete storage v1beta1 collection c s i node params
func (o *DeleteStorageV1beta1CollectionCSINodeParams) SetLimit(limit *int64) {
	o.Limit = limit
}

// WithOrphanDependents adds the orphanDependents to the delete storage v1beta1 collection c s i node params
func (o *DeleteStorageV1beta1CollectionCSINodeParams) WithOrphanDependents(orphanDependents *bool) *DeleteStorageV1beta1CollectionCSINodeParams {
...
func (o *DeleteStorageV1beta1CollectionCSINodeParams) WithPretty(pretty *string) *DeleteStorageV1beta1CollectionCSINodeParams {
	o.SetPretty(pretty)
	return o
}

// SetPretty adds the pretty to the delete storage v1beta1 collection c s i node params
func (o *DeleteStorageV1beta1CollectionCSINodeParams) SetPretty(pretty *string) {
	o.Pretty = pretty
}

// WithPropagationPolicy adds the propagationPolicy to the delete storage v1beta1 collection c s i node params
func (o *DeleteStorageV1beta1CollectionCSINodeParams) WithPropagationPolicy(propagationPolicy *string) *DeleteStorageV1beta1CollectionCSINodeParams {
...
func (o *DeleteStorageV1beta1CollectionCSINodeParams) WithResourceVersion(resourceVersion *string) *DeleteStorageV1beta1CollectionCSINodeParams {
...
func (o *DeleteStorageV1beta1CollectionCSINodeParams) WithTimeoutSeconds(timeoutSeconds *int64) *DeleteStorageV1beta1CollectionCSINodeParams {
...
func (o *DeleteStorageV1beta1CollectionCSINodeParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {

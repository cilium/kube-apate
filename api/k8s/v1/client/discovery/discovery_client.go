...
func (a *Client) GetDiscoveryAPIGroup(params *GetDiscoveryAPIGroupParams) (*GetDiscoveryAPIGroupOK, error) {
	...
	if params == nil {
		params = NewGetDiscoveryAPIGroupParams()
	}

	result, err := a.transport.Submit(&runtime.ClientOperation{
		ID:                 "getDiscoveryAPIGroup",
		Method:             "GET",
		PathPattern:        "/apis/discovery.k8s.io/",
		...
		Schemes:            []string{"http"},
		Params:             params,
		Reader:             &GetDiscoveryAPIGroupReader{formats: a.formats},
	...
	success, ok := result.(*GetDiscoveryAPIGroupOK)
	if ok {
		return success, nil
	}
	// unexpected success response
	// safeguard: normally, absent a default response, unknown success responses return an error above: so this is a codegen issue
	msg := fmt.Sprintf("unexpected success response for getDiscoveryAPIGroup: API contract not enforced by server. Client expected to get an error, but got: %T", result)
	panic(msg)
}

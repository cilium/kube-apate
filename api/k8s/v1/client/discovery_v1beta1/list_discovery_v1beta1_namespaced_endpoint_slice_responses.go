...
func (o *ListDiscoveryV1beta1NamespacedEndpointSliceReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewListDiscoveryV1beta1NamespacedEndpointSliceOK()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return result, nil
	case 401:
		result := NewListDiscoveryV1beta1NamespacedEndpointSliceUnauthorized()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
func (o *ListDiscoveryV1beta1NamespacedEndpointSliceOK) Error() string {
	return fmt.Sprintf("[GET /apis/discovery.k8s.io/v1beta1/namespaces/{namespace}/endpointslices][%d] listDiscoveryV1beta1NamespacedEndpointSliceOK  %+v", 200, o.Payload)
}
...
func (o *ListDiscoveryV1beta1NamespacedEndpointSliceOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
...
func (o *ListDiscoveryV1beta1NamespacedEndpointSliceUnauthorized) Error() string {
	return fmt.Sprintf("[GET /apis/discovery.k8s.io/v1beta1/namespaces/{namespace}/endpointslices][%d] listDiscoveryV1beta1NamespacedEndpointSliceUnauthorized ", 401)
}

func (o *ListDiscoveryV1beta1NamespacedEndpointSliceUnauthorized) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {

...
// NewListDiscoveryV1beta1EndpointSliceForAllNamespacesParamsWithTimeout creates a new ListDiscoveryV1beta1EndpointSliceForAllNamespacesParams object
...
// NewListDiscoveryV1beta1EndpointSliceForAllNamespacesParamsWithContext creates a new ListDiscoveryV1beta1EndpointSliceForAllNamespacesParams object
...
// NewListDiscoveryV1beta1EndpointSliceForAllNamespacesParamsWithHTTPClient creates a new ListDiscoveryV1beta1EndpointSliceForAllNamespacesParams object
...
/*ListDiscoveryV1beta1EndpointSliceForAllNamespacesParams contains all the parameters to send to the API endpoint
for the list discovery v1beta1 endpoint slice for all namespaces operation typically these are written to a http.Request
*/

...
// NewListApiextensionsV1beta1CustomResourceDefinitionParamsWithTimeout creates a new ListApiextensionsV1beta1CustomResourceDefinitionParams object
...
// NewListApiextensionsV1beta1CustomResourceDefinitionParamsWithContext creates a new ListApiextensionsV1beta1CustomResourceDefinitionParams object
...
// NewListApiextensionsV1beta1CustomResourceDefinitionParamsWithHTTPClient creates a new ListApiextensionsV1beta1CustomResourceDefinitionParams object
...
/*ListApiextensionsV1beta1CustomResourceDefinitionParams contains all the parameters to send to the API endpoint
for the list apiextensions v1beta1 custom resource definition operation typically these are written to a http.Request
*/
...
func (o *ListApiextensionsV1beta1CustomResourceDefinitionParams) WithTimeout(timeout time.Duration) *ListApiextensionsV1beta1CustomResourceDefinitionParams {
	o.SetTimeout(timeout)
	return o
}

// SetTimeout adds the timeout to the list apiextensions v1beta1 custom resource definition params
func (o *ListApiextensionsV1beta1CustomResourceDefinitionParams) SetTimeout(timeout time.Duration) {
	o.timeout = timeout
}

// WithContext adds the context to the list apiextensions v1beta1 custom resource definition params
func (o *ListApiextensionsV1beta1CustomResourceDefinitionParams) WithContext(ctx context.Context) *ListApiextensionsV1beta1CustomResourceDefinitionParams {
	o.SetContext(ctx)
	return o
}

// SetContext adds the context to the list apiextensions v1beta1 custom resource definition params
func (o *ListApiextensionsV1beta1CustomResourceDefinitionParams) SetContext(ctx context.Context) {
	o.Context = ctx
}

// WithHTTPClient adds the HTTPClient to the list apiextensions v1beta1 custom resource definition params
func (o *ListApiextensionsV1beta1CustomResourceDefinitionParams) WithHTTPClient(client *http.Client) *ListApiextensionsV1beta1CustomResourceDefinitionParams {
	o.SetHTTPClient(client)
	return o
}

// SetHTTPClient adds the HTTPClient to the list apiextensions v1beta1 custom resource definition params
func (o *ListApiextensionsV1beta1CustomResourceDefinitionParams) SetHTTPClient(client *http.Client) {
	o.HTTPClient = client
}

// WithAllowWatchBookmarks adds the allowWatchBookmarks to the list apiextensions v1beta1 custom resource definition params
func (o *ListApiextensionsV1beta1CustomResourceDefinitionParams) WithAllowWatchBookmarks(allowWatchBookmarks *bool) *ListApiextensionsV1beta1CustomResourceDefinitionParams {
...
func (o *ListApiextensionsV1beta1CustomResourceDefinitionParams) WithContinue(continueVar *string) *ListApiextensionsV1beta1CustomResourceDefinitionParams {
...
func (o *ListApiextensionsV1beta1CustomResourceDefinitionParams) SetContinue(continueVar *string) {
...
func (o *ListApiextensionsV1beta1CustomResourceDefinitionParams) WithFieldSelector(fieldSelector *string) *ListApiextensionsV1beta1CustomResourceDefinitionParams {
...
func (o *ListApiextensionsV1beta1CustomResourceDefinitionParams) WithLabelSelector(labelSelector *string) *ListApiextensionsV1beta1CustomResourceDefinitionParams {
...
func (o *ListApiextensionsV1beta1CustomResourceDefinitionParams) WithLimit(limit *int64) *ListApiextensionsV1beta1CustomResourceDefinitionParams {
	o.SetLimit(limit)
	return o
}

// SetLimit adds the limit to the list apiextensions v1beta1 custom resource definition params
func (o *ListApiextensionsV1beta1CustomResourceDefinitionParams) SetLimit(limit *int64) {
	o.Limit = limit
}

// WithPretty adds the pretty to the list apiextensions v1beta1 custom resource definition params
func (o *ListApiextensionsV1beta1CustomResourceDefinitionParams) WithPretty(pretty *string) *ListApiextensionsV1beta1CustomResourceDefinitionParams {
	o.SetPretty(pretty)
	return o
}

// SetPretty adds the pretty to the list apiextensions v1beta1 custom resource definition params
func (o *ListApiextensionsV1beta1CustomResourceDefinitionParams) SetPretty(pretty *string) {
	o.Pretty = pretty
}

// WithResourceVersion adds the resourceVersion to the list apiextensions v1beta1 custom resource definition params
func (o *ListApiextensionsV1beta1CustomResourceDefinitionParams) WithResourceVersion(resourceVersion *string) *ListApiextensionsV1beta1CustomResourceDefinitionParams {
...
func (o *ListApiextensionsV1beta1CustomResourceDefinitionParams) WithResourceVersionMatch(resourceVersionMatch *string) *ListApiextensionsV1beta1CustomResourceDefinitionParams {
...
func (o *ListApiextensionsV1beta1CustomResourceDefinitionParams) WithTimeoutSeconds(timeoutSeconds *int64) *ListApiextensionsV1beta1CustomResourceDefinitionParams {
...
func (o *ListApiextensionsV1beta1CustomResourceDefinitionParams) WithWatch(watch *bool) *ListApiextensionsV1beta1CustomResourceDefinitionParams {
	o.SetWatch(watch)
	return o
}

// SetWatch adds the watch to the list apiextensions v1beta1 custom resource definition params
func (o *ListApiextensionsV1beta1CustomResourceDefinitionParams) SetWatch(watch *bool) {
	o.Watch = watch
}

// WriteToRequest writes these params to a swagger request
func (o *ListApiextensionsV1beta1CustomResourceDefinitionParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {

...
// NewDeleteApiextensionsV1beta1CustomResourceDefinitionParamsWithTimeout creates a new DeleteApiextensionsV1beta1CustomResourceDefinitionParams object
...
// NewDeleteApiextensionsV1beta1CustomResourceDefinitionParamsWithContext creates a new DeleteApiextensionsV1beta1CustomResourceDefinitionParams object
...
// NewDeleteApiextensionsV1beta1CustomResourceDefinitionParamsWithHTTPClient creates a new DeleteApiextensionsV1beta1CustomResourceDefinitionParams object
...
/*DeleteApiextensionsV1beta1CustomResourceDefinitionParams contains all the parameters to send to the API endpoint
for the delete apiextensions v1beta1 custom resource definition operation typically these are written to a http.Request
*/
...
func (o *DeleteApiextensionsV1beta1CustomResourceDefinitionParams) WithTimeout(timeout time.Duration) *DeleteApiextensionsV1beta1CustomResourceDefinitionParams {
	o.SetTimeout(timeout)
	return o
}

// SetTimeout adds the timeout to the delete apiextensions v1beta1 custom resource definition params
func (o *DeleteApiextensionsV1beta1CustomResourceDefinitionParams) SetTimeout(timeout time.Duration) {
	o.timeout = timeout
}

// WithContext adds the context to the delete apiextensions v1beta1 custom resource definition params
func (o *DeleteApiextensionsV1beta1CustomResourceDefinitionParams) WithContext(ctx context.Context) *DeleteApiextensionsV1beta1CustomResourceDefinitionParams {
	o.SetContext(ctx)
	return o
}

// SetContext adds the context to the delete apiextensions v1beta1 custom resource definition params
func (o *DeleteApiextensionsV1beta1CustomResourceDefinitionParams) SetContext(ctx context.Context) {
	o.Context = ctx
}

// WithHTTPClient adds the HTTPClient to the delete apiextensions v1beta1 custom resource definition params
func (o *DeleteApiextensionsV1beta1CustomResourceDefinitionParams) WithHTTPClient(client *http.Client) *DeleteApiextensionsV1beta1CustomResourceDefinitionParams {
	o.SetHTTPClient(client)
	return o
}

// SetHTTPClient adds the HTTPClient to the delete apiextensions v1beta1 custom resource definition params
func (o *DeleteApiextensionsV1beta1CustomResourceDefinitionParams) SetHTTPClient(client *http.Client) {
	o.HTTPClient = client
}

// WithBody adds the body to the delete apiextensions v1beta1 custom resource definition params
func (o *DeleteApiextensionsV1beta1CustomResourceDefinitionParams) WithBody(body *models.IoK8sApimachineryPkgApisMetaV1DeleteOptions) *DeleteApiextensionsV1beta1CustomResourceDefinitionParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the delete apiextensions v1beta1 custom resource definition params
func (o *DeleteApiextensionsV1beta1CustomResourceDefinitionParams) SetBody(body *models.IoK8sApimachineryPkgApisMetaV1DeleteOptions) {
	o.Body = body
}

// WithDryRun adds the dryRun to the delete apiextensions v1beta1 custom resource definition params
func (o *DeleteApiextensionsV1beta1CustomResourceDefinitionParams) WithDryRun(dryRun *string) *DeleteApiextensionsV1beta1CustomResourceDefinitionParams {
	o.SetDryRun(dryRun)
	return o
}

// SetDryRun adds the dryRun to the delete apiextensions v1beta1 custom resource definition params
func (o *DeleteApiextensionsV1beta1CustomResourceDefinitionParams) SetDryRun(dryRun *string) {
	o.DryRun = dryRun
}

// WithGracePeriodSeconds adds the gracePeriodSeconds to the delete apiextensions v1beta1 custom resource definition params
func (o *DeleteApiextensionsV1beta1CustomResourceDefinitionParams) WithGracePeriodSeconds(gracePeriodSeconds *int64) *DeleteApiextensionsV1beta1CustomResourceDefinitionParams {
...
func (o *DeleteApiextensionsV1beta1CustomResourceDefinitionParams) WithName(name string) *DeleteApiextensionsV1beta1CustomResourceDefinitionParams {
	o.SetName(name)
	return o
}

// SetName adds the name to the delete apiextensions v1beta1 custom resource definition params
func (o *DeleteApiextensionsV1beta1CustomResourceDefinitionParams) SetName(name string) {
	o.Name = name
}

// WithOrphanDependents adds the orphanDependents to the delete apiextensions v1beta1 custom resource definition params
func (o *DeleteApiextensionsV1beta1CustomResourceDefinitionParams) WithOrphanDependents(orphanDependents *bool) *DeleteApiextensionsV1beta1CustomResourceDefinitionParams {
...
func (o *DeleteApiextensionsV1beta1CustomResourceDefinitionParams) WithPretty(pretty *string) *DeleteApiextensionsV1beta1CustomResourceDefinitionParams {
	o.SetPretty(pretty)
	return o
}

// SetPretty adds the pretty to the delete apiextensions v1beta1 custom resource definition params
func (o *DeleteApiextensionsV1beta1CustomResourceDefinitionParams) SetPretty(pretty *string) {
	o.Pretty = pretty
}

// WithPropagationPolicy adds the propagationPolicy to the delete apiextensions v1beta1 custom resource definition params
func (o *DeleteApiextensionsV1beta1CustomResourceDefinitionParams) WithPropagationPolicy(propagationPolicy *string) *DeleteApiextensionsV1beta1CustomResourceDefinitionParams {
...
func (o *DeleteApiextensionsV1beta1CustomResourceDefinitionParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {

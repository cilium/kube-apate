...
// NewWatchApiextensionsV1beta1CustomResourceDefinitionListParamsWithTimeout creates a new WatchApiextensionsV1beta1CustomResourceDefinitionListParams object
...
// NewWatchApiextensionsV1beta1CustomResourceDefinitionListParamsWithContext creates a new WatchApiextensionsV1beta1CustomResourceDefinitionListParams object
...
// NewWatchApiextensionsV1beta1CustomResourceDefinitionListParamsWithHTTPClient creates a new WatchApiextensionsV1beta1CustomResourceDefinitionListParams object
...
/*WatchApiextensionsV1beta1CustomResourceDefinitionListParams contains all the parameters to send to the API endpoint
for the watch apiextensions v1beta1 custom resource definition list operation typically these are written to a http.Request
*/
...
func (o *WatchApiextensionsV1beta1CustomResourceDefinitionListParams) WithTimeout(timeout time.Duration) *WatchApiextensionsV1beta1CustomResourceDefinitionListParams {
	o.SetTimeout(timeout)
	return o
}

// SetTimeout adds the timeout to the watch apiextensions v1beta1 custom resource definition list params
func (o *WatchApiextensionsV1beta1CustomResourceDefinitionListParams) SetTimeout(timeout time.Duration) {
	o.timeout = timeout
}

// WithContext adds the context to the watch apiextensions v1beta1 custom resource definition list params
func (o *WatchApiextensionsV1beta1CustomResourceDefinitionListParams) WithContext(ctx context.Context) *WatchApiextensionsV1beta1CustomResourceDefinitionListParams {
	o.SetContext(ctx)
	return o
}

// SetContext adds the context to the watch apiextensions v1beta1 custom resource definition list params
func (o *WatchApiextensionsV1beta1CustomResourceDefinitionListParams) SetContext(ctx context.Context) {
	o.Context = ctx
}

// WithHTTPClient adds the HTTPClient to the watch apiextensions v1beta1 custom resource definition list params
func (o *WatchApiextensionsV1beta1CustomResourceDefinitionListParams) WithHTTPClient(client *http.Client) *WatchApiextensionsV1beta1CustomResourceDefinitionListParams {
	o.SetHTTPClient(client)
	return o
}

// SetHTTPClient adds the HTTPClient to the watch apiextensions v1beta1 custom resource definition list params
func (o *WatchApiextensionsV1beta1CustomResourceDefinitionListParams) SetHTTPClient(client *http.Client) {
	o.HTTPClient = client
}
...
func (o *WatchApiextensionsV1beta1CustomResourceDefinitionListParams) WithAllowWatchBookmarks(allowWatchBookmarks *bool) *WatchApiextensionsV1beta1CustomResourceDefinitionListParams {
...
func (o *WatchApiextensionsV1beta1CustomResourceDefinitionListParams) WithContinue(continueVar *string) *WatchApiextensionsV1beta1CustomResourceDefinitionListParams {
...
func (o *WatchApiextensionsV1beta1CustomResourceDefinitionListParams) SetContinue(continueVar *string) {
...
func (o *WatchApiextensionsV1beta1CustomResourceDefinitionListParams) WithFieldSelector(fieldSelector *string) *WatchApiextensionsV1beta1CustomResourceDefinitionListParams {
...
func (o *WatchApiextensionsV1beta1CustomResourceDefinitionListParams) WithLabelSelector(labelSelector *string) *WatchApiextensionsV1beta1CustomResourceDefinitionListParams {
...
func (o *WatchApiextensionsV1beta1CustomResourceDefinitionListParams) WithLimit(limit *int64) *WatchApiextensionsV1beta1CustomResourceDefinitionListParams {
	o.SetLimit(limit)
	return o
}

// SetLimit adds the limit to the watch apiextensions v1beta1 custom resource definition list params
func (o *WatchApiextensionsV1beta1CustomResourceDefinitionListParams) SetLimit(limit *int64) {
	o.Limit = limit
}

// WithPretty adds the pretty to the watch apiextensions v1beta1 custom resource definition list params
func (o *WatchApiextensionsV1beta1CustomResourceDefinitionListParams) WithPretty(pretty *string) *WatchApiextensionsV1beta1CustomResourceDefinitionListParams {
	o.SetPretty(pretty)
	return o
}

// SetPretty adds the pretty to the watch apiextensions v1beta1 custom resource definition list params
func (o *WatchApiextensionsV1beta1CustomResourceDefinitionListParams) SetPretty(pretty *string) {
	o.Pretty = pretty
}

// WithResourceVersion adds the resourceVersion to the watch apiextensions v1beta1 custom resource definition list params
func (o *WatchApiextensionsV1beta1CustomResourceDefinitionListParams) WithResourceVersion(resourceVersion *string) *WatchApiextensionsV1beta1CustomResourceDefinitionListParams {
...
func (o *WatchApiextensionsV1beta1CustomResourceDefinitionListParams) WithResourceVersionMatch(resourceVersionMatch *string) *WatchApiextensionsV1beta1CustomResourceDefinitionListParams {
...
func (o *WatchApiextensionsV1beta1CustomResourceDefinitionListParams) WithTimeoutSeconds(timeoutSeconds *int64) *WatchApiextensionsV1beta1CustomResourceDefinitionListParams {
...
func (o *WatchApiextensionsV1beta1CustomResourceDefinitionListParams) WithWatch(watch *bool) *WatchApiextensionsV1beta1CustomResourceDefinitionListParams {
	o.SetWatch(watch)
	return o
}

// SetWatch adds the watch to the watch apiextensions v1beta1 custom resource definition list params
func (o *WatchApiextensionsV1beta1CustomResourceDefinitionListParams) SetWatch(watch *bool) {
	o.Watch = watch
}

// WriteToRequest writes these params to a swagger request
func (o *WatchApiextensionsV1beta1CustomResourceDefinitionListParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {

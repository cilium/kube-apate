...
func (o *ListApiextensionsV1beta1CustomResourceDefinitionReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewListApiextensionsV1beta1CustomResourceDefinitionOK()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return result, nil
	case 401:
		result := NewListApiextensionsV1beta1CustomResourceDefinitionUnauthorized()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
func (o *ListApiextensionsV1beta1CustomResourceDefinitionOK) Error() string {
	return fmt.Sprintf("[GET /apis/apiextensions.k8s.io/v1beta1/customresourcedefinitions][%d] listApiextensionsV1beta1CustomResourceDefinitionOK  %+v", 200, o.Payload)
}

func (o *ListApiextensionsV1beta1CustomResourceDefinitionOK) GetPayload() *models.IoK8sApiextensionsApiserverPkgApisApiextensionsV1beta1CustomResourceDefinitionList {
	return o.Payload
}

func (o *ListApiextensionsV1beta1CustomResourceDefinitionOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {

	o.Payload = new(models.IoK8sApiextensionsApiserverPkgApisApiextensionsV1beta1CustomResourceDefinitionList)
...
func (o *ListApiextensionsV1beta1CustomResourceDefinitionUnauthorized) Error() string {
	return fmt.Sprintf("[GET /apis/apiextensions.k8s.io/v1beta1/customresourcedefinitions][%d] listApiextensionsV1beta1CustomResourceDefinitionUnauthorized ", 401)
}

func (o *ListApiextensionsV1beta1CustomResourceDefinitionUnauthorized) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {

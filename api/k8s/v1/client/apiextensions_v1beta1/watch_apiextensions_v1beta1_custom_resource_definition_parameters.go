...
// NewWatchApiextensionsV1beta1CustomResourceDefinitionParamsWithTimeout creates a new WatchApiextensionsV1beta1CustomResourceDefinitionParams object
...
// NewWatchApiextensionsV1beta1CustomResourceDefinitionParamsWithContext creates a new WatchApiextensionsV1beta1CustomResourceDefinitionParams object
...
// NewWatchApiextensionsV1beta1CustomResourceDefinitionParamsWithHTTPClient creates a new WatchApiextensionsV1beta1CustomResourceDefinitionParams object
...
/*WatchApiextensionsV1beta1CustomResourceDefinitionParams contains all the parameters to send to the API endpoint
for the watch apiextensions v1beta1 custom resource definition operation typically these are written to a http.Request
*/
...
func (o *WatchApiextensionsV1beta1CustomResourceDefinitionParams) WithTimeout(timeout time.Duration) *WatchApiextensionsV1beta1CustomResourceDefinitionParams {
	o.SetTimeout(timeout)
	return o
}

// SetTimeout adds the timeout to the watch apiextensions v1beta1 custom resource definition params
func (o *WatchApiextensionsV1beta1CustomResourceDefinitionParams) SetTimeout(timeout time.Duration) {
	o.timeout = timeout
}

// WithContext adds the context to the watch apiextensions v1beta1 custom resource definition params
func (o *WatchApiextensionsV1beta1CustomResourceDefinitionParams) WithContext(ctx context.Context) *WatchApiextensionsV1beta1CustomResourceDefinitionParams {
	o.SetContext(ctx)
	return o
}

// SetContext adds the context to the watch apiextensions v1beta1 custom resource definition params
func (o *WatchApiextensionsV1beta1CustomResourceDefinitionParams) SetContext(ctx context.Context) {
	o.Context = ctx
}

// WithHTTPClient adds the HTTPClient to the watch apiextensions v1beta1 custom resource definition params
func (o *WatchApiextensionsV1beta1CustomResourceDefinitionParams) WithHTTPClient(client *http.Client) *WatchApiextensionsV1beta1CustomResourceDefinitionParams {
	o.SetHTTPClient(client)
	return o
}

// SetHTTPClient adds the HTTPClient to the watch apiextensions v1beta1 custom resource definition params
func (o *WatchApiextensionsV1beta1CustomResourceDefinitionParams) SetHTTPClient(client *http.Client) {
	o.HTTPClient = client
}
...
func (o *WatchApiextensionsV1beta1CustomResourceDefinitionParams) WithAllowWatchBookmarks(allowWatchBookmarks *bool) *WatchApiextensionsV1beta1CustomResourceDefinitionParams {
...
func (o *WatchApiextensionsV1beta1CustomResourceDefinitionParams) WithContinue(continueVar *string) *WatchApiextensionsV1beta1CustomResourceDefinitionParams {
...
func (o *WatchApiextensionsV1beta1CustomResourceDefinitionParams) SetContinue(continueVar *string) {
...
func (o *WatchApiextensionsV1beta1CustomResourceDefinitionParams) WithFieldSelector(fieldSelector *string) *WatchApiextensionsV1beta1CustomResourceDefinitionParams {
...
func (o *WatchApiextensionsV1beta1CustomResourceDefinitionParams) WithLabelSelector(labelSelector *string) *WatchApiextensionsV1beta1CustomResourceDefinitionParams {
...
func (o *WatchApiextensionsV1beta1CustomResourceDefinitionParams) WithLimit(limit *int64) *WatchApiextensionsV1beta1CustomResourceDefinitionParams {
	o.SetLimit(limit)
	return o
}

// SetLimit adds the limit to the watch apiextensions v1beta1 custom resource definition params
func (o *WatchApiextensionsV1beta1CustomResourceDefinitionParams) SetLimit(limit *int64) {
	o.Limit = limit
}

// WithName adds the name to the watch apiextensions v1beta1 custom resource definition params
func (o *WatchApiextensionsV1beta1CustomResourceDefinitionParams) WithName(name string) *WatchApiextensionsV1beta1CustomResourceDefinitionParams {
	o.SetName(name)
	return o
}

// SetName adds the name to the watch apiextensions v1beta1 custom resource definition params
func (o *WatchApiextensionsV1beta1CustomResourceDefinitionParams) SetName(name string) {
	o.Name = name
}

// WithPretty adds the pretty to the watch apiextensions v1beta1 custom resource definition params
func (o *WatchApiextensionsV1beta1CustomResourceDefinitionParams) WithPretty(pretty *string) *WatchApiextensionsV1beta1CustomResourceDefinitionParams {
	o.SetPretty(pretty)
	return o
}

// SetPretty adds the pretty to the watch apiextensions v1beta1 custom resource definition params
func (o *WatchApiextensionsV1beta1CustomResourceDefinitionParams) SetPretty(pretty *string) {
	o.Pretty = pretty
}

// WithResourceVersion adds the resourceVersion to the watch apiextensions v1beta1 custom resource definition params
func (o *WatchApiextensionsV1beta1CustomResourceDefinitionParams) WithResourceVersion(resourceVersion *string) *WatchApiextensionsV1beta1CustomResourceDefinitionParams {
...
func (o *WatchApiextensionsV1beta1CustomResourceDefinitionParams) WithResourceVersionMatch(resourceVersionMatch *string) *WatchApiextensionsV1beta1CustomResourceDefinitionParams {
...
func (o *WatchApiextensionsV1beta1CustomResourceDefinitionParams) WithTimeoutSeconds(timeoutSeconds *int64) *WatchApiextensionsV1beta1CustomResourceDefinitionParams {
...
func (o *WatchApiextensionsV1beta1CustomResourceDefinitionParams) WithWatch(watch *bool) *WatchApiextensionsV1beta1CustomResourceDefinitionParams {
	o.SetWatch(watch)
	return o
}

// SetWatch adds the watch to the watch apiextensions v1beta1 custom resource definition params
func (o *WatchApiextensionsV1beta1CustomResourceDefinitionParams) SetWatch(watch *bool) {
	o.Watch = watch
}

// WriteToRequest writes these params to a swagger request
func (o *WatchApiextensionsV1beta1CustomResourceDefinitionParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {

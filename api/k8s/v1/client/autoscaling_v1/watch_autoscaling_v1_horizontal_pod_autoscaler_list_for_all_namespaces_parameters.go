...
// NewWatchAutoscalingV1HorizontalPodAutoscalerListForAllNamespacesParamsWithTimeout creates a new WatchAutoscalingV1HorizontalPodAutoscalerListForAllNamespacesParams object
...
// NewWatchAutoscalingV1HorizontalPodAutoscalerListForAllNamespacesParamsWithContext creates a new WatchAutoscalingV1HorizontalPodAutoscalerListForAllNamespacesParams object
...
// NewWatchAutoscalingV1HorizontalPodAutoscalerListForAllNamespacesParamsWithHTTPClient creates a new WatchAutoscalingV1HorizontalPodAutoscalerListForAllNamespacesParams object
...
/*WatchAutoscalingV1HorizontalPodAutoscalerListForAllNamespacesParams contains all the parameters to send to the API endpoint
for the watch autoscaling v1 horizontal pod autoscaler list for all namespaces operation typically these are written to a http.Request
*/

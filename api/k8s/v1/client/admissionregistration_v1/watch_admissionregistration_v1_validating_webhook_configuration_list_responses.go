...
func (o *WatchAdmissionregistrationV1ValidatingWebhookConfigurationListReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewWatchAdmissionregistrationV1ValidatingWebhookConfigurationListOK()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return result, nil
	case 401:
		result := NewWatchAdmissionregistrationV1ValidatingWebhookConfigurationListUnauthorized()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
func (o *WatchAdmissionregistrationV1ValidatingWebhookConfigurationListOK) Error() string {
	return fmt.Sprintf("[GET /apis/admissionregistration.k8s.io/v1/watch/validatingwebhookconfigurations][%d] watchAdmissionregistrationV1ValidatingWebhookConfigurationListOK  %+v", 200, o.Payload)
}

func (o *WatchAdmissionregistrationV1ValidatingWebhookConfigurationListOK) GetPayload() *models.IoK8sApimachineryPkgApisMetaV1WatchEvent {
	return o.Payload
}

func (o *WatchAdmissionregistrationV1ValidatingWebhookConfigurationListOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
...
func (o *WatchAdmissionregistrationV1ValidatingWebhookConfigurationListUnauthorized) Error() string {
	return fmt.Sprintf("[GET /apis/admissionregistration.k8s.io/v1/watch/validatingwebhookconfigurations][%d] watchAdmissionregistrationV1ValidatingWebhookConfigurationListUnauthorized ", 401)
}

func (o *WatchAdmissionregistrationV1ValidatingWebhookConfigurationListUnauthorized) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {

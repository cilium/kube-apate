...
func (o *DeleteAdmissionregistrationV1MutatingWebhookConfigurationReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewDeleteAdmissionregistrationV1MutatingWebhookConfigurationOK()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return result, nil
	case 202:
		result := NewDeleteAdmissionregistrationV1MutatingWebhookConfigurationAccepted()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return result, nil
	case 401:
		result := NewDeleteAdmissionregistrationV1MutatingWebhookConfigurationUnauthorized()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
func (o *DeleteAdmissionregistrationV1MutatingWebhookConfigurationOK) Error() string {
	return fmt.Sprintf("[DELETE /apis/admissionregistration.k8s.io/v1/mutatingwebhookconfigurations/{name}][%d] deleteAdmissionregistrationV1MutatingWebhookConfigurationOK  %+v", 200, o.Payload)
}
...
func (o *DeleteAdmissionregistrationV1MutatingWebhookConfigurationOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
...
func (o *DeleteAdmissionregistrationV1MutatingWebhookConfigurationAccepted) Error() string {
	return fmt.Sprintf("[DELETE /apis/admissionregistration.k8s.io/v1/mutatingwebhookconfigurations/{name}][%d] deleteAdmissionregistrationV1MutatingWebhookConfigurationAccepted  %+v", 202, o.Payload)
}

func (o *DeleteAdmissionregistrationV1MutatingWebhookConfigurationAccepted) GetPayload() *models.IoK8sApimachineryPkgApisMetaV1Status {
	return o.Payload
}

func (o *DeleteAdmissionregistrationV1MutatingWebhookConfigurationAccepted) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
...
func (o *DeleteAdmissionregistrationV1MutatingWebhookConfigurationUnauthorized) Error() string {
	return fmt.Sprintf("[DELETE /apis/admissionregistration.k8s.io/v1/mutatingwebhookconfigurations/{name}][%d] deleteAdmissionregistrationV1MutatingWebhookConfigurationUnauthorized ", 401)
}

func (o *DeleteAdmissionregistrationV1MutatingWebhookConfigurationUnauthorized) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {

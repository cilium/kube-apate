...
func (o *PatchAdmissionregistrationV1MutatingWebhookConfigurationReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewPatchAdmissionregistrationV1MutatingWebhookConfigurationOK()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return result, nil
	case 401:
		result := NewPatchAdmissionregistrationV1MutatingWebhookConfigurationUnauthorized()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
func (o *PatchAdmissionregistrationV1MutatingWebhookConfigurationOK) Error() string {
	return fmt.Sprintf("[PATCH /apis/admissionregistration.k8s.io/v1/mutatingwebhookconfigurations/{name}][%d] patchAdmissionregistrationV1MutatingWebhookConfigurationOK  %+v", 200, o.Payload)
}

func (o *PatchAdmissionregistrationV1MutatingWebhookConfigurationOK) GetPayload() *models.IoK8sAPIAdmissionregistrationV1MutatingWebhookConfiguration {
	return o.Payload
}

func (o *PatchAdmissionregistrationV1MutatingWebhookConfigurationOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
...
func (o *PatchAdmissionregistrationV1MutatingWebhookConfigurationUnauthorized) Error() string {
	return fmt.Sprintf("[PATCH /apis/admissionregistration.k8s.io/v1/mutatingwebhookconfigurations/{name}][%d] patchAdmissionregistrationV1MutatingWebhookConfigurationUnauthorized ", 401)
}

func (o *PatchAdmissionregistrationV1MutatingWebhookConfigurationUnauthorized) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {

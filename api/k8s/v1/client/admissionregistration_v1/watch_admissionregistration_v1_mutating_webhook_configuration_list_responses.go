...
func (o *WatchAdmissionregistrationV1MutatingWebhookConfigurationListReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewWatchAdmissionregistrationV1MutatingWebhookConfigurationListOK()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return result, nil
	case 401:
		result := NewWatchAdmissionregistrationV1MutatingWebhookConfigurationListUnauthorized()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
func (o *WatchAdmissionregistrationV1MutatingWebhookConfigurationListOK) Error() string {
	return fmt.Sprintf("[GET /apis/admissionregistration.k8s.io/v1/watch/mutatingwebhookconfigurations][%d] watchAdmissionregistrationV1MutatingWebhookConfigurationListOK  %+v", 200, o.Payload)
}

func (o *WatchAdmissionregistrationV1MutatingWebhookConfigurationListOK) GetPayload() *models.IoK8sApimachineryPkgApisMetaV1WatchEvent {
	return o.Payload
}

func (o *WatchAdmissionregistrationV1MutatingWebhookConfigurationListOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
...
func (o *WatchAdmissionregistrationV1MutatingWebhookConfigurationListUnauthorized) Error() string {
	return fmt.Sprintf("[GET /apis/admissionregistration.k8s.io/v1/watch/mutatingwebhookconfigurations][%d] watchAdmissionregistrationV1MutatingWebhookConfigurationListUnauthorized ", 401)
}

func (o *WatchAdmissionregistrationV1MutatingWebhookConfigurationListUnauthorized) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {

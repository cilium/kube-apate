...
func (o *GetEventsV1beta1APIResourcesReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewGetEventsV1beta1APIResourcesOK()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return result, nil
	case 401:
		result := NewGetEventsV1beta1APIResourcesUnauthorized()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
func (o *GetEventsV1beta1APIResourcesOK) Error() string {
	return fmt.Sprintf("[GET /apis/events.k8s.io/v1beta1/][%d] getEventsV1beta1ApiResourcesOK  %+v", 200, o.Payload)
}
...
func (o *GetEventsV1beta1APIResourcesOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
...
func (o *GetEventsV1beta1APIResourcesUnauthorized) Error() string {
	return fmt.Sprintf("[GET /apis/events.k8s.io/v1beta1/][%d] getEventsV1beta1ApiResourcesUnauthorized ", 401)
}

func (o *GetEventsV1beta1APIResourcesUnauthorized) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {

...
func (o *ReadEventsV1beta1NamespacedEventReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewReadEventsV1beta1NamespacedEventOK()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return result, nil
	case 401:
		result := NewReadEventsV1beta1NamespacedEventUnauthorized()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
func (o *ReadEventsV1beta1NamespacedEventOK) Error() string {
	return fmt.Sprintf("[GET /apis/events.k8s.io/v1beta1/namespaces/{namespace}/events/{name}][%d] readEventsV1beta1NamespacedEventOK  %+v", 200, o.Payload)
}
...
func (o *ReadEventsV1beta1NamespacedEventOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
...
func (o *ReadEventsV1beta1NamespacedEventUnauthorized) Error() string {
	return fmt.Sprintf("[GET /apis/events.k8s.io/v1beta1/namespaces/{namespace}/events/{name}][%d] readEventsV1beta1NamespacedEventUnauthorized ", 401)
}

func (o *ReadEventsV1beta1NamespacedEventUnauthorized) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {

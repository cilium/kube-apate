...
func (o *GetRbacAuthorizationV1beta1APIResourcesReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewGetRbacAuthorizationV1beta1APIResourcesOK()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return result, nil
	case 401:
		result := NewGetRbacAuthorizationV1beta1APIResourcesUnauthorized()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
func (o *GetRbacAuthorizationV1beta1APIResourcesOK) Error() string {
	return fmt.Sprintf("[GET /apis/rbac.authorization.k8s.io/v1beta1/][%d] getRbacAuthorizationV1beta1ApiResourcesOK  %+v", 200, o.Payload)
}
...
func (o *GetRbacAuthorizationV1beta1APIResourcesOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
...
func (o *GetRbacAuthorizationV1beta1APIResourcesUnauthorized) Error() string {
	return fmt.Sprintf("[GET /apis/rbac.authorization.k8s.io/v1beta1/][%d] getRbacAuthorizationV1beta1ApiResourcesUnauthorized ", 401)
}

func (o *GetRbacAuthorizationV1beta1APIResourcesUnauthorized) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {

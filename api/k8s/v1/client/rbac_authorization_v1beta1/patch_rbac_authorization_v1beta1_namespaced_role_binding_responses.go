...
func (o *PatchRbacAuthorizationV1beta1NamespacedRoleBindingReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewPatchRbacAuthorizationV1beta1NamespacedRoleBindingOK()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return result, nil
	case 401:
		result := NewPatchRbacAuthorizationV1beta1NamespacedRoleBindingUnauthorized()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
func (o *PatchRbacAuthorizationV1beta1NamespacedRoleBindingOK) Error() string {
	return fmt.Sprintf("[PATCH /apis/rbac.authorization.k8s.io/v1beta1/namespaces/{namespace}/rolebindings/{name}][%d] patchRbacAuthorizationV1beta1NamespacedRoleBindingOK  %+v", 200, o.Payload)
}
...
func (o *PatchRbacAuthorizationV1beta1NamespacedRoleBindingOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
...
func (o *PatchRbacAuthorizationV1beta1NamespacedRoleBindingUnauthorized) Error() string {
	return fmt.Sprintf("[PATCH /apis/rbac.authorization.k8s.io/v1beta1/namespaces/{namespace}/rolebindings/{name}][%d] patchRbacAuthorizationV1beta1NamespacedRoleBindingUnauthorized ", 401)
}

func (o *PatchRbacAuthorizationV1beta1NamespacedRoleBindingUnauthorized) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {

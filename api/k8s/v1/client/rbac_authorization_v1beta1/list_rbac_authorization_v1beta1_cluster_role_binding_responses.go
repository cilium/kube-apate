...
func (o *ListRbacAuthorizationV1beta1ClusterRoleBindingReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewListRbacAuthorizationV1beta1ClusterRoleBindingOK()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return result, nil
	case 401:
		result := NewListRbacAuthorizationV1beta1ClusterRoleBindingUnauthorized()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
func (o *ListRbacAuthorizationV1beta1ClusterRoleBindingOK) Error() string {
	return fmt.Sprintf("[GET /apis/rbac.authorization.k8s.io/v1beta1/clusterrolebindings][%d] listRbacAuthorizationV1beta1ClusterRoleBindingOK  %+v", 200, o.Payload)
}
...
func (o *ListRbacAuthorizationV1beta1ClusterRoleBindingOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {

	o.Payload = new(models.IoK8sAPIRbacV1beta1ClusterRoleBindingList)
...
func (o *ListRbacAuthorizationV1beta1ClusterRoleBindingUnauthorized) Error() string {
	return fmt.Sprintf("[GET /apis/rbac.authorization.k8s.io/v1beta1/clusterrolebindings][%d] listRbacAuthorizationV1beta1ClusterRoleBindingUnauthorized ", 401)
}

func (o *ListRbacAuthorizationV1beta1ClusterRoleBindingUnauthorized) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {

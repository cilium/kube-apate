...
func (o *WatchRbacAuthorizationV1beta1RoleListForAllNamespacesReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewWatchRbacAuthorizationV1beta1RoleListForAllNamespacesOK()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return result, nil
	case 401:
		result := NewWatchRbacAuthorizationV1beta1RoleListForAllNamespacesUnauthorized()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
func (o *WatchRbacAuthorizationV1beta1RoleListForAllNamespacesOK) Error() string {
	return fmt.Sprintf("[GET /apis/rbac.authorization.k8s.io/v1beta1/watch/roles][%d] watchRbacAuthorizationV1beta1RoleListForAllNamespacesOK  %+v", 200, o.Payload)
}
...
func (o *WatchRbacAuthorizationV1beta1RoleListForAllNamespacesOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
...
func (o *WatchRbacAuthorizationV1beta1RoleListForAllNamespacesUnauthorized) Error() string {
	return fmt.Sprintf("[GET /apis/rbac.authorization.k8s.io/v1beta1/watch/roles][%d] watchRbacAuthorizationV1beta1RoleListForAllNamespacesUnauthorized ", 401)
}

func (o *WatchRbacAuthorizationV1beta1RoleListForAllNamespacesUnauthorized) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {

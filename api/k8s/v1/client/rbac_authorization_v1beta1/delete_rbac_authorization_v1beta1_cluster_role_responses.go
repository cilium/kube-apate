...
func (o *DeleteRbacAuthorizationV1beta1ClusterRoleReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewDeleteRbacAuthorizationV1beta1ClusterRoleOK()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return result, nil
	case 202:
		result := NewDeleteRbacAuthorizationV1beta1ClusterRoleAccepted()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return result, nil
	case 401:
		result := NewDeleteRbacAuthorizationV1beta1ClusterRoleUnauthorized()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
func (o *DeleteRbacAuthorizationV1beta1ClusterRoleOK) Error() string {
	return fmt.Sprintf("[DELETE /apis/rbac.authorization.k8s.io/v1beta1/clusterroles/{name}][%d] deleteRbacAuthorizationV1beta1ClusterRoleOK  %+v", 200, o.Payload)
}
...
func (o *DeleteRbacAuthorizationV1beta1ClusterRoleOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
...
func (o *DeleteRbacAuthorizationV1beta1ClusterRoleAccepted) Error() string {
	return fmt.Sprintf("[DELETE /apis/rbac.authorization.k8s.io/v1beta1/clusterroles/{name}][%d] deleteRbacAuthorizationV1beta1ClusterRoleAccepted  %+v", 202, o.Payload)
}
...
func (o *DeleteRbacAuthorizationV1beta1ClusterRoleAccepted) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
...
func (o *DeleteRbacAuthorizationV1beta1ClusterRoleUnauthorized) Error() string {
	return fmt.Sprintf("[DELETE /apis/rbac.authorization.k8s.io/v1beta1/clusterroles/{name}][%d] deleteRbacAuthorizationV1beta1ClusterRoleUnauthorized ", 401)
}

func (o *DeleteRbacAuthorizationV1beta1ClusterRoleUnauthorized) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {

...
func (o *WatchFlowcontrolApiserverV1alpha1FlowSchemaListReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewWatchFlowcontrolApiserverV1alpha1FlowSchemaListOK()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return result, nil
	case 401:
		result := NewWatchFlowcontrolApiserverV1alpha1FlowSchemaListUnauthorized()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
func (o *WatchFlowcontrolApiserverV1alpha1FlowSchemaListOK) Error() string {
	return fmt.Sprintf("[GET /apis/flowcontrol.apiserver.k8s.io/v1alpha1/watch/flowschemas][%d] watchFlowcontrolApiserverV1alpha1FlowSchemaListOK  %+v", 200, o.Payload)
}

func (o *WatchFlowcontrolApiserverV1alpha1FlowSchemaListOK) GetPayload() *models.IoK8sApimachineryPkgApisMetaV1WatchEvent {
	return o.Payload
}

func (o *WatchFlowcontrolApiserverV1alpha1FlowSchemaListOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
...
func (o *WatchFlowcontrolApiserverV1alpha1FlowSchemaListUnauthorized) Error() string {
	return fmt.Sprintf("[GET /apis/flowcontrol.apiserver.k8s.io/v1alpha1/watch/flowschemas][%d] watchFlowcontrolApiserverV1alpha1FlowSchemaListUnauthorized ", 401)
}

func (o *WatchFlowcontrolApiserverV1alpha1FlowSchemaListUnauthorized) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {

...
// NewWatchFlowcontrolApiserverV1alpha1PriorityLevelConfigurationParamsWithTimeout creates a new WatchFlowcontrolApiserverV1alpha1PriorityLevelConfigurationParams object
...
// NewWatchFlowcontrolApiserverV1alpha1PriorityLevelConfigurationParamsWithContext creates a new WatchFlowcontrolApiserverV1alpha1PriorityLevelConfigurationParams object
...
// NewWatchFlowcontrolApiserverV1alpha1PriorityLevelConfigurationParamsWithHTTPClient creates a new WatchFlowcontrolApiserverV1alpha1PriorityLevelConfigurationParams object
...
/*WatchFlowcontrolApiserverV1alpha1PriorityLevelConfigurationParams contains all the parameters to send to the API endpoint
for the watch flowcontrol apiserver v1alpha1 priority level configuration operation typically these are written to a http.Request
*/
...
func (o *WatchFlowcontrolApiserverV1alpha1PriorityLevelConfigurationParams) WithTimeout(timeout time.Duration) *WatchFlowcontrolApiserverV1alpha1PriorityLevelConfigurationParams {
	o.SetTimeout(timeout)
	return o
}

// SetTimeout adds the timeout to the watch flowcontrol apiserver v1alpha1 priority level configuration params
func (o *WatchFlowcontrolApiserverV1alpha1PriorityLevelConfigurationParams) SetTimeout(timeout time.Duration) {
	o.timeout = timeout
}

// WithContext adds the context to the watch flowcontrol apiserver v1alpha1 priority level configuration params
func (o *WatchFlowcontrolApiserverV1alpha1PriorityLevelConfigurationParams) WithContext(ctx context.Context) *WatchFlowcontrolApiserverV1alpha1PriorityLevelConfigurationParams {
	o.SetContext(ctx)
	return o
}

// SetContext adds the context to the watch flowcontrol apiserver v1alpha1 priority level configuration params
func (o *WatchFlowcontrolApiserverV1alpha1PriorityLevelConfigurationParams) SetContext(ctx context.Context) {
	o.Context = ctx
}

// WithHTTPClient adds the HTTPClient to the watch flowcontrol apiserver v1alpha1 priority level configuration params
func (o *WatchFlowcontrolApiserverV1alpha1PriorityLevelConfigurationParams) WithHTTPClient(client *http.Client) *WatchFlowcontrolApiserverV1alpha1PriorityLevelConfigurationParams {
	o.SetHTTPClient(client)
	return o
}

// SetHTTPClient adds the HTTPClient to the watch flowcontrol apiserver v1alpha1 priority level configuration params
func (o *WatchFlowcontrolApiserverV1alpha1PriorityLevelConfigurationParams) SetHTTPClient(client *http.Client) {
	o.HTTPClient = client
}
...
func (o *WatchFlowcontrolApiserverV1alpha1PriorityLevelConfigurationParams) WithAllowWatchBookmarks(allowWatchBookmarks *bool) *WatchFlowcontrolApiserverV1alpha1PriorityLevelConfigurationParams {
...
func (o *WatchFlowcontrolApiserverV1alpha1PriorityLevelConfigurationParams) WithContinue(continueVar *string) *WatchFlowcontrolApiserverV1alpha1PriorityLevelConfigurationParams {
...
func (o *WatchFlowcontrolApiserverV1alpha1PriorityLevelConfigurationParams) SetContinue(continueVar *string) {
...
func (o *WatchFlowcontrolApiserverV1alpha1PriorityLevelConfigurationParams) WithFieldSelector(fieldSelector *string) *WatchFlowcontrolApiserverV1alpha1PriorityLevelConfigurationParams {
...
func (o *WatchFlowcontrolApiserverV1alpha1PriorityLevelConfigurationParams) SetFieldSelector(fieldSelector *string) {
...
func (o *WatchFlowcontrolApiserverV1alpha1PriorityLevelConfigurationParams) WithLabelSelector(labelSelector *string) *WatchFlowcontrolApiserverV1alpha1PriorityLevelConfigurationParams {
...
func (o *WatchFlowcontrolApiserverV1alpha1PriorityLevelConfigurationParams) SetLabelSelector(labelSelector *string) {
	o.LabelSelector = labelSelector
}

// WithLimit adds the limit to the watch flowcontrol apiserver v1alpha1 priority level configuration params
func (o *WatchFlowcontrolApiserverV1alpha1PriorityLevelConfigurationParams) WithLimit(limit *int64) *WatchFlowcontrolApiserverV1alpha1PriorityLevelConfigurationParams {
	o.SetLimit(limit)
	return o
}

// SetLimit adds the limit to the watch flowcontrol apiserver v1alpha1 priority level configuration params
func (o *WatchFlowcontrolApiserverV1alpha1PriorityLevelConfigurationParams) SetLimit(limit *int64) {
	o.Limit = limit
}

// WithName adds the name to the watch flowcontrol apiserver v1alpha1 priority level configuration params
func (o *WatchFlowcontrolApiserverV1alpha1PriorityLevelConfigurationParams) WithName(name string) *WatchFlowcontrolApiserverV1alpha1PriorityLevelConfigurationParams {
	o.SetName(name)
	return o
}

// SetName adds the name to the watch flowcontrol apiserver v1alpha1 priority level configuration params
func (o *WatchFlowcontrolApiserverV1alpha1PriorityLevelConfigurationParams) SetName(name string) {
	o.Name = name
}

// WithPretty adds the pretty to the watch flowcontrol apiserver v1alpha1 priority level configuration params
func (o *WatchFlowcontrolApiserverV1alpha1PriorityLevelConfigurationParams) WithPretty(pretty *string) *WatchFlowcontrolApiserverV1alpha1PriorityLevelConfigurationParams {
	o.SetPretty(pretty)
	return o
}

// SetPretty adds the pretty to the watch flowcontrol apiserver v1alpha1 priority level configuration params
func (o *WatchFlowcontrolApiserverV1alpha1PriorityLevelConfigurationParams) SetPretty(pretty *string) {
	o.Pretty = pretty
}
...
func (o *WatchFlowcontrolApiserverV1alpha1PriorityLevelConfigurationParams) WithResourceVersion(resourceVersion *string) *WatchFlowcontrolApiserverV1alpha1PriorityLevelConfigurationParams {
...
func (o *WatchFlowcontrolApiserverV1alpha1PriorityLevelConfigurationParams) WithResourceVersionMatch(resourceVersionMatch *string) *WatchFlowcontrolApiserverV1alpha1PriorityLevelConfigurationParams {
...
func (o *WatchFlowcontrolApiserverV1alpha1PriorityLevelConfigurationParams) WithTimeoutSeconds(timeoutSeconds *int64) *WatchFlowcontrolApiserverV1alpha1PriorityLevelConfigurationParams {
...
func (o *WatchFlowcontrolApiserverV1alpha1PriorityLevelConfigurationParams) WithWatch(watch *bool) *WatchFlowcontrolApiserverV1alpha1PriorityLevelConfigurationParams {
	o.SetWatch(watch)
	return o
}

// SetWatch adds the watch to the watch flowcontrol apiserver v1alpha1 priority level configuration params
func (o *WatchFlowcontrolApiserverV1alpha1PriorityLevelConfigurationParams) SetWatch(watch *bool) {
	o.Watch = watch
}

// WriteToRequest writes these params to a swagger request
func (o *WatchFlowcontrolApiserverV1alpha1PriorityLevelConfigurationParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {

...
// NewListFlowcontrolApiserverV1alpha1FlowSchemaParamsWithTimeout creates a new ListFlowcontrolApiserverV1alpha1FlowSchemaParams object
...
// NewListFlowcontrolApiserverV1alpha1FlowSchemaParamsWithContext creates a new ListFlowcontrolApiserverV1alpha1FlowSchemaParams object
...
// NewListFlowcontrolApiserverV1alpha1FlowSchemaParamsWithHTTPClient creates a new ListFlowcontrolApiserverV1alpha1FlowSchemaParams object
...
/*ListFlowcontrolApiserverV1alpha1FlowSchemaParams contains all the parameters to send to the API endpoint
for the list flowcontrol apiserver v1alpha1 flow schema operation typically these are written to a http.Request
*/
...
func (o *ListFlowcontrolApiserverV1alpha1FlowSchemaParams) WithTimeout(timeout time.Duration) *ListFlowcontrolApiserverV1alpha1FlowSchemaParams {
	o.SetTimeout(timeout)
	return o
}

// SetTimeout adds the timeout to the list flowcontrol apiserver v1alpha1 flow schema params
func (o *ListFlowcontrolApiserverV1alpha1FlowSchemaParams) SetTimeout(timeout time.Duration) {
	o.timeout = timeout
}

// WithContext adds the context to the list flowcontrol apiserver v1alpha1 flow schema params
func (o *ListFlowcontrolApiserverV1alpha1FlowSchemaParams) WithContext(ctx context.Context) *ListFlowcontrolApiserverV1alpha1FlowSchemaParams {
	o.SetContext(ctx)
	return o
}

// SetContext adds the context to the list flowcontrol apiserver v1alpha1 flow schema params
func (o *ListFlowcontrolApiserverV1alpha1FlowSchemaParams) SetContext(ctx context.Context) {
	o.Context = ctx
}

// WithHTTPClient adds the HTTPClient to the list flowcontrol apiserver v1alpha1 flow schema params
func (o *ListFlowcontrolApiserverV1alpha1FlowSchemaParams) WithHTTPClient(client *http.Client) *ListFlowcontrolApiserverV1alpha1FlowSchemaParams {
	o.SetHTTPClient(client)
	return o
}

// SetHTTPClient adds the HTTPClient to the list flowcontrol apiserver v1alpha1 flow schema params
func (o *ListFlowcontrolApiserverV1alpha1FlowSchemaParams) SetHTTPClient(client *http.Client) {
	o.HTTPClient = client
}

// WithAllowWatchBookmarks adds the allowWatchBookmarks to the list flowcontrol apiserver v1alpha1 flow schema params
func (o *ListFlowcontrolApiserverV1alpha1FlowSchemaParams) WithAllowWatchBookmarks(allowWatchBookmarks *bool) *ListFlowcontrolApiserverV1alpha1FlowSchemaParams {
...
func (o *ListFlowcontrolApiserverV1alpha1FlowSchemaParams) WithContinue(continueVar *string) *ListFlowcontrolApiserverV1alpha1FlowSchemaParams {
...
func (o *ListFlowcontrolApiserverV1alpha1FlowSchemaParams) WithFieldSelector(fieldSelector *string) *ListFlowcontrolApiserverV1alpha1FlowSchemaParams {
...
func (o *ListFlowcontrolApiserverV1alpha1FlowSchemaParams) WithLabelSelector(labelSelector *string) *ListFlowcontrolApiserverV1alpha1FlowSchemaParams {
...
func (o *ListFlowcontrolApiserverV1alpha1FlowSchemaParams) WithLimit(limit *int64) *ListFlowcontrolApiserverV1alpha1FlowSchemaParams {
	o.SetLimit(limit)
	return o
}

// SetLimit adds the limit to the list flowcontrol apiserver v1alpha1 flow schema params
func (o *ListFlowcontrolApiserverV1alpha1FlowSchemaParams) SetLimit(limit *int64) {
	o.Limit = limit
}

// WithPretty adds the pretty to the list flowcontrol apiserver v1alpha1 flow schema params
func (o *ListFlowcontrolApiserverV1alpha1FlowSchemaParams) WithPretty(pretty *string) *ListFlowcontrolApiserverV1alpha1FlowSchemaParams {
	o.SetPretty(pretty)
	return o
}

// SetPretty adds the pretty to the list flowcontrol apiserver v1alpha1 flow schema params
func (o *ListFlowcontrolApiserverV1alpha1FlowSchemaParams) SetPretty(pretty *string) {
	o.Pretty = pretty
}

// WithResourceVersion adds the resourceVersion to the list flowcontrol apiserver v1alpha1 flow schema params
func (o *ListFlowcontrolApiserverV1alpha1FlowSchemaParams) WithResourceVersion(resourceVersion *string) *ListFlowcontrolApiserverV1alpha1FlowSchemaParams {
...
func (o *ListFlowcontrolApiserverV1alpha1FlowSchemaParams) WithResourceVersionMatch(resourceVersionMatch *string) *ListFlowcontrolApiserverV1alpha1FlowSchemaParams {
...
func (o *ListFlowcontrolApiserverV1alpha1FlowSchemaParams) WithTimeoutSeconds(timeoutSeconds *int64) *ListFlowcontrolApiserverV1alpha1FlowSchemaParams {
...
func (o *ListFlowcontrolApiserverV1alpha1FlowSchemaParams) WithWatch(watch *bool) *ListFlowcontrolApiserverV1alpha1FlowSchemaParams {
	o.SetWatch(watch)
	return o
}

// SetWatch adds the watch to the list flowcontrol apiserver v1alpha1 flow schema params
func (o *ListFlowcontrolApiserverV1alpha1FlowSchemaParams) SetWatch(watch *bool) {
	o.Watch = watch
}

// WriteToRequest writes these params to a swagger request
func (o *ListFlowcontrolApiserverV1alpha1FlowSchemaParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {

...
// NewWatchFlowcontrolApiserverV1alpha1FlowSchemaParamsWithTimeout creates a new WatchFlowcontrolApiserverV1alpha1FlowSchemaParams object
...
// NewWatchFlowcontrolApiserverV1alpha1FlowSchemaParamsWithContext creates a new WatchFlowcontrolApiserverV1alpha1FlowSchemaParams object
...
// NewWatchFlowcontrolApiserverV1alpha1FlowSchemaParamsWithHTTPClient creates a new WatchFlowcontrolApiserverV1alpha1FlowSchemaParams object
...
/*WatchFlowcontrolApiserverV1alpha1FlowSchemaParams contains all the parameters to send to the API endpoint
for the watch flowcontrol apiserver v1alpha1 flow schema operation typically these are written to a http.Request
*/
...
func (o *WatchFlowcontrolApiserverV1alpha1FlowSchemaParams) WithTimeout(timeout time.Duration) *WatchFlowcontrolApiserverV1alpha1FlowSchemaParams {
	o.SetTimeout(timeout)
	return o
}

// SetTimeout adds the timeout to the watch flowcontrol apiserver v1alpha1 flow schema params
func (o *WatchFlowcontrolApiserverV1alpha1FlowSchemaParams) SetTimeout(timeout time.Duration) {
	o.timeout = timeout
}

// WithContext adds the context to the watch flowcontrol apiserver v1alpha1 flow schema params
func (o *WatchFlowcontrolApiserverV1alpha1FlowSchemaParams) WithContext(ctx context.Context) *WatchFlowcontrolApiserverV1alpha1FlowSchemaParams {
	o.SetContext(ctx)
	return o
}

// SetContext adds the context to the watch flowcontrol apiserver v1alpha1 flow schema params
func (o *WatchFlowcontrolApiserverV1alpha1FlowSchemaParams) SetContext(ctx context.Context) {
	o.Context = ctx
}

// WithHTTPClient adds the HTTPClient to the watch flowcontrol apiserver v1alpha1 flow schema params
func (o *WatchFlowcontrolApiserverV1alpha1FlowSchemaParams) WithHTTPClient(client *http.Client) *WatchFlowcontrolApiserverV1alpha1FlowSchemaParams {
	o.SetHTTPClient(client)
	return o
}

// SetHTTPClient adds the HTTPClient to the watch flowcontrol apiserver v1alpha1 flow schema params
func (o *WatchFlowcontrolApiserverV1alpha1FlowSchemaParams) SetHTTPClient(client *http.Client) {
	o.HTTPClient = client
}

// WithAllowWatchBookmarks adds the allowWatchBookmarks to the watch flowcontrol apiserver v1alpha1 flow schema params
func (o *WatchFlowcontrolApiserverV1alpha1FlowSchemaParams) WithAllowWatchBookmarks(allowWatchBookmarks *bool) *WatchFlowcontrolApiserverV1alpha1FlowSchemaParams {
...
func (o *WatchFlowcontrolApiserverV1alpha1FlowSchemaParams) WithContinue(continueVar *string) *WatchFlowcontrolApiserverV1alpha1FlowSchemaParams {
...
func (o *WatchFlowcontrolApiserverV1alpha1FlowSchemaParams) WithFieldSelector(fieldSelector *string) *WatchFlowcontrolApiserverV1alpha1FlowSchemaParams {
...
func (o *WatchFlowcontrolApiserverV1alpha1FlowSchemaParams) WithLabelSelector(labelSelector *string) *WatchFlowcontrolApiserverV1alpha1FlowSchemaParams {
...
func (o *WatchFlowcontrolApiserverV1alpha1FlowSchemaParams) WithLimit(limit *int64) *WatchFlowcontrolApiserverV1alpha1FlowSchemaParams {
	o.SetLimit(limit)
	return o
}

// SetLimit adds the limit to the watch flowcontrol apiserver v1alpha1 flow schema params
func (o *WatchFlowcontrolApiserverV1alpha1FlowSchemaParams) SetLimit(limit *int64) {
	o.Limit = limit
}

// WithName adds the name to the watch flowcontrol apiserver v1alpha1 flow schema params
func (o *WatchFlowcontrolApiserverV1alpha1FlowSchemaParams) WithName(name string) *WatchFlowcontrolApiserverV1alpha1FlowSchemaParams {
	o.SetName(name)
	return o
}

// SetName adds the name to the watch flowcontrol apiserver v1alpha1 flow schema params
func (o *WatchFlowcontrolApiserverV1alpha1FlowSchemaParams) SetName(name string) {
	o.Name = name
}

// WithPretty adds the pretty to the watch flowcontrol apiserver v1alpha1 flow schema params
func (o *WatchFlowcontrolApiserverV1alpha1FlowSchemaParams) WithPretty(pretty *string) *WatchFlowcontrolApiserverV1alpha1FlowSchemaParams {
	o.SetPretty(pretty)
	return o
}

// SetPretty adds the pretty to the watch flowcontrol apiserver v1alpha1 flow schema params
func (o *WatchFlowcontrolApiserverV1alpha1FlowSchemaParams) SetPretty(pretty *string) {
	o.Pretty = pretty
}

// WithResourceVersion adds the resourceVersion to the watch flowcontrol apiserver v1alpha1 flow schema params
func (o *WatchFlowcontrolApiserverV1alpha1FlowSchemaParams) WithResourceVersion(resourceVersion *string) *WatchFlowcontrolApiserverV1alpha1FlowSchemaParams {
...
func (o *WatchFlowcontrolApiserverV1alpha1FlowSchemaParams) WithResourceVersionMatch(resourceVersionMatch *string) *WatchFlowcontrolApiserverV1alpha1FlowSchemaParams {
...
func (o *WatchFlowcontrolApiserverV1alpha1FlowSchemaParams) WithTimeoutSeconds(timeoutSeconds *int64) *WatchFlowcontrolApiserverV1alpha1FlowSchemaParams {
...
func (o *WatchFlowcontrolApiserverV1alpha1FlowSchemaParams) WithWatch(watch *bool) *WatchFlowcontrolApiserverV1alpha1FlowSchemaParams {
	o.SetWatch(watch)
	return o
}

// SetWatch adds the watch to the watch flowcontrol apiserver v1alpha1 flow schema params
func (o *WatchFlowcontrolApiserverV1alpha1FlowSchemaParams) SetWatch(watch *bool) {
	o.Watch = watch
}

// WriteToRequest writes these params to a swagger request
func (o *WatchFlowcontrolApiserverV1alpha1FlowSchemaParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {

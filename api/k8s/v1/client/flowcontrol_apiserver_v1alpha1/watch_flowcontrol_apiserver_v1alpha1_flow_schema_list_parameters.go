...
// NewWatchFlowcontrolApiserverV1alpha1FlowSchemaListParamsWithTimeout creates a new WatchFlowcontrolApiserverV1alpha1FlowSchemaListParams object
...
// NewWatchFlowcontrolApiserverV1alpha1FlowSchemaListParamsWithContext creates a new WatchFlowcontrolApiserverV1alpha1FlowSchemaListParams object
...
// NewWatchFlowcontrolApiserverV1alpha1FlowSchemaListParamsWithHTTPClient creates a new WatchFlowcontrolApiserverV1alpha1FlowSchemaListParams object
...
/*WatchFlowcontrolApiserverV1alpha1FlowSchemaListParams contains all the parameters to send to the API endpoint
for the watch flowcontrol apiserver v1alpha1 flow schema list operation typically these are written to a http.Request
*/
...
func (o *WatchFlowcontrolApiserverV1alpha1FlowSchemaListParams) WithTimeout(timeout time.Duration) *WatchFlowcontrolApiserverV1alpha1FlowSchemaListParams {
	o.SetTimeout(timeout)
	return o
}

// SetTimeout adds the timeout to the watch flowcontrol apiserver v1alpha1 flow schema list params
func (o *WatchFlowcontrolApiserverV1alpha1FlowSchemaListParams) SetTimeout(timeout time.Duration) {
	o.timeout = timeout
}

// WithContext adds the context to the watch flowcontrol apiserver v1alpha1 flow schema list params
func (o *WatchFlowcontrolApiserverV1alpha1FlowSchemaListParams) WithContext(ctx context.Context) *WatchFlowcontrolApiserverV1alpha1FlowSchemaListParams {
	o.SetContext(ctx)
	return o
}

// SetContext adds the context to the watch flowcontrol apiserver v1alpha1 flow schema list params
func (o *WatchFlowcontrolApiserverV1alpha1FlowSchemaListParams) SetContext(ctx context.Context) {
	o.Context = ctx
}

// WithHTTPClient adds the HTTPClient to the watch flowcontrol apiserver v1alpha1 flow schema list params
func (o *WatchFlowcontrolApiserverV1alpha1FlowSchemaListParams) WithHTTPClient(client *http.Client) *WatchFlowcontrolApiserverV1alpha1FlowSchemaListParams {
	o.SetHTTPClient(client)
	return o
}

// SetHTTPClient adds the HTTPClient to the watch flowcontrol apiserver v1alpha1 flow schema list params
func (o *WatchFlowcontrolApiserverV1alpha1FlowSchemaListParams) SetHTTPClient(client *http.Client) {
	o.HTTPClient = client
}

// WithAllowWatchBookmarks adds the allowWatchBookmarks to the watch flowcontrol apiserver v1alpha1 flow schema list params
func (o *WatchFlowcontrolApiserverV1alpha1FlowSchemaListParams) WithAllowWatchBookmarks(allowWatchBookmarks *bool) *WatchFlowcontrolApiserverV1alpha1FlowSchemaListParams {
...
func (o *WatchFlowcontrolApiserverV1alpha1FlowSchemaListParams) WithContinue(continueVar *string) *WatchFlowcontrolApiserverV1alpha1FlowSchemaListParams {
...
func (o *WatchFlowcontrolApiserverV1alpha1FlowSchemaListParams) SetContinue(continueVar *string) {
...
func (o *WatchFlowcontrolApiserverV1alpha1FlowSchemaListParams) WithFieldSelector(fieldSelector *string) *WatchFlowcontrolApiserverV1alpha1FlowSchemaListParams {
...
func (o *WatchFlowcontrolApiserverV1alpha1FlowSchemaListParams) WithLabelSelector(labelSelector *string) *WatchFlowcontrolApiserverV1alpha1FlowSchemaListParams {
...
func (o *WatchFlowcontrolApiserverV1alpha1FlowSchemaListParams) WithLimit(limit *int64) *WatchFlowcontrolApiserverV1alpha1FlowSchemaListParams {
	o.SetLimit(limit)
	return o
}

// SetLimit adds the limit to the watch flowcontrol apiserver v1alpha1 flow schema list params
func (o *WatchFlowcontrolApiserverV1alpha1FlowSchemaListParams) SetLimit(limit *int64) {
	o.Limit = limit
}

// WithPretty adds the pretty to the watch flowcontrol apiserver v1alpha1 flow schema list params
func (o *WatchFlowcontrolApiserverV1alpha1FlowSchemaListParams) WithPretty(pretty *string) *WatchFlowcontrolApiserverV1alpha1FlowSchemaListParams {
	o.SetPretty(pretty)
	return o
}

// SetPretty adds the pretty to the watch flowcontrol apiserver v1alpha1 flow schema list params
func (o *WatchFlowcontrolApiserverV1alpha1FlowSchemaListParams) SetPretty(pretty *string) {
	o.Pretty = pretty
}

// WithResourceVersion adds the resourceVersion to the watch flowcontrol apiserver v1alpha1 flow schema list params
func (o *WatchFlowcontrolApiserverV1alpha1FlowSchemaListParams) WithResourceVersion(resourceVersion *string) *WatchFlowcontrolApiserverV1alpha1FlowSchemaListParams {
...
func (o *WatchFlowcontrolApiserverV1alpha1FlowSchemaListParams) WithResourceVersionMatch(resourceVersionMatch *string) *WatchFlowcontrolApiserverV1alpha1FlowSchemaListParams {
...
func (o *WatchFlowcontrolApiserverV1alpha1FlowSchemaListParams) WithTimeoutSeconds(timeoutSeconds *int64) *WatchFlowcontrolApiserverV1alpha1FlowSchemaListParams {
...
func (o *WatchFlowcontrolApiserverV1alpha1FlowSchemaListParams) WithWatch(watch *bool) *WatchFlowcontrolApiserverV1alpha1FlowSchemaListParams {
	o.SetWatch(watch)
	return o
}

// SetWatch adds the watch to the watch flowcontrol apiserver v1alpha1 flow schema list params
func (o *WatchFlowcontrolApiserverV1alpha1FlowSchemaListParams) SetWatch(watch *bool) {
	o.Watch = watch
}

// WriteToRequest writes these params to a swagger request
func (o *WatchFlowcontrolApiserverV1alpha1FlowSchemaListParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {

...
func (o *ReadFlowcontrolApiserverV1alpha1PriorityLevelConfigurationReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	switch response.Code() {
	case 200:
		result := NewReadFlowcontrolApiserverV1alpha1PriorityLevelConfigurationOK()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return result, nil
	case 401:
		result := NewReadFlowcontrolApiserverV1alpha1PriorityLevelConfigurationUnauthorized()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
func (o *ReadFlowcontrolApiserverV1alpha1PriorityLevelConfigurationOK) Error() string {
	return fmt.Sprintf("[GET /apis/flowcontrol.apiserver.k8s.io/v1alpha1/prioritylevelconfigurations/{name}][%d] readFlowcontrolApiserverV1alpha1PriorityLevelConfigurationOK  %+v", 200, o.Payload)
}

func (o *ReadFlowcontrolApiserverV1alpha1PriorityLevelConfigurationOK) GetPayload() *models.IoK8sAPIFlowcontrolV1alpha1PriorityLevelConfiguration {
	return o.Payload
}

func (o *ReadFlowcontrolApiserverV1alpha1PriorityLevelConfigurationOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
...
func (o *ReadFlowcontrolApiserverV1alpha1PriorityLevelConfigurationUnauthorized) Error() string {
	return fmt.Sprintf("[GET /apis/flowcontrol.apiserver.k8s.io/v1alpha1/prioritylevelconfigurations/{name}][%d] readFlowcontrolApiserverV1alpha1PriorityLevelConfigurationUnauthorized ", 401)
}

func (o *ReadFlowcontrolApiserverV1alpha1PriorityLevelConfigurationUnauthorized) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {

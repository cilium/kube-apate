...
func (o *ListFlowcontrolApiserverV1alpha1FlowSchemaReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewListFlowcontrolApiserverV1alpha1FlowSchemaOK()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return result, nil
	case 401:
		result := NewListFlowcontrolApiserverV1alpha1FlowSchemaUnauthorized()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
func (o *ListFlowcontrolApiserverV1alpha1FlowSchemaOK) Error() string {
	return fmt.Sprintf("[GET /apis/flowcontrol.apiserver.k8s.io/v1alpha1/flowschemas][%d] listFlowcontrolApiserverV1alpha1FlowSchemaOK  %+v", 200, o.Payload)
}

func (o *ListFlowcontrolApiserverV1alpha1FlowSchemaOK) GetPayload() *models.IoK8sAPIFlowcontrolV1alpha1FlowSchemaList {
	return o.Payload
}

func (o *ListFlowcontrolApiserverV1alpha1FlowSchemaOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {

	o.Payload = new(models.IoK8sAPIFlowcontrolV1alpha1FlowSchemaList)
...
func (o *ListFlowcontrolApiserverV1alpha1FlowSchemaUnauthorized) Error() string {
	return fmt.Sprintf("[GET /apis/flowcontrol.apiserver.k8s.io/v1alpha1/flowschemas][%d] listFlowcontrolApiserverV1alpha1FlowSchemaUnauthorized ", 401)
}

func (o *ListFlowcontrolApiserverV1alpha1FlowSchemaUnauthorized) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {

...
func (o *DeleteFlowcontrolApiserverV1alpha1FlowSchemaReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewDeleteFlowcontrolApiserverV1alpha1FlowSchemaOK()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return result, nil
	case 202:
		result := NewDeleteFlowcontrolApiserverV1alpha1FlowSchemaAccepted()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return result, nil
	case 401:
		result := NewDeleteFlowcontrolApiserverV1alpha1FlowSchemaUnauthorized()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
func (o *DeleteFlowcontrolApiserverV1alpha1FlowSchemaOK) Error() string {
	return fmt.Sprintf("[DELETE /apis/flowcontrol.apiserver.k8s.io/v1alpha1/flowschemas/{name}][%d] deleteFlowcontrolApiserverV1alpha1FlowSchemaOK  %+v", 200, o.Payload)
}

func (o *DeleteFlowcontrolApiserverV1alpha1FlowSchemaOK) GetPayload() *models.IoK8sApimachineryPkgApisMetaV1Status {
	return o.Payload
}

func (o *DeleteFlowcontrolApiserverV1alpha1FlowSchemaOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
...
func (o *DeleteFlowcontrolApiserverV1alpha1FlowSchemaAccepted) Error() string {
	return fmt.Sprintf("[DELETE /apis/flowcontrol.apiserver.k8s.io/v1alpha1/flowschemas/{name}][%d] deleteFlowcontrolApiserverV1alpha1FlowSchemaAccepted  %+v", 202, o.Payload)
}

func (o *DeleteFlowcontrolApiserverV1alpha1FlowSchemaAccepted) GetPayload() *models.IoK8sApimachineryPkgApisMetaV1Status {
	return o.Payload
}

func (o *DeleteFlowcontrolApiserverV1alpha1FlowSchemaAccepted) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
...
func (o *DeleteFlowcontrolApiserverV1alpha1FlowSchemaUnauthorized) Error() string {
	return fmt.Sprintf("[DELETE /apis/flowcontrol.apiserver.k8s.io/v1alpha1/flowschemas/{name}][%d] deleteFlowcontrolApiserverV1alpha1FlowSchemaUnauthorized ", 401)
}

func (o *DeleteFlowcontrolApiserverV1alpha1FlowSchemaUnauthorized) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {

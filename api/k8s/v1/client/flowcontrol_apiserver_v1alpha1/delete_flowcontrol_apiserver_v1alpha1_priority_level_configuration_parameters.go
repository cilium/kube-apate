...
// NewDeleteFlowcontrolApiserverV1alpha1PriorityLevelConfigurationParamsWithTimeout creates a new DeleteFlowcontrolApiserverV1alpha1PriorityLevelConfigurationParams object
...
// NewDeleteFlowcontrolApiserverV1alpha1PriorityLevelConfigurationParamsWithContext creates a new DeleteFlowcontrolApiserverV1alpha1PriorityLevelConfigurationParams object
...
// NewDeleteFlowcontrolApiserverV1alpha1PriorityLevelConfigurationParamsWithHTTPClient creates a new DeleteFlowcontrolApiserverV1alpha1PriorityLevelConfigurationParams object
...
/*DeleteFlowcontrolApiserverV1alpha1PriorityLevelConfigurationParams contains all the parameters to send to the API endpoint
for the delete flowcontrol apiserver v1alpha1 priority level configuration operation typically these are written to a http.Request
*/
...
func (o *DeleteFlowcontrolApiserverV1alpha1PriorityLevelConfigurationParams) WithTimeout(timeout time.Duration) *DeleteFlowcontrolApiserverV1alpha1PriorityLevelConfigurationParams {
	o.SetTimeout(timeout)
	return o
}

// SetTimeout adds the timeout to the delete flowcontrol apiserver v1alpha1 priority level configuration params
func (o *DeleteFlowcontrolApiserverV1alpha1PriorityLevelConfigurationParams) SetTimeout(timeout time.Duration) {
	o.timeout = timeout
}

// WithContext adds the context to the delete flowcontrol apiserver v1alpha1 priority level configuration params
func (o *DeleteFlowcontrolApiserverV1alpha1PriorityLevelConfigurationParams) WithContext(ctx context.Context) *DeleteFlowcontrolApiserverV1alpha1PriorityLevelConfigurationParams {
	o.SetContext(ctx)
	return o
}

// SetContext adds the context to the delete flowcontrol apiserver v1alpha1 priority level configuration params
func (o *DeleteFlowcontrolApiserverV1alpha1PriorityLevelConfigurationParams) SetContext(ctx context.Context) {
	o.Context = ctx
}

// WithHTTPClient adds the HTTPClient to the delete flowcontrol apiserver v1alpha1 priority level configuration params
func (o *DeleteFlowcontrolApiserverV1alpha1PriorityLevelConfigurationParams) WithHTTPClient(client *http.Client) *DeleteFlowcontrolApiserverV1alpha1PriorityLevelConfigurationParams {
	o.SetHTTPClient(client)
	return o
}

// SetHTTPClient adds the HTTPClient to the delete flowcontrol apiserver v1alpha1 priority level configuration params
func (o *DeleteFlowcontrolApiserverV1alpha1PriorityLevelConfigurationParams) SetHTTPClient(client *http.Client) {
	o.HTTPClient = client
}

// WithBody adds the body to the delete flowcontrol apiserver v1alpha1 priority level configuration params
func (o *DeleteFlowcontrolApiserverV1alpha1PriorityLevelConfigurationParams) WithBody(body *models.IoK8sApimachineryPkgApisMetaV1DeleteOptions) *DeleteFlowcontrolApiserverV1alpha1PriorityLevelConfigurationParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the delete flowcontrol apiserver v1alpha1 priority level configuration params
func (o *DeleteFlowcontrolApiserverV1alpha1PriorityLevelConfigurationParams) SetBody(body *models.IoK8sApimachineryPkgApisMetaV1DeleteOptions) {
	o.Body = body
}

// WithDryRun adds the dryRun to the delete flowcontrol apiserver v1alpha1 priority level configuration params
func (o *DeleteFlowcontrolApiserverV1alpha1PriorityLevelConfigurationParams) WithDryRun(dryRun *string) *DeleteFlowcontrolApiserverV1alpha1PriorityLevelConfigurationParams {
	o.SetDryRun(dryRun)
	return o
}

// SetDryRun adds the dryRun to the delete flowcontrol apiserver v1alpha1 priority level configuration params
func (o *DeleteFlowcontrolApiserverV1alpha1PriorityLevelConfigurationParams) SetDryRun(dryRun *string) {
	o.DryRun = dryRun
}
...
func (o *DeleteFlowcontrolApiserverV1alpha1PriorityLevelConfigurationParams) WithGracePeriodSeconds(gracePeriodSeconds *int64) *DeleteFlowcontrolApiserverV1alpha1PriorityLevelConfigurationParams {
...
func (o *DeleteFlowcontrolApiserverV1alpha1PriorityLevelConfigurationParams) WithName(name string) *DeleteFlowcontrolApiserverV1alpha1PriorityLevelConfigurationParams {
	o.SetName(name)
	return o
}

// SetName adds the name to the delete flowcontrol apiserver v1alpha1 priority level configuration params
func (o *DeleteFlowcontrolApiserverV1alpha1PriorityLevelConfigurationParams) SetName(name string) {
	o.Name = name
}
...
func (o *DeleteFlowcontrolApiserverV1alpha1PriorityLevelConfigurationParams) WithOrphanDependents(orphanDependents *bool) *DeleteFlowcontrolApiserverV1alpha1PriorityLevelConfigurationParams {
...
func (o *DeleteFlowcontrolApiserverV1alpha1PriorityLevelConfigurationParams) WithPretty(pretty *string) *DeleteFlowcontrolApiserverV1alpha1PriorityLevelConfigurationParams {
	o.SetPretty(pretty)
	return o
}

// SetPretty adds the pretty to the delete flowcontrol apiserver v1alpha1 priority level configuration params
func (o *DeleteFlowcontrolApiserverV1alpha1PriorityLevelConfigurationParams) SetPretty(pretty *string) {
	o.Pretty = pretty
}
...
func (o *DeleteFlowcontrolApiserverV1alpha1PriorityLevelConfigurationParams) WithPropagationPolicy(propagationPolicy *string) *DeleteFlowcontrolApiserverV1alpha1PriorityLevelConfigurationParams {
...
func (o *DeleteFlowcontrolApiserverV1alpha1PriorityLevelConfigurationParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {

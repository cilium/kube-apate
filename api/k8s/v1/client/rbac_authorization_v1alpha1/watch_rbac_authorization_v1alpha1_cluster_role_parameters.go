...
// NewWatchRbacAuthorizationV1alpha1ClusterRoleParamsWithTimeout creates a new WatchRbacAuthorizationV1alpha1ClusterRoleParams object
...
// NewWatchRbacAuthorizationV1alpha1ClusterRoleParamsWithContext creates a new WatchRbacAuthorizationV1alpha1ClusterRoleParams object
...
// NewWatchRbacAuthorizationV1alpha1ClusterRoleParamsWithHTTPClient creates a new WatchRbacAuthorizationV1alpha1ClusterRoleParams object
...
/*WatchRbacAuthorizationV1alpha1ClusterRoleParams contains all the parameters to send to the API endpoint
for the watch rbac authorization v1alpha1 cluster role operation typically these are written to a http.Request
*/
...
func (o *WatchRbacAuthorizationV1alpha1ClusterRoleParams) WithTimeout(timeout time.Duration) *WatchRbacAuthorizationV1alpha1ClusterRoleParams {
	o.SetTimeout(timeout)
	return o
}

// SetTimeout adds the timeout to the watch rbac authorization v1alpha1 cluster role params
func (o *WatchRbacAuthorizationV1alpha1ClusterRoleParams) SetTimeout(timeout time.Duration) {
	o.timeout = timeout
}

// WithContext adds the context to the watch rbac authorization v1alpha1 cluster role params
func (o *WatchRbacAuthorizationV1alpha1ClusterRoleParams) WithContext(ctx context.Context) *WatchRbacAuthorizationV1alpha1ClusterRoleParams {
	o.SetContext(ctx)
	return o
}

// SetContext adds the context to the watch rbac authorization v1alpha1 cluster role params
func (o *WatchRbacAuthorizationV1alpha1ClusterRoleParams) SetContext(ctx context.Context) {
	o.Context = ctx
}

// WithHTTPClient adds the HTTPClient to the watch rbac authorization v1alpha1 cluster role params
func (o *WatchRbacAuthorizationV1alpha1ClusterRoleParams) WithHTTPClient(client *http.Client) *WatchRbacAuthorizationV1alpha1ClusterRoleParams {
	o.SetHTTPClient(client)
	return o
}

// SetHTTPClient adds the HTTPClient to the watch rbac authorization v1alpha1 cluster role params
func (o *WatchRbacAuthorizationV1alpha1ClusterRoleParams) SetHTTPClient(client *http.Client) {
	o.HTTPClient = client
}

// WithAllowWatchBookmarks adds the allowWatchBookmarks to the watch rbac authorization v1alpha1 cluster role params
func (o *WatchRbacAuthorizationV1alpha1ClusterRoleParams) WithAllowWatchBookmarks(allowWatchBookmarks *bool) *WatchRbacAuthorizationV1alpha1ClusterRoleParams {
...
func (o *WatchRbacAuthorizationV1alpha1ClusterRoleParams) WithContinue(continueVar *string) *WatchRbacAuthorizationV1alpha1ClusterRoleParams {
...
func (o *WatchRbacAuthorizationV1alpha1ClusterRoleParams) WithFieldSelector(fieldSelector *string) *WatchRbacAuthorizationV1alpha1ClusterRoleParams {
...
func (o *WatchRbacAuthorizationV1alpha1ClusterRoleParams) WithLabelSelector(labelSelector *string) *WatchRbacAuthorizationV1alpha1ClusterRoleParams {
...
func (o *WatchRbacAuthorizationV1alpha1ClusterRoleParams) WithLimit(limit *int64) *WatchRbacAuthorizationV1alpha1ClusterRoleParams {
	o.SetLimit(limit)
	return o
}

// SetLimit adds the limit to the watch rbac authorization v1alpha1 cluster role params
func (o *WatchRbacAuthorizationV1alpha1ClusterRoleParams) SetLimit(limit *int64) {
	o.Limit = limit
}

// WithName adds the name to the watch rbac authorization v1alpha1 cluster role params
func (o *WatchRbacAuthorizationV1alpha1ClusterRoleParams) WithName(name string) *WatchRbacAuthorizationV1alpha1ClusterRoleParams {
	o.SetName(name)
	return o
}

// SetName adds the name to the watch rbac authorization v1alpha1 cluster role params
func (o *WatchRbacAuthorizationV1alpha1ClusterRoleParams) SetName(name string) {
	o.Name = name
}

// WithPretty adds the pretty to the watch rbac authorization v1alpha1 cluster role params
func (o *WatchRbacAuthorizationV1alpha1ClusterRoleParams) WithPretty(pretty *string) *WatchRbacAuthorizationV1alpha1ClusterRoleParams {
	o.SetPretty(pretty)
	return o
}

// SetPretty adds the pretty to the watch rbac authorization v1alpha1 cluster role params
func (o *WatchRbacAuthorizationV1alpha1ClusterRoleParams) SetPretty(pretty *string) {
	o.Pretty = pretty
}

// WithResourceVersion adds the resourceVersion to the watch rbac authorization v1alpha1 cluster role params
func (o *WatchRbacAuthorizationV1alpha1ClusterRoleParams) WithResourceVersion(resourceVersion *string) *WatchRbacAuthorizationV1alpha1ClusterRoleParams {
...
func (o *WatchRbacAuthorizationV1alpha1ClusterRoleParams) WithResourceVersionMatch(resourceVersionMatch *string) *WatchRbacAuthorizationV1alpha1ClusterRoleParams {
...
func (o *WatchRbacAuthorizationV1alpha1ClusterRoleParams) WithTimeoutSeconds(timeoutSeconds *int64) *WatchRbacAuthorizationV1alpha1ClusterRoleParams {
...
func (o *WatchRbacAuthorizationV1alpha1ClusterRoleParams) WithWatch(watch *bool) *WatchRbacAuthorizationV1alpha1ClusterRoleParams {
	o.SetWatch(watch)
	return o
}

// SetWatch adds the watch to the watch rbac authorization v1alpha1 cluster role params
func (o *WatchRbacAuthorizationV1alpha1ClusterRoleParams) SetWatch(watch *bool) {
	o.Watch = watch
}

// WriteToRequest writes these params to a swagger request
func (o *WatchRbacAuthorizationV1alpha1ClusterRoleParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {

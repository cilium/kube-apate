...
// NewWatchRbacAuthorizationV1alpha1NamespacedRoleBindingParamsWithTimeout creates a new WatchRbacAuthorizationV1alpha1NamespacedRoleBindingParams object
...
// NewWatchRbacAuthorizationV1alpha1NamespacedRoleBindingParamsWithContext creates a new WatchRbacAuthorizationV1alpha1NamespacedRoleBindingParams object
...
// NewWatchRbacAuthorizationV1alpha1NamespacedRoleBindingParamsWithHTTPClient creates a new WatchRbacAuthorizationV1alpha1NamespacedRoleBindingParams object
...
/*WatchRbacAuthorizationV1alpha1NamespacedRoleBindingParams contains all the parameters to send to the API endpoint
for the watch rbac authorization v1alpha1 namespaced role binding operation typically these are written to a http.Request
*/
...
func (o *WatchRbacAuthorizationV1alpha1NamespacedRoleBindingParams) WithTimeout(timeout time.Duration) *WatchRbacAuthorizationV1alpha1NamespacedRoleBindingParams {
	o.SetTimeout(timeout)
	return o
}

// SetTimeout adds the timeout to the watch rbac authorization v1alpha1 namespaced role binding params
func (o *WatchRbacAuthorizationV1alpha1NamespacedRoleBindingParams) SetTimeout(timeout time.Duration) {
	o.timeout = timeout
}

// WithContext adds the context to the watch rbac authorization v1alpha1 namespaced role binding params
func (o *WatchRbacAuthorizationV1alpha1NamespacedRoleBindingParams) WithContext(ctx context.Context) *WatchRbacAuthorizationV1alpha1NamespacedRoleBindingParams {
	o.SetContext(ctx)
	return o
}

// SetContext adds the context to the watch rbac authorization v1alpha1 namespaced role binding params
func (o *WatchRbacAuthorizationV1alpha1NamespacedRoleBindingParams) SetContext(ctx context.Context) {
	o.Context = ctx
}

// WithHTTPClient adds the HTTPClient to the watch rbac authorization v1alpha1 namespaced role binding params
func (o *WatchRbacAuthorizationV1alpha1NamespacedRoleBindingParams) WithHTTPClient(client *http.Client) *WatchRbacAuthorizationV1alpha1NamespacedRoleBindingParams {
	o.SetHTTPClient(client)
	return o
}

// SetHTTPClient adds the HTTPClient to the watch rbac authorization v1alpha1 namespaced role binding params
func (o *WatchRbacAuthorizationV1alpha1NamespacedRoleBindingParams) SetHTTPClient(client *http.Client) {
	o.HTTPClient = client
}
...
func (o *WatchRbacAuthorizationV1alpha1NamespacedRoleBindingParams) WithAllowWatchBookmarks(allowWatchBookmarks *bool) *WatchRbacAuthorizationV1alpha1NamespacedRoleBindingParams {
...
func (o *WatchRbacAuthorizationV1alpha1NamespacedRoleBindingParams) WithContinue(continueVar *string) *WatchRbacAuthorizationV1alpha1NamespacedRoleBindingParams {
...
func (o *WatchRbacAuthorizationV1alpha1NamespacedRoleBindingParams) SetContinue(continueVar *string) {
...
func (o *WatchRbacAuthorizationV1alpha1NamespacedRoleBindingParams) WithFieldSelector(fieldSelector *string) *WatchRbacAuthorizationV1alpha1NamespacedRoleBindingParams {
...
func (o *WatchRbacAuthorizationV1alpha1NamespacedRoleBindingParams) WithLabelSelector(labelSelector *string) *WatchRbacAuthorizationV1alpha1NamespacedRoleBindingParams {
...
func (o *WatchRbacAuthorizationV1alpha1NamespacedRoleBindingParams) WithLimit(limit *int64) *WatchRbacAuthorizationV1alpha1NamespacedRoleBindingParams {
	o.SetLimit(limit)
	return o
}

// SetLimit adds the limit to the watch rbac authorization v1alpha1 namespaced role binding params
func (o *WatchRbacAuthorizationV1alpha1NamespacedRoleBindingParams) SetLimit(limit *int64) {
	o.Limit = limit
}

// WithName adds the name to the watch rbac authorization v1alpha1 namespaced role binding params
func (o *WatchRbacAuthorizationV1alpha1NamespacedRoleBindingParams) WithName(name string) *WatchRbacAuthorizationV1alpha1NamespacedRoleBindingParams {
	o.SetName(name)
	return o
}

// SetName adds the name to the watch rbac authorization v1alpha1 namespaced role binding params
func (o *WatchRbacAuthorizationV1alpha1NamespacedRoleBindingParams) SetName(name string) {
	o.Name = name
}

// WithNamespace adds the namespace to the watch rbac authorization v1alpha1 namespaced role binding params
func (o *WatchRbacAuthorizationV1alpha1NamespacedRoleBindingParams) WithNamespace(namespace string) *WatchRbacAuthorizationV1alpha1NamespacedRoleBindingParams {
	o.SetNamespace(namespace)
	return o
}

// SetNamespace adds the namespace to the watch rbac authorization v1alpha1 namespaced role binding params
func (o *WatchRbacAuthorizationV1alpha1NamespacedRoleBindingParams) SetNamespace(namespace string) {
	o.Namespace = namespace
}

// WithPretty adds the pretty to the watch rbac authorization v1alpha1 namespaced role binding params
func (o *WatchRbacAuthorizationV1alpha1NamespacedRoleBindingParams) WithPretty(pretty *string) *WatchRbacAuthorizationV1alpha1NamespacedRoleBindingParams {
	o.SetPretty(pretty)
	return o
}

// SetPretty adds the pretty to the watch rbac authorization v1alpha1 namespaced role binding params
func (o *WatchRbacAuthorizationV1alpha1NamespacedRoleBindingParams) SetPretty(pretty *string) {
	o.Pretty = pretty
}

// WithResourceVersion adds the resourceVersion to the watch rbac authorization v1alpha1 namespaced role binding params
func (o *WatchRbacAuthorizationV1alpha1NamespacedRoleBindingParams) WithResourceVersion(resourceVersion *string) *WatchRbacAuthorizationV1alpha1NamespacedRoleBindingParams {
...
func (o *WatchRbacAuthorizationV1alpha1NamespacedRoleBindingParams) WithResourceVersionMatch(resourceVersionMatch *string) *WatchRbacAuthorizationV1alpha1NamespacedRoleBindingParams {
...
func (o *WatchRbacAuthorizationV1alpha1NamespacedRoleBindingParams) WithTimeoutSeconds(timeoutSeconds *int64) *WatchRbacAuthorizationV1alpha1NamespacedRoleBindingParams {
...
func (o *WatchRbacAuthorizationV1alpha1NamespacedRoleBindingParams) WithWatch(watch *bool) *WatchRbacAuthorizationV1alpha1NamespacedRoleBindingParams {
	o.SetWatch(watch)
	return o
}

// SetWatch adds the watch to the watch rbac authorization v1alpha1 namespaced role binding params
func (o *WatchRbacAuthorizationV1alpha1NamespacedRoleBindingParams) SetWatch(watch *bool) {
	o.Watch = watch
}

// WriteToRequest writes these params to a swagger request
func (o *WatchRbacAuthorizationV1alpha1NamespacedRoleBindingParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {

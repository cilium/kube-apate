...
// NewWatchRbacAuthorizationV1alpha1ClusterRoleBindingParamsWithTimeout creates a new WatchRbacAuthorizationV1alpha1ClusterRoleBindingParams object
...
// NewWatchRbacAuthorizationV1alpha1ClusterRoleBindingParamsWithContext creates a new WatchRbacAuthorizationV1alpha1ClusterRoleBindingParams object
...
// NewWatchRbacAuthorizationV1alpha1ClusterRoleBindingParamsWithHTTPClient creates a new WatchRbacAuthorizationV1alpha1ClusterRoleBindingParams object
...
/*WatchRbacAuthorizationV1alpha1ClusterRoleBindingParams contains all the parameters to send to the API endpoint
for the watch rbac authorization v1alpha1 cluster role binding operation typically these are written to a http.Request
*/
...
func (o *WatchRbacAuthorizationV1alpha1ClusterRoleBindingParams) WithTimeout(timeout time.Duration) *WatchRbacAuthorizationV1alpha1ClusterRoleBindingParams {
	o.SetTimeout(timeout)
	return o
}

// SetTimeout adds the timeout to the watch rbac authorization v1alpha1 cluster role binding params
func (o *WatchRbacAuthorizationV1alpha1ClusterRoleBindingParams) SetTimeout(timeout time.Duration) {
	o.timeout = timeout
}

// WithContext adds the context to the watch rbac authorization v1alpha1 cluster role binding params
func (o *WatchRbacAuthorizationV1alpha1ClusterRoleBindingParams) WithContext(ctx context.Context) *WatchRbacAuthorizationV1alpha1ClusterRoleBindingParams {
	o.SetContext(ctx)
	return o
}

// SetContext adds the context to the watch rbac authorization v1alpha1 cluster role binding params
func (o *WatchRbacAuthorizationV1alpha1ClusterRoleBindingParams) SetContext(ctx context.Context) {
	o.Context = ctx
}

// WithHTTPClient adds the HTTPClient to the watch rbac authorization v1alpha1 cluster role binding params
func (o *WatchRbacAuthorizationV1alpha1ClusterRoleBindingParams) WithHTTPClient(client *http.Client) *WatchRbacAuthorizationV1alpha1ClusterRoleBindingParams {
	o.SetHTTPClient(client)
	return o
}

// SetHTTPClient adds the HTTPClient to the watch rbac authorization v1alpha1 cluster role binding params
func (o *WatchRbacAuthorizationV1alpha1ClusterRoleBindingParams) SetHTTPClient(client *http.Client) {
	o.HTTPClient = client
}
...
func (o *WatchRbacAuthorizationV1alpha1ClusterRoleBindingParams) WithAllowWatchBookmarks(allowWatchBookmarks *bool) *WatchRbacAuthorizationV1alpha1ClusterRoleBindingParams {
...
func (o *WatchRbacAuthorizationV1alpha1ClusterRoleBindingParams) WithContinue(continueVar *string) *WatchRbacAuthorizationV1alpha1ClusterRoleBindingParams {
...
func (o *WatchRbacAuthorizationV1alpha1ClusterRoleBindingParams) SetContinue(continueVar *string) {
...
func (o *WatchRbacAuthorizationV1alpha1ClusterRoleBindingParams) WithFieldSelector(fieldSelector *string) *WatchRbacAuthorizationV1alpha1ClusterRoleBindingParams {
...
func (o *WatchRbacAuthorizationV1alpha1ClusterRoleBindingParams) WithLabelSelector(labelSelector *string) *WatchRbacAuthorizationV1alpha1ClusterRoleBindingParams {
...
func (o *WatchRbacAuthorizationV1alpha1ClusterRoleBindingParams) WithLimit(limit *int64) *WatchRbacAuthorizationV1alpha1ClusterRoleBindingParams {
	o.SetLimit(limit)
	return o
}

// SetLimit adds the limit to the watch rbac authorization v1alpha1 cluster role binding params
func (o *WatchRbacAuthorizationV1alpha1ClusterRoleBindingParams) SetLimit(limit *int64) {
	o.Limit = limit
}

// WithName adds the name to the watch rbac authorization v1alpha1 cluster role binding params
func (o *WatchRbacAuthorizationV1alpha1ClusterRoleBindingParams) WithName(name string) *WatchRbacAuthorizationV1alpha1ClusterRoleBindingParams {
	o.SetName(name)
	return o
}

// SetName adds the name to the watch rbac authorization v1alpha1 cluster role binding params
func (o *WatchRbacAuthorizationV1alpha1ClusterRoleBindingParams) SetName(name string) {
	o.Name = name
}

// WithPretty adds the pretty to the watch rbac authorization v1alpha1 cluster role binding params
func (o *WatchRbacAuthorizationV1alpha1ClusterRoleBindingParams) WithPretty(pretty *string) *WatchRbacAuthorizationV1alpha1ClusterRoleBindingParams {
	o.SetPretty(pretty)
	return o
}

// SetPretty adds the pretty to the watch rbac authorization v1alpha1 cluster role binding params
func (o *WatchRbacAuthorizationV1alpha1ClusterRoleBindingParams) SetPretty(pretty *string) {
	o.Pretty = pretty
}

// WithResourceVersion adds the resourceVersion to the watch rbac authorization v1alpha1 cluster role binding params
func (o *WatchRbacAuthorizationV1alpha1ClusterRoleBindingParams) WithResourceVersion(resourceVersion *string) *WatchRbacAuthorizationV1alpha1ClusterRoleBindingParams {
...
func (o *WatchRbacAuthorizationV1alpha1ClusterRoleBindingParams) WithResourceVersionMatch(resourceVersionMatch *string) *WatchRbacAuthorizationV1alpha1ClusterRoleBindingParams {
...
func (o *WatchRbacAuthorizationV1alpha1ClusterRoleBindingParams) WithTimeoutSeconds(timeoutSeconds *int64) *WatchRbacAuthorizationV1alpha1ClusterRoleBindingParams {
...
func (o *WatchRbacAuthorizationV1alpha1ClusterRoleBindingParams) WithWatch(watch *bool) *WatchRbacAuthorizationV1alpha1ClusterRoleBindingParams {
	o.SetWatch(watch)
	return o
}

// SetWatch adds the watch to the watch rbac authorization v1alpha1 cluster role binding params
func (o *WatchRbacAuthorizationV1alpha1ClusterRoleBindingParams) SetWatch(watch *bool) {
	o.Watch = watch
}

// WriteToRequest writes these params to a swagger request
func (o *WatchRbacAuthorizationV1alpha1ClusterRoleBindingParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {

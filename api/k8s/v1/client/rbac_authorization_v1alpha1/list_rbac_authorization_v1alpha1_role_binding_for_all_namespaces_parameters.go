...
// NewListRbacAuthorizationV1alpha1RoleBindingForAllNamespacesParamsWithTimeout creates a new ListRbacAuthorizationV1alpha1RoleBindingForAllNamespacesParams object
...
// NewListRbacAuthorizationV1alpha1RoleBindingForAllNamespacesParamsWithContext creates a new ListRbacAuthorizationV1alpha1RoleBindingForAllNamespacesParams object
...
// NewListRbacAuthorizationV1alpha1RoleBindingForAllNamespacesParamsWithHTTPClient creates a new ListRbacAuthorizationV1alpha1RoleBindingForAllNamespacesParams object
...
/*ListRbacAuthorizationV1alpha1RoleBindingForAllNamespacesParams contains all the parameters to send to the API endpoint
for the list rbac authorization v1alpha1 role binding for all namespaces operation typically these are written to a http.Request
*/
...
func (o *ListRbacAuthorizationV1alpha1RoleBindingForAllNamespacesParams) WithTimeout(timeout time.Duration) *ListRbacAuthorizationV1alpha1RoleBindingForAllNamespacesParams {
	o.SetTimeout(timeout)
	return o
}

// SetTimeout adds the timeout to the list rbac authorization v1alpha1 role binding for all namespaces params
func (o *ListRbacAuthorizationV1alpha1RoleBindingForAllNamespacesParams) SetTimeout(timeout time.Duration) {
	o.timeout = timeout
}

// WithContext adds the context to the list rbac authorization v1alpha1 role binding for all namespaces params
func (o *ListRbacAuthorizationV1alpha1RoleBindingForAllNamespacesParams) WithContext(ctx context.Context) *ListRbacAuthorizationV1alpha1RoleBindingForAllNamespacesParams {
	o.SetContext(ctx)
	return o
}

// SetContext adds the context to the list rbac authorization v1alpha1 role binding for all namespaces params
func (o *ListRbacAuthorizationV1alpha1RoleBindingForAllNamespacesParams) SetContext(ctx context.Context) {
	o.Context = ctx
}

// WithHTTPClient adds the HTTPClient to the list rbac authorization v1alpha1 role binding for all namespaces params
func (o *ListRbacAuthorizationV1alpha1RoleBindingForAllNamespacesParams) WithHTTPClient(client *http.Client) *ListRbacAuthorizationV1alpha1RoleBindingForAllNamespacesParams {
	o.SetHTTPClient(client)
	return o
}

// SetHTTPClient adds the HTTPClient to the list rbac authorization v1alpha1 role binding for all namespaces params
func (o *ListRbacAuthorizationV1alpha1RoleBindingForAllNamespacesParams) SetHTTPClient(client *http.Client) {
	o.HTTPClient = client
}
...
func (o *ListRbacAuthorizationV1alpha1RoleBindingForAllNamespacesParams) WithAllowWatchBookmarks(allowWatchBookmarks *bool) *ListRbacAuthorizationV1alpha1RoleBindingForAllNamespacesParams {
...
func (o *ListRbacAuthorizationV1alpha1RoleBindingForAllNamespacesParams) WithContinue(continueVar *string) *ListRbacAuthorizationV1alpha1RoleBindingForAllNamespacesParams {
...
func (o *ListRbacAuthorizationV1alpha1RoleBindingForAllNamespacesParams) SetContinue(continueVar *string) {
...
func (o *ListRbacAuthorizationV1alpha1RoleBindingForAllNamespacesParams) WithFieldSelector(fieldSelector *string) *ListRbacAuthorizationV1alpha1RoleBindingForAllNamespacesParams {
...
func (o *ListRbacAuthorizationV1alpha1RoleBindingForAllNamespacesParams) WithLabelSelector(labelSelector *string) *ListRbacAuthorizationV1alpha1RoleBindingForAllNamespacesParams {
...
func (o *ListRbacAuthorizationV1alpha1RoleBindingForAllNamespacesParams) WithLimit(limit *int64) *ListRbacAuthorizationV1alpha1RoleBindingForAllNamespacesParams {
	o.SetLimit(limit)
	return o
}

// SetLimit adds the limit to the list rbac authorization v1alpha1 role binding for all namespaces params
func (o *ListRbacAuthorizationV1alpha1RoleBindingForAllNamespacesParams) SetLimit(limit *int64) {
	o.Limit = limit
}

// WithPretty adds the pretty to the list rbac authorization v1alpha1 role binding for all namespaces params
func (o *ListRbacAuthorizationV1alpha1RoleBindingForAllNamespacesParams) WithPretty(pretty *string) *ListRbacAuthorizationV1alpha1RoleBindingForAllNamespacesParams {
	o.SetPretty(pretty)
	return o
}

// SetPretty adds the pretty to the list rbac authorization v1alpha1 role binding for all namespaces params
func (o *ListRbacAuthorizationV1alpha1RoleBindingForAllNamespacesParams) SetPretty(pretty *string) {
	o.Pretty = pretty
}
...
func (o *ListRbacAuthorizationV1alpha1RoleBindingForAllNamespacesParams) WithResourceVersion(resourceVersion *string) *ListRbacAuthorizationV1alpha1RoleBindingForAllNamespacesParams {
...
func (o *ListRbacAuthorizationV1alpha1RoleBindingForAllNamespacesParams) WithResourceVersionMatch(resourceVersionMatch *string) *ListRbacAuthorizationV1alpha1RoleBindingForAllNamespacesParams {
...
func (o *ListRbacAuthorizationV1alpha1RoleBindingForAllNamespacesParams) WithTimeoutSeconds(timeoutSeconds *int64) *ListRbacAuthorizationV1alpha1RoleBindingForAllNamespacesParams {
...
func (o *ListRbacAuthorizationV1alpha1RoleBindingForAllNamespacesParams) WithWatch(watch *bool) *ListRbacAuthorizationV1alpha1RoleBindingForAllNamespacesParams {
	o.SetWatch(watch)
	return o
}

// SetWatch adds the watch to the list rbac authorization v1alpha1 role binding for all namespaces params
func (o *ListRbacAuthorizationV1alpha1RoleBindingForAllNamespacesParams) SetWatch(watch *bool) {
	o.Watch = watch
}

// WriteToRequest writes these params to a swagger request
func (o *ListRbacAuthorizationV1alpha1RoleBindingForAllNamespacesParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {

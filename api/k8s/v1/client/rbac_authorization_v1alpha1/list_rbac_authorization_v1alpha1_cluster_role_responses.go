...
func (o *ListRbacAuthorizationV1alpha1ClusterRoleReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewListRbacAuthorizationV1alpha1ClusterRoleOK()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return result, nil
	case 401:
		result := NewListRbacAuthorizationV1alpha1ClusterRoleUnauthorized()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
func (o *ListRbacAuthorizationV1alpha1ClusterRoleOK) Error() string {
	return fmt.Sprintf("[GET /apis/rbac.authorization.k8s.io/v1alpha1/clusterroles][%d] listRbacAuthorizationV1alpha1ClusterRoleOK  %+v", 200, o.Payload)
}

func (o *ListRbacAuthorizationV1alpha1ClusterRoleOK) GetPayload() *models.IoK8sAPIRbacV1alpha1ClusterRoleList {
	return o.Payload
}

func (o *ListRbacAuthorizationV1alpha1ClusterRoleOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {

	o.Payload = new(models.IoK8sAPIRbacV1alpha1ClusterRoleList)
...
func (o *ListRbacAuthorizationV1alpha1ClusterRoleUnauthorized) Error() string {
	return fmt.Sprintf("[GET /apis/rbac.authorization.k8s.io/v1alpha1/clusterroles][%d] listRbacAuthorizationV1alpha1ClusterRoleUnauthorized ", 401)
}

func (o *ListRbacAuthorizationV1alpha1ClusterRoleUnauthorized) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {

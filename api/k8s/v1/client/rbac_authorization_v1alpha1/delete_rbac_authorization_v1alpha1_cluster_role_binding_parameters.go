...
// NewDeleteRbacAuthorizationV1alpha1ClusterRoleBindingParamsWithTimeout creates a new DeleteRbacAuthorizationV1alpha1ClusterRoleBindingParams object
...
// NewDeleteRbacAuthorizationV1alpha1ClusterRoleBindingParamsWithContext creates a new DeleteRbacAuthorizationV1alpha1ClusterRoleBindingParams object
...
// NewDeleteRbacAuthorizationV1alpha1ClusterRoleBindingParamsWithHTTPClient creates a new DeleteRbacAuthorizationV1alpha1ClusterRoleBindingParams object
...
/*DeleteRbacAuthorizationV1alpha1ClusterRoleBindingParams contains all the parameters to send to the API endpoint
for the delete rbac authorization v1alpha1 cluster role binding operation typically these are written to a http.Request
*/
...
func (o *DeleteRbacAuthorizationV1alpha1ClusterRoleBindingParams) WithTimeout(timeout time.Duration) *DeleteRbacAuthorizationV1alpha1ClusterRoleBindingParams {
	o.SetTimeout(timeout)
	return o
}

// SetTimeout adds the timeout to the delete rbac authorization v1alpha1 cluster role binding params
func (o *DeleteRbacAuthorizationV1alpha1ClusterRoleBindingParams) SetTimeout(timeout time.Duration) {
	o.timeout = timeout
}

// WithContext adds the context to the delete rbac authorization v1alpha1 cluster role binding params
func (o *DeleteRbacAuthorizationV1alpha1ClusterRoleBindingParams) WithContext(ctx context.Context) *DeleteRbacAuthorizationV1alpha1ClusterRoleBindingParams {
	o.SetContext(ctx)
	return o
}

// SetContext adds the context to the delete rbac authorization v1alpha1 cluster role binding params
func (o *DeleteRbacAuthorizationV1alpha1ClusterRoleBindingParams) SetContext(ctx context.Context) {
	o.Context = ctx
}

// WithHTTPClient adds the HTTPClient to the delete rbac authorization v1alpha1 cluster role binding params
func (o *DeleteRbacAuthorizationV1alpha1ClusterRoleBindingParams) WithHTTPClient(client *http.Client) *DeleteRbacAuthorizationV1alpha1ClusterRoleBindingParams {
	o.SetHTTPClient(client)
	return o
}

// SetHTTPClient adds the HTTPClient to the delete rbac authorization v1alpha1 cluster role binding params
func (o *DeleteRbacAuthorizationV1alpha1ClusterRoleBindingParams) SetHTTPClient(client *http.Client) {
	o.HTTPClient = client
}

// WithBody adds the body to the delete rbac authorization v1alpha1 cluster role binding params
func (o *DeleteRbacAuthorizationV1alpha1ClusterRoleBindingParams) WithBody(body *models.IoK8sApimachineryPkgApisMetaV1DeleteOptions) *DeleteRbacAuthorizationV1alpha1ClusterRoleBindingParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the delete rbac authorization v1alpha1 cluster role binding params
func (o *DeleteRbacAuthorizationV1alpha1ClusterRoleBindingParams) SetBody(body *models.IoK8sApimachineryPkgApisMetaV1DeleteOptions) {
	o.Body = body
}

// WithDryRun adds the dryRun to the delete rbac authorization v1alpha1 cluster role binding params
func (o *DeleteRbacAuthorizationV1alpha1ClusterRoleBindingParams) WithDryRun(dryRun *string) *DeleteRbacAuthorizationV1alpha1ClusterRoleBindingParams {
	o.SetDryRun(dryRun)
	return o
}

// SetDryRun adds the dryRun to the delete rbac authorization v1alpha1 cluster role binding params
func (o *DeleteRbacAuthorizationV1alpha1ClusterRoleBindingParams) SetDryRun(dryRun *string) {
	o.DryRun = dryRun
}

// WithGracePeriodSeconds adds the gracePeriodSeconds to the delete rbac authorization v1alpha1 cluster role binding params
func (o *DeleteRbacAuthorizationV1alpha1ClusterRoleBindingParams) WithGracePeriodSeconds(gracePeriodSeconds *int64) *DeleteRbacAuthorizationV1alpha1ClusterRoleBindingParams {
...
func (o *DeleteRbacAuthorizationV1alpha1ClusterRoleBindingParams) WithName(name string) *DeleteRbacAuthorizationV1alpha1ClusterRoleBindingParams {
	o.SetName(name)
	return o
}

// SetName adds the name to the delete rbac authorization v1alpha1 cluster role binding params
func (o *DeleteRbacAuthorizationV1alpha1ClusterRoleBindingParams) SetName(name string) {
	o.Name = name
}

// WithOrphanDependents adds the orphanDependents to the delete rbac authorization v1alpha1 cluster role binding params
func (o *DeleteRbacAuthorizationV1alpha1ClusterRoleBindingParams) WithOrphanDependents(orphanDependents *bool) *DeleteRbacAuthorizationV1alpha1ClusterRoleBindingParams {
...
func (o *DeleteRbacAuthorizationV1alpha1ClusterRoleBindingParams) WithPretty(pretty *string) *DeleteRbacAuthorizationV1alpha1ClusterRoleBindingParams {
	o.SetPretty(pretty)
	return o
}

// SetPretty adds the pretty to the delete rbac authorization v1alpha1 cluster role binding params
func (o *DeleteRbacAuthorizationV1alpha1ClusterRoleBindingParams) SetPretty(pretty *string) {
	o.Pretty = pretty
}

// WithPropagationPolicy adds the propagationPolicy to the delete rbac authorization v1alpha1 cluster role binding params
func (o *DeleteRbacAuthorizationV1alpha1ClusterRoleBindingParams) WithPropagationPolicy(propagationPolicy *string) *DeleteRbacAuthorizationV1alpha1ClusterRoleBindingParams {
...
func (o *DeleteRbacAuthorizationV1alpha1ClusterRoleBindingParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {

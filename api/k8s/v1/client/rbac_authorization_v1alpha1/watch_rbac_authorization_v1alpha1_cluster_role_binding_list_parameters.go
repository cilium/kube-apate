...
// NewWatchRbacAuthorizationV1alpha1ClusterRoleBindingListParamsWithTimeout creates a new WatchRbacAuthorizationV1alpha1ClusterRoleBindingListParams object
...
// NewWatchRbacAuthorizationV1alpha1ClusterRoleBindingListParamsWithContext creates a new WatchRbacAuthorizationV1alpha1ClusterRoleBindingListParams object
...
// NewWatchRbacAuthorizationV1alpha1ClusterRoleBindingListParamsWithHTTPClient creates a new WatchRbacAuthorizationV1alpha1ClusterRoleBindingListParams object
...
/*WatchRbacAuthorizationV1alpha1ClusterRoleBindingListParams contains all the parameters to send to the API endpoint
for the watch rbac authorization v1alpha1 cluster role binding list operation typically these are written to a http.Request
*/
...
func (o *WatchRbacAuthorizationV1alpha1ClusterRoleBindingListParams) WithTimeout(timeout time.Duration) *WatchRbacAuthorizationV1alpha1ClusterRoleBindingListParams {
	o.SetTimeout(timeout)
	return o
}

// SetTimeout adds the timeout to the watch rbac authorization v1alpha1 cluster role binding list params
func (o *WatchRbacAuthorizationV1alpha1ClusterRoleBindingListParams) SetTimeout(timeout time.Duration) {
	o.timeout = timeout
}

// WithContext adds the context to the watch rbac authorization v1alpha1 cluster role binding list params
func (o *WatchRbacAuthorizationV1alpha1ClusterRoleBindingListParams) WithContext(ctx context.Context) *WatchRbacAuthorizationV1alpha1ClusterRoleBindingListParams {
	o.SetContext(ctx)
	return o
}

// SetContext adds the context to the watch rbac authorization v1alpha1 cluster role binding list params
func (o *WatchRbacAuthorizationV1alpha1ClusterRoleBindingListParams) SetContext(ctx context.Context) {
	o.Context = ctx
}

// WithHTTPClient adds the HTTPClient to the watch rbac authorization v1alpha1 cluster role binding list params
func (o *WatchRbacAuthorizationV1alpha1ClusterRoleBindingListParams) WithHTTPClient(client *http.Client) *WatchRbacAuthorizationV1alpha1ClusterRoleBindingListParams {
	o.SetHTTPClient(client)
	return o
}

// SetHTTPClient adds the HTTPClient to the watch rbac authorization v1alpha1 cluster role binding list params
func (o *WatchRbacAuthorizationV1alpha1ClusterRoleBindingListParams) SetHTTPClient(client *http.Client) {
	o.HTTPClient = client
}
...
func (o *WatchRbacAuthorizationV1alpha1ClusterRoleBindingListParams) WithAllowWatchBookmarks(allowWatchBookmarks *bool) *WatchRbacAuthorizationV1alpha1ClusterRoleBindingListParams {
...
func (o *WatchRbacAuthorizationV1alpha1ClusterRoleBindingListParams) WithContinue(continueVar *string) *WatchRbacAuthorizationV1alpha1ClusterRoleBindingListParams {
...
func (o *WatchRbacAuthorizationV1alpha1ClusterRoleBindingListParams) SetContinue(continueVar *string) {
...
func (o *WatchRbacAuthorizationV1alpha1ClusterRoleBindingListParams) WithFieldSelector(fieldSelector *string) *WatchRbacAuthorizationV1alpha1ClusterRoleBindingListParams {
...
func (o *WatchRbacAuthorizationV1alpha1ClusterRoleBindingListParams) WithLabelSelector(labelSelector *string) *WatchRbacAuthorizationV1alpha1ClusterRoleBindingListParams {
...
func (o *WatchRbacAuthorizationV1alpha1ClusterRoleBindingListParams) WithLimit(limit *int64) *WatchRbacAuthorizationV1alpha1ClusterRoleBindingListParams {
	o.SetLimit(limit)
	return o
}

// SetLimit adds the limit to the watch rbac authorization v1alpha1 cluster role binding list params
func (o *WatchRbacAuthorizationV1alpha1ClusterRoleBindingListParams) SetLimit(limit *int64) {
	o.Limit = limit
}

// WithPretty adds the pretty to the watch rbac authorization v1alpha1 cluster role binding list params
func (o *WatchRbacAuthorizationV1alpha1ClusterRoleBindingListParams) WithPretty(pretty *string) *WatchRbacAuthorizationV1alpha1ClusterRoleBindingListParams {
	o.SetPretty(pretty)
	return o
}

// SetPretty adds the pretty to the watch rbac authorization v1alpha1 cluster role binding list params
func (o *WatchRbacAuthorizationV1alpha1ClusterRoleBindingListParams) SetPretty(pretty *string) {
	o.Pretty = pretty
}

// WithResourceVersion adds the resourceVersion to the watch rbac authorization v1alpha1 cluster role binding list params
func (o *WatchRbacAuthorizationV1alpha1ClusterRoleBindingListParams) WithResourceVersion(resourceVersion *string) *WatchRbacAuthorizationV1alpha1ClusterRoleBindingListParams {
...
func (o *WatchRbacAuthorizationV1alpha1ClusterRoleBindingListParams) WithResourceVersionMatch(resourceVersionMatch *string) *WatchRbacAuthorizationV1alpha1ClusterRoleBindingListParams {
...
func (o *WatchRbacAuthorizationV1alpha1ClusterRoleBindingListParams) WithTimeoutSeconds(timeoutSeconds *int64) *WatchRbacAuthorizationV1alpha1ClusterRoleBindingListParams {
...
func (o *WatchRbacAuthorizationV1alpha1ClusterRoleBindingListParams) WithWatch(watch *bool) *WatchRbacAuthorizationV1alpha1ClusterRoleBindingListParams {
	o.SetWatch(watch)
	return o
}

// SetWatch adds the watch to the watch rbac authorization v1alpha1 cluster role binding list params
func (o *WatchRbacAuthorizationV1alpha1ClusterRoleBindingListParams) SetWatch(watch *bool) {
	o.Watch = watch
}

// WriteToRequest writes these params to a swagger request
func (o *WatchRbacAuthorizationV1alpha1ClusterRoleBindingListParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {

...
func (o *WatchRbacAuthorizationV1alpha1ClusterRoleBindingReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewWatchRbacAuthorizationV1alpha1ClusterRoleBindingOK()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return result, nil
	case 401:
		result := NewWatchRbacAuthorizationV1alpha1ClusterRoleBindingUnauthorized()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
func (o *WatchRbacAuthorizationV1alpha1ClusterRoleBindingOK) Error() string {
	return fmt.Sprintf("[GET /apis/rbac.authorization.k8s.io/v1alpha1/watch/clusterrolebindings/{name}][%d] watchRbacAuthorizationV1alpha1ClusterRoleBindingOK  %+v", 200, o.Payload)
}

func (o *WatchRbacAuthorizationV1alpha1ClusterRoleBindingOK) GetPayload() *models.IoK8sApimachineryPkgApisMetaV1WatchEvent {
	return o.Payload
}

func (o *WatchRbacAuthorizationV1alpha1ClusterRoleBindingOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
...
func (o *WatchRbacAuthorizationV1alpha1ClusterRoleBindingUnauthorized) Error() string {
	return fmt.Sprintf("[GET /apis/rbac.authorization.k8s.io/v1alpha1/watch/clusterrolebindings/{name}][%d] watchRbacAuthorizationV1alpha1ClusterRoleBindingUnauthorized ", 401)
}

func (o *WatchRbacAuthorizationV1alpha1ClusterRoleBindingUnauthorized) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {

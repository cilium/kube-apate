...
// NewWatchRbacAuthorizationV1alpha1NamespacedRoleListParamsWithTimeout creates a new WatchRbacAuthorizationV1alpha1NamespacedRoleListParams object
...
// NewWatchRbacAuthorizationV1alpha1NamespacedRoleListParamsWithContext creates a new WatchRbacAuthorizationV1alpha1NamespacedRoleListParams object
...
// NewWatchRbacAuthorizationV1alpha1NamespacedRoleListParamsWithHTTPClient creates a new WatchRbacAuthorizationV1alpha1NamespacedRoleListParams object
...
/*WatchRbacAuthorizationV1alpha1NamespacedRoleListParams contains all the parameters to send to the API endpoint
for the watch rbac authorization v1alpha1 namespaced role list operation typically these are written to a http.Request
*/
...
func (o *WatchRbacAuthorizationV1alpha1NamespacedRoleListParams) WithTimeout(timeout time.Duration) *WatchRbacAuthorizationV1alpha1NamespacedRoleListParams {
	o.SetTimeout(timeout)
	return o
}

// SetTimeout adds the timeout to the watch rbac authorization v1alpha1 namespaced role list params
func (o *WatchRbacAuthorizationV1alpha1NamespacedRoleListParams) SetTimeout(timeout time.Duration) {
	o.timeout = timeout
}

// WithContext adds the context to the watch rbac authorization v1alpha1 namespaced role list params
func (o *WatchRbacAuthorizationV1alpha1NamespacedRoleListParams) WithContext(ctx context.Context) *WatchRbacAuthorizationV1alpha1NamespacedRoleListParams {
	o.SetContext(ctx)
	return o
}

// SetContext adds the context to the watch rbac authorization v1alpha1 namespaced role list params
func (o *WatchRbacAuthorizationV1alpha1NamespacedRoleListParams) SetContext(ctx context.Context) {
	o.Context = ctx
}

// WithHTTPClient adds the HTTPClient to the watch rbac authorization v1alpha1 namespaced role list params
func (o *WatchRbacAuthorizationV1alpha1NamespacedRoleListParams) WithHTTPClient(client *http.Client) *WatchRbacAuthorizationV1alpha1NamespacedRoleListParams {
	o.SetHTTPClient(client)
	return o
}

// SetHTTPClient adds the HTTPClient to the watch rbac authorization v1alpha1 namespaced role list params
func (o *WatchRbacAuthorizationV1alpha1NamespacedRoleListParams) SetHTTPClient(client *http.Client) {
	o.HTTPClient = client
}
...
func (o *WatchRbacAuthorizationV1alpha1NamespacedRoleListParams) WithAllowWatchBookmarks(allowWatchBookmarks *bool) *WatchRbacAuthorizationV1alpha1NamespacedRoleListParams {
...
func (o *WatchRbacAuthorizationV1alpha1NamespacedRoleListParams) WithContinue(continueVar *string) *WatchRbacAuthorizationV1alpha1NamespacedRoleListParams {
...
func (o *WatchRbacAuthorizationV1alpha1NamespacedRoleListParams) SetContinue(continueVar *string) {
...
func (o *WatchRbacAuthorizationV1alpha1NamespacedRoleListParams) WithFieldSelector(fieldSelector *string) *WatchRbacAuthorizationV1alpha1NamespacedRoleListParams {
...
func (o *WatchRbacAuthorizationV1alpha1NamespacedRoleListParams) WithLabelSelector(labelSelector *string) *WatchRbacAuthorizationV1alpha1NamespacedRoleListParams {
...
func (o *WatchRbacAuthorizationV1alpha1NamespacedRoleListParams) WithLimit(limit *int64) *WatchRbacAuthorizationV1alpha1NamespacedRoleListParams {
	o.SetLimit(limit)
	return o
}

// SetLimit adds the limit to the watch rbac authorization v1alpha1 namespaced role list params
func (o *WatchRbacAuthorizationV1alpha1NamespacedRoleListParams) SetLimit(limit *int64) {
	o.Limit = limit
}

// WithNamespace adds the namespace to the watch rbac authorization v1alpha1 namespaced role list params
func (o *WatchRbacAuthorizationV1alpha1NamespacedRoleListParams) WithNamespace(namespace string) *WatchRbacAuthorizationV1alpha1NamespacedRoleListParams {
	o.SetNamespace(namespace)
	return o
}

// SetNamespace adds the namespace to the watch rbac authorization v1alpha1 namespaced role list params
func (o *WatchRbacAuthorizationV1alpha1NamespacedRoleListParams) SetNamespace(namespace string) {
	o.Namespace = namespace
}

// WithPretty adds the pretty to the watch rbac authorization v1alpha1 namespaced role list params
func (o *WatchRbacAuthorizationV1alpha1NamespacedRoleListParams) WithPretty(pretty *string) *WatchRbacAuthorizationV1alpha1NamespacedRoleListParams {
	o.SetPretty(pretty)
	return o
}

// SetPretty adds the pretty to the watch rbac authorization v1alpha1 namespaced role list params
func (o *WatchRbacAuthorizationV1alpha1NamespacedRoleListParams) SetPretty(pretty *string) {
	o.Pretty = pretty
}

// WithResourceVersion adds the resourceVersion to the watch rbac authorization v1alpha1 namespaced role list params
func (o *WatchRbacAuthorizationV1alpha1NamespacedRoleListParams) WithResourceVersion(resourceVersion *string) *WatchRbacAuthorizationV1alpha1NamespacedRoleListParams {
...
func (o *WatchRbacAuthorizationV1alpha1NamespacedRoleListParams) WithResourceVersionMatch(resourceVersionMatch *string) *WatchRbacAuthorizationV1alpha1NamespacedRoleListParams {
...
func (o *WatchRbacAuthorizationV1alpha1NamespacedRoleListParams) WithTimeoutSeconds(timeoutSeconds *int64) *WatchRbacAuthorizationV1alpha1NamespacedRoleListParams {
...
func (o *WatchRbacAuthorizationV1alpha1NamespacedRoleListParams) WithWatch(watch *bool) *WatchRbacAuthorizationV1alpha1NamespacedRoleListParams {
	o.SetWatch(watch)
	return o
}

// SetWatch adds the watch to the watch rbac authorization v1alpha1 namespaced role list params
func (o *WatchRbacAuthorizationV1alpha1NamespacedRoleListParams) SetWatch(watch *bool) {
	o.Watch = watch
}

// WriteToRequest writes these params to a swagger request
func (o *WatchRbacAuthorizationV1alpha1NamespacedRoleListParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {

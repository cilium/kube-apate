...
// NewWatchRbacAuthorizationV1alpha1NamespacedRoleBindingListParamsWithTimeout creates a new WatchRbacAuthorizationV1alpha1NamespacedRoleBindingListParams object
...
// NewWatchRbacAuthorizationV1alpha1NamespacedRoleBindingListParamsWithContext creates a new WatchRbacAuthorizationV1alpha1NamespacedRoleBindingListParams object
...
// NewWatchRbacAuthorizationV1alpha1NamespacedRoleBindingListParamsWithHTTPClient creates a new WatchRbacAuthorizationV1alpha1NamespacedRoleBindingListParams object
...
/*WatchRbacAuthorizationV1alpha1NamespacedRoleBindingListParams contains all the parameters to send to the API endpoint
for the watch rbac authorization v1alpha1 namespaced role binding list operation typically these are written to a http.Request
*/
...
func (o *WatchRbacAuthorizationV1alpha1NamespacedRoleBindingListParams) WithTimeout(timeout time.Duration) *WatchRbacAuthorizationV1alpha1NamespacedRoleBindingListParams {
	o.SetTimeout(timeout)
	return o
}

// SetTimeout adds the timeout to the watch rbac authorization v1alpha1 namespaced role binding list params
func (o *WatchRbacAuthorizationV1alpha1NamespacedRoleBindingListParams) SetTimeout(timeout time.Duration) {
	o.timeout = timeout
}

// WithContext adds the context to the watch rbac authorization v1alpha1 namespaced role binding list params
func (o *WatchRbacAuthorizationV1alpha1NamespacedRoleBindingListParams) WithContext(ctx context.Context) *WatchRbacAuthorizationV1alpha1NamespacedRoleBindingListParams {
	o.SetContext(ctx)
	return o
}

// SetContext adds the context to the watch rbac authorization v1alpha1 namespaced role binding list params
func (o *WatchRbacAuthorizationV1alpha1NamespacedRoleBindingListParams) SetContext(ctx context.Context) {
	o.Context = ctx
}

// WithHTTPClient adds the HTTPClient to the watch rbac authorization v1alpha1 namespaced role binding list params
func (o *WatchRbacAuthorizationV1alpha1NamespacedRoleBindingListParams) WithHTTPClient(client *http.Client) *WatchRbacAuthorizationV1alpha1NamespacedRoleBindingListParams {
	o.SetHTTPClient(client)
	return o
}

// SetHTTPClient adds the HTTPClient to the watch rbac authorization v1alpha1 namespaced role binding list params
func (o *WatchRbacAuthorizationV1alpha1NamespacedRoleBindingListParams) SetHTTPClient(client *http.Client) {
	o.HTTPClient = client
}
...
func (o *WatchRbacAuthorizationV1alpha1NamespacedRoleBindingListParams) WithAllowWatchBookmarks(allowWatchBookmarks *bool) *WatchRbacAuthorizationV1alpha1NamespacedRoleBindingListParams {
...
func (o *WatchRbacAuthorizationV1alpha1NamespacedRoleBindingListParams) WithContinue(continueVar *string) *WatchRbacAuthorizationV1alpha1NamespacedRoleBindingListParams {
...
func (o *WatchRbacAuthorizationV1alpha1NamespacedRoleBindingListParams) SetContinue(continueVar *string) {
...
func (o *WatchRbacAuthorizationV1alpha1NamespacedRoleBindingListParams) WithFieldSelector(fieldSelector *string) *WatchRbacAuthorizationV1alpha1NamespacedRoleBindingListParams {
...
func (o *WatchRbacAuthorizationV1alpha1NamespacedRoleBindingListParams) WithLabelSelector(labelSelector *string) *WatchRbacAuthorizationV1alpha1NamespacedRoleBindingListParams {
...
func (o *WatchRbacAuthorizationV1alpha1NamespacedRoleBindingListParams) WithLimit(limit *int64) *WatchRbacAuthorizationV1alpha1NamespacedRoleBindingListParams {
	o.SetLimit(limit)
	return o
}

// SetLimit adds the limit to the watch rbac authorization v1alpha1 namespaced role binding list params
func (o *WatchRbacAuthorizationV1alpha1NamespacedRoleBindingListParams) SetLimit(limit *int64) {
	o.Limit = limit
}

// WithNamespace adds the namespace to the watch rbac authorization v1alpha1 namespaced role binding list params
func (o *WatchRbacAuthorizationV1alpha1NamespacedRoleBindingListParams) WithNamespace(namespace string) *WatchRbacAuthorizationV1alpha1NamespacedRoleBindingListParams {
	o.SetNamespace(namespace)
	return o
}

// SetNamespace adds the namespace to the watch rbac authorization v1alpha1 namespaced role binding list params
func (o *WatchRbacAuthorizationV1alpha1NamespacedRoleBindingListParams) SetNamespace(namespace string) {
	o.Namespace = namespace
}

// WithPretty adds the pretty to the watch rbac authorization v1alpha1 namespaced role binding list params
func (o *WatchRbacAuthorizationV1alpha1NamespacedRoleBindingListParams) WithPretty(pretty *string) *WatchRbacAuthorizationV1alpha1NamespacedRoleBindingListParams {
	o.SetPretty(pretty)
	return o
}

// SetPretty adds the pretty to the watch rbac authorization v1alpha1 namespaced role binding list params
func (o *WatchRbacAuthorizationV1alpha1NamespacedRoleBindingListParams) SetPretty(pretty *string) {
	o.Pretty = pretty
}
...
func (o *WatchRbacAuthorizationV1alpha1NamespacedRoleBindingListParams) WithResourceVersion(resourceVersion *string) *WatchRbacAuthorizationV1alpha1NamespacedRoleBindingListParams {
...
func (o *WatchRbacAuthorizationV1alpha1NamespacedRoleBindingListParams) WithResourceVersionMatch(resourceVersionMatch *string) *WatchRbacAuthorizationV1alpha1NamespacedRoleBindingListParams {
...
func (o *WatchRbacAuthorizationV1alpha1NamespacedRoleBindingListParams) WithTimeoutSeconds(timeoutSeconds *int64) *WatchRbacAuthorizationV1alpha1NamespacedRoleBindingListParams {
...
func (o *WatchRbacAuthorizationV1alpha1NamespacedRoleBindingListParams) WithWatch(watch *bool) *WatchRbacAuthorizationV1alpha1NamespacedRoleBindingListParams {
	o.SetWatch(watch)
	return o
}

// SetWatch adds the watch to the watch rbac authorization v1alpha1 namespaced role binding list params
func (o *WatchRbacAuthorizationV1alpha1NamespacedRoleBindingListParams) SetWatch(watch *bool) {
	o.Watch = watch
}

// WriteToRequest writes these params to a swagger request
func (o *WatchRbacAuthorizationV1alpha1NamespacedRoleBindingListParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {

...
// NewListRbacAuthorizationV1alpha1NamespacedRoleBindingParamsWithTimeout creates a new ListRbacAuthorizationV1alpha1NamespacedRoleBindingParams object
...
// NewListRbacAuthorizationV1alpha1NamespacedRoleBindingParamsWithContext creates a new ListRbacAuthorizationV1alpha1NamespacedRoleBindingParams object
...
// NewListRbacAuthorizationV1alpha1NamespacedRoleBindingParamsWithHTTPClient creates a new ListRbacAuthorizationV1alpha1NamespacedRoleBindingParams object
...
/*ListRbacAuthorizationV1alpha1NamespacedRoleBindingParams contains all the parameters to send to the API endpoint
for the list rbac authorization v1alpha1 namespaced role binding operation typically these are written to a http.Request
*/
...
func (o *ListRbacAuthorizationV1alpha1NamespacedRoleBindingParams) WithTimeout(timeout time.Duration) *ListRbacAuthorizationV1alpha1NamespacedRoleBindingParams {
	o.SetTimeout(timeout)
	return o
}

// SetTimeout adds the timeout to the list rbac authorization v1alpha1 namespaced role binding params
func (o *ListRbacAuthorizationV1alpha1NamespacedRoleBindingParams) SetTimeout(timeout time.Duration) {
	o.timeout = timeout
}

// WithContext adds the context to the list rbac authorization v1alpha1 namespaced role binding params
func (o *ListRbacAuthorizationV1alpha1NamespacedRoleBindingParams) WithContext(ctx context.Context) *ListRbacAuthorizationV1alpha1NamespacedRoleBindingParams {
	o.SetContext(ctx)
	return o
}

// SetContext adds the context to the list rbac authorization v1alpha1 namespaced role binding params
func (o *ListRbacAuthorizationV1alpha1NamespacedRoleBindingParams) SetContext(ctx context.Context) {
	o.Context = ctx
}

// WithHTTPClient adds the HTTPClient to the list rbac authorization v1alpha1 namespaced role binding params
func (o *ListRbacAuthorizationV1alpha1NamespacedRoleBindingParams) WithHTTPClient(client *http.Client) *ListRbacAuthorizationV1alpha1NamespacedRoleBindingParams {
	o.SetHTTPClient(client)
	return o
}

// SetHTTPClient adds the HTTPClient to the list rbac authorization v1alpha1 namespaced role binding params
func (o *ListRbacAuthorizationV1alpha1NamespacedRoleBindingParams) SetHTTPClient(client *http.Client) {
	o.HTTPClient = client
}
...
func (o *ListRbacAuthorizationV1alpha1NamespacedRoleBindingParams) WithAllowWatchBookmarks(allowWatchBookmarks *bool) *ListRbacAuthorizationV1alpha1NamespacedRoleBindingParams {
...
func (o *ListRbacAuthorizationV1alpha1NamespacedRoleBindingParams) WithContinue(continueVar *string) *ListRbacAuthorizationV1alpha1NamespacedRoleBindingParams {
...
func (o *ListRbacAuthorizationV1alpha1NamespacedRoleBindingParams) SetContinue(continueVar *string) {
...
func (o *ListRbacAuthorizationV1alpha1NamespacedRoleBindingParams) WithFieldSelector(fieldSelector *string) *ListRbacAuthorizationV1alpha1NamespacedRoleBindingParams {
...
func (o *ListRbacAuthorizationV1alpha1NamespacedRoleBindingParams) WithLabelSelector(labelSelector *string) *ListRbacAuthorizationV1alpha1NamespacedRoleBindingParams {
...
func (o *ListRbacAuthorizationV1alpha1NamespacedRoleBindingParams) WithLimit(limit *int64) *ListRbacAuthorizationV1alpha1NamespacedRoleBindingParams {
	o.SetLimit(limit)
	return o
}

// SetLimit adds the limit to the list rbac authorization v1alpha1 namespaced role binding params
func (o *ListRbacAuthorizationV1alpha1NamespacedRoleBindingParams) SetLimit(limit *int64) {
	o.Limit = limit
}

// WithNamespace adds the namespace to the list rbac authorization v1alpha1 namespaced role binding params
func (o *ListRbacAuthorizationV1alpha1NamespacedRoleBindingParams) WithNamespace(namespace string) *ListRbacAuthorizationV1alpha1NamespacedRoleBindingParams {
	o.SetNamespace(namespace)
	return o
}

// SetNamespace adds the namespace to the list rbac authorization v1alpha1 namespaced role binding params
func (o *ListRbacAuthorizationV1alpha1NamespacedRoleBindingParams) SetNamespace(namespace string) {
	o.Namespace = namespace
}

// WithPretty adds the pretty to the list rbac authorization v1alpha1 namespaced role binding params
func (o *ListRbacAuthorizationV1alpha1NamespacedRoleBindingParams) WithPretty(pretty *string) *ListRbacAuthorizationV1alpha1NamespacedRoleBindingParams {
	o.SetPretty(pretty)
	return o
}

// SetPretty adds the pretty to the list rbac authorization v1alpha1 namespaced role binding params
func (o *ListRbacAuthorizationV1alpha1NamespacedRoleBindingParams) SetPretty(pretty *string) {
	o.Pretty = pretty
}

// WithResourceVersion adds the resourceVersion to the list rbac authorization v1alpha1 namespaced role binding params
func (o *ListRbacAuthorizationV1alpha1NamespacedRoleBindingParams) WithResourceVersion(resourceVersion *string) *ListRbacAuthorizationV1alpha1NamespacedRoleBindingParams {
...
func (o *ListRbacAuthorizationV1alpha1NamespacedRoleBindingParams) WithResourceVersionMatch(resourceVersionMatch *string) *ListRbacAuthorizationV1alpha1NamespacedRoleBindingParams {
...
func (o *ListRbacAuthorizationV1alpha1NamespacedRoleBindingParams) WithTimeoutSeconds(timeoutSeconds *int64) *ListRbacAuthorizationV1alpha1NamespacedRoleBindingParams {
...
func (o *ListRbacAuthorizationV1alpha1NamespacedRoleBindingParams) WithWatch(watch *bool) *ListRbacAuthorizationV1alpha1NamespacedRoleBindingParams {
	o.SetWatch(watch)
	return o
}

// SetWatch adds the watch to the list rbac authorization v1alpha1 namespaced role binding params
func (o *ListRbacAuthorizationV1alpha1NamespacedRoleBindingParams) SetWatch(watch *bool) {
	o.Watch = watch
}

// WriteToRequest writes these params to a swagger request
func (o *ListRbacAuthorizationV1alpha1NamespacedRoleBindingParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {

...
// NewListRbacAuthorizationV1alpha1ClusterRoleParamsWithTimeout creates a new ListRbacAuthorizationV1alpha1ClusterRoleParams object
...
// NewListRbacAuthorizationV1alpha1ClusterRoleParamsWithContext creates a new ListRbacAuthorizationV1alpha1ClusterRoleParams object
...
// NewListRbacAuthorizationV1alpha1ClusterRoleParamsWithHTTPClient creates a new ListRbacAuthorizationV1alpha1ClusterRoleParams object
...
/*ListRbacAuthorizationV1alpha1ClusterRoleParams contains all the parameters to send to the API endpoint
for the list rbac authorization v1alpha1 cluster role operation typically these are written to a http.Request
*/
...
func (o *ListRbacAuthorizationV1alpha1ClusterRoleParams) WithTimeout(timeout time.Duration) *ListRbacAuthorizationV1alpha1ClusterRoleParams {
	o.SetTimeout(timeout)
	return o
}

// SetTimeout adds the timeout to the list rbac authorization v1alpha1 cluster role params
func (o *ListRbacAuthorizationV1alpha1ClusterRoleParams) SetTimeout(timeout time.Duration) {
	o.timeout = timeout
}

// WithContext adds the context to the list rbac authorization v1alpha1 cluster role params
func (o *ListRbacAuthorizationV1alpha1ClusterRoleParams) WithContext(ctx context.Context) *ListRbacAuthorizationV1alpha1ClusterRoleParams {
	o.SetContext(ctx)
	return o
}

// SetContext adds the context to the list rbac authorization v1alpha1 cluster role params
func (o *ListRbacAuthorizationV1alpha1ClusterRoleParams) SetContext(ctx context.Context) {
	o.Context = ctx
}

// WithHTTPClient adds the HTTPClient to the list rbac authorization v1alpha1 cluster role params
func (o *ListRbacAuthorizationV1alpha1ClusterRoleParams) WithHTTPClient(client *http.Client) *ListRbacAuthorizationV1alpha1ClusterRoleParams {
	o.SetHTTPClient(client)
	return o
}

// SetHTTPClient adds the HTTPClient to the list rbac authorization v1alpha1 cluster role params
func (o *ListRbacAuthorizationV1alpha1ClusterRoleParams) SetHTTPClient(client *http.Client) {
	o.HTTPClient = client
}

// WithAllowWatchBookmarks adds the allowWatchBookmarks to the list rbac authorization v1alpha1 cluster role params
func (o *ListRbacAuthorizationV1alpha1ClusterRoleParams) WithAllowWatchBookmarks(allowWatchBookmarks *bool) *ListRbacAuthorizationV1alpha1ClusterRoleParams {
...
func (o *ListRbacAuthorizationV1alpha1ClusterRoleParams) WithContinue(continueVar *string) *ListRbacAuthorizationV1alpha1ClusterRoleParams {
...
func (o *ListRbacAuthorizationV1alpha1ClusterRoleParams) WithFieldSelector(fieldSelector *string) *ListRbacAuthorizationV1alpha1ClusterRoleParams {
...
func (o *ListRbacAuthorizationV1alpha1ClusterRoleParams) WithLabelSelector(labelSelector *string) *ListRbacAuthorizationV1alpha1ClusterRoleParams {
...
func (o *ListRbacAuthorizationV1alpha1ClusterRoleParams) WithLimit(limit *int64) *ListRbacAuthorizationV1alpha1ClusterRoleParams {
	o.SetLimit(limit)
	return o
}

// SetLimit adds the limit to the list rbac authorization v1alpha1 cluster role params
func (o *ListRbacAuthorizationV1alpha1ClusterRoleParams) SetLimit(limit *int64) {
	o.Limit = limit
}

// WithPretty adds the pretty to the list rbac authorization v1alpha1 cluster role params
func (o *ListRbacAuthorizationV1alpha1ClusterRoleParams) WithPretty(pretty *string) *ListRbacAuthorizationV1alpha1ClusterRoleParams {
	o.SetPretty(pretty)
	return o
}

// SetPretty adds the pretty to the list rbac authorization v1alpha1 cluster role params
func (o *ListRbacAuthorizationV1alpha1ClusterRoleParams) SetPretty(pretty *string) {
	o.Pretty = pretty
}

// WithResourceVersion adds the resourceVersion to the list rbac authorization v1alpha1 cluster role params
func (o *ListRbacAuthorizationV1alpha1ClusterRoleParams) WithResourceVersion(resourceVersion *string) *ListRbacAuthorizationV1alpha1ClusterRoleParams {
...
func (o *ListRbacAuthorizationV1alpha1ClusterRoleParams) WithResourceVersionMatch(resourceVersionMatch *string) *ListRbacAuthorizationV1alpha1ClusterRoleParams {
...
func (o *ListRbacAuthorizationV1alpha1ClusterRoleParams) WithTimeoutSeconds(timeoutSeconds *int64) *ListRbacAuthorizationV1alpha1ClusterRoleParams {
...
func (o *ListRbacAuthorizationV1alpha1ClusterRoleParams) WithWatch(watch *bool) *ListRbacAuthorizationV1alpha1ClusterRoleParams {
	o.SetWatch(watch)
	return o
}

// SetWatch adds the watch to the list rbac authorization v1alpha1 cluster role params
func (o *ListRbacAuthorizationV1alpha1ClusterRoleParams) SetWatch(watch *bool) {
	o.Watch = watch
}

// WriteToRequest writes these params to a swagger request
func (o *ListRbacAuthorizationV1alpha1ClusterRoleParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {

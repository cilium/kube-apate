...
// NewWatchRbacAuthorizationV1alpha1RoleBindingListForAllNamespacesParamsWithTimeout creates a new WatchRbacAuthorizationV1alpha1RoleBindingListForAllNamespacesParams object
...
// NewWatchRbacAuthorizationV1alpha1RoleBindingListForAllNamespacesParamsWithContext creates a new WatchRbacAuthorizationV1alpha1RoleBindingListForAllNamespacesParams object
...
// NewWatchRbacAuthorizationV1alpha1RoleBindingListForAllNamespacesParamsWithHTTPClient creates a new WatchRbacAuthorizationV1alpha1RoleBindingListForAllNamespacesParams object
...
/*WatchRbacAuthorizationV1alpha1RoleBindingListForAllNamespacesParams contains all the parameters to send to the API endpoint
for the watch rbac authorization v1alpha1 role binding list for all namespaces operation typically these are written to a http.Request
*/
...
func (o *WatchRbacAuthorizationV1alpha1RoleBindingListForAllNamespacesParams) WithTimeout(timeout time.Duration) *WatchRbacAuthorizationV1alpha1RoleBindingListForAllNamespacesParams {
	o.SetTimeout(timeout)
	return o
}

// SetTimeout adds the timeout to the watch rbac authorization v1alpha1 role binding list for all namespaces params
func (o *WatchRbacAuthorizationV1alpha1RoleBindingListForAllNamespacesParams) SetTimeout(timeout time.Duration) {
	o.timeout = timeout
}

// WithContext adds the context to the watch rbac authorization v1alpha1 role binding list for all namespaces params
func (o *WatchRbacAuthorizationV1alpha1RoleBindingListForAllNamespacesParams) WithContext(ctx context.Context) *WatchRbacAuthorizationV1alpha1RoleBindingListForAllNamespacesParams {
	o.SetContext(ctx)
	return o
}

// SetContext adds the context to the watch rbac authorization v1alpha1 role binding list for all namespaces params
func (o *WatchRbacAuthorizationV1alpha1RoleBindingListForAllNamespacesParams) SetContext(ctx context.Context) {
	o.Context = ctx
}

// WithHTTPClient adds the HTTPClient to the watch rbac authorization v1alpha1 role binding list for all namespaces params
func (o *WatchRbacAuthorizationV1alpha1RoleBindingListForAllNamespacesParams) WithHTTPClient(client *http.Client) *WatchRbacAuthorizationV1alpha1RoleBindingListForAllNamespacesParams {
...
func (o *WatchRbacAuthorizationV1alpha1RoleBindingListForAllNamespacesParams) SetHTTPClient(client *http.Client) {
	o.HTTPClient = client
}
...
func (o *WatchRbacAuthorizationV1alpha1RoleBindingListForAllNamespacesParams) WithAllowWatchBookmarks(allowWatchBookmarks *bool) *WatchRbacAuthorizationV1alpha1RoleBindingListForAllNamespacesParams {
...
func (o *WatchRbacAuthorizationV1alpha1RoleBindingListForAllNamespacesParams) WithContinue(continueVar *string) *WatchRbacAuthorizationV1alpha1RoleBindingListForAllNamespacesParams {
...
func (o *WatchRbacAuthorizationV1alpha1RoleBindingListForAllNamespacesParams) SetContinue(continueVar *string) {
...
func (o *WatchRbacAuthorizationV1alpha1RoleBindingListForAllNamespacesParams) WithFieldSelector(fieldSelector *string) *WatchRbacAuthorizationV1alpha1RoleBindingListForAllNamespacesParams {
...
func (o *WatchRbacAuthorizationV1alpha1RoleBindingListForAllNamespacesParams) SetFieldSelector(fieldSelector *string) {
...
func (o *WatchRbacAuthorizationV1alpha1RoleBindingListForAllNamespacesParams) WithLabelSelector(labelSelector *string) *WatchRbacAuthorizationV1alpha1RoleBindingListForAllNamespacesParams {
...
func (o *WatchRbacAuthorizationV1alpha1RoleBindingListForAllNamespacesParams) SetLabelSelector(labelSelector *string) {
	o.LabelSelector = labelSelector
}

// WithLimit adds the limit to the watch rbac authorization v1alpha1 role binding list for all namespaces params
func (o *WatchRbacAuthorizationV1alpha1RoleBindingListForAllNamespacesParams) WithLimit(limit *int64) *WatchRbacAuthorizationV1alpha1RoleBindingListForAllNamespacesParams {
	o.SetLimit(limit)
	return o
}

// SetLimit adds the limit to the watch rbac authorization v1alpha1 role binding list for all namespaces params
func (o *WatchRbacAuthorizationV1alpha1RoleBindingListForAllNamespacesParams) SetLimit(limit *int64) {
	o.Limit = limit
}

// WithPretty adds the pretty to the watch rbac authorization v1alpha1 role binding list for all namespaces params
func (o *WatchRbacAuthorizationV1alpha1RoleBindingListForAllNamespacesParams) WithPretty(pretty *string) *WatchRbacAuthorizationV1alpha1RoleBindingListForAllNamespacesParams {
	o.SetPretty(pretty)
	return o
}

// SetPretty adds the pretty to the watch rbac authorization v1alpha1 role binding list for all namespaces params
func (o *WatchRbacAuthorizationV1alpha1RoleBindingListForAllNamespacesParams) SetPretty(pretty *string) {
	o.Pretty = pretty
}
...
func (o *WatchRbacAuthorizationV1alpha1RoleBindingListForAllNamespacesParams) WithResourceVersion(resourceVersion *string) *WatchRbacAuthorizationV1alpha1RoleBindingListForAllNamespacesParams {
...
func (o *WatchRbacAuthorizationV1alpha1RoleBindingListForAllNamespacesParams) WithResourceVersionMatch(resourceVersionMatch *string) *WatchRbacAuthorizationV1alpha1RoleBindingListForAllNamespacesParams {
...
func (o *WatchRbacAuthorizationV1alpha1RoleBindingListForAllNamespacesParams) WithTimeoutSeconds(timeoutSeconds *int64) *WatchRbacAuthorizationV1alpha1RoleBindingListForAllNamespacesParams {
...
func (o *WatchRbacAuthorizationV1alpha1RoleBindingListForAllNamespacesParams) WithWatch(watch *bool) *WatchRbacAuthorizationV1alpha1RoleBindingListForAllNamespacesParams {
	o.SetWatch(watch)
	return o
}

// SetWatch adds the watch to the watch rbac authorization v1alpha1 role binding list for all namespaces params
func (o *WatchRbacAuthorizationV1alpha1RoleBindingListForAllNamespacesParams) SetWatch(watch *bool) {
	o.Watch = watch
}

// WriteToRequest writes these params to a swagger request
func (o *WatchRbacAuthorizationV1alpha1RoleBindingListForAllNamespacesParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {

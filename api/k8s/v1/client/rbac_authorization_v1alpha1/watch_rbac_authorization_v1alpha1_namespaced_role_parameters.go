...
// NewWatchRbacAuthorizationV1alpha1NamespacedRoleParamsWithTimeout creates a new WatchRbacAuthorizationV1alpha1NamespacedRoleParams object
...
// NewWatchRbacAuthorizationV1alpha1NamespacedRoleParamsWithContext creates a new WatchRbacAuthorizationV1alpha1NamespacedRoleParams object
...
// NewWatchRbacAuthorizationV1alpha1NamespacedRoleParamsWithHTTPClient creates a new WatchRbacAuthorizationV1alpha1NamespacedRoleParams object
...
/*WatchRbacAuthorizationV1alpha1NamespacedRoleParams contains all the parameters to send to the API endpoint
for the watch rbac authorization v1alpha1 namespaced role operation typically these are written to a http.Request
*/
...
func (o *WatchRbacAuthorizationV1alpha1NamespacedRoleParams) WithTimeout(timeout time.Duration) *WatchRbacAuthorizationV1alpha1NamespacedRoleParams {
	o.SetTimeout(timeout)
	return o
}

// SetTimeout adds the timeout to the watch rbac authorization v1alpha1 namespaced role params
func (o *WatchRbacAuthorizationV1alpha1NamespacedRoleParams) SetTimeout(timeout time.Duration) {
	o.timeout = timeout
}

// WithContext adds the context to the watch rbac authorization v1alpha1 namespaced role params
func (o *WatchRbacAuthorizationV1alpha1NamespacedRoleParams) WithContext(ctx context.Context) *WatchRbacAuthorizationV1alpha1NamespacedRoleParams {
	o.SetContext(ctx)
	return o
}

// SetContext adds the context to the watch rbac authorization v1alpha1 namespaced role params
func (o *WatchRbacAuthorizationV1alpha1NamespacedRoleParams) SetContext(ctx context.Context) {
	o.Context = ctx
}

// WithHTTPClient adds the HTTPClient to the watch rbac authorization v1alpha1 namespaced role params
func (o *WatchRbacAuthorizationV1alpha1NamespacedRoleParams) WithHTTPClient(client *http.Client) *WatchRbacAuthorizationV1alpha1NamespacedRoleParams {
	o.SetHTTPClient(client)
	return o
}

// SetHTTPClient adds the HTTPClient to the watch rbac authorization v1alpha1 namespaced role params
func (o *WatchRbacAuthorizationV1alpha1NamespacedRoleParams) SetHTTPClient(client *http.Client) {
	o.HTTPClient = client
}

// WithAllowWatchBookmarks adds the allowWatchBookmarks to the watch rbac authorization v1alpha1 namespaced role params
func (o *WatchRbacAuthorizationV1alpha1NamespacedRoleParams) WithAllowWatchBookmarks(allowWatchBookmarks *bool) *WatchRbacAuthorizationV1alpha1NamespacedRoleParams {
...
func (o *WatchRbacAuthorizationV1alpha1NamespacedRoleParams) WithContinue(continueVar *string) *WatchRbacAuthorizationV1alpha1NamespacedRoleParams {
...
func (o *WatchRbacAuthorizationV1alpha1NamespacedRoleParams) WithFieldSelector(fieldSelector *string) *WatchRbacAuthorizationV1alpha1NamespacedRoleParams {
...
func (o *WatchRbacAuthorizationV1alpha1NamespacedRoleParams) WithLabelSelector(labelSelector *string) *WatchRbacAuthorizationV1alpha1NamespacedRoleParams {
...
func (o *WatchRbacAuthorizationV1alpha1NamespacedRoleParams) WithLimit(limit *int64) *WatchRbacAuthorizationV1alpha1NamespacedRoleParams {
	o.SetLimit(limit)
	return o
}

// SetLimit adds the limit to the watch rbac authorization v1alpha1 namespaced role params
func (o *WatchRbacAuthorizationV1alpha1NamespacedRoleParams) SetLimit(limit *int64) {
	o.Limit = limit
}

// WithName adds the name to the watch rbac authorization v1alpha1 namespaced role params
func (o *WatchRbacAuthorizationV1alpha1NamespacedRoleParams) WithName(name string) *WatchRbacAuthorizationV1alpha1NamespacedRoleParams {
	o.SetName(name)
	return o
}

// SetName adds the name to the watch rbac authorization v1alpha1 namespaced role params
func (o *WatchRbacAuthorizationV1alpha1NamespacedRoleParams) SetName(name string) {
	o.Name = name
}

// WithNamespace adds the namespace to the watch rbac authorization v1alpha1 namespaced role params
func (o *WatchRbacAuthorizationV1alpha1NamespacedRoleParams) WithNamespace(namespace string) *WatchRbacAuthorizationV1alpha1NamespacedRoleParams {
	o.SetNamespace(namespace)
	return o
}

// SetNamespace adds the namespace to the watch rbac authorization v1alpha1 namespaced role params
func (o *WatchRbacAuthorizationV1alpha1NamespacedRoleParams) SetNamespace(namespace string) {
	o.Namespace = namespace
}

// WithPretty adds the pretty to the watch rbac authorization v1alpha1 namespaced role params
func (o *WatchRbacAuthorizationV1alpha1NamespacedRoleParams) WithPretty(pretty *string) *WatchRbacAuthorizationV1alpha1NamespacedRoleParams {
	o.SetPretty(pretty)
	return o
}

// SetPretty adds the pretty to the watch rbac authorization v1alpha1 namespaced role params
func (o *WatchRbacAuthorizationV1alpha1NamespacedRoleParams) SetPretty(pretty *string) {
	o.Pretty = pretty
}

// WithResourceVersion adds the resourceVersion to the watch rbac authorization v1alpha1 namespaced role params
func (o *WatchRbacAuthorizationV1alpha1NamespacedRoleParams) WithResourceVersion(resourceVersion *string) *WatchRbacAuthorizationV1alpha1NamespacedRoleParams {
...
func (o *WatchRbacAuthorizationV1alpha1NamespacedRoleParams) WithResourceVersionMatch(resourceVersionMatch *string) *WatchRbacAuthorizationV1alpha1NamespacedRoleParams {
...
func (o *WatchRbacAuthorizationV1alpha1NamespacedRoleParams) WithTimeoutSeconds(timeoutSeconds *int64) *WatchRbacAuthorizationV1alpha1NamespacedRoleParams {
...
func (o *WatchRbacAuthorizationV1alpha1NamespacedRoleParams) WithWatch(watch *bool) *WatchRbacAuthorizationV1alpha1NamespacedRoleParams {
	o.SetWatch(watch)
	return o
}

// SetWatch adds the watch to the watch rbac authorization v1alpha1 namespaced role params
func (o *WatchRbacAuthorizationV1alpha1NamespacedRoleParams) SetWatch(watch *bool) {
	o.Watch = watch
}

// WriteToRequest writes these params to a swagger request
func (o *WatchRbacAuthorizationV1alpha1NamespacedRoleParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {

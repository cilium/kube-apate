...
// NewDeleteRbacAuthorizationV1alpha1NamespacedRoleBindingParamsWithTimeout creates a new DeleteRbacAuthorizationV1alpha1NamespacedRoleBindingParams object
...
// NewDeleteRbacAuthorizationV1alpha1NamespacedRoleBindingParamsWithContext creates a new DeleteRbacAuthorizationV1alpha1NamespacedRoleBindingParams object
...
// NewDeleteRbacAuthorizationV1alpha1NamespacedRoleBindingParamsWithHTTPClient creates a new DeleteRbacAuthorizationV1alpha1NamespacedRoleBindingParams object
...
/*DeleteRbacAuthorizationV1alpha1NamespacedRoleBindingParams contains all the parameters to send to the API endpoint
for the delete rbac authorization v1alpha1 namespaced role binding operation typically these are written to a http.Request
*/
...
func (o *DeleteRbacAuthorizationV1alpha1NamespacedRoleBindingParams) WithTimeout(timeout time.Duration) *DeleteRbacAuthorizationV1alpha1NamespacedRoleBindingParams {
	o.SetTimeout(timeout)
	return o
}

// SetTimeout adds the timeout to the delete rbac authorization v1alpha1 namespaced role binding params
func (o *DeleteRbacAuthorizationV1alpha1NamespacedRoleBindingParams) SetTimeout(timeout time.Duration) {
	o.timeout = timeout
}

// WithContext adds the context to the delete rbac authorization v1alpha1 namespaced role binding params
func (o *DeleteRbacAuthorizationV1alpha1NamespacedRoleBindingParams) WithContext(ctx context.Context) *DeleteRbacAuthorizationV1alpha1NamespacedRoleBindingParams {
	o.SetContext(ctx)
	return o
}

// SetContext adds the context to the delete rbac authorization v1alpha1 namespaced role binding params
func (o *DeleteRbacAuthorizationV1alpha1NamespacedRoleBindingParams) SetContext(ctx context.Context) {
	o.Context = ctx
}

// WithHTTPClient adds the HTTPClient to the delete rbac authorization v1alpha1 namespaced role binding params
func (o *DeleteRbacAuthorizationV1alpha1NamespacedRoleBindingParams) WithHTTPClient(client *http.Client) *DeleteRbacAuthorizationV1alpha1NamespacedRoleBindingParams {
	o.SetHTTPClient(client)
	return o
}

// SetHTTPClient adds the HTTPClient to the delete rbac authorization v1alpha1 namespaced role binding params
func (o *DeleteRbacAuthorizationV1alpha1NamespacedRoleBindingParams) SetHTTPClient(client *http.Client) {
	o.HTTPClient = client
}

// WithBody adds the body to the delete rbac authorization v1alpha1 namespaced role binding params
func (o *DeleteRbacAuthorizationV1alpha1NamespacedRoleBindingParams) WithBody(body *models.IoK8sApimachineryPkgApisMetaV1DeleteOptions) *DeleteRbacAuthorizationV1alpha1NamespacedRoleBindingParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the delete rbac authorization v1alpha1 namespaced role binding params
func (o *DeleteRbacAuthorizationV1alpha1NamespacedRoleBindingParams) SetBody(body *models.IoK8sApimachineryPkgApisMetaV1DeleteOptions) {
	o.Body = body
}

// WithDryRun adds the dryRun to the delete rbac authorization v1alpha1 namespaced role binding params
func (o *DeleteRbacAuthorizationV1alpha1NamespacedRoleBindingParams) WithDryRun(dryRun *string) *DeleteRbacAuthorizationV1alpha1NamespacedRoleBindingParams {
	o.SetDryRun(dryRun)
	return o
}

// SetDryRun adds the dryRun to the delete rbac authorization v1alpha1 namespaced role binding params
func (o *DeleteRbacAuthorizationV1alpha1NamespacedRoleBindingParams) SetDryRun(dryRun *string) {
	o.DryRun = dryRun
}
...
func (o *DeleteRbacAuthorizationV1alpha1NamespacedRoleBindingParams) WithGracePeriodSeconds(gracePeriodSeconds *int64) *DeleteRbacAuthorizationV1alpha1NamespacedRoleBindingParams {
...
func (o *DeleteRbacAuthorizationV1alpha1NamespacedRoleBindingParams) WithName(name string) *DeleteRbacAuthorizationV1alpha1NamespacedRoleBindingParams {
	o.SetName(name)
	return o
}

// SetName adds the name to the delete rbac authorization v1alpha1 namespaced role binding params
func (o *DeleteRbacAuthorizationV1alpha1NamespacedRoleBindingParams) SetName(name string) {
	o.Name = name
}

// WithNamespace adds the namespace to the delete rbac authorization v1alpha1 namespaced role binding params
func (o *DeleteRbacAuthorizationV1alpha1NamespacedRoleBindingParams) WithNamespace(namespace string) *DeleteRbacAuthorizationV1alpha1NamespacedRoleBindingParams {
	o.SetNamespace(namespace)
	return o
}

// SetNamespace adds the namespace to the delete rbac authorization v1alpha1 namespaced role binding params
func (o *DeleteRbacAuthorizationV1alpha1NamespacedRoleBindingParams) SetNamespace(namespace string) {
...
func (o *DeleteRbacAuthorizationV1alpha1NamespacedRoleBindingParams) WithOrphanDependents(orphanDependents *bool) *DeleteRbacAuthorizationV1alpha1NamespacedRoleBindingParams {
...
func (o *DeleteRbacAuthorizationV1alpha1NamespacedRoleBindingParams) WithPretty(pretty *string) *DeleteRbacAuthorizationV1alpha1NamespacedRoleBindingParams {
	o.SetPretty(pretty)
	return o
}

// SetPretty adds the pretty to the delete rbac authorization v1alpha1 namespaced role binding params
func (o *DeleteRbacAuthorizationV1alpha1NamespacedRoleBindingParams) SetPretty(pretty *string) {
	o.Pretty = pretty
}
...
func (o *DeleteRbacAuthorizationV1alpha1NamespacedRoleBindingParams) WithPropagationPolicy(propagationPolicy *string) *DeleteRbacAuthorizationV1alpha1NamespacedRoleBindingParams {
...
func (o *DeleteRbacAuthorizationV1alpha1NamespacedRoleBindingParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {

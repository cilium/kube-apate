...
// NewListRbacAuthorizationV1alpha1RoleForAllNamespacesParamsWithTimeout creates a new ListRbacAuthorizationV1alpha1RoleForAllNamespacesParams object
...
// NewListRbacAuthorizationV1alpha1RoleForAllNamespacesParamsWithContext creates a new ListRbacAuthorizationV1alpha1RoleForAllNamespacesParams object
...
// NewListRbacAuthorizationV1alpha1RoleForAllNamespacesParamsWithHTTPClient creates a new ListRbacAuthorizationV1alpha1RoleForAllNamespacesParams object
...
/*ListRbacAuthorizationV1alpha1RoleForAllNamespacesParams contains all the parameters to send to the API endpoint
for the list rbac authorization v1alpha1 role for all namespaces operation typically these are written to a http.Request
*/
...
func (o *ListRbacAuthorizationV1alpha1RoleForAllNamespacesParams) WithTimeout(timeout time.Duration) *ListRbacAuthorizationV1alpha1RoleForAllNamespacesParams {
	o.SetTimeout(timeout)
	return o
}

// SetTimeout adds the timeout to the list rbac authorization v1alpha1 role for all namespaces params
func (o *ListRbacAuthorizationV1alpha1RoleForAllNamespacesParams) SetTimeout(timeout time.Duration) {
	o.timeout = timeout
}

// WithContext adds the context to the list rbac authorization v1alpha1 role for all namespaces params
func (o *ListRbacAuthorizationV1alpha1RoleForAllNamespacesParams) WithContext(ctx context.Context) *ListRbacAuthorizationV1alpha1RoleForAllNamespacesParams {
	o.SetContext(ctx)
	return o
}

// SetContext adds the context to the list rbac authorization v1alpha1 role for all namespaces params
func (o *ListRbacAuthorizationV1alpha1RoleForAllNamespacesParams) SetContext(ctx context.Context) {
	o.Context = ctx
}

// WithHTTPClient adds the HTTPClient to the list rbac authorization v1alpha1 role for all namespaces params
func (o *ListRbacAuthorizationV1alpha1RoleForAllNamespacesParams) WithHTTPClient(client *http.Client) *ListRbacAuthorizationV1alpha1RoleForAllNamespacesParams {
	o.SetHTTPClient(client)
	return o
}

// SetHTTPClient adds the HTTPClient to the list rbac authorization v1alpha1 role for all namespaces params
func (o *ListRbacAuthorizationV1alpha1RoleForAllNamespacesParams) SetHTTPClient(client *http.Client) {
	o.HTTPClient = client
}
...
func (o *ListRbacAuthorizationV1alpha1RoleForAllNamespacesParams) WithAllowWatchBookmarks(allowWatchBookmarks *bool) *ListRbacAuthorizationV1alpha1RoleForAllNamespacesParams {
...
func (o *ListRbacAuthorizationV1alpha1RoleForAllNamespacesParams) WithContinue(continueVar *string) *ListRbacAuthorizationV1alpha1RoleForAllNamespacesParams {
...
func (o *ListRbacAuthorizationV1alpha1RoleForAllNamespacesParams) SetContinue(continueVar *string) {
...
func (o *ListRbacAuthorizationV1alpha1RoleForAllNamespacesParams) WithFieldSelector(fieldSelector *string) *ListRbacAuthorizationV1alpha1RoleForAllNamespacesParams {
...
func (o *ListRbacAuthorizationV1alpha1RoleForAllNamespacesParams) WithLabelSelector(labelSelector *string) *ListRbacAuthorizationV1alpha1RoleForAllNamespacesParams {
...
func (o *ListRbacAuthorizationV1alpha1RoleForAllNamespacesParams) WithLimit(limit *int64) *ListRbacAuthorizationV1alpha1RoleForAllNamespacesParams {
	o.SetLimit(limit)
	return o
}

// SetLimit adds the limit to the list rbac authorization v1alpha1 role for all namespaces params
func (o *ListRbacAuthorizationV1alpha1RoleForAllNamespacesParams) SetLimit(limit *int64) {
	o.Limit = limit
}

// WithPretty adds the pretty to the list rbac authorization v1alpha1 role for all namespaces params
func (o *ListRbacAuthorizationV1alpha1RoleForAllNamespacesParams) WithPretty(pretty *string) *ListRbacAuthorizationV1alpha1RoleForAllNamespacesParams {
	o.SetPretty(pretty)
	return o
}

// SetPretty adds the pretty to the list rbac authorization v1alpha1 role for all namespaces params
func (o *ListRbacAuthorizationV1alpha1RoleForAllNamespacesParams) SetPretty(pretty *string) {
	o.Pretty = pretty
}

// WithResourceVersion adds the resourceVersion to the list rbac authorization v1alpha1 role for all namespaces params
func (o *ListRbacAuthorizationV1alpha1RoleForAllNamespacesParams) WithResourceVersion(resourceVersion *string) *ListRbacAuthorizationV1alpha1RoleForAllNamespacesParams {
...
func (o *ListRbacAuthorizationV1alpha1RoleForAllNamespacesParams) WithResourceVersionMatch(resourceVersionMatch *string) *ListRbacAuthorizationV1alpha1RoleForAllNamespacesParams {
...
func (o *ListRbacAuthorizationV1alpha1RoleForAllNamespacesParams) WithTimeoutSeconds(timeoutSeconds *int64) *ListRbacAuthorizationV1alpha1RoleForAllNamespacesParams {
...
func (o *ListRbacAuthorizationV1alpha1RoleForAllNamespacesParams) WithWatch(watch *bool) *ListRbacAuthorizationV1alpha1RoleForAllNamespacesParams {
	o.SetWatch(watch)
	return o
}

// SetWatch adds the watch to the list rbac authorization v1alpha1 role for all namespaces params
func (o *ListRbacAuthorizationV1alpha1RoleForAllNamespacesParams) SetWatch(watch *bool) {
	o.Watch = watch
}

// WriteToRequest writes these params to a swagger request
func (o *ListRbacAuthorizationV1alpha1RoleForAllNamespacesParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {

...
func (o *WatchRbacAuthorizationV1alpha1NamespacedRoleListReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewWatchRbacAuthorizationV1alpha1NamespacedRoleListOK()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return result, nil
	case 401:
		result := NewWatchRbacAuthorizationV1alpha1NamespacedRoleListUnauthorized()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
func (o *WatchRbacAuthorizationV1alpha1NamespacedRoleListOK) Error() string {
	return fmt.Sprintf("[GET /apis/rbac.authorization.k8s.io/v1alpha1/watch/namespaces/{namespace}/roles][%d] watchRbacAuthorizationV1alpha1NamespacedRoleListOK  %+v", 200, o.Payload)
}

func (o *WatchRbacAuthorizationV1alpha1NamespacedRoleListOK) GetPayload() *models.IoK8sApimachineryPkgApisMetaV1WatchEvent {
	return o.Payload
}

func (o *WatchRbacAuthorizationV1alpha1NamespacedRoleListOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
...
func (o *WatchRbacAuthorizationV1alpha1NamespacedRoleListUnauthorized) Error() string {
	return fmt.Sprintf("[GET /apis/rbac.authorization.k8s.io/v1alpha1/watch/namespaces/{namespace}/roles][%d] watchRbacAuthorizationV1alpha1NamespacedRoleListUnauthorized ", 401)
}

func (o *WatchRbacAuthorizationV1alpha1NamespacedRoleListUnauthorized) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {

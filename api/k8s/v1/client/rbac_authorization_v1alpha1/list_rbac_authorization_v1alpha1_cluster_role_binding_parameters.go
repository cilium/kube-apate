...
// NewListRbacAuthorizationV1alpha1ClusterRoleBindingParamsWithTimeout creates a new ListRbacAuthorizationV1alpha1ClusterRoleBindingParams object
...
// NewListRbacAuthorizationV1alpha1ClusterRoleBindingParamsWithContext creates a new ListRbacAuthorizationV1alpha1ClusterRoleBindingParams object
...
// NewListRbacAuthorizationV1alpha1ClusterRoleBindingParamsWithHTTPClient creates a new ListRbacAuthorizationV1alpha1ClusterRoleBindingParams object
...
/*ListRbacAuthorizationV1alpha1ClusterRoleBindingParams contains all the parameters to send to the API endpoint
for the list rbac authorization v1alpha1 cluster role binding operation typically these are written to a http.Request
*/
...
func (o *ListRbacAuthorizationV1alpha1ClusterRoleBindingParams) WithTimeout(timeout time.Duration) *ListRbacAuthorizationV1alpha1ClusterRoleBindingParams {
	o.SetTimeout(timeout)
	return o
}

// SetTimeout adds the timeout to the list rbac authorization v1alpha1 cluster role binding params
func (o *ListRbacAuthorizationV1alpha1ClusterRoleBindingParams) SetTimeout(timeout time.Duration) {
	o.timeout = timeout
}

// WithContext adds the context to the list rbac authorization v1alpha1 cluster role binding params
func (o *ListRbacAuthorizationV1alpha1ClusterRoleBindingParams) WithContext(ctx context.Context) *ListRbacAuthorizationV1alpha1ClusterRoleBindingParams {
	o.SetContext(ctx)
	return o
}

// SetContext adds the context to the list rbac authorization v1alpha1 cluster role binding params
func (o *ListRbacAuthorizationV1alpha1ClusterRoleBindingParams) SetContext(ctx context.Context) {
	o.Context = ctx
}

// WithHTTPClient adds the HTTPClient to the list rbac authorization v1alpha1 cluster role binding params
func (o *ListRbacAuthorizationV1alpha1ClusterRoleBindingParams) WithHTTPClient(client *http.Client) *ListRbacAuthorizationV1alpha1ClusterRoleBindingParams {
	o.SetHTTPClient(client)
	return o
}

// SetHTTPClient adds the HTTPClient to the list rbac authorization v1alpha1 cluster role binding params
func (o *ListRbacAuthorizationV1alpha1ClusterRoleBindingParams) SetHTTPClient(client *http.Client) {
	o.HTTPClient = client
}

// WithAllowWatchBookmarks adds the allowWatchBookmarks to the list rbac authorization v1alpha1 cluster role binding params
func (o *ListRbacAuthorizationV1alpha1ClusterRoleBindingParams) WithAllowWatchBookmarks(allowWatchBookmarks *bool) *ListRbacAuthorizationV1alpha1ClusterRoleBindingParams {
...
func (o *ListRbacAuthorizationV1alpha1ClusterRoleBindingParams) WithContinue(continueVar *string) *ListRbacAuthorizationV1alpha1ClusterRoleBindingParams {
...
func (o *ListRbacAuthorizationV1alpha1ClusterRoleBindingParams) SetContinue(continueVar *string) {
...
func (o *ListRbacAuthorizationV1alpha1ClusterRoleBindingParams) WithFieldSelector(fieldSelector *string) *ListRbacAuthorizationV1alpha1ClusterRoleBindingParams {
...
func (o *ListRbacAuthorizationV1alpha1ClusterRoleBindingParams) WithLabelSelector(labelSelector *string) *ListRbacAuthorizationV1alpha1ClusterRoleBindingParams {
...
func (o *ListRbacAuthorizationV1alpha1ClusterRoleBindingParams) WithLimit(limit *int64) *ListRbacAuthorizationV1alpha1ClusterRoleBindingParams {
	o.SetLimit(limit)
	return o
}

// SetLimit adds the limit to the list rbac authorization v1alpha1 cluster role binding params
func (o *ListRbacAuthorizationV1alpha1ClusterRoleBindingParams) SetLimit(limit *int64) {
	o.Limit = limit
}

// WithPretty adds the pretty to the list rbac authorization v1alpha1 cluster role binding params
func (o *ListRbacAuthorizationV1alpha1ClusterRoleBindingParams) WithPretty(pretty *string) *ListRbacAuthorizationV1alpha1ClusterRoleBindingParams {
	o.SetPretty(pretty)
	return o
}

// SetPretty adds the pretty to the list rbac authorization v1alpha1 cluster role binding params
func (o *ListRbacAuthorizationV1alpha1ClusterRoleBindingParams) SetPretty(pretty *string) {
	o.Pretty = pretty
}

// WithResourceVersion adds the resourceVersion to the list rbac authorization v1alpha1 cluster role binding params
func (o *ListRbacAuthorizationV1alpha1ClusterRoleBindingParams) WithResourceVersion(resourceVersion *string) *ListRbacAuthorizationV1alpha1ClusterRoleBindingParams {
...
func (o *ListRbacAuthorizationV1alpha1ClusterRoleBindingParams) WithResourceVersionMatch(resourceVersionMatch *string) *ListRbacAuthorizationV1alpha1ClusterRoleBindingParams {
...
func (o *ListRbacAuthorizationV1alpha1ClusterRoleBindingParams) WithTimeoutSeconds(timeoutSeconds *int64) *ListRbacAuthorizationV1alpha1ClusterRoleBindingParams {
...
func (o *ListRbacAuthorizationV1alpha1ClusterRoleBindingParams) WithWatch(watch *bool) *ListRbacAuthorizationV1alpha1ClusterRoleBindingParams {
	o.SetWatch(watch)
	return o
}

// SetWatch adds the watch to the list rbac authorization v1alpha1 cluster role binding params
func (o *ListRbacAuthorizationV1alpha1ClusterRoleBindingParams) SetWatch(watch *bool) {
	o.Watch = watch
}

// WriteToRequest writes these params to a swagger request
func (o *ListRbacAuthorizationV1alpha1ClusterRoleBindingParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {

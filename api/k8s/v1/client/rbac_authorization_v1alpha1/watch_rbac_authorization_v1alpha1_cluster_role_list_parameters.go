...
// NewWatchRbacAuthorizationV1alpha1ClusterRoleListParamsWithTimeout creates a new WatchRbacAuthorizationV1alpha1ClusterRoleListParams object
...
// NewWatchRbacAuthorizationV1alpha1ClusterRoleListParamsWithContext creates a new WatchRbacAuthorizationV1alpha1ClusterRoleListParams object
...
// NewWatchRbacAuthorizationV1alpha1ClusterRoleListParamsWithHTTPClient creates a new WatchRbacAuthorizationV1alpha1ClusterRoleListParams object
...
/*WatchRbacAuthorizationV1alpha1ClusterRoleListParams contains all the parameters to send to the API endpoint
for the watch rbac authorization v1alpha1 cluster role list operation typically these are written to a http.Request
*/
...
func (o *WatchRbacAuthorizationV1alpha1ClusterRoleListParams) WithTimeout(timeout time.Duration) *WatchRbacAuthorizationV1alpha1ClusterRoleListParams {
	o.SetTimeout(timeout)
	return o
}

// SetTimeout adds the timeout to the watch rbac authorization v1alpha1 cluster role list params
func (o *WatchRbacAuthorizationV1alpha1ClusterRoleListParams) SetTimeout(timeout time.Duration) {
	o.timeout = timeout
}

// WithContext adds the context to the watch rbac authorization v1alpha1 cluster role list params
func (o *WatchRbacAuthorizationV1alpha1ClusterRoleListParams) WithContext(ctx context.Context) *WatchRbacAuthorizationV1alpha1ClusterRoleListParams {
	o.SetContext(ctx)
	return o
}

// SetContext adds the context to the watch rbac authorization v1alpha1 cluster role list params
func (o *WatchRbacAuthorizationV1alpha1ClusterRoleListParams) SetContext(ctx context.Context) {
	o.Context = ctx
}

// WithHTTPClient adds the HTTPClient to the watch rbac authorization v1alpha1 cluster role list params
func (o *WatchRbacAuthorizationV1alpha1ClusterRoleListParams) WithHTTPClient(client *http.Client) *WatchRbacAuthorizationV1alpha1ClusterRoleListParams {
	o.SetHTTPClient(client)
	return o
}

// SetHTTPClient adds the HTTPClient to the watch rbac authorization v1alpha1 cluster role list params
func (o *WatchRbacAuthorizationV1alpha1ClusterRoleListParams) SetHTTPClient(client *http.Client) {
	o.HTTPClient = client
}

// WithAllowWatchBookmarks adds the allowWatchBookmarks to the watch rbac authorization v1alpha1 cluster role list params
func (o *WatchRbacAuthorizationV1alpha1ClusterRoleListParams) WithAllowWatchBookmarks(allowWatchBookmarks *bool) *WatchRbacAuthorizationV1alpha1ClusterRoleListParams {
...
func (o *WatchRbacAuthorizationV1alpha1ClusterRoleListParams) WithContinue(continueVar *string) *WatchRbacAuthorizationV1alpha1ClusterRoleListParams {
...
func (o *WatchRbacAuthorizationV1alpha1ClusterRoleListParams) WithFieldSelector(fieldSelector *string) *WatchRbacAuthorizationV1alpha1ClusterRoleListParams {
...
func (o *WatchRbacAuthorizationV1alpha1ClusterRoleListParams) WithLabelSelector(labelSelector *string) *WatchRbacAuthorizationV1alpha1ClusterRoleListParams {
...
func (o *WatchRbacAuthorizationV1alpha1ClusterRoleListParams) WithLimit(limit *int64) *WatchRbacAuthorizationV1alpha1ClusterRoleListParams {
	o.SetLimit(limit)
	return o
}

// SetLimit adds the limit to the watch rbac authorization v1alpha1 cluster role list params
func (o *WatchRbacAuthorizationV1alpha1ClusterRoleListParams) SetLimit(limit *int64) {
	o.Limit = limit
}

// WithPretty adds the pretty to the watch rbac authorization v1alpha1 cluster role list params
func (o *WatchRbacAuthorizationV1alpha1ClusterRoleListParams) WithPretty(pretty *string) *WatchRbacAuthorizationV1alpha1ClusterRoleListParams {
	o.SetPretty(pretty)
	return o
}

// SetPretty adds the pretty to the watch rbac authorization v1alpha1 cluster role list params
func (o *WatchRbacAuthorizationV1alpha1ClusterRoleListParams) SetPretty(pretty *string) {
	o.Pretty = pretty
}

// WithResourceVersion adds the resourceVersion to the watch rbac authorization v1alpha1 cluster role list params
func (o *WatchRbacAuthorizationV1alpha1ClusterRoleListParams) WithResourceVersion(resourceVersion *string) *WatchRbacAuthorizationV1alpha1ClusterRoleListParams {
...
func (o *WatchRbacAuthorizationV1alpha1ClusterRoleListParams) WithResourceVersionMatch(resourceVersionMatch *string) *WatchRbacAuthorizationV1alpha1ClusterRoleListParams {
...
func (o *WatchRbacAuthorizationV1alpha1ClusterRoleListParams) WithTimeoutSeconds(timeoutSeconds *int64) *WatchRbacAuthorizationV1alpha1ClusterRoleListParams {
...
func (o *WatchRbacAuthorizationV1alpha1ClusterRoleListParams) WithWatch(watch *bool) *WatchRbacAuthorizationV1alpha1ClusterRoleListParams {
	o.SetWatch(watch)
	return o
}

// SetWatch adds the watch to the watch rbac authorization v1alpha1 cluster role list params
func (o *WatchRbacAuthorizationV1alpha1ClusterRoleListParams) SetWatch(watch *bool) {
	o.Watch = watch
}

// WriteToRequest writes these params to a swagger request
func (o *WatchRbacAuthorizationV1alpha1ClusterRoleListParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {

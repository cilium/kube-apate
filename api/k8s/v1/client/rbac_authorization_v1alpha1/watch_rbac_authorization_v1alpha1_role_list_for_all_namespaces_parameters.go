...
// NewWatchRbacAuthorizationV1alpha1RoleListForAllNamespacesParamsWithTimeout creates a new WatchRbacAuthorizationV1alpha1RoleListForAllNamespacesParams object
...
// NewWatchRbacAuthorizationV1alpha1RoleListForAllNamespacesParamsWithContext creates a new WatchRbacAuthorizationV1alpha1RoleListForAllNamespacesParams object
...
// NewWatchRbacAuthorizationV1alpha1RoleListForAllNamespacesParamsWithHTTPClient creates a new WatchRbacAuthorizationV1alpha1RoleListForAllNamespacesParams object
...
/*WatchRbacAuthorizationV1alpha1RoleListForAllNamespacesParams contains all the parameters to send to the API endpoint
for the watch rbac authorization v1alpha1 role list for all namespaces operation typically these are written to a http.Request
*/
...
func (o *WatchRbacAuthorizationV1alpha1RoleListForAllNamespacesParams) WithTimeout(timeout time.Duration) *WatchRbacAuthorizationV1alpha1RoleListForAllNamespacesParams {
	o.SetTimeout(timeout)
	return o
}

// SetTimeout adds the timeout to the watch rbac authorization v1alpha1 role list for all namespaces params
func (o *WatchRbacAuthorizationV1alpha1RoleListForAllNamespacesParams) SetTimeout(timeout time.Duration) {
	o.timeout = timeout
}

// WithContext adds the context to the watch rbac authorization v1alpha1 role list for all namespaces params
func (o *WatchRbacAuthorizationV1alpha1RoleListForAllNamespacesParams) WithContext(ctx context.Context) *WatchRbacAuthorizationV1alpha1RoleListForAllNamespacesParams {
	o.SetContext(ctx)
	return o
}

// SetContext adds the context to the watch rbac authorization v1alpha1 role list for all namespaces params
func (o *WatchRbacAuthorizationV1alpha1RoleListForAllNamespacesParams) SetContext(ctx context.Context) {
	o.Context = ctx
}

// WithHTTPClient adds the HTTPClient to the watch rbac authorization v1alpha1 role list for all namespaces params
func (o *WatchRbacAuthorizationV1alpha1RoleListForAllNamespacesParams) WithHTTPClient(client *http.Client) *WatchRbacAuthorizationV1alpha1RoleListForAllNamespacesParams {
	o.SetHTTPClient(client)
	return o
}

// SetHTTPClient adds the HTTPClient to the watch rbac authorization v1alpha1 role list for all namespaces params
func (o *WatchRbacAuthorizationV1alpha1RoleListForAllNamespacesParams) SetHTTPClient(client *http.Client) {
	o.HTTPClient = client
}
...
func (o *WatchRbacAuthorizationV1alpha1RoleListForAllNamespacesParams) WithAllowWatchBookmarks(allowWatchBookmarks *bool) *WatchRbacAuthorizationV1alpha1RoleListForAllNamespacesParams {
...
func (o *WatchRbacAuthorizationV1alpha1RoleListForAllNamespacesParams) WithContinue(continueVar *string) *WatchRbacAuthorizationV1alpha1RoleListForAllNamespacesParams {
...
func (o *WatchRbacAuthorizationV1alpha1RoleListForAllNamespacesParams) SetContinue(continueVar *string) {
...
func (o *WatchRbacAuthorizationV1alpha1RoleListForAllNamespacesParams) WithFieldSelector(fieldSelector *string) *WatchRbacAuthorizationV1alpha1RoleListForAllNamespacesParams {
...
func (o *WatchRbacAuthorizationV1alpha1RoleListForAllNamespacesParams) WithLabelSelector(labelSelector *string) *WatchRbacAuthorizationV1alpha1RoleListForAllNamespacesParams {
...
func (o *WatchRbacAuthorizationV1alpha1RoleListForAllNamespacesParams) WithLimit(limit *int64) *WatchRbacAuthorizationV1alpha1RoleListForAllNamespacesParams {
	o.SetLimit(limit)
	return o
}

// SetLimit adds the limit to the watch rbac authorization v1alpha1 role list for all namespaces params
func (o *WatchRbacAuthorizationV1alpha1RoleListForAllNamespacesParams) SetLimit(limit *int64) {
	o.Limit = limit
}

// WithPretty adds the pretty to the watch rbac authorization v1alpha1 role list for all namespaces params
func (o *WatchRbacAuthorizationV1alpha1RoleListForAllNamespacesParams) WithPretty(pretty *string) *WatchRbacAuthorizationV1alpha1RoleListForAllNamespacesParams {
	o.SetPretty(pretty)
	return o
}

// SetPretty adds the pretty to the watch rbac authorization v1alpha1 role list for all namespaces params
func (o *WatchRbacAuthorizationV1alpha1RoleListForAllNamespacesParams) SetPretty(pretty *string) {
	o.Pretty = pretty
}
...
func (o *WatchRbacAuthorizationV1alpha1RoleListForAllNamespacesParams) WithResourceVersion(resourceVersion *string) *WatchRbacAuthorizationV1alpha1RoleListForAllNamespacesParams {
...
func (o *WatchRbacAuthorizationV1alpha1RoleListForAllNamespacesParams) WithResourceVersionMatch(resourceVersionMatch *string) *WatchRbacAuthorizationV1alpha1RoleListForAllNamespacesParams {
...
func (o *WatchRbacAuthorizationV1alpha1RoleListForAllNamespacesParams) WithTimeoutSeconds(timeoutSeconds *int64) *WatchRbacAuthorizationV1alpha1RoleListForAllNamespacesParams {
...
func (o *WatchRbacAuthorizationV1alpha1RoleListForAllNamespacesParams) WithWatch(watch *bool) *WatchRbacAuthorizationV1alpha1RoleListForAllNamespacesParams {
	o.SetWatch(watch)
	return o
}

// SetWatch adds the watch to the watch rbac authorization v1alpha1 role list for all namespaces params
func (o *WatchRbacAuthorizationV1alpha1RoleListForAllNamespacesParams) SetWatch(watch *bool) {
	o.Watch = watch
}

// WriteToRequest writes these params to a swagger request
func (o *WatchRbacAuthorizationV1alpha1RoleListForAllNamespacesParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {

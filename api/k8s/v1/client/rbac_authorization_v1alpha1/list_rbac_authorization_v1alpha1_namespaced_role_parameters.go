...
// NewListRbacAuthorizationV1alpha1NamespacedRoleParamsWithTimeout creates a new ListRbacAuthorizationV1alpha1NamespacedRoleParams object
...
// NewListRbacAuthorizationV1alpha1NamespacedRoleParamsWithContext creates a new ListRbacAuthorizationV1alpha1NamespacedRoleParams object
...
// NewListRbacAuthorizationV1alpha1NamespacedRoleParamsWithHTTPClient creates a new ListRbacAuthorizationV1alpha1NamespacedRoleParams object
...
/*ListRbacAuthorizationV1alpha1NamespacedRoleParams contains all the parameters to send to the API endpoint
for the list rbac authorization v1alpha1 namespaced role operation typically these are written to a http.Request
*/
...
func (o *ListRbacAuthorizationV1alpha1NamespacedRoleParams) WithTimeout(timeout time.Duration) *ListRbacAuthorizationV1alpha1NamespacedRoleParams {
	o.SetTimeout(timeout)
	return o
}

// SetTimeout adds the timeout to the list rbac authorization v1alpha1 namespaced role params
func (o *ListRbacAuthorizationV1alpha1NamespacedRoleParams) SetTimeout(timeout time.Duration) {
	o.timeout = timeout
}

// WithContext adds the context to the list rbac authorization v1alpha1 namespaced role params
func (o *ListRbacAuthorizationV1alpha1NamespacedRoleParams) WithContext(ctx context.Context) *ListRbacAuthorizationV1alpha1NamespacedRoleParams {
	o.SetContext(ctx)
	return o
}

// SetContext adds the context to the list rbac authorization v1alpha1 namespaced role params
func (o *ListRbacAuthorizationV1alpha1NamespacedRoleParams) SetContext(ctx context.Context) {
	o.Context = ctx
}

// WithHTTPClient adds the HTTPClient to the list rbac authorization v1alpha1 namespaced role params
func (o *ListRbacAuthorizationV1alpha1NamespacedRoleParams) WithHTTPClient(client *http.Client) *ListRbacAuthorizationV1alpha1NamespacedRoleParams {
	o.SetHTTPClient(client)
	return o
}

// SetHTTPClient adds the HTTPClient to the list rbac authorization v1alpha1 namespaced role params
func (o *ListRbacAuthorizationV1alpha1NamespacedRoleParams) SetHTTPClient(client *http.Client) {
	o.HTTPClient = client
}

// WithAllowWatchBookmarks adds the allowWatchBookmarks to the list rbac authorization v1alpha1 namespaced role params
func (o *ListRbacAuthorizationV1alpha1NamespacedRoleParams) WithAllowWatchBookmarks(allowWatchBookmarks *bool) *ListRbacAuthorizationV1alpha1NamespacedRoleParams {
...
func (o *ListRbacAuthorizationV1alpha1NamespacedRoleParams) WithContinue(continueVar *string) *ListRbacAuthorizationV1alpha1NamespacedRoleParams {
...
func (o *ListRbacAuthorizationV1alpha1NamespacedRoleParams) WithFieldSelector(fieldSelector *string) *ListRbacAuthorizationV1alpha1NamespacedRoleParams {
...
func (o *ListRbacAuthorizationV1alpha1NamespacedRoleParams) WithLabelSelector(labelSelector *string) *ListRbacAuthorizationV1alpha1NamespacedRoleParams {
...
func (o *ListRbacAuthorizationV1alpha1NamespacedRoleParams) WithLimit(limit *int64) *ListRbacAuthorizationV1alpha1NamespacedRoleParams {
	o.SetLimit(limit)
	return o
}

// SetLimit adds the limit to the list rbac authorization v1alpha1 namespaced role params
func (o *ListRbacAuthorizationV1alpha1NamespacedRoleParams) SetLimit(limit *int64) {
	o.Limit = limit
}

// WithNamespace adds the namespace to the list rbac authorization v1alpha1 namespaced role params
func (o *ListRbacAuthorizationV1alpha1NamespacedRoleParams) WithNamespace(namespace string) *ListRbacAuthorizationV1alpha1NamespacedRoleParams {
...
func (o *ListRbacAuthorizationV1alpha1NamespacedRoleParams) WithPretty(pretty *string) *ListRbacAuthorizationV1alpha1NamespacedRoleParams {
	o.SetPretty(pretty)
	return o
}

// SetPretty adds the pretty to the list rbac authorization v1alpha1 namespaced role params
func (o *ListRbacAuthorizationV1alpha1NamespacedRoleParams) SetPretty(pretty *string) {
	o.Pretty = pretty
}

// WithResourceVersion adds the resourceVersion to the list rbac authorization v1alpha1 namespaced role params
func (o *ListRbacAuthorizationV1alpha1NamespacedRoleParams) WithResourceVersion(resourceVersion *string) *ListRbacAuthorizationV1alpha1NamespacedRoleParams {
...
func (o *ListRbacAuthorizationV1alpha1NamespacedRoleParams) WithResourceVersionMatch(resourceVersionMatch *string) *ListRbacAuthorizationV1alpha1NamespacedRoleParams {
...
func (o *ListRbacAuthorizationV1alpha1NamespacedRoleParams) WithTimeoutSeconds(timeoutSeconds *int64) *ListRbacAuthorizationV1alpha1NamespacedRoleParams {
...
func (o *ListRbacAuthorizationV1alpha1NamespacedRoleParams) WithWatch(watch *bool) *ListRbacAuthorizationV1alpha1NamespacedRoleParams {
	o.SetWatch(watch)
	return o
}

// SetWatch adds the watch to the list rbac authorization v1alpha1 namespaced role params
func (o *ListRbacAuthorizationV1alpha1NamespacedRoleParams) SetWatch(watch *bool) {
	o.Watch = watch
}

// WriteToRequest writes these params to a swagger request
func (o *ListRbacAuthorizationV1alpha1NamespacedRoleParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {

...
// NewListNodeV1beta1RuntimeClassParamsWithTimeout creates a new ListNodeV1beta1RuntimeClassParams object
...
// NewListNodeV1beta1RuntimeClassParamsWithContext creates a new ListNodeV1beta1RuntimeClassParams object
...
// NewListNodeV1beta1RuntimeClassParamsWithHTTPClient creates a new ListNodeV1beta1RuntimeClassParams object
...
/*ListNodeV1beta1RuntimeClassParams contains all the parameters to send to the API endpoint
for the list node v1beta1 runtime class operation typically these are written to a http.Request
*/
...
func (o *ListNodeV1beta1RuntimeClassParams) WithTimeout(timeout time.Duration) *ListNodeV1beta1RuntimeClassParams {
...
func (o *ListNodeV1beta1RuntimeClassParams) WithContext(ctx context.Context) *ListNodeV1beta1RuntimeClassParams {
	o.SetContext(ctx)
	return o
}

// SetContext adds the context to the list node v1beta1 runtime class params
func (o *ListNodeV1beta1RuntimeClassParams) SetContext(ctx context.Context) {
	o.Context = ctx
}

// WithHTTPClient adds the HTTPClient to the list node v1beta1 runtime class params
func (o *ListNodeV1beta1RuntimeClassParams) WithHTTPClient(client *http.Client) *ListNodeV1beta1RuntimeClassParams {
...
func (o *ListNodeV1beta1RuntimeClassParams) WithContinue(continueVar *string) *ListNodeV1beta1RuntimeClassParams {
...
func (o *ListNodeV1beta1RuntimeClassParams) WithLimit(limit *int64) *ListNodeV1beta1RuntimeClassParams {
	o.SetLimit(limit)
	return o
}
...
func (o *ListNodeV1beta1RuntimeClassParams) WithPretty(pretty *string) *ListNodeV1beta1RuntimeClassParams {
	o.SetPretty(pretty)
	return o
}
...
func (o *ListNodeV1beta1RuntimeClassParams) WithWatch(watch *bool) *ListNodeV1beta1RuntimeClassParams {
	o.SetWatch(watch)
	return o
}
...
func (o *ListNodeV1beta1RuntimeClassParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {

...
// NewReadNodeV1beta1RuntimeClassParamsWithTimeout creates a new ReadNodeV1beta1RuntimeClassParams object
...
// NewReadNodeV1beta1RuntimeClassParamsWithContext creates a new ReadNodeV1beta1RuntimeClassParams object
...
// NewReadNodeV1beta1RuntimeClassParamsWithHTTPClient creates a new ReadNodeV1beta1RuntimeClassParams object
...
/*ReadNodeV1beta1RuntimeClassParams contains all the parameters to send to the API endpoint
for the read node v1beta1 runtime class operation typically these are written to a http.Request
*/
...
func (o *ReadNodeV1beta1RuntimeClassParams) WithTimeout(timeout time.Duration) *ReadNodeV1beta1RuntimeClassParams {
...
func (o *ReadNodeV1beta1RuntimeClassParams) WithContext(ctx context.Context) *ReadNodeV1beta1RuntimeClassParams {
	o.SetContext(ctx)
	return o
}

// SetContext adds the context to the read node v1beta1 runtime class params
func (o *ReadNodeV1beta1RuntimeClassParams) SetContext(ctx context.Context) {
	o.Context = ctx
}

// WithHTTPClient adds the HTTPClient to the read node v1beta1 runtime class params
func (o *ReadNodeV1beta1RuntimeClassParams) WithHTTPClient(client *http.Client) *ReadNodeV1beta1RuntimeClassParams {
...
func (o *ReadNodeV1beta1RuntimeClassParams) WithExact(exact *bool) *ReadNodeV1beta1RuntimeClassParams {
	o.SetExact(exact)
	return o
}
...
func (o *ReadNodeV1beta1RuntimeClassParams) WithExport(export *bool) *ReadNodeV1beta1RuntimeClassParams {
	o.SetExport(export)
	return o
}
...
func (o *ReadNodeV1beta1RuntimeClassParams) WithName(name string) *ReadNodeV1beta1RuntimeClassParams {
	o.SetName(name)
	return o
}
...
func (o *ReadNodeV1beta1RuntimeClassParams) WithPretty(pretty *string) *ReadNodeV1beta1RuntimeClassParams {
	o.SetPretty(pretty)
	return o
}
...
func (o *ReadNodeV1beta1RuntimeClassParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {

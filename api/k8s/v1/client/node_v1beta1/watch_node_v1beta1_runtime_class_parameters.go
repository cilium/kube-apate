...
// NewWatchNodeV1beta1RuntimeClassParamsWithTimeout creates a new WatchNodeV1beta1RuntimeClassParams object
...
// NewWatchNodeV1beta1RuntimeClassParamsWithContext creates a new WatchNodeV1beta1RuntimeClassParams object
...
// NewWatchNodeV1beta1RuntimeClassParamsWithHTTPClient creates a new WatchNodeV1beta1RuntimeClassParams object
...
/*WatchNodeV1beta1RuntimeClassParams contains all the parameters to send to the API endpoint
for the watch node v1beta1 runtime class operation typically these are written to a http.Request
*/
...
func (o *WatchNodeV1beta1RuntimeClassParams) WithTimeout(timeout time.Duration) *WatchNodeV1beta1RuntimeClassParams {
...
func (o *WatchNodeV1beta1RuntimeClassParams) WithContext(ctx context.Context) *WatchNodeV1beta1RuntimeClassParams {
	o.SetContext(ctx)
	return o
}

// SetContext adds the context to the watch node v1beta1 runtime class params
func (o *WatchNodeV1beta1RuntimeClassParams) SetContext(ctx context.Context) {
	o.Context = ctx
}

// WithHTTPClient adds the HTTPClient to the watch node v1beta1 runtime class params
func (o *WatchNodeV1beta1RuntimeClassParams) WithHTTPClient(client *http.Client) *WatchNodeV1beta1RuntimeClassParams {
...
func (o *WatchNodeV1beta1RuntimeClassParams) WithContinue(continueVar *string) *WatchNodeV1beta1RuntimeClassParams {
...
func (o *WatchNodeV1beta1RuntimeClassParams) WithFieldSelector(fieldSelector *string) *WatchNodeV1beta1RuntimeClassParams {
...
func (o *WatchNodeV1beta1RuntimeClassParams) WithLabelSelector(labelSelector *string) *WatchNodeV1beta1RuntimeClassParams {
...
func (o *WatchNodeV1beta1RuntimeClassParams) WithLimit(limit *int64) *WatchNodeV1beta1RuntimeClassParams {
	o.SetLimit(limit)
	return o
}
...
func (o *WatchNodeV1beta1RuntimeClassParams) WithName(name string) *WatchNodeV1beta1RuntimeClassParams {
	o.SetName(name)
	return o
}
...
func (o *WatchNodeV1beta1RuntimeClassParams) WithPretty(pretty *string) *WatchNodeV1beta1RuntimeClassParams {
	o.SetPretty(pretty)
	return o
}
...
func (o *WatchNodeV1beta1RuntimeClassParams) WithWatch(watch *bool) *WatchNodeV1beta1RuntimeClassParams {
	o.SetWatch(watch)
	return o
}
...
func (o *WatchNodeV1beta1RuntimeClassParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {

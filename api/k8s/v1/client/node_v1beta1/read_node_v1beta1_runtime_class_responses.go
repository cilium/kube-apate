...
func (o *ReadNodeV1beta1RuntimeClassReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewReadNodeV1beta1RuntimeClassOK()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return result, nil
	case 401:
		result := NewReadNodeV1beta1RuntimeClassUnauthorized()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
func (o *ReadNodeV1beta1RuntimeClassOK) Error() string {
	return fmt.Sprintf("[GET /apis/node.k8s.io/v1beta1/runtimeclasses/{name}][%d] readNodeV1beta1RuntimeClassOK  %+v", 200, o.Payload)
}

func (o *ReadNodeV1beta1RuntimeClassOK) GetPayload() *models.IoK8sAPINodeV1beta1RuntimeClass {
	return o.Payload
}

func (o *ReadNodeV1beta1RuntimeClassOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
...
func (o *ReadNodeV1beta1RuntimeClassUnauthorized) Error() string {
	return fmt.Sprintf("[GET /apis/node.k8s.io/v1beta1/runtimeclasses/{name}][%d] readNodeV1beta1RuntimeClassUnauthorized ", 401)
}

func (o *ReadNodeV1beta1RuntimeClassUnauthorized) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {

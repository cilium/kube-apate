...
// NewCreateNodeV1beta1RuntimeClassParamsWithTimeout creates a new CreateNodeV1beta1RuntimeClassParams object
...
// NewCreateNodeV1beta1RuntimeClassParamsWithContext creates a new CreateNodeV1beta1RuntimeClassParams object
...
// NewCreateNodeV1beta1RuntimeClassParamsWithHTTPClient creates a new CreateNodeV1beta1RuntimeClassParams object
...
/*CreateNodeV1beta1RuntimeClassParams contains all the parameters to send to the API endpoint
for the create node v1beta1 runtime class operation typically these are written to a http.Request
*/
...
func (o *CreateNodeV1beta1RuntimeClassParams) WithTimeout(timeout time.Duration) *CreateNodeV1beta1RuntimeClassParams {
...
func (o *CreateNodeV1beta1RuntimeClassParams) WithContext(ctx context.Context) *CreateNodeV1beta1RuntimeClassParams {
	o.SetContext(ctx)
	return o
}

// SetContext adds the context to the create node v1beta1 runtime class params
func (o *CreateNodeV1beta1RuntimeClassParams) SetContext(ctx context.Context) {
	o.Context = ctx
}

// WithHTTPClient adds the HTTPClient to the create node v1beta1 runtime class params
func (o *CreateNodeV1beta1RuntimeClassParams) WithHTTPClient(client *http.Client) *CreateNodeV1beta1RuntimeClassParams {
...
func (o *CreateNodeV1beta1RuntimeClassParams) WithBody(body *models.IoK8sAPINodeV1beta1RuntimeClass) *CreateNodeV1beta1RuntimeClassParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the create node v1beta1 runtime class params
func (o *CreateNodeV1beta1RuntimeClassParams) SetBody(body *models.IoK8sAPINodeV1beta1RuntimeClass) {
	o.Body = body
}

// WithDryRun adds the dryRun to the create node v1beta1 runtime class params
func (o *CreateNodeV1beta1RuntimeClassParams) WithDryRun(dryRun *string) *CreateNodeV1beta1RuntimeClassParams {
	o.SetDryRun(dryRun)
	return o
}
...
func (o *CreateNodeV1beta1RuntimeClassParams) WithFieldManager(fieldManager *string) *CreateNodeV1beta1RuntimeClassParams {
...
func (o *CreateNodeV1beta1RuntimeClassParams) WithPretty(pretty *string) *CreateNodeV1beta1RuntimeClassParams {
	o.SetPretty(pretty)
	return o
}
...
func (o *CreateNodeV1beta1RuntimeClassParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {

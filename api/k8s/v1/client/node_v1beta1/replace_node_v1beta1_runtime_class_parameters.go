...
// NewReplaceNodeV1beta1RuntimeClassParamsWithTimeout creates a new ReplaceNodeV1beta1RuntimeClassParams object
...
// NewReplaceNodeV1beta1RuntimeClassParamsWithContext creates a new ReplaceNodeV1beta1RuntimeClassParams object
...
// NewReplaceNodeV1beta1RuntimeClassParamsWithHTTPClient creates a new ReplaceNodeV1beta1RuntimeClassParams object
...
/*ReplaceNodeV1beta1RuntimeClassParams contains all the parameters to send to the API endpoint
for the replace node v1beta1 runtime class operation typically these are written to a http.Request
*/
...
func (o *ReplaceNodeV1beta1RuntimeClassParams) WithTimeout(timeout time.Duration) *ReplaceNodeV1beta1RuntimeClassParams {
...
func (o *ReplaceNodeV1beta1RuntimeClassParams) WithContext(ctx context.Context) *ReplaceNodeV1beta1RuntimeClassParams {
	o.SetContext(ctx)
	return o
}

// SetContext adds the context to the replace node v1beta1 runtime class params
func (o *ReplaceNodeV1beta1RuntimeClassParams) SetContext(ctx context.Context) {
	o.Context = ctx
}

// WithHTTPClient adds the HTTPClient to the replace node v1beta1 runtime class params
func (o *ReplaceNodeV1beta1RuntimeClassParams) WithHTTPClient(client *http.Client) *ReplaceNodeV1beta1RuntimeClassParams {
...
func (o *ReplaceNodeV1beta1RuntimeClassParams) WithBody(body *models.IoK8sAPINodeV1beta1RuntimeClass) *ReplaceNodeV1beta1RuntimeClassParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the replace node v1beta1 runtime class params
func (o *ReplaceNodeV1beta1RuntimeClassParams) SetBody(body *models.IoK8sAPINodeV1beta1RuntimeClass) {
	o.Body = body
}

// WithDryRun adds the dryRun to the replace node v1beta1 runtime class params
func (o *ReplaceNodeV1beta1RuntimeClassParams) WithDryRun(dryRun *string) *ReplaceNodeV1beta1RuntimeClassParams {
	o.SetDryRun(dryRun)
	return o
}
...
func (o *ReplaceNodeV1beta1RuntimeClassParams) WithFieldManager(fieldManager *string) *ReplaceNodeV1beta1RuntimeClassParams {
...
func (o *ReplaceNodeV1beta1RuntimeClassParams) WithName(name string) *ReplaceNodeV1beta1RuntimeClassParams {
	o.SetName(name)
	return o
}

// SetName adds the name to the replace node v1beta1 runtime class params
func (o *ReplaceNodeV1beta1RuntimeClassParams) SetName(name string) {
	o.Name = name
}

// WithPretty adds the pretty to the replace node v1beta1 runtime class params
func (o *ReplaceNodeV1beta1RuntimeClassParams) WithPretty(pretty *string) *ReplaceNodeV1beta1RuntimeClassParams {
	o.SetPretty(pretty)
	return o
}
...
func (o *ReplaceNodeV1beta1RuntimeClassParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {

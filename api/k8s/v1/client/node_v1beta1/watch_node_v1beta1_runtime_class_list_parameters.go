...
// NewWatchNodeV1beta1RuntimeClassListParamsWithTimeout creates a new WatchNodeV1beta1RuntimeClassListParams object
...
// NewWatchNodeV1beta1RuntimeClassListParamsWithContext creates a new WatchNodeV1beta1RuntimeClassListParams object
...
// NewWatchNodeV1beta1RuntimeClassListParamsWithHTTPClient creates a new WatchNodeV1beta1RuntimeClassListParams object
...
/*WatchNodeV1beta1RuntimeClassListParams contains all the parameters to send to the API endpoint
for the watch node v1beta1 runtime class list operation typically these are written to a http.Request
*/
...
func (o *WatchNodeV1beta1RuntimeClassListParams) WithTimeout(timeout time.Duration) *WatchNodeV1beta1RuntimeClassListParams {
...
func (o *WatchNodeV1beta1RuntimeClassListParams) WithContext(ctx context.Context) *WatchNodeV1beta1RuntimeClassListParams {
	o.SetContext(ctx)
	return o
}

// SetContext adds the context to the watch node v1beta1 runtime class list params
func (o *WatchNodeV1beta1RuntimeClassListParams) SetContext(ctx context.Context) {
	o.Context = ctx
}

// WithHTTPClient adds the HTTPClient to the watch node v1beta1 runtime class list params
func (o *WatchNodeV1beta1RuntimeClassListParams) WithHTTPClient(client *http.Client) *WatchNodeV1beta1RuntimeClassListParams {
...
func (o *WatchNodeV1beta1RuntimeClassListParams) WithContinue(continueVar *string) *WatchNodeV1beta1RuntimeClassListParams {
...
func (o *WatchNodeV1beta1RuntimeClassListParams) WithFieldSelector(fieldSelector *string) *WatchNodeV1beta1RuntimeClassListParams {
...
func (o *WatchNodeV1beta1RuntimeClassListParams) WithLabelSelector(labelSelector *string) *WatchNodeV1beta1RuntimeClassListParams {
...
func (o *WatchNodeV1beta1RuntimeClassListParams) WithLimit(limit *int64) *WatchNodeV1beta1RuntimeClassListParams {
	o.SetLimit(limit)
	return o
}
...
func (o *WatchNodeV1beta1RuntimeClassListParams) WithPretty(pretty *string) *WatchNodeV1beta1RuntimeClassListParams {
	o.SetPretty(pretty)
	return o
}
...
func (o *WatchNodeV1beta1RuntimeClassListParams) WithResourceVersion(resourceVersion *string) *WatchNodeV1beta1RuntimeClassListParams {
...
func (o *WatchNodeV1beta1RuntimeClassListParams) WithTimeoutSeconds(timeoutSeconds *int64) *WatchNodeV1beta1RuntimeClassListParams {
...
func (o *WatchNodeV1beta1RuntimeClassListParams) WithWatch(watch *bool) *WatchNodeV1beta1RuntimeClassListParams {
	o.SetWatch(watch)
	return o
}
...
func (o *WatchNodeV1beta1RuntimeClassListParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {

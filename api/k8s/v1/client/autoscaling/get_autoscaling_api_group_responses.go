...
func (o *GetAutoscalingAPIGroupReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewGetAutoscalingAPIGroupOK()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return result, nil
	case 401:
		result := NewGetAutoscalingAPIGroupUnauthorized()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
func (o *GetAutoscalingAPIGroupOK) Error() string {
	return fmt.Sprintf("[GET /apis/autoscaling/][%d] getAutoscalingApiGroupOK  %+v", 200, o.Payload)
}
...
func (o *GetAutoscalingAPIGroupOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
...
func (o *GetAutoscalingAPIGroupUnauthorized) Error() string {
	return fmt.Sprintf("[GET /apis/autoscaling/][%d] getAutoscalingApiGroupUnauthorized ", 401)
}

func (o *GetAutoscalingAPIGroupUnauthorized) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {

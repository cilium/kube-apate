...
func (o *ReplaceRbacAuthorizationV1ClusterRoleBindingReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewReplaceRbacAuthorizationV1ClusterRoleBindingOK()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return result, nil
	case 201:
		result := NewReplaceRbacAuthorizationV1ClusterRoleBindingCreated()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return result, nil
	case 401:
		result := NewReplaceRbacAuthorizationV1ClusterRoleBindingUnauthorized()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
func (o *ReplaceRbacAuthorizationV1ClusterRoleBindingOK) Error() string {
	return fmt.Sprintf("[PUT /apis/rbac.authorization.k8s.io/v1/clusterrolebindings/{name}][%d] replaceRbacAuthorizationV1ClusterRoleBindingOK  %+v", 200, o.Payload)
}
...
func (o *ReplaceRbacAuthorizationV1ClusterRoleBindingOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
...
func (o *ReplaceRbacAuthorizationV1ClusterRoleBindingCreated) Error() string {
	return fmt.Sprintf("[PUT /apis/rbac.authorization.k8s.io/v1/clusterrolebindings/{name}][%d] replaceRbacAuthorizationV1ClusterRoleBindingCreated  %+v", 201, o.Payload)
}
...
func (o *ReplaceRbacAuthorizationV1ClusterRoleBindingCreated) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
...
func (o *ReplaceRbacAuthorizationV1ClusterRoleBindingUnauthorized) Error() string {
	return fmt.Sprintf("[PUT /apis/rbac.authorization.k8s.io/v1/clusterrolebindings/{name}][%d] replaceRbacAuthorizationV1ClusterRoleBindingUnauthorized ", 401)
}

func (o *ReplaceRbacAuthorizationV1ClusterRoleBindingUnauthorized) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {

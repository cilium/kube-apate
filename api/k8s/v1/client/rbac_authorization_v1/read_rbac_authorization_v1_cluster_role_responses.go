...
func (o *ReadRbacAuthorizationV1ClusterRoleReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewReadRbacAuthorizationV1ClusterRoleOK()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return result, nil
	case 401:
		result := NewReadRbacAuthorizationV1ClusterRoleUnauthorized()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
func (o *ReadRbacAuthorizationV1ClusterRoleOK) Error() string {
	return fmt.Sprintf("[GET /apis/rbac.authorization.k8s.io/v1/clusterroles/{name}][%d] readRbacAuthorizationV1ClusterRoleOK  %+v", 200, o.Payload)
}
...
func (o *ReadRbacAuthorizationV1ClusterRoleOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
...
func (o *ReadRbacAuthorizationV1ClusterRoleUnauthorized) Error() string {
	return fmt.Sprintf("[GET /apis/rbac.authorization.k8s.io/v1/clusterroles/{name}][%d] readRbacAuthorizationV1ClusterRoleUnauthorized ", 401)
}

func (o *ReadRbacAuthorizationV1ClusterRoleUnauthorized) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {

...
func (o *ReadRbacAuthorizationV1NamespacedRoleBindingReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewReadRbacAuthorizationV1NamespacedRoleBindingOK()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return result, nil
	case 401:
		result := NewReadRbacAuthorizationV1NamespacedRoleBindingUnauthorized()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
func (o *ReadRbacAuthorizationV1NamespacedRoleBindingOK) Error() string {
	return fmt.Sprintf("[GET /apis/rbac.authorization.k8s.io/v1/namespaces/{namespace}/rolebindings/{name}][%d] readRbacAuthorizationV1NamespacedRoleBindingOK  %+v", 200, o.Payload)
}
...
func (o *ReadRbacAuthorizationV1NamespacedRoleBindingOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
...
func (o *ReadRbacAuthorizationV1NamespacedRoleBindingUnauthorized) Error() string {
	return fmt.Sprintf("[GET /apis/rbac.authorization.k8s.io/v1/namespaces/{namespace}/rolebindings/{name}][%d] readRbacAuthorizationV1NamespacedRoleBindingUnauthorized ", 401)
}

func (o *ReadRbacAuthorizationV1NamespacedRoleBindingUnauthorized) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {

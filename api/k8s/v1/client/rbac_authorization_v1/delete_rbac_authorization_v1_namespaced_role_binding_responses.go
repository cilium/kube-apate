...
func (o *DeleteRbacAuthorizationV1NamespacedRoleBindingReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewDeleteRbacAuthorizationV1NamespacedRoleBindingOK()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return result, nil
	case 202:
		result := NewDeleteRbacAuthorizationV1NamespacedRoleBindingAccepted()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return result, nil
	case 401:
		result := NewDeleteRbacAuthorizationV1NamespacedRoleBindingUnauthorized()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
func (o *DeleteRbacAuthorizationV1NamespacedRoleBindingOK) Error() string {
	return fmt.Sprintf("[DELETE /apis/rbac.authorization.k8s.io/v1/namespaces/{namespace}/rolebindings/{name}][%d] deleteRbacAuthorizationV1NamespacedRoleBindingOK  %+v", 200, o.Payload)
}
...
func (o *DeleteRbacAuthorizationV1NamespacedRoleBindingOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
...
func (o *DeleteRbacAuthorizationV1NamespacedRoleBindingAccepted) Error() string {
	return fmt.Sprintf("[DELETE /apis/rbac.authorization.k8s.io/v1/namespaces/{namespace}/rolebindings/{name}][%d] deleteRbacAuthorizationV1NamespacedRoleBindingAccepted  %+v", 202, o.Payload)
}
...
func (o *DeleteRbacAuthorizationV1NamespacedRoleBindingAccepted) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
...
func (o *DeleteRbacAuthorizationV1NamespacedRoleBindingUnauthorized) Error() string {
	return fmt.Sprintf("[DELETE /apis/rbac.authorization.k8s.io/v1/namespaces/{namespace}/rolebindings/{name}][%d] deleteRbacAuthorizationV1NamespacedRoleBindingUnauthorized ", 401)
}

func (o *DeleteRbacAuthorizationV1NamespacedRoleBindingUnauthorized) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {

...
func (o *WatchRbacAuthorizationV1ClusterRoleListReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewWatchRbacAuthorizationV1ClusterRoleListOK()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return result, nil
	case 401:
		result := NewWatchRbacAuthorizationV1ClusterRoleListUnauthorized()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
func (o *WatchRbacAuthorizationV1ClusterRoleListOK) Error() string {
	return fmt.Sprintf("[GET /apis/rbac.authorization.k8s.io/v1/watch/clusterroles][%d] watchRbacAuthorizationV1ClusterRoleListOK  %+v", 200, o.Payload)
}
...
func (o *WatchRbacAuthorizationV1ClusterRoleListOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
...
func (o *WatchRbacAuthorizationV1ClusterRoleListUnauthorized) Error() string {
	return fmt.Sprintf("[GET /apis/rbac.authorization.k8s.io/v1/watch/clusterroles][%d] watchRbacAuthorizationV1ClusterRoleListUnauthorized ", 401)
}

func (o *WatchRbacAuthorizationV1ClusterRoleListUnauthorized) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {

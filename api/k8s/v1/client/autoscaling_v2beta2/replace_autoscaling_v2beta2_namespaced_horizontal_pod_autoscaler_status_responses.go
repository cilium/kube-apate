...
func (o *ReplaceAutoscalingV2beta2NamespacedHorizontalPodAutoscalerStatusReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewReplaceAutoscalingV2beta2NamespacedHorizontalPodAutoscalerStatusOK()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return result, nil
	case 201:
		result := NewReplaceAutoscalingV2beta2NamespacedHorizontalPodAutoscalerStatusCreated()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return result, nil
	case 401:
		result := NewReplaceAutoscalingV2beta2NamespacedHorizontalPodAutoscalerStatusUnauthorized()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
func (o *ReplaceAutoscalingV2beta2NamespacedHorizontalPodAutoscalerStatusOK) Error() string {
	return fmt.Sprintf("[PUT /apis/autoscaling/v2beta2/namespaces/{namespace}/horizontalpodautoscalers/{name}/status][%d] replaceAutoscalingV2beta2NamespacedHorizontalPodAutoscalerStatusOK  %+v", 200, o.Payload)
}

func (o *ReplaceAutoscalingV2beta2NamespacedHorizontalPodAutoscalerStatusOK) GetPayload() *models.IoK8sAPIAutoscalingV2beta2HorizontalPodAutoscaler {
	return o.Payload
}

func (o *ReplaceAutoscalingV2beta2NamespacedHorizontalPodAutoscalerStatusOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
...
func (o *ReplaceAutoscalingV2beta2NamespacedHorizontalPodAutoscalerStatusCreated) Error() string {
	return fmt.Sprintf("[PUT /apis/autoscaling/v2beta2/namespaces/{namespace}/horizontalpodautoscalers/{name}/status][%d] replaceAutoscalingV2beta2NamespacedHorizontalPodAutoscalerStatusCreated  %+v", 201, o.Payload)
}

func (o *ReplaceAutoscalingV2beta2NamespacedHorizontalPodAutoscalerStatusCreated) GetPayload() *models.IoK8sAPIAutoscalingV2beta2HorizontalPodAutoscaler {
	return o.Payload
}

func (o *ReplaceAutoscalingV2beta2NamespacedHorizontalPodAutoscalerStatusCreated) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
...
func (o *ReplaceAutoscalingV2beta2NamespacedHorizontalPodAutoscalerStatusUnauthorized) Error() string {
	return fmt.Sprintf("[PUT /apis/autoscaling/v2beta2/namespaces/{namespace}/horizontalpodautoscalers/{name}/status][%d] replaceAutoscalingV2beta2NamespacedHorizontalPodAutoscalerStatusUnauthorized ", 401)
}

func (o *ReplaceAutoscalingV2beta2NamespacedHorizontalPodAutoscalerStatusUnauthorized) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {

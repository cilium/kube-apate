...
func (o *PatchAutoscalingV2beta2NamespacedHorizontalPodAutoscalerReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewPatchAutoscalingV2beta2NamespacedHorizontalPodAutoscalerOK()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return result, nil
	case 401:
		result := NewPatchAutoscalingV2beta2NamespacedHorizontalPodAutoscalerUnauthorized()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
func (o *PatchAutoscalingV2beta2NamespacedHorizontalPodAutoscalerOK) Error() string {
	return fmt.Sprintf("[PATCH /apis/autoscaling/v2beta2/namespaces/{namespace}/horizontalpodautoscalers/{name}][%d] patchAutoscalingV2beta2NamespacedHorizontalPodAutoscalerOK  %+v", 200, o.Payload)
}

func (o *PatchAutoscalingV2beta2NamespacedHorizontalPodAutoscalerOK) GetPayload() *models.IoK8sAPIAutoscalingV2beta2HorizontalPodAutoscaler {
	return o.Payload
}

func (o *PatchAutoscalingV2beta2NamespacedHorizontalPodAutoscalerOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
...
func (o *PatchAutoscalingV2beta2NamespacedHorizontalPodAutoscalerUnauthorized) Error() string {
	return fmt.Sprintf("[PATCH /apis/autoscaling/v2beta2/namespaces/{namespace}/horizontalpodautoscalers/{name}][%d] patchAutoscalingV2beta2NamespacedHorizontalPodAutoscalerUnauthorized ", 401)
}

func (o *PatchAutoscalingV2beta2NamespacedHorizontalPodAutoscalerUnauthorized) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {

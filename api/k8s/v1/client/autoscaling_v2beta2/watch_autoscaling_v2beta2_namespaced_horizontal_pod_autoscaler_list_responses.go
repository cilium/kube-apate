...
func (o *WatchAutoscalingV2beta2NamespacedHorizontalPodAutoscalerListReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewWatchAutoscalingV2beta2NamespacedHorizontalPodAutoscalerListOK()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return result, nil
	case 401:
		result := NewWatchAutoscalingV2beta2NamespacedHorizontalPodAutoscalerListUnauthorized()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
func (o *WatchAutoscalingV2beta2NamespacedHorizontalPodAutoscalerListOK) Error() string {
	return fmt.Sprintf("[GET /apis/autoscaling/v2beta2/watch/namespaces/{namespace}/horizontalpodautoscalers][%d] watchAutoscalingV2beta2NamespacedHorizontalPodAutoscalerListOK  %+v", 200, o.Payload)
}

func (o *WatchAutoscalingV2beta2NamespacedHorizontalPodAutoscalerListOK) GetPayload() *models.IoK8sApimachineryPkgApisMetaV1WatchEvent {
	return o.Payload
}

func (o *WatchAutoscalingV2beta2NamespacedHorizontalPodAutoscalerListOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
...
func (o *WatchAutoscalingV2beta2NamespacedHorizontalPodAutoscalerListUnauthorized) Error() string {
	return fmt.Sprintf("[GET /apis/autoscaling/v2beta2/watch/namespaces/{namespace}/horizontalpodautoscalers][%d] watchAutoscalingV2beta2NamespacedHorizontalPodAutoscalerListUnauthorized ", 401)
}

func (o *WatchAutoscalingV2beta2NamespacedHorizontalPodAutoscalerListUnauthorized) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {

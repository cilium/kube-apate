...
func (m *IoK8sAPIEventsV1EventSeries) validateCount(formats strfmt.Registry) error {
...
func (m *IoK8sAPIEventsV1EventSeries) validateLastObservedTime(formats strfmt.Registry) error {
...
func (m *IoK8sAPIEventsV1EventSeries) UnmarshalBinary(b []byte) error {
	var res IoK8sAPIEventsV1EventSeries

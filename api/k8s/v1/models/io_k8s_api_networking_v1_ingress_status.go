...
func (m *IoK8sAPINetworkingV1IngressStatus) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *IoK8sAPINetworkingV1IngressStatus) validateLoadBalancer(formats strfmt.Registry) error {
...
func (m *IoK8sAPINetworkingV1IngressStatus) UnmarshalBinary(b []byte) error {
	var res IoK8sAPINetworkingV1IngressStatus

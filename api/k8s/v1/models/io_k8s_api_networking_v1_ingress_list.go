...
func (m *IoK8sAPINetworkingV1IngressList) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *IoK8sAPINetworkingV1IngressList) validateItems(formats strfmt.Registry) error {
...
func (m *IoK8sAPINetworkingV1IngressList) validateMetadata(formats strfmt.Registry) error {
...
func (m *IoK8sAPINetworkingV1IngressList) UnmarshalBinary(b []byte) error {
	var res IoK8sAPINetworkingV1IngressList

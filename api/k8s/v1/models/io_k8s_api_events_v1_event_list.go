...
func (m *IoK8sAPIEventsV1EventList) validateItems(formats strfmt.Registry) error {
...
func (m *IoK8sAPIEventsV1EventList) validateMetadata(formats strfmt.Registry) error {
...
func (m *IoK8sAPIEventsV1EventList) UnmarshalBinary(b []byte) error {
	var res IoK8sAPIEventsV1EventList

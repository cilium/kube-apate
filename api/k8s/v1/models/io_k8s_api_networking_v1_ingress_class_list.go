...
func (m *IoK8sAPINetworkingV1IngressClassList) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *IoK8sAPINetworkingV1IngressClassList) validateItems(formats strfmt.Registry) error {
...
func (m *IoK8sAPINetworkingV1IngressClassList) validateMetadata(formats strfmt.Registry) error {
...
func (m *IoK8sAPINetworkingV1IngressClassList) UnmarshalBinary(b []byte) error {
	var res IoK8sAPINetworkingV1IngressClassList

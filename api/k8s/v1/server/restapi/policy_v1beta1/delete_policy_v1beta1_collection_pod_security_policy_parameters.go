...
func (o *DeletePolicyV1beta1CollectionPodSecurityPolicyParams) bindResourceVersionMatch(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *DeletePolicyV1beta1CollectionPodSecurityPolicyParams) validateResourceVersionMatch(formats strfmt.Registry) error {

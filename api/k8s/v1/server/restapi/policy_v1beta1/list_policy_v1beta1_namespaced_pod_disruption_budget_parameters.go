...
func (o *ListPolicyV1beta1NamespacedPodDisruptionBudgetParams) bindResourceVersionMatch(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *ListPolicyV1beta1NamespacedPodDisruptionBudgetParams) validateResourceVersionMatch(formats strfmt.Registry) error {

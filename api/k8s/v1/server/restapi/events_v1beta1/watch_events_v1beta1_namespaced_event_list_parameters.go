...
func (o *WatchEventsV1beta1NamespacedEventListParams) bindResourceVersionMatch(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *WatchEventsV1beta1NamespacedEventListParams) validateResourceVersionMatch(formats strfmt.Registry) error {

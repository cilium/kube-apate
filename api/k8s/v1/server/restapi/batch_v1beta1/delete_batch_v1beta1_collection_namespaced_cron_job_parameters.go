...
func (o *DeleteBatchV1beta1CollectionNamespacedCronJobParams) bindResourceVersionMatch(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *DeleteBatchV1beta1CollectionNamespacedCronJobParams) validateResourceVersionMatch(formats strfmt.Registry) error {

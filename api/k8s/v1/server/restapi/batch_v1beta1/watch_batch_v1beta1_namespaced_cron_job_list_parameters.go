...
func (o *WatchBatchV1beta1NamespacedCronJobListParams) bindResourceVersionMatch(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *WatchBatchV1beta1NamespacedCronJobListParams) validateResourceVersionMatch(formats strfmt.Registry) error {

...
// NewDeleteCertificatesV1CollectionCertificateSigningRequestParams creates a new DeleteCertificatesV1CollectionCertificateSigningRequestParams object
...
func NewDeleteCertificatesV1CollectionCertificateSigningRequestParams() DeleteCertificatesV1CollectionCertificateSigningRequestParams {
	...
	return DeleteCertificatesV1CollectionCertificateSigningRequestParams{}
}

// DeleteCertificatesV1CollectionCertificateSigningRequestParams contains all the bound params for the delete certificates v1 collection certificate signing request operation
// typically these are obtained from a http.Request
//
// swagger:parameters deleteCertificatesV1CollectionCertificateSigningRequest
...
//
// To ensure default values, the struct must have been initialized with NewDeleteCertificatesV1CollectionCertificateSigningRequestParams() beforehand.
func (o *DeleteCertificatesV1CollectionCertificateSigningRequestParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
...
func (o *DeleteCertificatesV1CollectionCertificateSigningRequestParams) bindContinue(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *DeleteCertificatesV1CollectionCertificateSigningRequestParams) validateContinue(formats strfmt.Registry) error {

	return nil
}

// bindDryRun binds and validates parameter DryRun from query.
func (o *DeleteCertificatesV1CollectionCertificateSigningRequestParams) bindDryRun(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *DeleteCertificatesV1CollectionCertificateSigningRequestParams) validateDryRun(formats strfmt.Registry) error {

	return nil
}

// bindFieldSelector binds and validates parameter FieldSelector from query.
func (o *DeleteCertificatesV1CollectionCertificateSigningRequestParams) bindFieldSelector(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *DeleteCertificatesV1CollectionCertificateSigningRequestParams) validateFieldSelector(formats strfmt.Registry) error {

	return nil
}

// bindGracePeriodSeconds binds and validates parameter GracePeriodSeconds from query.
func (o *DeleteCertificatesV1CollectionCertificateSigningRequestParams) bindGracePeriodSeconds(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *DeleteCertificatesV1CollectionCertificateSigningRequestParams) validateGracePeriodSeconds(formats strfmt.Registry) error {

	return nil
}

// bindLabelSelector binds and validates parameter LabelSelector from query.
func (o *DeleteCertificatesV1CollectionCertificateSigningRequestParams) bindLabelSelector(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *DeleteCertificatesV1CollectionCertificateSigningRequestParams) validateLabelSelector(formats strfmt.Registry) error {

	return nil
}

// bindLimit binds and validates parameter Limit from query.
func (o *DeleteCertificatesV1CollectionCertificateSigningRequestParams) bindLimit(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *DeleteCertificatesV1CollectionCertificateSigningRequestParams) validateLimit(formats strfmt.Registry) error {

	return nil
}

// bindOrphanDependents binds and validates parameter OrphanDependents from query.
func (o *DeleteCertificatesV1CollectionCertificateSigningRequestParams) bindOrphanDependents(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *DeleteCertificatesV1CollectionCertificateSigningRequestParams) validateOrphanDependents(formats strfmt.Registry) error {

	return nil
}

// bindPretty binds and validates parameter Pretty from query.
func (o *DeleteCertificatesV1CollectionCertificateSigningRequestParams) bindPretty(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *DeleteCertificatesV1CollectionCertificateSigningRequestParams) validatePretty(formats strfmt.Registry) error {

	return nil
}

// bindPropagationPolicy binds and validates parameter PropagationPolicy from query.
func (o *DeleteCertificatesV1CollectionCertificateSigningRequestParams) bindPropagationPolicy(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *DeleteCertificatesV1CollectionCertificateSigningRequestParams) validatePropagationPolicy(formats strfmt.Registry) error {

	return nil
}

// bindResourceVersion binds and validates parameter ResourceVersion from query.
func (o *DeleteCertificatesV1CollectionCertificateSigningRequestParams) bindResourceVersion(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *DeleteCertificatesV1CollectionCertificateSigningRequestParams) validateResourceVersion(formats strfmt.Registry) error {

	return nil
}

// bindResourceVersionMatch binds and validates parameter ResourceVersionMatch from query.
func (o *DeleteCertificatesV1CollectionCertificateSigningRequestParams) bindResourceVersionMatch(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *DeleteCertificatesV1CollectionCertificateSigningRequestParams) validateResourceVersionMatch(formats strfmt.Registry) error {

	return nil
}

// bindTimeoutSeconds binds and validates parameter TimeoutSeconds from query.
func (o *DeleteCertificatesV1CollectionCertificateSigningRequestParams) bindTimeoutSeconds(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *DeleteCertificatesV1CollectionCertificateSigningRequestParams) validateTimeoutSeconds(formats strfmt.Registry) error {

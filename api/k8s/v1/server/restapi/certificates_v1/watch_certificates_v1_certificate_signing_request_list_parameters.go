...
// NewWatchCertificatesV1CertificateSigningRequestListParams creates a new WatchCertificatesV1CertificateSigningRequestListParams object
...
func NewWatchCertificatesV1CertificateSigningRequestListParams() WatchCertificatesV1CertificateSigningRequestListParams {
	...
	return WatchCertificatesV1CertificateSigningRequestListParams{}
}

// WatchCertificatesV1CertificateSigningRequestListParams contains all the bound params for the watch certificates v1 certificate signing request list operation
// typically these are obtained from a http.Request
//
// swagger:parameters watchCertificatesV1CertificateSigningRequestList
...
//
// To ensure default values, the struct must have been initialized with NewWatchCertificatesV1CertificateSigningRequestListParams() beforehand.
func (o *WatchCertificatesV1CertificateSigningRequestListParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
...
func (o *WatchCertificatesV1CertificateSigningRequestListParams) bindAllowWatchBookmarks(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *WatchCertificatesV1CertificateSigningRequestListParams) validateAllowWatchBookmarks(formats strfmt.Registry) error {

	return nil
}

// bindContinue binds and validates parameter Continue from query.
func (o *WatchCertificatesV1CertificateSigningRequestListParams) bindContinue(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *WatchCertificatesV1CertificateSigningRequestListParams) validateContinue(formats strfmt.Registry) error {

	return nil
}

// bindFieldSelector binds and validates parameter FieldSelector from query.
func (o *WatchCertificatesV1CertificateSigningRequestListParams) bindFieldSelector(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *WatchCertificatesV1CertificateSigningRequestListParams) validateFieldSelector(formats strfmt.Registry) error {

	return nil
}

// bindLabelSelector binds and validates parameter LabelSelector from query.
func (o *WatchCertificatesV1CertificateSigningRequestListParams) bindLabelSelector(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *WatchCertificatesV1CertificateSigningRequestListParams) validateLabelSelector(formats strfmt.Registry) error {

	return nil
}

// bindLimit binds and validates parameter Limit from query.
func (o *WatchCertificatesV1CertificateSigningRequestListParams) bindLimit(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *WatchCertificatesV1CertificateSigningRequestListParams) validateLimit(formats strfmt.Registry) error {

	return nil
}

// bindPretty binds and validates parameter Pretty from query.
func (o *WatchCertificatesV1CertificateSigningRequestListParams) bindPretty(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *WatchCertificatesV1CertificateSigningRequestListParams) validatePretty(formats strfmt.Registry) error {

	return nil
}

// bindResourceVersion binds and validates parameter ResourceVersion from query.
func (o *WatchCertificatesV1CertificateSigningRequestListParams) bindResourceVersion(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *WatchCertificatesV1CertificateSigningRequestListParams) validateResourceVersion(formats strfmt.Registry) error {

	return nil
}

// bindResourceVersionMatch binds and validates parameter ResourceVersionMatch from query.
func (o *WatchCertificatesV1CertificateSigningRequestListParams) bindResourceVersionMatch(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *WatchCertificatesV1CertificateSigningRequestListParams) validateResourceVersionMatch(formats strfmt.Registry) error {

	return nil
}

// bindTimeoutSeconds binds and validates parameter TimeoutSeconds from query.
func (o *WatchCertificatesV1CertificateSigningRequestListParams) bindTimeoutSeconds(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *WatchCertificatesV1CertificateSigningRequestListParams) validateTimeoutSeconds(formats strfmt.Registry) error {

	return nil
}

// bindWatch binds and validates parameter Watch from query.
func (o *WatchCertificatesV1CertificateSigningRequestListParams) bindWatch(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *WatchCertificatesV1CertificateSigningRequestListParams) validateWatch(formats strfmt.Registry) error {

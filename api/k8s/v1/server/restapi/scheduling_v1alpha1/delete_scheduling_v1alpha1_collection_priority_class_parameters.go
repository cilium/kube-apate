...
func (o *DeleteSchedulingV1alpha1CollectionPriorityClassParams) bindResourceVersionMatch(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *DeleteSchedulingV1alpha1CollectionPriorityClassParams) validateResourceVersionMatch(formats strfmt.Registry) error {

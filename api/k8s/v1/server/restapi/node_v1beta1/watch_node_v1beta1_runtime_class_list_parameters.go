...
func (o *WatchNodeV1beta1RuntimeClassListParams) bindResourceVersionMatch(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *WatchNodeV1beta1RuntimeClassListParams) validateResourceVersionMatch(formats strfmt.Registry) error {

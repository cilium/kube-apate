...
func (o *DeleteNodeV1beta1CollectionRuntimeClassParams) bindResourceVersionMatch(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *DeleteNodeV1beta1CollectionRuntimeClassParams) validateResourceVersionMatch(formats strfmt.Registry) error {

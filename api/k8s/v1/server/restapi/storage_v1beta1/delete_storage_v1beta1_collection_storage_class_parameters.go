...
func (o *DeleteStorageV1beta1CollectionStorageClassParams) bindResourceVersionMatch(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *DeleteStorageV1beta1CollectionStorageClassParams) validateResourceVersionMatch(formats strfmt.Registry) error {

...
func (o *WatchRbacAuthorizationV1beta1RoleListForAllNamespacesParams) bindResourceVersionMatch(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *WatchRbacAuthorizationV1beta1RoleListForAllNamespacesParams) validateResourceVersionMatch(formats strfmt.Registry) error {

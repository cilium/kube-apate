...
func (o *ListRbacAuthorizationV1beta1ClusterRoleBindingParams) bindResourceVersionMatch(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *ListRbacAuthorizationV1beta1ClusterRoleBindingParams) validateResourceVersionMatch(formats strfmt.Registry) error {

...
func (o *DeleteSettingsV1alpha1CollectionNamespacedPodPresetParams) bindResourceVersionMatch(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *DeleteSettingsV1alpha1CollectionNamespacedPodPresetParams) validateResourceVersionMatch(formats strfmt.Registry) error {

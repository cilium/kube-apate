...
func (o *WatchSettingsV1alpha1NamespacedPodPresetParams) bindResourceVersionMatch(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *WatchSettingsV1alpha1NamespacedPodPresetParams) validateResourceVersionMatch(formats strfmt.Registry) error {

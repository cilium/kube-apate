...
func (o *WatchApiregistrationV1APIServiceParams) bindResourceVersionMatch(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *WatchApiregistrationV1APIServiceParams) validateResourceVersionMatch(formats strfmt.Registry) error {

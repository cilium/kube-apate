...
func (o *WatchStorageV1alpha1VolumeAttachmentListParams) bindResourceVersionMatch(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *WatchStorageV1alpha1VolumeAttachmentListParams) validateResourceVersionMatch(formats strfmt.Registry) error {

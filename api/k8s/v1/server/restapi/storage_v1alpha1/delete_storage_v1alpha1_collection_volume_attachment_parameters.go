...
func (o *DeleteStorageV1alpha1CollectionVolumeAttachmentParams) bindResourceVersionMatch(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *DeleteStorageV1alpha1CollectionVolumeAttachmentParams) validateResourceVersionMatch(formats strfmt.Registry) error {

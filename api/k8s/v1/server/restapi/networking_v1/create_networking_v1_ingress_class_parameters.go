...
// CreateNetworkingV1IngressClassParams contains all the bound params for the create networking v1 ingress class operation
...
func (o *CreateNetworkingV1IngressClassParams) bindDryRun(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *CreateNetworkingV1IngressClassParams) validateDryRun(formats strfmt.Registry) error {

	return nil
}

// bindFieldManager binds and validates parameter FieldManager from query.
func (o *CreateNetworkingV1IngressClassParams) bindFieldManager(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *CreateNetworkingV1IngressClassParams) validateFieldManager(formats strfmt.Registry) error {

	return nil
}

// bindPretty binds and validates parameter Pretty from query.
func (o *CreateNetworkingV1IngressClassParams) bindPretty(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *CreateNetworkingV1IngressClassParams) validatePretty(formats strfmt.Registry) error {

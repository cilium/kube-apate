...
func (o *ListCoordinationV1beta1NamespacedLeaseParams) bindResourceVersionMatch(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *ListCoordinationV1beta1NamespacedLeaseParams) validateResourceVersionMatch(formats strfmt.Registry) error {

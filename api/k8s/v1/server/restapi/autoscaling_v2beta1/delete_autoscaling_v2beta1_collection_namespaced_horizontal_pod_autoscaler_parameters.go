...
func (o *DeleteAutoscalingV2beta1CollectionNamespacedHorizontalPodAutoscalerParams) bindResourceVersionMatch(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *DeleteAutoscalingV2beta1CollectionNamespacedHorizontalPodAutoscalerParams) validateResourceVersionMatch(formats strfmt.Registry) error {

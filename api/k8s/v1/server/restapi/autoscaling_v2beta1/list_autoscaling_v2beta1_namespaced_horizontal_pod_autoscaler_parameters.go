...
func (o *ListAutoscalingV2beta1NamespacedHorizontalPodAutoscalerParams) bindResourceVersionMatch(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *ListAutoscalingV2beta1NamespacedHorizontalPodAutoscalerParams) validateResourceVersionMatch(formats strfmt.Registry) error {

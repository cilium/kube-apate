...
func (o *WatchFlowcontrolApiserverV1alpha1PriorityLevelConfigurationParams) bindResourceVersionMatch(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *WatchFlowcontrolApiserverV1alpha1PriorityLevelConfigurationParams) validateResourceVersionMatch(formats strfmt.Registry) error {

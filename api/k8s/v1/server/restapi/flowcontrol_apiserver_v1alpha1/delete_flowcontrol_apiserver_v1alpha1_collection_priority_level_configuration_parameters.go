...
func (o *DeleteFlowcontrolApiserverV1alpha1CollectionPriorityLevelConfigurationParams) bindResourceVersionMatch(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *DeleteFlowcontrolApiserverV1alpha1CollectionPriorityLevelConfigurationParams) validateResourceVersionMatch(formats strfmt.Registry) error {

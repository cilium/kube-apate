...
func (o *ListFlowcontrolApiserverV1alpha1FlowSchemaParams) bindResourceVersionMatch(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *ListFlowcontrolApiserverV1alpha1FlowSchemaParams) validateResourceVersionMatch(formats strfmt.Registry) error {

...
func (o *DeleteFlowcontrolApiserverV1alpha1CollectionFlowSchemaParams) bindResourceVersionMatch(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *DeleteFlowcontrolApiserverV1alpha1CollectionFlowSchemaParams) validateResourceVersionMatch(formats strfmt.Registry) error {

...
func (o *WatchFlowcontrolApiserverV1alpha1PriorityLevelConfigurationListParams) bindResourceVersionMatch(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *WatchFlowcontrolApiserverV1alpha1PriorityLevelConfigurationListParams) validateResourceVersionMatch(formats strfmt.Registry) error {

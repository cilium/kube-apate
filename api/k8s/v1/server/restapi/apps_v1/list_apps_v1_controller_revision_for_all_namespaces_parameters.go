...
func (o *ListAppsV1ControllerRevisionForAllNamespacesParams) bindResourceVersionMatch(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *ListAppsV1ControllerRevisionForAllNamespacesParams) validateResourceVersionMatch(formats strfmt.Registry) error {

...
func (o *DeleteAppsV1CollectionNamespacedReplicaSetParams) bindResourceVersionMatch(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *DeleteAppsV1CollectionNamespacedReplicaSetParams) validateResourceVersionMatch(formats strfmt.Registry) error {

...
func (o *ListAppsV1NamespacedStatefulSetParams) bindResourceVersionMatch(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *ListAppsV1NamespacedStatefulSetParams) validateResourceVersionMatch(formats strfmt.Registry) error {

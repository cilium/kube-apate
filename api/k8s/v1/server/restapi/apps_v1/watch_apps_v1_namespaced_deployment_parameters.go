...
func (o *WatchAppsV1NamespacedDeploymentParams) bindResourceVersionMatch(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *WatchAppsV1NamespacedDeploymentParams) validateResourceVersionMatch(formats strfmt.Registry) error {

...
func (o *ListNetworkingV1beta1IngressClassParams) bindResourceVersionMatch(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *ListNetworkingV1beta1IngressClassParams) validateResourceVersionMatch(formats strfmt.Registry) error {

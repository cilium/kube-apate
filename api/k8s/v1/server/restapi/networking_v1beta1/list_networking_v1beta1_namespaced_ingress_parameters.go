...
func (o *ListNetworkingV1beta1NamespacedIngressParams) bindResourceVersionMatch(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *ListNetworkingV1beta1NamespacedIngressParams) validateResourceVersionMatch(formats strfmt.Registry) error {

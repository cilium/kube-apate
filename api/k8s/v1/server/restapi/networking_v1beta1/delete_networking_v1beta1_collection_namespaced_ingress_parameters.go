...
func (o *DeleteNetworkingV1beta1CollectionNamespacedIngressParams) bindResourceVersionMatch(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *DeleteNetworkingV1beta1CollectionNamespacedIngressParams) validateResourceVersionMatch(formats strfmt.Registry) error {

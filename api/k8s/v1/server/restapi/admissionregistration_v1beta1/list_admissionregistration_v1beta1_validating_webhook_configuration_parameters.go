...
func (o *ListAdmissionregistrationV1beta1ValidatingWebhookConfigurationParams) bindResourceVersionMatch(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *ListAdmissionregistrationV1beta1ValidatingWebhookConfigurationParams) validateResourceVersionMatch(formats strfmt.Registry) error {

...
func (o *DeleteAdmissionregistrationV1beta1CollectionValidatingWebhookConfigurationParams) bindResourceVersionMatch(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *DeleteAdmissionregistrationV1beta1CollectionValidatingWebhookConfigurationParams) validateResourceVersionMatch(formats strfmt.Registry) error {

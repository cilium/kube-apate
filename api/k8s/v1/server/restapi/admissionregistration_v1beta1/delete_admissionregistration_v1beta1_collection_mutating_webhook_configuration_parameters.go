...
func (o *DeleteAdmissionregistrationV1beta1CollectionMutatingWebhookConfigurationParams) bindResourceVersionMatch(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *DeleteAdmissionregistrationV1beta1CollectionMutatingWebhookConfigurationParams) validateResourceVersionMatch(formats strfmt.Registry) error {

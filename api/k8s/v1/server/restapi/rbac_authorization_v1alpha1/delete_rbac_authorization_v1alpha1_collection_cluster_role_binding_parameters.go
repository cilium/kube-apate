...
func (o *DeleteRbacAuthorizationV1alpha1CollectionClusterRoleBindingParams) bindResourceVersionMatch(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *DeleteRbacAuthorizationV1alpha1CollectionClusterRoleBindingParams) validateResourceVersionMatch(formats strfmt.Registry) error {

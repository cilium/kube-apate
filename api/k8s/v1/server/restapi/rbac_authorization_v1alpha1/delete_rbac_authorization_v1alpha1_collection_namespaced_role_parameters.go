...
func (o *DeleteRbacAuthorizationV1alpha1CollectionNamespacedRoleParams) bindResourceVersionMatch(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *DeleteRbacAuthorizationV1alpha1CollectionNamespacedRoleParams) validateResourceVersionMatch(formats strfmt.Registry) error {

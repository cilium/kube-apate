...
func (o *WatchBatchV2alpha1NamespacedCronJobListParams) bindResourceVersionMatch(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *WatchBatchV2alpha1NamespacedCronJobListParams) validateResourceVersionMatch(formats strfmt.Registry) error {

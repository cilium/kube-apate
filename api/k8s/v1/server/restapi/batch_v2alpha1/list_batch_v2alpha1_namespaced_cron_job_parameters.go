...
func (o *ListBatchV2alpha1NamespacedCronJobParams) bindResourceVersionMatch(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *ListBatchV2alpha1NamespacedCronJobParams) validateResourceVersionMatch(formats strfmt.Registry) error {

...
func (o *DeleteBatchV2alpha1CollectionNamespacedCronJobParams) bindResourceVersionMatch(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *DeleteBatchV2alpha1CollectionNamespacedCronJobParams) validateResourceVersionMatch(formats strfmt.Registry) error {

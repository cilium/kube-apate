...
func (o *DeleteRbacAuthorizationV1CollectionClusterRoleParams) bindResourceVersionMatch(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *DeleteRbacAuthorizationV1CollectionClusterRoleParams) validateResourceVersionMatch(formats strfmt.Registry) error {

...
func (o *WatchDiscoveryV1beta1NamespacedEndpointSliceListParams) bindResourceVersionMatch(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *WatchDiscoveryV1beta1NamespacedEndpointSliceListParams) validateResourceVersionMatch(formats strfmt.Registry) error {

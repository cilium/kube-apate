...
func (o *DeleteDiscoveryV1beta1CollectionNamespacedEndpointSliceParams) bindResourceVersionMatch(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *DeleteDiscoveryV1beta1CollectionNamespacedEndpointSliceParams) validateResourceVersionMatch(formats strfmt.Registry) error {

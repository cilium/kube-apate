...
func (o *WatchDiscoveryV1beta1NamespacedEndpointSliceParams) bindResourceVersionMatch(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *WatchDiscoveryV1beta1NamespacedEndpointSliceParams) validateResourceVersionMatch(formats strfmt.Registry) error {

...
func (fn ListEventsV1NamespacedEventHandlerFunc) Handle(params ListEventsV1NamespacedEventParams) middleware.Responder {
	return fn(params)
}
...
func NewListEventsV1NamespacedEvent(ctx *middleware.Context, handler ListEventsV1NamespacedEventHandler) *ListEventsV1NamespacedEvent {
	return &ListEventsV1NamespacedEvent{Context: ctx, Handler: handler}
}
...
func (o *ListEventsV1NamespacedEvent) ServeHTTP(rw http.ResponseWriter, r *http.Request) {
	route, rCtx, _ := o.Context.RouteInfo(r)
	if rCtx != nil {
		r = rCtx
	}
	var Params = NewListEventsV1NamespacedEventParams()

...
func (fn WatchEventsV1NamespacedEventListHandlerFunc) Handle(params WatchEventsV1NamespacedEventListParams) middleware.Responder {
	return fn(params)
}
...
func NewWatchEventsV1NamespacedEventList(ctx *middleware.Context, handler WatchEventsV1NamespacedEventListHandler) *WatchEventsV1NamespacedEventList {
	return &WatchEventsV1NamespacedEventList{Context: ctx, Handler: handler}
}
...
func (o *WatchEventsV1NamespacedEventList) ServeHTTP(rw http.ResponseWriter, r *http.Request) {
	route, rCtx, _ := o.Context.RouteInfo(r)
	if rCtx != nil {
		r = rCtx
	}
	var Params = NewWatchEventsV1NamespacedEventListParams()
